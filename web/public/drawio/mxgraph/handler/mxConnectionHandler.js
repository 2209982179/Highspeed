  ...
  if (target != null || this.isCreateTarget(evt) || this.graph.allowDanglingEdges) {
    ...
    try {
      ...
      if (edge != null) {
        ...
        if (this.isInsertBefore(edge, source, target, evt, dropTarget) && (this.constraintHandler.currentConstraint == null || this.constraintHandler.currentConstraint.perimeter)) {
          var tmp = source;
