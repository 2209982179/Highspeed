...
mxEdgeHandler.prototype.mouseMove = function (sender, me) {
  if (this.index != null && this.marker != null) {
    ...
    if (this.snapPoint != null && mxEvent.isShiftDown(me.getEvent()) && !this.graph.isIgnoreTerminalEvent(me.getEvent()) && constraintHandler.currentFocus == null && constraintHandler.currentFocus != this.state) {
    ...
    me.consume();
  } else if (!mxEvent.isControlDown(me.getEvent()) && !mxEvent.isShiftDown(me.getEvent()) && this.mouseDownX != null && this.mouseDownY != null && this.handle != null) {
