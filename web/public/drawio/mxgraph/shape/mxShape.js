...
mxShape.prototype.configurePointerEvents = function (c) {
  if (this.style != null && (this.fill == null || this.fill == mxConstants.NONE || this.opacity == 0 || this.fillOpacity == 0) && mxUtils.getValue(this.style, mxConstants.STYLE_POINTER_EVENTS, '1') == '0') {
...
mxShape.prototype.intersectsRectangle = function (rect, ignoreNode) {
  return rect != null && (ignoreNode || this.node != null && this.node.style.display != 'none' && this.node.style.visibility != 'hidden') && mxUtils.intersects(this.bounds, rect, true);
};
