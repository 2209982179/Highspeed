...
Draw.loadPlugin(function (ui) {
      ...
      if (!this.isEditable()) {
        ...
        var doSave = mxUtils.bind(this, function () {
          try {
            ...
            ui.remoteInvoke('saveFile', this.desc.ver > 1 ? [this.desc.id, this.desc.shareToken, savedData, etag] : [this.desc.path, savedData, etag], null, mxUtils.bind(this, function (resp) {
              try {
                ...
                if (this.isConflict(err)) {
                  ...
                  if (this.sync != null) {
                    ...
                    this.sync.fileConflict(null, mxUtils.bind(this, function () {
                      ...
                      EditorUi.debug('EmbedFile.saveFile.conflict', [this], 'err', err, 'delay', delay);
  ...
  EmbedFile.prototype.getLatestVersion = function (success, error) {
    ui.remoteInvoke('loadFile', this.desc.ver > 1 ? [this.desc.id, this.desc.shareToken] : [this.desc.path], null, mxUtils.bind(this, function (data) {
      var xml = data.xml;
      delete data.xml;
