  ...
  return function a(b, c, d) {
    ...
    9: [function (a, b, c) {
      ...
      var j = function () {
        function a(a, b, c) {
          void 0 === c && (c = 12);
          var e = this;
          this.originalnodes = a, this.groupPadding = c, this.leaves = null, this.nodes = a.map(function (a, c) {
    ...
    10: [function (a, b, c) {
      ...
      function d(a, b, c, d, e) {
        ...
        function h(a, b) {
          for (var c = void 0, d = 0; d < s.length; d++) if (s[d].space_left >= a.height && s[d].x + s[d].width + a.width + f.PADDING - b <= f.FLOAT_EPSILON) {
            c = s[d];
            break;
          }
          s.push(a), void 0 !== c ? (a.x = c.x + c.width + f.PADDING, a.y = c.bottom, a.space_left = a.height, a.bottom = a.y, c.space_left -= a.height + f.PADDING, c.bottom += a.height + f.PADDING) : (a.y = r, r += a.height + f.PADDING, a.x = k, a.bottom = a.y, a.space_left = a.height), a.y + a.height - p > -f.FLOAT_EPSILON && (p = a.y + a.height - l), a.x + a.width - o > -f.FLOAT_EPSILON && (o = a.x + a.width - k);
        }
        function i(a) {
          var b = 0;
        ...
        0 != a.length && (function (a) {
          ...
          for (var e = p = q, h = r = i(a), j = 0, k = Number.MAX_VALUE, l = Number.MAX_VALUE, m = -1, n = Number.MAX_VALUE, o = Number.MAX_VALUE; n > q || o > f.FLOAT_EPSILON;) {
            if (1 != m) var p = h - (h - e) / f.GOLDEN_SECTION,
              k = g(a, p);
            if (0 != m) var r = e + (h - e) / f.GOLDEN_SECTION,
              l = g(a, r);
            if (n = Math.abs(p - r), o = Math.abs(k - l), k < c && (c = k, d = p), l < c && (c = l, d = r), k > l ? (e = p, p = r, k = l, m = 1) : (h = r, r = p, l = k, m = 0), j++ > 100) break;
          }
          g(a, d);
        }(a), function (a) {
          a.forEach(function (a) {
    ...
    11: [function (a, b, c) {
      ...
      var m = function () {
        ...
        return a.prototype.on = function (a, b) {
          ...
          var u;
          this._distanceMatrix ? u = this._distanceMatrix : (u = new j.Calculator(n, this._links, a.getSourceIndex, a.getTargetIndex, function (a) {
            return k.getLinkLength(a);
          }).DistanceMatrix(), s = h.Descent.createSquareMatrix(n, function () {
            return 2;
          }), this._links.forEach(function (a) {
          ...
          if (this._rootGroup && void 0 !== this._rootGroup.groups) {
            ...
            this._groups.forEach(function (a) {
              w(l, l + 1, k._groupCompactness, .1), q[l] = 0, r[l++] = 0, q[l] = 0, r[l++] = 0;
            });
          ...
          this._directedLinkConstraints && (this.linkAccessor.getMinSeparation = this._directedLinkConstraints.getMinSeparation, x = x.concat(g.generateDirectedEdgeConstraints(m, this._links, this._directedLinkConstraints.axis, this.linkAccessor))), this.avoidOverlaps(!1), this._descent = new h.Descent([q, r], v), this._descent.locks.clear();
          for (var l = 0; l < m; ++l) {
            var y = this._nodes[l];
            if (y.fixed) {
              y.px = y.x, y.py = y.y;
          ...
          if (this._descent.threshold = this._threshold, this.initialLayout(b, q, r), x.length > 0 && (this._descent.project = new i.Projection(this._nodes, this._groups, this._rootGroup, x).projectFunctions()), this._descent.run(c), this.separateOverlappingComponents(o, p), this.avoidOverlaps(t), t && (this._nodes.forEach(function (a, b) {
            a.x = q[b], a.y = r[b];
          }), this._descent.project = new i.Projection(this._nodes, this._groups, this._rootGroup, x, !0).projectFunctions(), this._nodes.forEach(function (a, b) {
            q[b] = a.x, r[b] = a.y;
          })), this._descent.G = s, this._descent.run(d), e) {
            this._descent.snapStrength = 1e3, this._descent.snapGridSize = this._nodes[0].width, this._descent.numGridSnapNodes = m, this._descent.scaleSnapByMaxH = m != n;
    ...
    12: [function (a, b, c) {
      ...
      var j = function () {
        function a(b, c, d) {
          void 0 === d && (d = 1);
          var e = this;
          this.nodes = b, this.links = c, this.idealLinkLength = d, this.constraints = null, this.useJaccardLinkLengths = !0, this.result = new Array(a.k);
    ...
    17: [function (a, b, c) {
      ...
      var A = function () {
        function a(a, b, c, e, f) {
          ...
          var g = this;
          if (this.nodes = a, this.groups = b, this.rootGroup = c, this.avoidOverlaps = f, this.variables = a.map(function (a, b) {
