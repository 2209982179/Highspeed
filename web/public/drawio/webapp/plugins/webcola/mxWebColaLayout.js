 ...
 */
{
  ...
  var maxX = -1000000;
  var maxY = -1000000;
  if (groupCell.children == null || groupCell.children.length == 0) return null;
  var cellsToVisit = [];
 ...
 */
{
  if (groupCell.children == null || groupCell.children.length == 0) return;
  ...
  try {
    ...
    for (var id in cells) {
      ...
      if (cell.isVertex() && this.layout.isLeafOrCollapsed(cell)) {
        ...
        if (typeof nodeId == "undefined") continue;
