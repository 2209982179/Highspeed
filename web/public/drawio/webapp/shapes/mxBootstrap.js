...
mxShapeBootstrapCheckbox2.prototype.customProperties = [{
  ...
  name: 'checkedFill',
  dispName: 'Checked Fill Color',
  type: 'color',
  defVal: '#ffffff'
}, {
  name: 'checkedStroke',
  dispName: 'Checked Stroke Color',
  type: 'color',
  defVal: '#000000'
}];
...
mxShapeBootstrapSwitch.prototype.customProperties = [{
  ...
  name: 'onStrokeColor',
  dispName: 'On Stroke Color',
  type: 'color'
}, {
  name: 'onFillColor',
  dispName: 'On Fill Color',
  type: 'color'
}];
...
mxShapeInfographicPopover.prototype.cst = {
  SHAPE_POPOVER: 'mxgraph.bootstrap.popover'
};
