...
mxShapeElectricalDCSource3_v2.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0.5, 0), true), new mxConnectionConstraint(new mxPoint(0.5, 1), true)];
...
mxShapeElectricalSource.prototype.customProperties = [{
  name: 'elSourceType',
  dispName: 'Source Type',
  type: 'enum',
  defVal: 'independent',
  enumList: [{
    val: 'independent',
    dispName: 'Independent'
  }, {
    val: 'dependent',
    dispName: 'Dependent'
  }]
  ...
  enumList: [{
    ...
    val: 'expSquib',
    dispName: 'Explosive Squib'
  }, {
    val: 'pulse',
    dispName: 'Pulse'
  }, {
    val: 'invPulse',
    dispName: 'Inverse Pulse'
  }, {
    val: 'chopSquare',
    dispName: 'Chopped Square'
  }, {
    val: 'stepOn',
    dispName: 'Step On'
  }, {
    ...
    val: 'dc1',
    dispName: 'DC Horizontal'
  }, {
    val: 'dc2',
    dispName: 'DC Vertical'
  }, {
    val: 'dc3',
    dispName: 'DC Plus minus'
  }]
}];
...
mxShapeElectricalTwoWaySwitch.prototype.constraints = [new mxConnectionConstraint(new mxPoint(1, 0.12), true), new mxConnectionConstraint(new mxPoint(0, 0.5), true), new mxConnectionConstraint(new mxPoint(1, 0.88), true)];
...
mxShapeElectricalPushbutton.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.8), true), new mxConnectionConstraint(new mxPoint(1, 0.8), true)];
...
mxShapeElectricalSingleSwitch.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.8), true), new mxConnectionConstraint(new mxPoint(1, 0.8), true)];
...
mxShapeElectricalSwitchDisconnector.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.84), true), new mxConnectionConstraint(new mxPoint(1, 0.84), true)];
...
mxShapeElectricalFuse2.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.8), true), new mxConnectionConstraint(new mxPoint(1, 0.8), true)];
...
mxShapeElectricalLiquidLevelActuatedSwitch.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.27), true), new mxConnectionConstraint(new mxPoint(1, 0.27), true)];
...
mxShapeElectricalLiquidLevelActuatedSwitch2.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 1), true), new mxConnectionConstraint(new mxPoint(1, 1), true)];
...
mxShapeElectricalGasFlowActuatedSwitch.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 1), true), new mxConnectionConstraint(new mxPoint(1, 1), true)];
...
mxShapeElectricalFlowActuatedSwitch.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.27), true), new mxConnectionConstraint(new mxPoint(1, 0.27), true)];
...
mxShapeElectricalPressureActuatedSwitch.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.1), true), new mxConnectionConstraint(new mxPoint(1, 0.1), true)];
...
mxShapeElectricalTemperatureActuatedSwitch.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.1), true), new mxConnectionConstraint(new mxPoint(1, 0.1), true)];
...
mxShapeElectricalSafetyInterlockSwitch.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.35), true), new mxConnectionConstraint(new mxPoint(1, 0.35), true)];
...
mxShapeElectricalTemperatureSwitch.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 1), true), new mxConnectionConstraint(new mxPoint(1, 1), true)];
...
mxShapeElectricalThermostat2.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 1), true), new mxConnectionConstraint(new mxPoint(1, 1), true)];
...
mxShapeElectricalLimitSwitch2.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 1), true), new mxConnectionConstraint(new mxPoint(1, 1), true)];
...
mxShapeElectricalCircuitBreaker2.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.8), true), new mxConnectionConstraint(new mxPoint(1, 0.8), true)];
...
mxShapeElectricalSelectorSwitch3Position2.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.8), true), new mxConnectionConstraint(new mxPoint(1, 0.8), true)];
...
mxShapeElectricalSelectorSwitch4Position2.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.8), true), new mxConnectionConstraint(new mxPoint(1, 0.8), true)];
...
mxShapeElectricalSelectorSwitch6Position2.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.5), true), new mxConnectionConstraint(new mxPoint(1, 0.03), true), new mxConnectionConstraint(new mxPoint(1, 0.22), true), new mxConnectionConstraint(new mxPoint(1, 0.405), true), new mxConnectionConstraint(new mxPoint(1, 0.595), true), new mxConnectionConstraint(new mxPoint(1, 0.78), true), new mxConnectionConstraint(new mxPoint(1, 0.97), true)];
...
mxShapeElectricalShortingSelectorSwitch2.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.5), true)];
...
mxShapeElectricalProximityLimitSwitch2.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.5), true), new mxConnectionConstraint(new mxPoint(1, 0.5), true)];
...
mxShapeElectricalInertiaSwitch2.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.85), true), new mxConnectionConstraint(new mxPoint(1, 0.85), true)];
...
mxShapeElectricalPushbuttonBreak2.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.8), true), new mxConnectionConstraint(new mxPoint(1, 0.8), true)];
...
mxShapeElectricalManualSwitch2.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.8), true), new mxConnectionConstraint(new mxPoint(1, 0.8), true)];
...
mxShapeElectricalTwoWayContact2.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.5), true), new mxConnectionConstraint(new mxPoint(1, 0), true), new mxConnectionConstraint(new mxPoint(1, 1), true)];
...
mxShapeElectricalPassingMakeContact2.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.7), true), new mxConnectionConstraint(new mxPoint(1, 0.7), true)];
...
mxShapeElectricalDPST2.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.4), true), new mxConnectionConstraint(new mxPoint(0, 0.92), true), new mxConnectionConstraint(new mxPoint(1, 0.4), true), new mxConnectionConstraint(new mxPoint(1, 0.92), true)];
...
mxShapeElectricalSpringReturn3.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.62), true), new mxConnectionConstraint(new mxPoint(1, 0.62), true)];
...
mxShapeElectricalLimitSwitch.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.16), true), new mxConnectionConstraint(new mxPoint(1, 0.16), true)];
...
mxShapeElectricalDPDT3.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.23), true), new mxConnectionConstraint(new mxPoint(0, 0.79), true), new mxConnectionConstraint(new mxPoint(1, 0.05), true), new mxConnectionConstraint(new mxPoint(1, 0.39), true), new mxConnectionConstraint(new mxPoint(1, 0.61), true), new mxConnectionConstraint(new mxPoint(1, 0.95), true)];
...
mxShapeElectricalTwoPositionSwitch2.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.5), true), new mxConnectionConstraint(new mxPoint(1, 0.5), true), new mxConnectionConstraint(new mxPoint(0.5, 0), true), new mxConnectionConstraint(new mxPoint(0.5, 1), true)];
...
mxShapeElectricalThreePositionSwitch2.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0.5, 0), true), new mxConnectionConstraint(new mxPoint(0, 1), true), new mxConnectionConstraint(new mxPoint(1, 1), true)];
...
mxShapeElectricalFourPositionSwitch2.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.5), true), new mxConnectionConstraint(new mxPoint(1, 0.5), true), new mxConnectionConstraint(new mxPoint(0.5, 0), true), new mxConnectionConstraint(new mxPoint(0.5, 1), true)];
...
mxShapeElectricalPushbuttonMakeSwitch2.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.94), true), new mxConnectionConstraint(new mxPoint(1, 0.94), true)];
...
mxShapeElectricalPushbuttonTwoCircuitSwitch2.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.68), true), new mxConnectionConstraint(new mxPoint(1, 0.68), true), new mxConnectionConstraint(new mxPoint(0, 0.96), true), new mxConnectionConstraint(new mxPoint(1, 0.96), true)];
...
mxShapeElectricalTimeDelaySwitch.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.13), true), new mxConnectionConstraint(new mxPoint(1, 0.13), true)];
...
mxShapeElectricalTimeDelaySwitch2.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.45), true), new mxConnectionConstraint(new mxPoint(1, 0.45), true)];
...
mxShapeElectricalIsolatorSwitch2.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.8), true), new mxConnectionConstraint(new mxPoint(1, 0.8), true)];
...
mxShapeElectricalChangeoverContactSwitch2.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.8), true), new mxConnectionConstraint(new mxPoint(0, 0.8), true), new mxConnectionConstraint(new mxPoint(1, 0.8), true)];
...
mxShapeElectricalReedSwitch2.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0, 0.5), true), new mxConnectionConstraint(new mxPoint(1, 0.5), true)];