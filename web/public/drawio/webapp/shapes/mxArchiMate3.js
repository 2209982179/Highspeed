...
mxArchiMate3Application.prototype.customProperties = [{
  ...
  enumList: [{
    ...
    val: 'valueStream',
    dispName: 'Value Stream'
  }, {
    val: 'workPackage',
    dispName: 'Work Package'
  }]
}];
...
mxArchiMate3Application.prototype.foreground = function (c, x, y, w, h) {
  ...
  } else if (type === mxArchiMate3Application.prototype.cst.GENERIC) {} else if (type === mxArchiMate3Application.prototype.cst.NETWORK) {
