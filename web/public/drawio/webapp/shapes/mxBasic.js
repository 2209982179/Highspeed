...
mxShapeBasicPolygon.prototype.cst = {
...
mxShapeBasicPatternFillRect.prototype.cst = {
  PATTERN_FILL_RECT: 'mxgraph.basic.patternFillRect'
};
mxShapeBasicPatternFillRect.prototype.customProperties = [{
  ...
  enumList: [{
    ...
    val: 'diagGrid',
    dispName: 'Diagonal Grid'
  }]
}, {
  name: 'fillStrokeWidth',
  dispName: 'Fill Stroke Width',
  type: 'float',
  min: 0,
  defVal: 1
}, {
  name: 'fillStrokeColor',
  dispName: 'Fill Stroke Color',
  type: 'color',
  defVal: '#cccccc'
}, {
  name: 'top',
