...
!function () {
  ...
  var t = {
      515: function (t, e, r) {
        ...
        function i(t, e) {
          ...
          try {
            for (var u = n(Object.keys(e)), c = u.next(); !c.done; c = u.next()) {
              var l = c.value;
              "__esModule" !== l && (!a(t[l]) || !a(e[l]) || e[l] instanceof Promise ? null !== e[l] && void 0 !== e[l] && (t[l] = e[l]) : i(t[l], e[l]));
            }
          } catch (t) {
            r = {
              error: t
        ...
        e.isObject = a, e.combineConfig = i, e.combineDefaults = function t(e, r, o) {
          var i, u;
          e[r] || (e[r] = {}), e = e[r];
          try {
      ...
      235: function (t, e, r) {
        ...
        if (e.PathFilters = {
          ...
          t.versions = new Map(), t.ready = function () {
            ...
            for (var r, n, o = [], i = 0; i < arguments.length; i++) o[i] = arguments[i];
            ...
            var c = [],
              l = function (r) {
                ...
                n || (n = new u.Package(r)).provides(e.CONFIG.provides[r]), n.checkNoLoad(), c.push(n.promise.then(function () {
                  e.CONFIG.versionWarnings && n.isLoaded && !t.versions.has(u.Package.resolvePath(r)) && console.warn("No version information available for component ".concat(r));
                }));
              };
            try {
            ...
            return t.versions.set(u.Package.resolvePath(n), r), !(!e.CONFIG.versionWarnings || o === r) && (console.warn("Component ".concat(n, " uses ").concat(o, " of MathJax; version in use is ").concat(r)), !0);
          }, t.pathFilters = new s.FunctionList(), t.pathFilters.add(e.PathFilters.source, 0), t.pathFilters.add(e.PathFilters.normalize, 10), t.pathFilters.add(e.PathFilters.prefix, 20);
        }(l = e.Loader || (e.Loader = {})), e.MathJax = i.MathJax, void 0 === e.MathJax.loader) {
          ...
          return Object.defineProperty(t.prototype, "canLoad", {
            ...
            try {
              for (var d = a(f), p = d.next(); !p.done; p = d.next()) {
                var h = p.value,
                  y = o.get(h) || new t(h, l);
                this.dependencies.indexOf(y) < 0 && (y.addDependent(this, l), this.dependencies.push(y), y.isLoaded || (this.dependencyCount++, n.push(y.promise)));
              }
            } catch (t) {
              e = {
                error: t
            ...
            var t = this;
            ((c.CONFIG[this.name] || {}).checkReady || function () {
            ...
            try {
              for (var o = a(e), i = o.next(); !i.done; i = o.next()) {
                var u = i.value,
                  l = t.packages.get(u);
                l || (c.CONFIG.dependencies[u] || (c.CONFIG.dependencies[u] = []), c.CONFIG.dependencies[u].push(u), (l = new t(u, !0)).isLoading = !0), this.provided.push(l);
              }
            } catch (t) {
              r = {
                error: t
      ...
      388: function (t, e, r) {
        ...
        !function (t) {
          ...
          function p() {
            u = new e.MathJax._.core.MmlTree.SerializedMmlVisitor.SerializedMmlVisitor(), c = e.MathJax._.mathjax.mathjax, t.input = b(), t.output = g(), t.adaptor = O(), t.handler && c.handlers.unregister(t.handler), t.handler = w(), t.handler && (c.handlers.register(t.handler), t.document = P());
          }
          function h() {
            var e, r;
            t.input && t.output && y();
          ...
          function y() {
            e.MathJax.typeset = function (e) {
              ...
              return void 0 === e && (e = null), t.document.options.elements = e, t.document.reset(), c.handleRetriesFor(function () {
                t.document.render();
              });
          ...
          function v(r, n, o) {
            ...
            e.MathJax[a] = function (e, r) {
              ...
              return void 0 === r && (r = {}), r.format = o.name, c.handleRetriesFor(function () {
          ...
          function m(r, n) {
            ...
            e.MathJax[r + "2mml"] = function (e, r) {
              ...
              return void 0 === r && (r = {}), r.end = o.CONVERT, r.format = n.name, c.handleRetriesFor(function () {
          ...
          function b() {
            ...
            try {
              for (var i = o(e.CONFIG.input), u = i.next(); !u.done; u = i.next()) {
                var c = u.value,
                  l = t.constructors[c];
                if (!l) throw Error('Input Jax "' + c + '" is not defined (has it been loaded?)');
          ...
          function w() {
            ...
            if (!i) throw Error('Handler "' + a + '" is not defined (has it been loaded?)');
          ...
          t.constructors = {}, t.input = [], t.output = null, t.handler = null, t.adaptor = null, t.elements = null, t.document = null, t.promise = new Promise(function (e, r) {
          ...
          }), t.toMML = d, t.registerConstructor = function (e, r) {
            t.constructors[e] = r;
            ...
            p(), h(), t.pagePromise.then(function () {
          ...
          }, t.getComponents = p, t.makeMethods = h, t.makeTypesetMethods = y, t.makeOutputMethods = v, t.makeMmlMethods = m, t.makeResetMethod = x, t.getInputJax = b, t.getOutputJax = g, t.getAdaptor = O, t.getHandler = w, t.getDocument = P;
        }(u = e.Startup || (e.Startup = {})), e.MathJax = c.MathJax, void 0 === e.MathJax._.startup && ((0, c.combineDefaults)(e.MathJax.config, "startup", {
          input: [],
          output: "",
          handler: null,
          adaptor: null,
        ...
        }), (0, c.combineWithMathJax)({
          startup: u,
          options: {}
        }), e.MathJax.config.startup.invalidOption && (s.OPTIONS.invalidOption = e.MathJax.config.startup.invalidOption), e.MathJax.config.startup.optionError && (s.OPTIONS.optionError = e.MathJax.config.startup.optionError)), e.CONFIG = e.MathJax.config.startup;
            ...
            return new Promise(function (e, o) {
              !function a() {
                for (var c; ++r < n.length;) {
                  ...
                  if (l instanceof Promise) return void l.then(a).catch(function (t) {
                    return o(t);
                  });
      ...
      233: function (t, e) {
        ...
        e.isObject = i, e.APPEND = "[+]", e.REMOVE = "[-]", e.OPTIONS = {
          invalidOption: "warn",
        ...
        function f(t, a, c) {
          ...
          void 0 === c && (c = !0);
          var h = function (r) {
            if (c && void 0 === t[r] && t.constructor !== u) return "symbol" == typeof r && (r = r.toString()), e.OPTIONS.optionError('Invalid option "'.concat(r, '" (no default value).'), r), "continue";
            var d = a[r],
              p = t[r];
            if (!i(d) || null === p || "object" != typeof p && "function" != typeof p) Array.isArray(d) ? (t[r] = [], f(t[r], d, !1)) : i(d) ? t[r] = s(d) : t[r] = d;else {
              var h = l(d);
              Array.isArray(p) && (1 === h.length && (h[0] === e.APPEND || h[0] === e.REMOVE) && Array.isArray(d[h[0]]) || 2 === h.length && h.sort().join(",") === e.APPEND + "," + e.REMOVE && Array.isArray(d[e.APPEND]) && Array.isArray(d[e.REMOVE])) ? (d[e.REMOVE] && (p = t[r] = p.filter(function (t) {
                return d[e.REMOVE].indexOf(t) < 0;
              })), d[e.APPEND] && (t[r] = o(o([], n(p), !1), n(d[e.APPEND]), !1))) : f(p, d, c);
            }
          };
          try {
        ...
        function d(t) {
          for (var e, n, o = [], a = 1; a < arguments.length; a++) o[a - 1] = arguments[a];
          var i = {};
          try {
        ...
        e.Expandable = u, e.expandable = c, e.makeArray = function (t) {
          return Array.isArray(t) ? t : [t];
        }, e.keys = l, e.copy = s, e.insert = f, e.defaultOptions = function (t) {
        ...
        }, e.selectOptions = d, e.selectOptionsFromKeys = function (t, e) {
          return d.apply(void 0, o([t], n(Object.keys(e)), !1));
        }, e.separateOptions = function (t) {
          for (var e, n, o, a, i = [], u = 1; u < arguments.length; u++) i[u - 1] = arguments[u];
          var c = [];
          try {
  ...
  r.g = function () {
    ...
    var u,
      ...
      s = {
        ...
        "input/tex-full": ["input/tex-base", "[tex]/all-packages"].concat((u = l, function (t) {
    ...
    (0, t.combineDefaults)(MathJax.config.loader, "dependencies", c), (0, t.combineDefaults)(MathJax.config.loader, "paths", {
      tex: "[mathjax]/input/tex/extensions",
      mml: "[mathjax]/input/mml/extensions",
      sre: "[mathjax]/sre/mathmaps"
    }), (0, t.combineDefaults)(MathJax.config.loader, "provides", s), (0, t.combineDefaults)(MathJax.config.loader, "source", {
      "[tex]/amsCd": "[tex]/amscd",
      "[tex]/colorV2": "[tex]/colorv2",
      "[tex]/configMacros": "[tex]/configmacros",
      "[tex]/tagFormat": "[tex]/tagformat"
    }), n.Loader.preLoad("loader"), n.Loader.load.apply(n.Loader, function (t) {
      return function (t) {
