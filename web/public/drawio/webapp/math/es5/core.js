...
!function () {
        ...
        function a(t, e) {
          ...
          try {
            for (var s = n(Object.keys(e)), l = s.next(); !l.done; l = s.next()) {
              var u = l.value;
              "__esModule" !== u && (!i(t[u]) || !i(e[u]) || e[u] instanceof Promise ? null !== e[u] && void 0 !== e[u] && (t[u] = e[u]) : a(t[u], e[u]));
            }
          } catch (t) {
            r = {
              error: t
          ...
          y = function (t) {
            ...
            return o(e, t), e.create = function (t) {
              ...
              var r,
                ...
                u = !0,
                c = e[0];
              if (1 === e.length || "boolean" == typeof e[1]) 2 === e.length && (u = e[1]), s = (r = a(this.methodActions(t), 2))[0], l = r[1];else if ("string" == typeof e[1]) {
                ...
                } else 3 === e.length && (u = e[2]), s = (o = a(this.methodActions(e[1]), 2))[0], l = o[1];
              } else 4 === e.length && (u = e[3]), s = (i = a(e.slice(1), 2))[0], l = i[1];
              return [{
                id: t,
                renderDoc: s,
                renderMath: l,
        ...
        var O = function (t) {
          ...
          m = function () {
            function t(e, r, n) {
              var o = this,
                i = this.constructor;
              this.document = e, this.options = (0, l.userOptions)((0, l.defaultOptions)({}, i.OPTIONS), n), this.math = new (this.options.MathList || E)(), this.renderActions = y.create(this.options.renderActions), this.processed = new t.ProcessBits(), this.outputJax = this.options.OutputJax || new M();
            ...
            return Object.defineProperty(t.prototype, "kind", {
              ...
              return y.start.node = this.adaptor.body(this.document), y.setMetrics(s, a, u, c, p), this.outputJax.options.mtextInheritFont && (y.outputData.mtextFamily = h), this.outputJax.options.merrorInheritFont && (y.outputData.merrorFamily = h), y.convert(this, i), y.typesetRoot || y.root;
            ...
            return o(e, t), Object.defineProperty(e.prototype, "texClass", {
              ...
              if (t.match(e)) {
                var r = this.constructor.remapPrimes,
                  n = (0, c.unicodeString)((0, c.unicodeChars)(t).map(function (t) {
                    return r[t];
                  }));
              ...
              indentalignlast: "indentalign",
              indentshiftlast: "indentshift"
            }), e.MMLSPACING = u.MMLSPACING, e.OPTABLE = u.OPTABLE, e.pseudoScripts = new RegExp(["^[\"'*`", "\xaa", "\xb0", "\xb2-\xb4", "\xb9", "\xba", "\u2018-\u201f", "\u2032-\u2037\u2057", "\u2070\u2071", "\u2074-\u207f", "\u2080-\u208e", "]+$"].join("")), e.primes = new RegExp(["^[\"'`", "\u2018-\u201f", "]+$"].join("")), e.remapPrimes = {
              34: 8243,
              39: 8242,
              96: 8245,
              8216: 8245,
          ...
          d = function (t) {
            ...
            return o(e, t), e.prototype.findPosition = function (t, e, r, n) {
              ...
              if (!this.processed.isSet("findMath")) {
                this.adaptor.document = this.document, t = (0, u.userOptions)({
                    ...
                    try {
                      for (var v = (n = void 0, s(this.inputJax)), m = v.next(); !m.done; m = v.next()) {
                        ...
                        if (b.processStrings) {
                          ...
                          try {
                            for (var L = (l = void 0, s(b.findMath(M))), N = L.next(); !N.done; N = L.next()) {
                              var R = N.value;
                          ...
                          for (var T = (p = void 0, s(b.findMath(y))), S = T.next(); !S.done; S = T.next()) {
                            R = S.value;
                            var A = new this.options.MathItem(R.math, b, R.display, R.start, R.end);
                            g.push(A);
                          }
                        } catch (t) {
                          p = {
            ...
            return new Promise(function (e, o) {
              !function i() {
                for (var l; ++r < n.length;) {
                  ...
                  if (u instanceof Promise) return void u.then(i).catch(function (t) {
                    return o(t);
                  });
        ...
        var s = function () {
          ...
          return t.prototype.isBefore = function (t, e) {
            ...
            for (var c = this.list.next; c.data !== e.END;) {
              var p = c.next;
              a.has(c.data) && (c.prev.next = c.next, c.next.prev = c.prev, c.next = c.prev = null), c = p;
            }
          }, t.prototype.clear = function () {
            ...
            var o, i, a, s, l;
            void 0 === r && (r = null), null === r && (r = this.isBefore.bind(this));
            for (var u = this.list.next, c = t.list.next; u.data !== e.END && c.data !== e.END;) r(c.data, u.data) ? (o = n([u, c], 2), c.prev.next = o[0], u.prev.next = o[1], i = n([u.prev, c.prev], 2), c.prev = i[0], u.prev = i[1], a = n([t.list, this.list], 2), this.list.prev.next = a[0], t.list.prev.next = a[1], s = n([t.list.prev, this.list.prev], 2), this.list.prev = s[0], t.list.prev = s[1], u = (l = n([c.next, u], 2))[0], c = l[1]) : u = u.next;
            return c.data !== e.END && (this.list.prev.next = t.list.next, t.list.next.prev = this.list.prev, t.list.prev.next = this.list, this.list.prev = t.list.prev, t.list.next = t.list.prev = t.list), this;
          }, t;
        }();
        e.LinkedList = s;
      },
      7233: function (t, e) {
        ...
        function p(t, i, l) {
          ...
          var d = function (r) {
            ...
            var f = i[r],
              h = t[r];
            if (!a(f) || null === h || "object" != typeof h && "function" != typeof h) Array.isArray(f) ? (t[r] = [], p(t[r], f, !1)) : a(f) ? t[r] = c(f) : t[r] = f;else {
              var d = u(f);
        ...
        }, e.keys = u, e.copy = c, e.insert = p, e.defaultOptions = function (t) {
          for (var e = [], r = 1; r < arguments.length; r++) e[r - 1] = arguments[r];
            ...
            for (var c = r(l), p = c.next(); !p.done; p = c.next()) {
              ...
              try {
                for (var h = (i = void 0, r(Object.keys(O))), d = h.next(); !d.done; d = h.next()) {
                  var y = d.value;
                  if ((Array.isArray(u[y]) || "" === u[y]) && f.match(O[y])) if ("size" === y) {
                    var M = n(f.split(/\//), 2),
                      E = M[0],
                      m = M[1];
                    u[y] = E, m && (u["line-height"] = m);
                  } else "" === u.size && (Array.isArray(u[y]) ? u[y].push(f) : u[y] = f);
                }
              } catch (t) {
                i = {
                  error: t
  ...
  }(), t = Tt(9515), e = Tt(3282), r = Tt(444), n = Tt(6191), o = Tt(5009), i = Tt(3494), a = Tt(3670), s = Tt(805), l = Tt(9206), u = Tt(5722), c = Tt(4474), p = Tt(9e3), f = Tt(91), h = Tt(6336), d = Tt(1759), y = Tt(3909), O = Tt(9007), M = Tt(3948), E = Tt(9145), v = Tt(142), m = Tt(7590), b = Tt(3233), g = Tt(1334), L = Tt(6661), N = Tt(1581), R = Tt(5410), T = Tt(6850), S = Tt(3985), A = Tt(450), C = Tt(6405), _ = Tt(3050), x = Tt(2756), I = Tt(7238), w = Tt(5741), P = Tt(6145), j = Tt(9878), D = Tt(7265), B = Tt(6030), k = Tt(7131), X = Tt(1314), H = Tt(4461), W = Tt(1349), F = Tt(4359), q = Tt(4770), J = Tt(5022), z = Tt(5184), G = Tt(9102), V = Tt(6325), U = Tt(4082), K = Tt(9259), $ = Tt(2975), Y = Tt(4574), Z = Tt(4596), Q = Tt(7860), tt = Tt(8823), et = Tt(8912), rt = Tt(3811), nt = Tt(6272), ot = Tt(3683), it = Tt(5138), at = Tt(3726), st = Tt(3363), lt = Tt(3335), ut = Tt(5713), ct = Tt(9923), pt = Tt(6469), ft = Tt(6751), ht = Tt(5368), dt = Tt(7525), yt = Tt(103), Ot = Tt(7233), Mt = Tt(8666), Et = Tt(4542), vt = Tt(4139), mt = Tt(8054), bt = Tt(6010), gt = Tt(7875), Lt = Tt(505), MathJax.loader && MathJax.loader.checkVersion("core", e.VERSION, "core"), (0, t.combineWithMathJax)({
    _: {
      adaptors: {
        HTMLAdaptor: r,
        browserAdaptor: n
  ...
  }), MathJax.startup && (MathJax.startup.registerConstructor("HTMLHandler", at.HTMLHandler), MathJax.startup.registerConstructor("browserAdaptor", n.browserAdaptor), MathJax.startup.useHandler("HTMLHandler"), MathJax.startup.useAdaptor("browserAdaptor")), MathJax.loader && (MathJax._.mathjax.mathjax.asyncLoad = function (t) {
