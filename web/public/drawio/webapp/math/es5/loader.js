...
!function () {
  ...
  var e = {
      515: function (e, t, r) {
        ...
        function i(e, t) {
          ...
          try {
            for (var c = n(Object.keys(t)), s = c.next(); !s.done; s = c.next()) {
              var l = s.value;
              "__esModule" !== l && (!a(e[l]) || !a(t[l]) || t[l] instanceof Promise ? null !== t[l] && void 0 !== t[l] && (e[l] = t[l]) : i(e[l], t[l]));
            }
          } catch (e) {
            r = {
              error: e
        ...
        t.isObject = a, t.combineConfig = i, t.combineDefaults = function e(t, r, o) {
          var i, c;
          t[r] || (t[r] = {}), t = t[r];
          try {
      ...
      235: function (e, t, r) {
        ...
        if (t.PathFilters = {
          ...
          normalize: function (e) {
            var t = e.name;
            return t.match(/^(?:[a-z]+:\/)?\/|[a-z]:\\|\[/i) || (e.name = "[mathjax]/" + t.replace(/^\.\//, "")), e.addExtension && !t.match(/\.[^\/]+$/) && (e.name += ".js"), !0;
          },
          prefix: function (e) {
            for (var r; (r = e.name.match(/^\[([^\]]*)\]/)) && t.CONFIG.paths.hasOwnProperty(r[1]);) e.name = t.CONFIG.paths[r[1]] + e.name.substr(r[0].length);
            return !0;
          }
        }, function (e) {
          var r = i.MathJax.version;
          e.versions = new Map(), e.ready = function () {
            ...
            var s = [],
              l = function (r) {
                ...
                n || (n = new c.Package(r)).provides(t.CONFIG.provides[r]), n.checkNoLoad(), s.push(n.promise.then(function () {
                  t.CONFIG.versionWarnings && n.isLoaded && !e.versions.has(c.Package.resolvePath(r)) && console.warn("No version information available for component ".concat(r));
                }));
              };
            try {
            ...
            return e.versions.set(c.Package.resolvePath(n), r), !(!t.CONFIG.versionWarnings || o === r) && (console.warn("Component ".concat(n, " uses ").concat(o, " of MathJax; version in use is ").concat(r)), !0);
          }, e.pathFilters = new u.FunctionList(), e.pathFilters.add(t.PathFilters.source, 0), e.pathFilters.add(t.PathFilters.normalize, 10), e.pathFilters.add(t.PathFilters.prefix, 20);
        }(l = t.Loader || (t.Loader = {})), t.MathJax = i.MathJax, void 0 === t.MathJax.loader) {
      ...
      265: function (e, t, r) {
        ...
        var u = function () {
          function e(t, r) {
            void 0 === r && (r = !1), this.isLoaded = !1, this.isLoading = !1, this.hasFailed = !1, this.dependents = [], this.dependencies = [], this.dependencyCount = 0, this.provided = [], this.name = t, this.noLoad = r, e.packages.set(t, this), this.promise = this.makePromise(this.makeDependencies());
          }
          return Object.defineProperty(e.prototype, "canLoad", {
            get: function () {
            ...
            return n.ready && (r = r.then(function (e) {
              return n.ready(t.name);
            })), e.length && (e.push(r), r = Promise.all(e).then(function (e) {
              return e.join(", ");
            })), n.failed && r.catch(function (e) {
            ...
            r.src = e, r.charset = "UTF-8", r.onload = function (e) {
              return t.checkLoad();
            ...
            var e = this;
            ((s.CONFIG[this.name] || {}).checkReady || function () {
            ...
            try {
              for (var o = a(t), i = o.next(); !i.done; i = o.next()) {
                var c = i.value,
                  l = e.packages.get(c);
                l || (s.CONFIG.dependencies[c] || (s.CONFIG.dependencies[c] = []), s.CONFIG.dependencies[c].push(c), (l = new e(c, !0)).isLoading = !0), this.provided.push(l);
              }
            } catch (e) {
              r = {
                error: e
      ...
      282: function (e, t) {
        Object.defineProperty(t, "__esModule", {
          value: !0
        }), t.VERSION = void 0, t.VERSION = "3.2.2";
      },
      525: function (e, t, r) {
        var n,
          o = this && this.__extends || (n = function (e, t) {
            ...
            return new Promise(function (t, o) {
              !function a() {
                for (var s; ++r < n.length;) {
                  ...
                  if (l instanceof Promise) return void l.then(a).catch(function (e) {
                    return o(e);
                  });
  ...
  r.g = function () {
    ...
    var i,
      ...
      s = Array.from(Object.keys(c)).filter(function (e) {
        return "[tex]" === e.substr(0, 5) && "[tex]/autoload" !== e && "[tex]/colorv2" !== e && "[tex]/all-packages" !== e;
      }),
      l = {
        startup: ["loader"],
        "input/tex": ["input/tex-base", "[tex]/ams", "[tex]/newcommand", "[tex]/noundefined", "[tex]/require", "[tex]/autoload", "[tex]/configmacros"],
        "input/tex-full": ["input/tex-base", "[tex]/all-packages"].concat((i = s, function (e) {
    ...
    (0, e.combineDefaults)(MathJax.config.loader, "dependencies", c), (0, e.combineDefaults)(MathJax.config.loader, "paths", {
      tex: "[mathjax]/input/tex/extensions",
      mml: "[mathjax]/input/mml/extensions",
      sre: "[mathjax]/sre/mathmaps"
    }), (0, e.combineDefaults)(MathJax.config.loader, "provides", l), n.Loader.load.apply(n.Loader, function (e) {
      return function (e) {
