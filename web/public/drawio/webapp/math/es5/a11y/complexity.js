...
!function () {
      ...
      589: function (t, e, o) {
        var i,
          ...
          l = this && this.__read || function (t, e) {
            ...
            var i,
              ...
              l = [];
            try {
              for (; (void 0 === e || e-- > 0) && !(i = n.next()).done;) l.push(i.value);
            } catch (t) {
              r = {
                error: t
              };
          ...
          s = this && this.__spreadArray || function (t, e, o) {
            if (o || 2 === arguments.length) for (var i, r = 0, n = e.length; r < n; r++) !i && r in e || (i || (i = Array.prototype.slice.call(e, 0, r)), i[r] = e[r]);
        ...
        function y(t, e) {
          return function (t) {
            ...
            return r(o, t), o.prototype.complexity = function (t, o) {
              void 0 === o && (o = !1), this.state() >= p.STATE.COMPLEXITY || (this.isEscaped || !t.options.enableComplexity && !o || (this.enrich(t, !0), e(this.root)), this.state(p.STATE.COMPLEXITY));
            }, o;
          }(t);
        }
        function d(t) {
          ...
          return e = function (t) {
            ...
            return r(e, t), e.prototype.complexity = function () {
              var t, e;
              if (!this.processed.isSet("complexity")) {
                if (this.options.enableComplexity) try {
              ...
              return void 0 === o && (o = !1), t.prototype.state.call(this, e, o), e < p.STATE.COMPLEXITY && this.processed.clear("complexity"), this;
            }, e;
          }(t), e.OPTIONS = n(n(n({}, t.OPTIONS), u.ComplexityVisitor.OPTIONS), {
            enableComplexity: !0,
        ...
        (0, p.newState)("COMPLEXITY", 40), e.ComplexityMathItemMixin = y, e.ComplexityMathDocumentMixin = d, e.ComplexityHandler = function (t, e) {
          return void 0 === e && (e = null), !t.documentClass.prototype.enrich && e && (t = (0, c.EnrichHandler)(t, e)), t.documentClass = d(t.documentClass), t;
        };
      },
      850: function (t, e) {
        ...
        var i = function () {
          function t(e) {
            ...
            this.cutoff = {
            ...
            }, this.collapse = new Map([["fenced", function (t, e) {
              return (e = o.uncollapseChild(e, t, 1)) > o.cutoff.fenced && "leftright" === t.attributes.get("data-semantic-role") && (e = o.recordCollapse(t, e, o.getText(t.childNodes[0]) + o.getText(t.childNodes[t.childNodes.length - 1]))), e;
            }], ["appl", function (t, e) {
              if (o.canUncollapse(t, 2, 2)) {
                e = o.complexity.visitNode(t, !1);
                var i = o.marker.appl,
                  r = i[t.attributes.get("data-semantic-role")] || i.value;
              ...
              return (e = o.uncollapseChild(e, t, 0, 2)) > o.cutoff.superscript && (e = o.recordCollapse(t, e, o.marker.superscript)), e;
            }], ["subscript", function (t, e) {
              return (e = o.uncollapseChild(e, t, 0, 2)) > o.cutoff.subscript && (e = o.recordCollapse(t, e, o.marker.subscript)), e;
            }], ["subsup", function (t, e) {
          ...
          return t.prototype.check = function (t, e) {
            ...
            return this.collapse.has(o) ? this.collapse.get(o).call(this, t, e) : this.cutoff.hasOwnProperty(o) ? this.defaultCheck(t, e, o) : e;
            ...
            return o = "\u25c2" + o + "\u25b8", t.setProperty("collapse-marker", o), t.setProperty("collapse-complexity", e), o.length * this.complexity.complexity.text;
          }, t.prototype.unrecordCollapse = function (t) {
            var e = t.getProperty("collapse-complexity");
            null != e && (t.attributes.set("data-semantic-complexity", e), t.removeProperty("collapse-complexity"), t.removeProperty("collapse-marker"));
            ...
            return r && (this.unrecordCollapse(r), r.parent !== e && r.parent.attributes.set("data-semantic-complexity", void 0), t = this.complexity.visitNode(e, !1)), t;
          }, t.prototype.splitAttribute = function (t, e) {
            return (t.attributes.get("data-semantic-" + e) || "").split(/,/);
          }, t.prototype.getText = function (t) {
            var e = this;
            return t.isToken ? t.getText() : t.childNodes.map(function (t) {
              return e.getText(t);
            }).join("");
            ...
            r.inheritAttributesFrom(t), t.attributes.set("data-semantic-complexity", t.getProperty("collapse-complexity")), t.removeProperty("collapse-marker"), t.removeProperty("collapse-complexity"), i.replaceChild(r, t), r.appendChild(t);
            ...
            return r.setProperty("collapse-marker", t.getProperty("collapse-marker")), r.setProperty("collapse-complexity", t.getProperty("collapse-complexity")), t.removeProperty("collapse-marker"), t.removeProperty("collapse-complexity"), r;
          }, t.NOCOLLAPSE = 1e7, t;
        }();
        e.Collapse = i;
      },
        ...
        var l = o(176),
          ...
          p = function (t) {
            function e(e, o) {
              ...
              var r = i.constructor;
              return i.options = (0, a.userOptions)((0, a.defaultOptions)({}, r.OPTIONS), o), i.collapse = new i.options.Collapse(i), i.factory = e, i;
            }
            return r(e, t), e.prototype.visitTree = function (e) {
              t.prototype.visitTree.call(this, e, !0), this.options.makeCollapsible && this.collapse.makeCollapse(e);
            }, e.prototype.visitNode = function (e, o) {
              if (!e.attributes.get("data-semantic-complexity")) return t.prototype.visitNode.call(this, e, o);
              ...
              var o = this.childrenComplexity(t) + this.complexity.sqrt - (1 - this.complexity.script) * this.getComplexity(t.childNodes[1]);
              return this.setComplexity(t, o, e);
              ...
              return l += this.complexity.child * ((i ? 1 : 0) + (r ? 1 : 0)), l += n ? this.getComplexity(n) + this.complexity.child : 0, l += this.complexity.subsup, this.setComplexity(e, l, o);
              ...
              var i = e.childNodes[e.under],
                ...
                n = e.childNodes[e.base],
                l = Math.max(i ? this.getComplexity(i) : 0, r ? this.getComplexity(r) : 0) * this.complexity.script;
              return n && (l = Math.max(this.getComplexity(n), l)), l += this.complexity.child * ((i ? 1 : 0) + (r ? 1 : 0) + (n ? 1 : 0)), l += this.complexity.underover, this.setComplexity(e, l, o);
              ...
              return o && (this.options.identifyCollapsible && (e = this.collapse.check(t, e)), t.attributes.set("data-semantic-complexity", e)), e;
  ...
  t = a(723), e = a(306), o = a(589), i = a(850), r = a(175), n = a(511), MathJax.loader && MathJax.loader.checkVersion("a11y/complexity", e.q, "a11y"), (0, t.r8)({
    _: {
      a11y: {
        complexity_ts: o,
        complexity: {
