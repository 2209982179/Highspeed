...
!function () {
    ...
    i = {
      ...
      63: function (t, e, r) {
        ...
        function u(t) {
          ...
          return e = function (t) {
            function e() {
              for (var e, r, n = [], a = 0; a < arguments.length; a++) n[a] = arguments[a];
              ...
              try {
                for (var u = s(i.inputJax), p = u.next(); !p.done; p = u.next()) {
                  var c = p.value;
                  c.name.match(/MathML/) ? (c.mathml.filterAttribute = i.safe.mmlAttribute.bind(i.safe), c.mathml.filterClassList = i.safe.mmlClassList.bind(i.safe)) : c.name.match(/TeX/) && c.postFilters.add(i.sanitize.bind(c), -5.5);
                }
              } catch (t) {
                e = {
                  error: t
            ...
            return a(e, t), e.prototype.sanitize = function (t) {
        ...
        e.SafeMathDocumentMixin = u, e.SafeHandler = function (t) {
      ...
      509: function (t, e, r) {
        ...
        e.SafeMethods = {
          ...
          filterClassList: function (t, e) {
            var r = this;
            return e.trim().replace(/\s\s+/g, " ").split(/ /).map(function (e) {
          ...
          filterStyle: function (t, e, r) {
            ...
            if ("string" != typeof n || "" === n || n.match(/^\s*calc/) || n.match(/javascript:/) && !t.options.safeProtocols.javascript || n.match(/data:/) && !t.options.safeProtocols.data) return null;
          ...
          filterStyleLength: function (t, e, r) {
            ...
            var n = (0, i.length2em)(r, 1),
              ...
              l = a(Array.isArray(o) ? o : [-t.options.lengthMax, t.options.lengthMax], 2),
              s = l[0],
              f = l[1];
          ...
          filterSizeMultiplier: function (t, e) {
            var r = a(t.options.scriptsizemultiplierRange || [-1 / 0, 1 / 0], 2),
              n = r[0],
              i = r[1];
      ...
      477: function (t, e, r) {
        ...
        var i = r(77),
          ...
          l = function () {
            function t(t, e) {
              this.filterAttributes = new Map([["href", "filterURL"], ["src", "filterURL"], ["altimg", "filterURL"], ["class", "filterClassList"], ["style", "filterStyles"], ["id", "filterID"], ["fontsize", "filterFontSize"], ["mathsize", "filterFontSize"], ["scriptminsize", "filterFontSize"], ["scriptsizemultiplier", "filterSizeMultiplier"], ["scriptlevel", "filterScriptLevel"], ["data-", "filterData"]]), this.filterMethods = n({}, o.SafeMethods), this.adaptor = t.adaptor, this.options = e, this.allow = this.options.allow;
            }
  ...
  t = l(723), e = l(306), r = l(63), n = l(509), a = l(477), MathJax.loader && MathJax.loader.checkVersion("ui/safe", e.q, "ui"), (0, t.r8)({
    _: {
      ui: {
        safe: {
          SafeHandler: r,
  ...
  }), MathJax.startup && "undefined" != typeof window && MathJax.startup.extendHandler(function (t) {
