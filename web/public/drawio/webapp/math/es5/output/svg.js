...
!function () {
    ...
    ft = {
                ...
                for (var i = s(t.math), a = i.next(); !a.done; a = i.next()) {
                  ...
                  if (l.state() < c.STATE.METRICS && h) {
                    var u = n[l.display ? 1 : 0].get(h),
                      ...
                      m = u.scale,
                      v = u.family;
                    l.setMetrics(p, d, f, y, m), this.options.mtextInheritFont && (l.outputData.mtextFamily = v), this.options.merrorInheritFont && (l.outputData.merrorFamily = v), l.state(c.STATE.METRICS);
                  }
                }
              } catch (t) {
                e = {
      ...
      1541: function (t, e, r) {
        ...
        var x = function (t) {
          function e(e, r, o) {
            ...
            return n.parent = null, n.removedStyles = null, n.styles = null, n.variant = "", n.bboxComputed = !1, n.stretch = v.NOSTRETCH, n.font = null, n.parent = o, n.font = e.jax.font, n.bbox = m.BBox.zero(), n.getStyles(), n.getVariant(), n.getScale(), n.getSpace(), n.childNodes = r.childNodes.map(function (t) {
              var e = n.wrap(t);
          ...
          return n(e, t), Object.defineProperty(e.prototype, "jax", {
            ...
            if (t) for (var r = this.styles = new y.Styles(t), o = 0, n = e.removeStyles.length; o < n; o++) {
            ...
            var o = this.styles;
            return o || (o = this.styles = new y.Styles()), o.set("fontFamily", t), e && o.set("fontWeight", e), r && o.set("fontStyle", r), "-explicitFont";
            ...
            if (r && r.isKind("mrow") && 1 !== r.childNodes.length) {
              ...
              this.bbox.L = o.isSet("lspace") ? Math.max(0, this.length2em(o.get("lspace"))) : b(n, t.lspace), this.bbox.R = o.isSet("rspace") ? Math.max(0, this.length2em(o.get("rspace"))) : b(n, t.rspace);
              ...
              if ("-explicitFont" === a) {
                ...
                try {
                  for (var f = n(d), y = f.next(); !y.done; y = f.next()) {
                    ...
                    t.w += h, u > t.h && (t.h = u), p > t.d && (t.d = p), t.ic = g.ic || 0, t.sk = g.sk || 0, t.dx = g.dx || 0;
                  }
                } catch (t) {
                  r = {
                    error: t
              ...
              if (void 0 === e && (e = !1), 0 !== this.stretch.dir) {
                ...
                if (d.sizes) try {
                  for (var m = c(d.sizes), v = m.next(); !v.done; v = m.next()) {
                    if (v.value >= p) return l && y && y--, this.variant = this.font.getSizeVariant(f, y), this.size = y, void (d.schar && d.schar[y] && (this.stretch = a(a({}, this.stretch), {
                      c: d.schar[y]
                    })));
                    y++;
                  }
                ...
                d.stretch ? (this.size = -1, this.invalidateBBox(), this.getStretchBBox(t, this.checkExtendedHeight(n, d), d)) : (this.variant = this.font.getSizeVariant(f, y - 1), this.size = y - 1);
              }
            ...
            return n(e, t), Object.defineProperty(e.prototype, "tableRows", {
              ...
              try {
                for (var h = s(this.tableRows), u = h.next(); !u.done; u = h.next()) {
                  if (v = u.value.getChild(t)) 0 === (M = v.childNodes[0]).stretch.dir && M.canStretch(2) && c.push(M);
                }
              } catch (t) {
                r = {
                  error: t
      ...
      6582: function (t, e, r) {
        ...
        var d = function (t) {
          function r(e) {
            ...
            return r.minwidth = 0, r.shift = 0, r.container = null, r.svgStyles = null, r.fontCache = new h.FontCache(r), r;
          }
          return n(r, t), r.prototype.initialize = function () {
            ...
            1 !== this.options.scale && this.adaptor.setStyle(t, "fontSize", (0, p.percent)(this.options.scale));
            ...
            for (var e = this.adaptor, o = e.tags(e.body(t.document), "svg"), n = o.length - 1; n >= 0; n--) if (this.adaptor.getAttribute(o[n], "id") === r.FONTCACHEID) return !0;
            return !1;
            ...
            if ("-explicitFont" !== e) {
              ...
              if (1 !== s.length || s[0] < 119808 || s[0] > 120831) {
                var l = a(this.font.getCssFont(e), 3),
                  ...
                  h = l[1],
                  p = l[2];
                i.setAttribute(n, "font-family", c), h && i.setAttribute(n, "font-style", "italic"), p && i.setAttribute(n, "font-weight", "bold");
              }
            }
            return n;
      ...
      4129: function (t, e) {
        ...
        var r = function () {
          ...
          return t.prototype.cachePath = function (t, e, r) {
      ...
      9737: function (t, e, r) {
        ...
        Object.defineProperty(e, "__esModule", {
          value: !0
        }), e.Arrow = e.DiagonalArrow = e.DiagonalStrike = e.Border2 = e.Border = e.RenderLine = e.lineOffset = e.lineData = e.computeLineData = void 0;
        var s = i(r(5373));
        a(r(5373), e), e.computeLineData = {
        ...
        e.RenderLine = function (t, r) {
          return void 0 === r && (r = ""), function (o, n) {
        ...
        e.Border2 = function (t, r, o) {
          return s.CommonBorder2(function (t, n) {
            t.adaptor.append(t.element, t.line((0, e.lineData)(t, r))), t.adaptor.append(t.element, t.line((0, e.lineData)(t, o)));
          })(t, r, o);
        };
      ...
      9321: function (t, e, r) {
        ...
        var s = r(3717),
          ...
          h = function (t) {
            ...
            return n(e, t), e.prototype.toSVG = function (t) {
              ...
              return this.handleStyles(), this.handleScale(), this.handleBorder(), this.handleColor(), this.handleAttributes(), e;
              ...
              if (this.styles) {
                ...
                e && this.adaptor.setAttribute(this.element, "style", e), s.BBox.StyleAdjust.forEach(function (e) {
                  var r = a(e, 3),
                    o = r[0];
                  if (0 === r[2]) {
              ...
              if ((o || n) && (e.setAttribute(this.element, "fill", o || n), e.setAttribute(this.element, "stroke", o || n)), i || a || s) {
              ...
              if (this.styles) {
                var s = Array(4).fill(0),
                  ...
                  c = Array(4);
                try {
                  for (var h = i([["Top", 0], ["Right", 1], ["Bottom", 2], ["Left", 3]]), u = h.next(); !u.done; u = h.next()) {
                    var p = a(u.value, 2),
                      d = p[0],
                      f = p[1],
                      y = "border" + d,
                      m = this.styles.get(y + "Width");
                    m && (s[f] = Math.max(0, this.length2em(m, 1, this.bbox.rscale)), l[f] = this.styles.get(y + "Style") || "solid", c[f] = this.styles.get(y + "Color") || "currentColor");
                  }
                } catch (e) {
                  t = {
                    error: e
                ...
                var v = e.borderFuzz,
                  ...
                  P = [M - s[1], -_ + s[2]],
                  A = [-v + s[3], -_ + s[2]],
                  V = [[S, w, B, j], [O, w, B, P], [C, O, P, A], [C, S, j, A]],
                  T = this.adaptor.firstChild(this.element);
                try {
                  for (var k = i([0, 1, 2, 3]), G = k.next(); !G.done; G = k.next()) {
                    if (s[f = G.value]) {
                      var N = V[f];
                      "dashed" === l[f] || "dotted" === l[f] ? this.addBorderBroken(N, c[f], l[f], s[f], f) : this.addBorderSolid(N, c[f], T);
                    }
                  }
                } catch (t) {
                  o = {
              ...
              var i = "dotted" === r,
                s = o / 2,
                l = a([[s, -s, -s, -s], [-s, s, -s, -s], [s, s, -s, s], [s, s, s, -s]][n], 4),
                c = l[0],
                h = l[1],
                u = l[2],
                p = l[3],
                ...
                w = this.svg("line", {
                  ...
                  "stroke-dasharray": i ? [1, this.fixed(x / _ - .002)].join(" ") : [this.fixed(M), this.fixed(3 * M)].join(" ")
                }),
                S = this.adaptor,
              ...
              try {
                for (var c = i(a.getExplicitNames()), h = c.next(); !h.done; h = c.next()) {
                  var u = h.value;
                  !1 !== l[u] && (u in s || l[u] || this.adaptor.hasAttribute(this.element, u)) || this.adaptor.setAttribute(this.element, u, a.getExplicit(u));
                }
              } catch (e) {
                t = {
                  error: e
              ...
              return e.append(this.element, this.svg("text", {
                "data-id-align": !0
              }, [this.text("")])), e.append(this.element, n), t + r;
            }, e.prototype.firstChild = function () {
              var t = this.adaptor,
                e = t.firstChild(this.element);
              return e && "text" === t.kind(e) && t.getAttribute(e, "data-id-align") && (e = t.firstChild(t.next(e))), e && "rect" === t.kind(e) && t.getAttribute(e, "data-hitbox") && (e = t.next(e)), e;
              ...
              if ("p" in p) {
                ...
                var f = this.adaptor.append(o, this.svg("g", {
                  "data-c": c
                }));
            ...
            }, e.kind = "unknown", e.borderFuzz = .005, e;
          }(l.CommonWrapper);
        e.SVGWrapper = h;
      },
      9416: function (t, e, r) {
      ...
      484: function (t, e, r) {
        ...
        var i = r(9321),
          ...
          c = function (t) {
            ...
            return n(e, t), e.prototype.toSVG = function (e) {
              if (t.prototype.toSVG.call(this, e), this.adaptor.setAttribute(this.element, "data-mjx-texclass", l.TEXCLASSNAMES[this.node.texClass]), this.node.texClass === l.TEXCLASS.VCENTER) {
                var r = this.childNodes[0].getBBox(),
                  o = r.h,
        ...
        var a = r(8921),
          ...
          l = function (t) {
            ...
            return n(e, t), e.prototype.toSVG = function (t) {
              ...
              if (0 !== o.length) if ("-explicitFont" === n) this.element = this.adaptor.append(t, this.jax.unknownText(o, n));else {
                var a = this.remappedText(o, n);
                this.parent.childNodes.length > 1 && (t = this.element = this.adaptor.append(t, this.svg("g", {
                  "data-mml-node": "text"
                })));
                var s = 0;
                try {
          ...
          c = function (t) {
            ...
            return n(e, t), e.prototype.toSVG = function (t) {
              ...
              if (r) {
                ...
                if (r.node.isKind("mtext")) {
                  ...
                  var i = t.adaptor,
                    ...
                    c = i.append(o, t.svg("foreignObject", {
                      style: {
                        display: "none"
                      }
                    }, [l]));
                  t.jax.processMath(s, i.firstChild(l)), t.childNodes[1].node.parent = t.node, t.setEventHandler("mouseover", function (r) {
                    e.stopTimers(t, e), e.hoverTimer.set(t, setTimeout(function () {
                      i.setStyle(l, "left", "0"), i.setStyle(l, "top", "0"), i.append(a, l);
                      var e = i.nodeBBox(l),
                        r = i.nodeBBox(t.element),
                        o = (r.right - e.left) / t.metrics.em + t.dx,
                        n = (r.bottom - e.bottom) / t.metrics.em + t.dy;
                      i.setStyle(l, "left", t.px(o)), i.setStyle(l, "top", t.px(n));
                    }, e.postDelay)), r.stopPropagation();
              ...
              if (r && r.node.isKind("mtext")) {
                var o = t.adaptor,
                  n = r.node.getText();
                o.setAttribute(t.element, "data-statusline", n), t.setEventHandler("mouseover", function (r) {
                  if (null === e.status) {
        ...
        var s = r(9321),
          ...
          u = function (t) {
            ...
            return n(e, t), e.prototype.toSVG = function (e) {
              ...
              var r = this.adaptor;
              "block" === this.node.attributes.get("display") && (r.setAttribute(this.jax.container, "display", "true"), this.handleDisplay()), this.jax.document.options.internalSpeechTitles && this.handleSpeech();
            }, e.prototype.handleDisplay = function () {
              var t = i(this.getAlignShift(), 2),
                e = t[0],
                r = t[1];
              if ("center" !== e && this.adaptor.setAttribute(this.jax.container, "justify", e), this.bbox.pwidth === h.BBox.fullWidth) {
                if (this.adaptor.setAttribute(this.jax.container, "width", "full"), this.jax.table) {
                  var o = this.jax.table.getOuterBBox(),
                    n = o.L,
                    a = o.w,
                    s = o.R;
                  "right" === e ? s = Math.max(s || -r, -r) : "left" === e ? n = Math.max(n || r, r) : "center" === e && (a += 2 * Math.abs(r)), this.jax.minwidth = Math.max(0, n + a + s);
                }
              ...
              if (n) {
                ...
                r.insert(s, r.firstChild(this.element)), r.setAttribute(this.element, "aria-labeledby", i), r.removeAttribute(this.element, "aria-label");
                try {
              ...
              return void 0 === r && (r = null), void 0 === o && (o = !0), t.prototype.setChildPWidths.call(this, e, this.parent ? r : this.metrics.containerWidth / this.jax.pxPerEm, !1);
          ...
          f = function (t) {
            ...
            return n(e, t), e.prototype.toSVG = function (t) {
              ...
              var i = this.getBBox(),
                ...
                h = this.thickness,
                u = h / 2,
                p = c([h * this.arrowhead.x, h * this.arrowhead.y, h * this.arrowhead.dx], 3),
                d = p[0],
                f = p[1],
                y = p[2],
                m = r ? this.fill("M", a + s, l, "l", -(d + y), f, "l", y, u - f, "L", d - s, l + u, "l", y, f - u, "l", -(d + y), -f, "l", d + y, -f, "l", -y, f - u, "L", a + s - d, l - u, "l", -y, u - f, "Z") : this.fill("M", a + s, l, "l", -(d + y), f, "l", y, u - f, "L", -s, l + u, "l", 0, -h, "L", a + s - d, l - u, "l", -y, u - f, "Z"),
                v = [];
            ...
            }, e.kind = d.MmlMenclose.prototype.kind, e.notations = new Map([p.Border("top"), p.Border("right"), p.Border("bottom"), p.Border("left"), p.Border2("actuarial", "top", "right"), p.Border2("madruwb", "bottom", "right"), p.DiagonalStrike("up"), p.DiagonalStrike("down"), ["horizontalstrike", {
              ...
              renderer: function (t, e) {
                var r = t.getBBox(),
                  ...
                  l = n + i,
                  c = Math.cos(a);
                t.adaptor.append(t.element, t.path("mitre", "M", o, s - i, "L", s + c * s, s - i, "L", c * l + s, l - i - s));
              },
              bbox: function (t) {
                var e = t.padding / 2,
                  r = t.thickness;
              ...
              renderer: function (t, e) {
                var r = t.getBBox(),
                  ...
                  a = t.thickness / 2,
                  s = t.padding;
                t.adaptor.append(t.element, t.path("round", "M", a, a - i, "a", s - a / 2, (n + i) / 2 - 4 * a, 0, "0,1", 0, n + i - 2 * a, "L", o - a, n - a));
              },
              bbox: function (t) {
                var e = t.padding,
                  r = t.thickness;
        ...
        var i = r(9321),
          ...
          s = function (t) {
            ...
            return n(e, t), e.prototype.toSVG = function (t) {
              ...
              a && this.adaptor.append(this.element, this.svg("title", {}, [this.adaptor.text(a)])), this.addChildren(e);
          ...
          c = function (t) {
            ...
            return n(e, t), e.prototype.toSVG = function (t) {
              ...
              var r = this.element,
                ...
                m = this.getAlignX(y, h, n) + .1 + f,
                v = this.getAlignX(y, u, a) + .1 + f,
                g = this.getTUV(t, e),
                b = g.T,
                x = g.u,
                _ = g.v;
              l.toSVG(r), l.place(m, d + b + Math.max(h.d * h.rscale, x)), c.toSVG(r), c.place(v, d - b - Math.max(u.h * u.rscale, _)), this.adaptor.append(r, this.svg("rect", {
                width: this.fixed(y + .2),
                height: this.fixed(e),
                x: this.fixed(f),
                y: this.fixed(d - e / 2)
              }));
              ...
              o.toSVG(e), this.bevel.toSVG(e), n.toSVG(e), o.place(h.L * h.rscale, s), this.bevel.place(p - c / 2, 0), n.place(p + this.bevel.getOuterBBox().w + u.L * u.rscale - c, l);
      ...
      4916: function (t, e, r) {
        ...
        var i = r(9321),
          ...
          l = function (t) {
            ...
            return n(e, t), e.prototype.toSVG = function (t) {
              var e = this.standardSVGnode(t);
              if (this.charWrapper) this.charWrapper.toSVG(e);else {
        ...
        var u = function (t) {
          ...
          return n(e, t), e.prototype.toSVG = function (t) {
            var e = this.standardSVGnode(t),
              ...
              d = u[1],
              f = 0;
            r.numPrescripts && (f = this.addScripts(.05, p, d, this.firstPrescript, r.numPrescripts, a));
            var y = this.baseChild;
            y.toSVG(e), y.place(f, 0), f += y.getOuterBBox().w, r.numScripts && this.addScripts(f, p, d, 1, r.numScripts, s);
        ...
        var s = r(9321),
          ...
          u = function (t) {
            ...
            return n(e, t), e.prototype.toSVG = function (t) {
              ...
              if (o && this.size < 0) this.stretchSVG();else {
                ...
                "0" === i && "0" === a || this.adaptor.setAttribute(n, "transform", "translate(".concat(a, " ").concat(i, ")")), this.addChildren(n);
              }
              ...
              if (t) {
                ...
                if (!(y <= 0)) {
                  var g = this.svg("svg", {
                    ...
                    y: this.fixed(i - o),
                    x: this.fixed((s - f) / 2),
                    viewBox: [0, v, f, y].map(function (t) {
                      return l.fixed(t);
                    }).join(" ")
                  });
                  this.addGlyph(t, e, 0, 0, g);
                  var b = c.lastChild(g);
                  c.setAttribute(b, "transform", "scale(1,".concat(this.jax.fixed(m), ")")), c.append(this.element, g);
                }
              }
              ...
              var s = this;
              if (void 0 === i && (i = 0), t) {
                n = Math.max(0, n - .1), o = Math.max(0, o - .1);
                var l = this.adaptor,
                ...
                if (!(f <= 0)) {
                  var g = this.svg("svg", {
                    ...
                    x: this.fixed(i + o),
                    y: this.fixed(v),
                    viewBox: [(m * d - f) / 2, v, f, y].map(function (t) {
                      return s.fixed(t);
                    }).join(" ")
                  });
                  this.addGlyph(t, e, 0, 0, g);
                  var b = l.lastChild(g);
                  l.setAttribute(b, "transform", "scale(" + this.jax.fixed(m) + ",1)"), l.append(this.element, g);
                }
              }
        ...
        var a = r(9321),
          ...
          c = function (t) {
            ...
            return n(e, t), e.prototype.toSVG = function (t) {
              ...
              (c || a) && (e = this.adaptor.append(e, this.svg("g")), this.place(c, a, e)), this.addChildren(e);
        ...
        var i = r(9321),
          ...
          l = function (t) {
            ...
            return n(e, t), e.prototype.toSVG = function (t) {
              ...
              this.addRoot(c, o, n, l), e.toSVG(c), e.place(this.dx, l - n.h), r.toSVG(h), r.place(this.dx + n.w, 0), this.adaptor.append(c, this.svg("rect", {
        ...
        var s = r(9321),
          ...
          h = function (t) {
            ...
            return n(e, t), e.prototype.toSVG = function (t) {
              ...
              for (var e, r, o, n = this.node.attributes.get("equalrows"), s = this.getTableData(), l = s.H, c = s.D, h = this.getEqualRowHeight(), u = this.getRowHalfSpacing(), p = a(a([this.fLine], i(this.rLines), !1), [this.fLine], !1), d = this.getBBox().h - p[0], f = 0; f < this.numRows; f++) {
                var y = this.childNodes[f];
                e = i(this.getRowHD(n, h, l[f], c[f]), 2), y.H = e[0], y.D = e[1], r = i([u[f], u[f + 1]], 2), y.tSpace = r[0], y.bSpace = r[1], o = i([p[f], p[f + 1]], 2), y.tLine = o[0], y.bLine = o[1], y.toSVG(t), y.place(0, d - u[f] - y.H), d -= u[f] + y.H + y.D + u[f + 1] + p[f + 1];
              }
              ...
              if ("none" !== this.node.attributes.get("columnlines")) {
                ...
                if (e) for (var r = this.getColumnHalfSpacing(), o = this.cLines, n = this.getComputedWidths(), i = this.fLine, a = 0; a < e.length; a++) i += r[a] + n[a] + r[a + 1], "none" !== e[a] && this.adaptor.append(t, this.makeVLine(i, e[a], o[a])), i += o[a];
              }
            }, e.prototype.handleRowLines = function (t) {
              if ("none" !== this.node.attributes.get("rowlines")) {
                var e = this.getRowAttributes("rowlines");
                if (e) for (var r = this.node.attributes.get("equalrows"), o = this.getTableData(), n = o.H, a = o.D, s = this.getEqualRowHeight(), l = this.getRowHalfSpacing(), c = this.rLines, h = this.getBBox().h - this.fLine, u = 0; u < e.length; u++) {
                  var p = i(this.getRowHD(r, s, n[u], a[u]), 2),
                    d = p[0],
                    f = p[1];
                  h -= l[u] + d + f + l[u + 1], "none" !== e[u] && this.adaptor.append(t, this.makeHLine(h, e[u], c[u])), h -= c[u];
                }
              }
              ...
              for (var t = this.adaptor, e = this.getBBox().h, r = this.getTableData().L, o = this.getRowHalfSpacing(), n = e - this.fLine, i = t.firstChild(this.labels), a = 0; a < this.numRows; a++) {
              ...
              var o = this.adaptor,
                ...
                v = "scale(".concat(this.jax.fixed(1e3 * this.font.params.x_height / this.metrics.ex, 2), ")"),
                g = "translate(0 ".concat(this.fixed(a), ") ").concat(m, " ").concat(v),
                b = this.svg("svg", {
                  "data-table": !0,
                  preserveAspectRatio: "left" === f ? "xMinYMid" : "right" === f ? "xMaxYMid" : "xMidYMid",
              ...
              e = this.svg("svg", {
                ...
                viewBox: ["left" === r ? 0 : this.fixed(p), this.fixed(-a), 1, this.fixed(a + s)].join(" ")
              }, [e]), o.append(t, this.svg("g", {
                transform: g
              }, [b, e])), this.place(-c, 0, t);
              ...
              this.place("left" === r ? ("left" === u ? 0 : "right" === u ? c - p + o : (c - p) / 2 + o) - s : ("left" === u ? p : "right" === u ? c + o : (p + c) / 2 + o) - s - h, 0, e), n.append(t, e);
      ...
      2673: function (t, e, r) {
        ...
        var i = r(9321),
          ...
          l = function (t) {
            ...
            return n(e, t), e.prototype.placeCell = function (t, e, r, o, n) {
              var i = this.getBBox(),
                a = Math.max(i.h, .75),
                s = Math.max(i.d, .25),
              ...
              var n = this.adaptor,
                i = this.firstChild();
              i && "rect" === n.kind(i) && n.getAttribute(i, "data-bgcolor") && (n.setAttribute(i, "x", this.fixed(t)), n.setAttribute(i, "y", this.fixed(e)), n.setAttribute(i, "width", this.fixed(r)), n.setAttribute(i, "height", this.fixed(o)));
        ...
        var s = r(9321),
          ...
          u = function (t) {
            ...
            return n(e, t), e.prototype.toSVG = function (t) {
              ...
              for (var e = this.parent.getColumnHalfSpacing(), r = a(a([this.parent.fLine], i(this.parent.cLines), !1), [this.parent.fLine], !1), o = this.parent.getComputedWidths(), n = 1 / this.getBBox().rscale, s = r[0], l = 0; l < this.numCells; l++) {
              ...
              if (r && "rect" === e.kind(r) && e.getAttribute(r, "data-bgcolor")) {
                var o = i([this.tLine / 2 * t, this.bLine / 2 * t], 2),
                  ...
                  u = h[0],
                  p = h[1];
                e.setAttribute(r, "y", this.fixed(-(p + c + a))), e.setAttribute(r, "width", this.fixed(this.parent.getWidth() * t)), e.setAttribute(r, "height", this.fixed(n + l + u + p + c + a));
              }
      ...
      4299: function (t, e, r) {
        ...
        var a = r(7522),
          ...
          u = function (t) {
            ...
            return n(e, t), e.prototype.toSVG = function (e) {
              if (this.hasMovableLimits()) t.prototype.toSVG.call(this, e);else {
          ...
          return n(e, t), e.prototype.toSVG = function (e) {
            if (this.hasMovableLimits()) t.prototype.toSVG.call(this, e);else {
              var r = this.standardSVGnode(e),
                ...
                a = o[1],
                s = o[2],
                l = i([n.getOuterBBox(), a.getOuterBBox(), s.getOuterBBox()], 3),
                c = l[0],
                h = l[1],
                u = l[2];
              ...
              var p = this.getDelta(),
                ...
                y = i(this.getDeltaW([c, u, h], [0, this.isLineBelow ? 0 : -p, this.isLineAbove ? 0 : p]), 3),
                m = y[0],
                v = y[1],
                g = y[2];
          ...
          s = function (t) {
            ...
            return n(e, t), e.prototype.toSVG = function (t) {
              var e = this.standardSVGnode(t),
                ...
                n = o[0],
                a = o[1];
              this.baseChild.toSVG(e), this.scriptChild.toSVG(e), this.scriptChild.place(r + n, a);
            }, e.kind = "scriptbase", e;
  ...
  mt.n = function (t) {
    ...
    for (var r in e) mt.o(e, r) && !mt.o(t, r) && Object.defineProperty(t, r, {
      enumerable: !0,
      get: e[r]
    });
  }, mt.o = function (t, e) {
  ...
  }), MathJax.loader && (0, t.PV)(MathJax.config.loader, "output/svg", {
    checkReady: function () {
