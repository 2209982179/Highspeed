...
!function () {
  ...
  var t,
    ...
    i = {
      ...
      236: function (t, e, r) {
        var a,
          o = this && this.__extends || (a = function (t, e) {
        ...
        var n = r(309),
          ...
          p = function (t) {
            function e(e) {
              void 0 === e && (e = {});
              var r = this,
                a = i((0, s.separateOptions)(e, c.FindMathML.OPTIONS, h.MathMLCompile.OPTIONS), 3),
                o = a[0],
                n = a[1],
                p = a[2];
            ...
            return o(e, t), e.prototype.setAdaptor = function (e) {
              ...
              if (!r || !t.end.node || this.options.forceReparse || "#text" === this.adaptor.kind(r)) {
                var a = this.executeFilters(this.preFilters, t, e, (t.math || "<math></math>").trim()),
                  o = this.checkForErrors(this.adaptor.parse(a, "text/" + this.options.parseAs)),
            ...
            return t.prototype.setMmlFactory = function (t) {
              ...
              try {
                for (var i = s(this.adaptor.allAttributes(e)), n = i.next(); !n.done; n = i.next()) {
                  ...
                  if (null !== h && "xmlns" !== c) if ("data-mjx-" === c.substr(0, 9)) switch (c.substr(9)) {
                    case "alternate":
              ...
              if (0 !== t.arity) {
                ...
                try {
                  for (var i = s(o.childNodes(e)), n = i.next(); !n.done; n = i.next()) {
                    var l = n.value,
                      c = o.kind(l);
                    if ("#comment" !== c) if ("#text" === c) this.addText(t, l);else if (t.isKind("annotation-xml")) t.appendChild(this.factory.create("XML").setXML(l, o));else {
