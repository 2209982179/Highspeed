...
!function () {
    ...
    n = {
      ...
      530: function (t, e, a) {
        ...
        var M = function (t) {
          ...
          return r(e, t), e.prototype.start = function (e, a, n) {
        ...
        e.CasesTags = M, e.CasesMethods = {
          NumCases: function (t, e) {
            if (t.stack.env.closing === e.getName()) {
              ...
              return x.EmpheqUtil.left(n, s, r + "\\empheqlbrace\\,", t, "numcases-left"), t.Push(t.itemFactory.create("end").setProperty("name", e.getName())), null;
            }
          ...
          Entry: function (t, e) {
            if (!t.stack.Top().getProperty("numCases")) return p.default.Entry(t, e);
            ...
            for (var a = t.string, n = 0, s = t.i, r = a.length; s < r;) {
              ...
              if ("{" === o) n++, s++;else if ("}" === o) {
                ...
                if ("&" === o && 0 === n) throw new l.default("ExtraCasesAlignTab", "Extra alignment tab in text for numcase environment");
                if ("\\" === o && 0 === n) {
                  var i = (a.slice(s + 1).match(/^[a-z]+|./i) || [])[0];
                  if ("\\" === i || "cr" === i || "end" === i || "label" === i) break;
                  s += i.length;
                } else s++;
              }
            }
        ...
        }, new u.EnvironmentMap("cases-env", x.EmpheqUtil.environment, {
          numcases: ["NumCases", "cases"],
          subnumcases: ["NumCases", "cases"]
        }, e.CasesMethods), new u.MacroMap("cases-macros", {
          "&": "Entry"
        }, e.CasesMethods), e.CasesConfiguration = i.Configuration.create("cases", {
          handler: {
      ...
      379: function (t, e) {
        Object.defineProperty(e, "__esModule", {
          value: !0
        }), e.AmsTags = MathJax._.input.tex.ams.AmsConfiguration.AmsTags, e.AmsConfiguration = MathJax._.input.tex.ams.AmsConfiguration.AmsConfiguration;
      },
      446: function (t, e) {
        Object.defineProperty(e, "__esModule", {
          value: !0
  ...
  t = r(955), e = r(667), a = r(530), MathJax.loader && MathJax.loader.checkVersion("[tex]/cases", e.q, "tex-extension"), (0, t.r8)({
    _: {
      input: {
        tex: {
          cases: {
            CasesConfiguration: a
          }
        }
      }
    }
