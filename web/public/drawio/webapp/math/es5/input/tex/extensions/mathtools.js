...
!function () {
  ...
  var t,
    ...
    i = {
      ...
      205: function (t, e, a) {
              ...
              if (m.getProperty("fixPrescript")) {
                ...
                try {
                  for (var x = (l = void 0, o([4, 5])), g = x.next(); !g.done; g = x.next()) {
                    var v = g.value;
                    s.default.isType(h[v], "mrow") && 0 === s.default.getChildren(h[v]).length && s.default.setChild(m, v, u.nodeFactory.create("node", "none"));
                  }
                } catch (t) {
                  l = {
                    error: t
        ...
        e.PAIREDDELIMS = "mathtools-paired-delims", e.fixPrescripts = h, e.MathtoolsConfiguration = l.Configuration.create("mathtools", {
          handler: {
          ...
          init: function (t) {
            new i.CommandMap(e.PAIREDDELIMS, {}, {}), t.append(l.Configuration.local({
              handler: {
      ...
      926: function (t, e, a) {
        ...
        }, i.MathtoolsMethods), new n.EnvironmentMap("mathtools-environments", o.default.environment, {
        ...
        }, i.MathtoolsMethods), new n.DelimiterMap("mathtools-delimiters", o.default.delimiter, {
          "\\lparen": "(",
          "\\rparen": ")"
        }), new n.CommandMap("mathtools-characters", {
          ":": ["CenterColon", !0]
        }, i.MathtoolsMethods);
      },
      178: function (t, e, a) {
        var r = this && this.__assign || function () {
            return r = Object.assign || function (t) {
              for (var e, a = 1, r = arguments.length; a < r; a++) for (var o in e = arguments[a]) Object.prototype.hasOwnProperty.call(e, o) && (t[o] = e[o]);
              return t;
          ...
          o = this && this.__read || function (t, e) {
            ...
            var r,
              ...
              l = [];
            try {
              for (; (void 0 === e || e-- > 0) && !(r = n.next()).done;) l.push(r.value);
            } catch (t) {
              o = {
                error: t
              };
        ...
        e.MathtoolsMethods = {
          ...
          MtSmallMatrix: function (t, a, r, o, n) {
            return n || (n = t.GetBrackets("\\begin{".concat(a.getName(), "}"), t.options.mathtools["smallmatrix-align"])), e.MathtoolsMethods.Array(t, a, r, o, n, i.default.Em(1 / 3), ".2em", "S", 1);
          },
          ...
          HandleShove: function (t, e, a) {
            var r = t.stack.Top();
            if ("multline" !== r.kind && "multlined" !== r.kind) throw new d.default("CommandInMultlined", "%1 can only appear within the multline or multlined environments", e);
            if (r.Size()) throw new d.default("CommandAtTheBeginingOfLine", "%1 must come at the beginning of the line", e);
          ...
          Cases: function (t, e, a, r, o) {
            ...
            return n.arraydef = {
              ...
              columnspacing: "1em",
              columnalign: "left"
            }, "D" === o && (n.arraydef.displaystyle = !0), n.setProperties({
              open: a,
              close: r
            }), t.Push(e), n;
          },
          MathLap: function (t, e, a, o) {
            var n = t.GetBrackets(e, "").trim(),
              l = t.create("node", "mstyle", [t.create("node", "mpadded", [t.ParseArg(e)], r({
                width: 0
              }, "r" === a ? {} : {
          ...
          UnderOverBracket: function (t, e) {
            var a = (0, p.length2em)(t.GetBrackets(e, ".1em"), .1),
              r = t.GetBrackets(e, ".2em"),
              n = t.GetArgument(e),
              l = o("o" === e.charAt(1) ? ["over", "accent", "bottom"] : ["under", "accentunder", "top"], 3),
              s = l[0],
              u = l[1],
              d = l[2],
              h = (0, p.em)(a),
          ...
          Aboxed: function (t, e) {
            ...
            var s = i.default.substituteArgs(t, [n, l], "\\rlap{\\boxed{#1{}#2}}\\kern.267em\\phantom{#1}&\\phantom{{}#2}\\kern.267em");
            t.string = s + o, t.i = 0;
          },
          ArrowBetweenLines: function (t, e) {
            var a = g.MathtoolsUtil.checkAlignment(t, e);
            if (a.Size() || a.row.length) throw new d.default("BetweenLines", "%1 must be on a row by itself", e);
            var r = t.GetStar(),
          ...
          VDotsWithin: function (t, e) {
            var a = t.stack.Top(),
              ...
              l = new c.default(n, t.stack.env, t.configuration).mml(),
              i = t.create("node", "mpadded", [t.create("node", "mpadded", [t.create("node", "mo", [t.create("text", "\u22ee")])], r({
                width: 0,
                lspace: "-.5width"
              }, o ? {
                height: "-.6em",
          ...
          ShortVDotsWithin: function (t, a) {
            var r = t.stack.Top(),
              o = t.GetStar();
            e.MathtoolsMethods.FlushSpaceAbove(t, "\\MTFlushSpaceAbove"), !o && r.EndEntry(), e.MathtoolsMethods.VDotsWithin(t, "\\vdotswithin"), o && r.EndEntry(), e.MathtoolsMethods.FlushSpaceBelow(t, "\\MTFlushSpaceBelow");
          },
          ...
          PairedDelimiters: function (t, e, a, r, n, l, s, u) {
            ...
            if (l) {
              ...
              s = i.default.substituteArgs(t, M, s), n = i.default.substituteArgs(t, M, n), u = i.default.substituteArgs(t, M, u);
            }
            n = n.replace(/\\delimsize/g, f), t.string = [s, h, a, n, p, r, u, t.string.substr(t.i)].reduce(function (e, a) {
          ...
          CenterColon: function (t, e, a, o, n) {
            ...
            if (a && (l.centercolon || o)) {
              ...
              i = t.create("node", "mpadded", [i], r({
                voffset: s,
                height: "+".concat(s),
                depth: "-".concat(s)
              }, n ? {
                width: l["thincolon-dw"],
                lspace: l["thincolon-dx"]
              } : {}));
            }
            t.Push(i);
          },
          Relation: function (t, e, a, r) {
            t.options.mathtools["use-unicode"] && r ? t.Push(t.create("token", "mo", {
              texClass: h.TEXCLASS.REL
            }, r)) : (a = "\\mathrel{" + a.replace(/:/g, "\\MTThinColon").replace(/-/g, "\\mathrel{-}") + "}", t.string = i.default.addArgs(t, a, t.string.substr(t.i)), t.i = 0);
          },
          NArrow: function (t, e, a, r) {
            t.Push(t.create("node", "TeXAtom", [t.create("token", "mtext", {}, a), t.create("node", "mpadded", [t.create("node", "mpadded", [t.create("node", "menclose", [t.create("node", "mspace", [], {
              height: ".2em",
              depth: 0,
              width: ".4em"
            })], {
          ...
          SplitFrac: function (t, e, a) {
            var r = t.ParseArg(e),
              o = t.ParseArg(e);
            t.Push(t.create("node", "mstyle", [t.create("node", "mfrac", [t.create("node", "mstyle", [r, t.create("token", "mi"), t.create("token", "mspace", {
              width: "1em"
            })], {
              scriptlevel: 0
          ...
          XMathStrut: function (t, e) {
            var a = t.GetBrackets(e),
              r = t.GetArgument(e);
            r = g.MathtoolsUtil.plusOrMinus(e, r), a = g.MathtoolsUtil.plusOrMinus(e, a || r), t.Push(t.create("node", "TeXAtom", [t.create("node", "mpadded", [t.create("node", "mphantom", [t.create("token", "mo", {
              stretchy: !1
            }, "(")])], {
              width: 0,
              height: r + "height",
          ...
          Prescript: function (t, e) {
            ...
            if (m.default.isType(a, "none") && m.default.isType(r, "none")) t.Push(o);else {
              var n = t.create("node", "mmultiscripts", [o]);
              m.default.getChildren(n).push(null, null), m.default.appendChildren(n, [t.create("node", "mprescripts"), r, a]), n.setProperty("fixPrescript", !0), t.Push(n);
            }
          },
          NewTagForm: function (t, e, a) {
            ...
            var n = t.GetBrackets(e, ""),
              l = t.GetArgument(e),
              i = t.GetArgument(e);
            if (!a && r.mtFormats.has(o)) throw new d.default("DuplicateTagForm", "Duplicate tag form: %1", o);
            r.mtFormats.set(o, [l, i, n]);
          },
          UseTagForm: function (t, e) {
            var a = t.tags;
            if (!("mtFormats" in a)) throw new d.default("TagsNotMT", "%1 can only be used with ams or mathtools tags", e);
            var r = t.GetArgument(e).trim();
            if (r) {
              if (!a.mtFormats.has(r)) throw new d.default("UndefinedTagForm", "Undefined tag form: %1", r);
          ...
          SetOptions: function (t, e) {
            ...
            Object.keys(o).forEach(function (t) {
              "pariedDelimiters" !== t && "tagforms" !== t && "allow-mathtoolsset" !== t && (l[t] = 1);
            });
      ...
      298: function (t, e, a) {
        ...
        e.MathtoolsTagFormat = function (t, e) {
          ...
          var r = function (t) {
              function a() {
                ...
                try {
                  for (var i = n(Object.keys(l)), u = i.next(); !u.done; u = i.next()) {
                    var c = u.value;
                    if (!Array.isArray(l[c]) || 3 !== l[c].length) throw new s.default("InvalidTagFormDef", 'The tag form definition for "%1" should be an array fo three strings', c);
              ...
              return o(a, t), a.prototype.formatTag = function (e) {
                if (this.mtCurrent) {
                  var a = l(this.mtCurrent, 3),
                    r = a[0],
                    o = a[1],
                    n = a[2];
                  return n ? "".concat(r).concat(n, "{").concat(e, "}").concat(o) : "".concat(r).concat(e).concat(o);
                }
      ...
      262: function (t, e, a) {
        ...
        e.MathtoolsUtil = {
          ...
          checkAlignment: function (t, e) {
            var a = t.stack.Top();
            if (a.kind !== n.EqnArrayItem.prototype.kind) throw new s.default("NotInAlignment", "%1 can only be used in aligment environments", e);
            return a;
          },
          ...
          plusOrMinus: function (t, e) {
            if (!(e = e.trim()).match(/^[-+]?(?:\d+(?:\.\d*)?|\.\d+)$/)) throw new s.default("NotANumber", "Argument to %1 is not a number", t);
            return e.match(/^[-+]/) ? e : "+" + e;
          },
      ...
      927: function (t, e) {
        Object.defineProperty(e, "__esModule", {
          value: !0
        }), e.MultlineItem = MathJax._.input.tex.ams.AmsItems.MultlineItem, e.FlalignItem = MathJax._.input.tex.ams.AmsItems.FlalignItem;
      },
      939: function (t, e) {
        Object.defineProperty(e, "__esModule", {
          value: !0
        }), e.AmsMethods = MathJax._.input.tex.ams.AmsMethods.AmsMethods, e.NEW_OPS = MathJax._.input.tex.ams.AmsMethods.NEW_OPS;
      },
      432: function (t, e) {
        Object.defineProperty(e, "__esModule", {
          value: !0
  ...
  t = u(955), e = u(667), a = u(205), r = u(144), o = u(178), n = u(298), l = u(262), MathJax.loader && MathJax.loader.checkVersion("[tex]/mathtools", e.q, "tex-extension"), (0, t.r8)({
    _: {
      input: {
        tex: {
          mathtools: {
