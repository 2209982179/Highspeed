...
!function () {
    ...
    n = {
        ...
        var i = a(76),
          ...
          s = function (t) {
            ...
            return o(e, t), Object.defineProperty(e.prototype, "kind", {
              ...
              if (this.getProperty("stretchy")) return c.default.fenced(this.factory.configuration, a, e, r);
              var o = {
                  fence: !0,
                  stretchy: !1,
                  symmetric: !0,
      ...
      299: function (t, e, a) {
        ...
        new o.CommandMap("Braket-macros", {
          ...
          "|": "Bar"
        }, n.default), new o.MacroMap("Braket-characters", {
          "|": "Bar"
        }, n.default);
      },
      277: function (t, e, a) {
        ...
        var o = r(a(360)),
          ...
          i = r(a(402)),
          l = {};
        l.Macro = o.default.Macro, l.Braket = function (t, e, a, r, o, n) {
          var l = t.GetNext();
          if ("" === l) throw new i.default("MissingArgFor", "Missing argument for %1", t.currentCS);
          var c = !0;
          ...
          if ("braket" !== r.kind || r.getProperty("barcount") >= r.getProperty("barmax")) {
            ...
            if ("|" === a && "|" === t.GetNext() && (t.i++, a = "\u2225"), r.getProperty("stretchy")) {
              ...
              t.Push(i), r.setProperty("barcount", r.getProperty("barcount") + 1), i = t.create("token", "mo", {
                stretchy: !0,
                braketbar: !0
              }, a), t.Push(i), i = t.create("node", "TeXAtom", [], {
                texClass: n.TEXCLASS.OPEN
              }), t.Push(i);
            } else {
              var l = t.create("token", "mo", {
                stretchy: !1,
                braketbar: !0
              }, a);
              t.Push(l);
  ...
  t = l(955), e = l(667), a = l(243), r = l(519), o = l(277), MathJax.loader && MathJax.loader.checkVersion("[tex]/braket", e.q, "tex-extension"), (0, t.r8)({
    _: {
      input: {
        tex: {
          braket: {
