!function () {
    ...
    r = {
      ...
      738: function (t, e, a) {
        ...
        new o.CommandMap("html_macros", {
          ...
          style: "Style",
          cssId: "Id"
        }, i.default), e.HtmlConfiguration = r.Configuration.create("html", {
          handler: {
            macro: ["html_macros"]
          }
        });
  ...
  t = i(955), e = i(667), a = i(738), n = i(248), MathJax.loader && MathJax.loader.checkVersion("[tex]/html", e.q, "tex-extension"), (0, t.r8)({
    _: {
      input: {
        tex: {
          html: {
