...
!function () {
      ...
      558: function (t, e, a) {
        ...
        var i = a(935),
          ...
          u = function (t) {
            ...
            return n(e, t), e.prototype.EndEntry = function () {
              ...
              return a.isKind("menclose") && (a = a.childNodes[0].childNodes[0]), this.hasColor && "none" === a.attributes.get("frame") && a.attributes.set("frame", ""), e;
            }, e;
          }(i.ArrayItem);
        e.ColorArrayItem = u, new l.CommandMap("colortbl", {
          ...
          TableColor: function (t, e, a) {
            ...
            if ("col" === a) {
              if (i.table.length) throw new p.default("ColumnColorNotTop", "%1 must be in the top row", e);
              i.color.col[i.row.length] = r, t.GetBrackets(e, "") && t.GetBrackets(e, "");
            } else if (i.color[a] = r, "row" === a && (i.Size() || i.row.length)) throw new p.default("RowColorNotFirst", "%1 must be at the beginning of a row", e);
          }
        });
  ...
  t = r(955), e = r(667), a = r(558), MathJax.loader && MathJax.loader.checkVersion("[tex]/colortbl", e.q, "tex-extension"), (0, t.r8)({
    _: {
      input: {
        tex: {
          colortbl: {
            ColortblConfiguration: a
          }
        }
      }
    }
