...
!function () {
    ...
    r = {
      ...
      762: function (t, e, a) {
        ...
        function p(t, e, a, n) {
          ...
          return t instanceof l.TextParser || (o.texParser = t), [new l.TextParser(e, n ? {
            mathvariant: n
          } : {}, o.parseOptions, a).mml()];
        }
        a(557), e.TextBaseConfiguration = r.Configuration.create("text-base", {
          parser: "text",
          handler: {
          ...
          fallback: {
            ...
            macro: function (t, e) {
              var a = t.texParser,
                n = a.lookup("macro", e);
              n && n._func !== u.TextMacrosMethods.Macro && t.Error("MathMacro", "%1 is only supported in math mode", "\\" + e), a.parse("macro", [t, e]);
            }
          },
          ...
          config: function (t, e) {
            ...
            n.options = e.parseOptions.options, a.config(e), i.TagsFactory.addTags(a.tags), n.tags = i.TagsFactory.getDefault(), n.tags.configuration = n, n.packageData = e.parseOptions.packageData, n.packageData.set("textmacros", {
              parseOptions: n,
              jax: e,
              texParser: null
      ...
      557: function (t, e, a) {
        ...
        new n.MacroMap("text-special", {
          ...
          "`": "OpenQuote",
          "'": "CloseQuote"
        }, r.TextMacrosMethods), new n.CommandMap("text-macros", {
          "(": "Math",
          $: "SelfQuote",
          _: "SelfQuote",
          "%": "SelfQuote",
      ...
      807: function (t, e, a) {
        ...
        e.TextMacrosMethods = {
          ...
          Math: function (t, e) {
            t.saveText();
            for (var a, n, r = t.i, s = 0; n = t.GetNext();) switch (a = t.i++, n) {
              case "\\":
                ")" === t.GetCS() && (n = "\\(");
              case "$":
                if (0 === s && e === n) {
                  var i = t.texParser.configuration,
                    c = new o.default(t.string.substr(r, a - r), t.stack.env, i).mml();
      ...
      787: function (t, e, a) {
        var n,
          ...
          i = this && this.__spreadArray || function (t, e, a) {
            if (a || 2 === arguments.length) for (var n, o = 0, r = e.length; o < r; o++) !n && o in e || (n || (n = Array.prototype.slice.call(e, 0, o)), n[o] = e[o]);
        ...
        var l = c(a(193)),
          ...
          M = function (t) {
            ...
            return o(e, t), Object.defineProperty(e.prototype, "texParser", {
              ...
              if (this.text && this.saveText(), e instanceof x.StopItem) return t.prototype.Push.call(this, e);
              e instanceof x.StyleItem ? this.stack.env.mathcolor = this.stack.env.color : e instanceof m.AbstractMmlNode && (this.addAttributes(e), this.nodes.push(e));
              ...
              try {
                for (var o = r(["mathsize", "mathcolor"]), s = o.next(); !s.done; s = o.next()) {
                  var i = s.value;
                  n[i] && !t.attributes.getExplicit(i) && (t.isToken || t.isKind("mstyle") || (t = this.create("node", "mstyle", [t])), h.default.setAttribute(t, i, n[i]));
                }
              } catch (t) {
                e = {
                  error: t
  ...
  t = i(955), e = i(667), a = i(762), n = i(807), o = i(787), MathJax.loader && MathJax.loader.checkVersion("[tex]/textmacros", e.q, "tex-extension"), (0, t.r8)({
    _: {
      input: {
        tex: {
          textmacros: {
