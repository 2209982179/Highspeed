...
!function () {
    ...
    l = {
      ...
      162: function (e, o, t) {
        ...
        o.ColorMethods = {}, o.ColorMethods.Color = function (e, o) {
          var t = e.GetBrackets(o, ""),
            ...
            n = e.itemFactory.create("style").setProperties({
              styles: {
                mathcolor: a
              }
            });
      ...
      358: function (e, o, t) {
        ...
        var n = a(t(402)),
          ...
          u = function () {
            ...
            return e.prototype.normalizeColor = function (e, o) {
              ...
              return this.userColors.has(e) ? this.userColors.get(e) : l.COLORS.has(e) ? l.COLORS.get(e) : e;
        ...
        o.ColorModel = u, i.set("rgb", function (e) {
          ...
          if (!e.match(/^\s*(\d+(\.\d*)?|\.\d+)\s*$/)) throw new n.default("InvalidDecimalNumber", "Invalid decimal number");
          var o = parseFloat(e);
          if (o < 0 || o > 1) throw new n.default("ModelArg2", "Color values for the %1 model must be between %2 and %3", "gray", "0", "1");
          var t = Math.floor(255 * o).toString(16);
          return t.length < 2 && (t = "0" + t), "#".concat(t).concat(t).concat(t);
        });
      },
      955: function (e, o) {
        MathJax._.components.global.isObject, MathJax._.components.global.combineConfig, MathJax._.components.global.combineDefaults, o.r8 = MathJax._.components.global.combineWithMathJax, MathJax._.components.global.MathJax;
      },
      251: function (e, o) {
        Object.defineProperty(o, "__esModule", {
          value: !0
        }), o.Configuration = MathJax._.input.tex.Configuration.Configuration, o.ConfigurationHandler = MathJax._.input.tex.Configuration.ConfigurationHandler, o.ParserConfiguration = MathJax._.input.tex.Configuration.ParserConfiguration;
      },
      748: function (e, o) {
        Object.defineProperty(o, "__esModule", {
          value: !0
  ...
  e = u(955), o = u(667), t = u(224), r = u(59), a = u(162), n = u(358), MathJax.loader && MathJax.loader.checkVersion("[tex]/color", o.q, "tex-extension"), (0, e.r8)({
    _: {
      input: {
        tex: {
          color: {
