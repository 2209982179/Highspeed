    ...
    e = {
      ...
      986: function (t, a, o) {
        ...
        function x(t, a, o, e) {
          ...
          return "mtext" !== a && t.configuration.parser.stack.env.boldsymbol && (i.default.setProperty(n, "fixBold", !0), t.configuration.addNode("fixBold", n)), n;
        }
        function p(t) {
          var a, o;
          try {
            for (var n = e(t.data.getList("fixBold")), r = n.next(); !r.done; r = n.next()) {
              ...
              if (i.default.getProperty(s, "fixBold")) {
                ...
                null == u ? i.default.setAttribute(s, "mathvariant", l.TexConstant.Variant.BOLD) : i.default.setAttribute(s, "mathvariant", d[u] || u), i.default.removeProperties(s, "fixBold");
              }
            }
          } catch (t) {
            a = {
      ...
      251: function (t, a) {
        Object.defineProperty(a, "__esModule", {
          value: !0
        }), a.Configuration = MathJax._.input.tex.Configuration.Configuration, a.ConfigurationHandler = MathJax._.input.tex.Configuration.ConfigurationHandler, a.ParserConfiguration = MathJax._.input.tex.Configuration.ParserConfiguration;
      },
      348: function (t, a) {
        Object.defineProperty(a, "__esModule", {
          value: !0
