  ...
  var t = {
      ...
      669: function (t, e, r) {
        ...
        e.ActionMethods = {}, e.ActionMethods.Macro = s.default.Macro, e.ActionMethods.Toggle = function (t, e) {
          for (var r, n = []; "\\endtoggle" !== (r = t.GetArgument(e));) n.push(new o.default(r, t.stack.env, t.configuration).mml());
        ...
        }, e.ActionMethods), e.ActionConfiguration = a.Configuration.create("action", {
          handler: {
            macro: ["action-macros"]
          }
        });
      ...
      2577: function (t, e, r) {
        ...
        e.AmsConfiguration = i.Configuration.create("ams", {
          ...
          items: (a = {}, a[s.MultlineItem.prototype.kind] = s.MultlineItem, a[s.FlalignItem.prototype.kind] = s.FlalignItem, a),
          tags: {
            ams: d
          },
          init: function (t) {
      ...
      8016: function (t, e, r) {
        ...
        e.AmsMethods = {}, e.AmsMethods.AmsEqnArray = function (t, e, r, n, a, o, s) {
          ...
          var o,
            ...
            c = "",
            u = [];
          if (a || (s = t.GetBrackets("\\begin{" + l + "}")), (o = t.GetArgument("\\begin{" + l + "}")).match(/[^0-9]/)) throw new d.default("PositiveIntegerArg", "Argument to %1 must me a positive integer", "\\begin{" + l + "}");
          ...
          if (o.match(/[^0-9]/)) throw new d.default("PositiveIntegerArg", "Argument to %1 must me a positive integer", "\\begin{" + r.getName() + "}");
          var i = a ? "crl" : "rlc",
          ...
          void 0 === l && (l = !1), t.Push(e), i.default.checkEqnEnv(t), o = o.split("").join(" ").replace(/r/g, "right").replace(/l/g, "left").replace(/c/g, "center");
          ...
          t.configuration.handlers.retrieve(e.NEW_OPS).add(a, new p.Macro(a, e.AmsMethods.Macro, ["\\operatorname".concat(n, "{").concat(o, "}")]));
        }, e.AmsMethods.HandleOperatorName = function (t, e) {
          var r = t.GetStar(),
            a = i.default.trimSpaces(t.GetArgument(e)),
            o = new u.default(a, n(n({}, t.stack.env), {
          ...
          var r = a(h(t.ParseArg(e)), 2),
            ...
            d = t.ParseArg(e),
            p = d;
          n && (o ? n.replaceChild(t.create("node", "mphantom", [t.create("node", "mpadded", [i.default.copyNode(d, t)], {
            width: 0
          })]), l.default.getChildAt(n, 0)) : (p = t.create("node", "mmultiscripts", [d]), c && l.default.appendChildren(p, [l.default.getChildAt(c, 1) || t.create("node", "none"), l.default.getChildAt(c, 2) || t.create("node", "none")]), l.default.setProperty(p, "scriptalign", "left"), l.default.appendChildren(p, [t.create("node", "mprescripts"), l.default.getChildAt(n, 1) || t.create("node", "none"), l.default.getChildAt(n, 2) || t.create("node", "none")]))), c && p === d && (c.replaceChild(d, l.default.getChildAt(c, 0)), p = c);
          var f = t.create("node", "TeXAtom", [], {
            texClass: m.TEXCLASS.OP,
            movesupsub: !0,
            movablelimits: !0
          });
          o && (n && f.appendChild(n), f.appendChild(o)), f.appendChild(p), u && f.appendChild(u), t.Push(f);
          ...
          if ("\\" === n) {
            var a = t.i;
            n = t.GetArgument(e), t.i = a, "\\limits" === n && (r = "\\idotsint" === e ? "\\!\\!\\mathop{\\,\\," + r + "}" : "\\!\\!\\!\\mathop{\\,\\,\\," + r + "}");
          }
          ...
          if (l.default.setAttribute(h, "voffset", "-.2em"), l.default.setAttribute(h, "height", "-.2em"), l.default.setChild(f, f.over, h), s) {
            ...
            h = t.create("node", "mpadded", [g, v], o), l.default.setAttribute(h, "voffset", ".15em"), l.default.setAttribute(h, "depth", "-.15em"), l.default.setChild(f, f.under, h);
          }
          ...
          if (null == (r = o[r])) throw new d.default("IllegalAlign", "Illegal alignment specified in %1", t.currentCS);
          r && l.default.setProperties(f, {
            numalign: r,
            denomalign: r
          }), t.Push(f);
        }, e.AmsMethods.Genfrac = function (t, e, r, n, a, o) {
          null == r && (r = t.GetDelimiterArg(e)), null == n && (n = t.GetDelimiterArg(e)), null == a && (a = t.GetArgument(e)), null == o && (o = i.default.trimSpaces(t.GetArgument(e)));
          var s = t.ParseArg(e),
            c = t.ParseArg(e),
            u = t.create("node", "mfrac", [s, c]);
          if ("" !== a && l.default.setAttribute(u, "linethickness", a), (r || n) && (l.default.setProperty(u, "withDelims", !0), u = i.default.fixedFence(t.configuration, r, u, n)), "" !== o) {
            var p = parseInt(o, 10),
              f = ["D", "T", "S", "SS"][p];
          ...
          if (!t.tags.currentTag.taggable && t.tags.env) throw new d.default("CommandNotAllowedInEnv", "%1 not allowed in %2 environment", t.currentCS, t.tags.env);
        ...
        var a = n(r(2193)),
          ...
          l = {
            ...
            arrow: function (t, e) {
              ...
              if ("." === r) ;else if ("|" === r) c = t.create("token", "mo", m, "\u2225");else if ("=" === r) c = t.create("token", "mo", f, "=");else {
                var h = {
                    ">": "\u2192",
                    "<": "\u2190",
                    V: "\u2193",
                ...
                if (">" === r || "<" === r) {
                  ...
                  c = M, (g || v) && (c = t.create("node", "mrow"), g && s.default.appendChildren(c, [new a.default("\\scriptstyle\\llap{" + g + "}", t.stack.env, t.configuration).mml()]), M.texClass = i.TEXCLASS.ORD, s.default.appendChildren(c, [M]), v && s.default.appendChildren(c, [new a.default("\\scriptstyle\\rlap{" + v + "}", t.stack.env, t.configuration).mml()]));
                }
              }
      ...
      2133: function (t, e, r) {
        ...
        e.BboxMethods = {}, e.BboxMethods.BBox = function (t, e) {
          for (var r, n, a, o = t.GetBrackets(e, ""), c = t.ParseArg(e), u = o.split(/,/), d = 0, p = u.length; d < p; d++) {
            ...
            if (m) {
              ...
              if (a) throw new i.default("MultipleBBoxProperty", "%1 specified twice in %2", "Style", e);
              a = s(f);
            } else if ("" !== f) throw new i.default("InvalidBBoxProperty", '"%1" doesn\'t look like a color, a padding dimension, or a style', f);
          }
          r && (c = t.create("node", "mpadded", [c], r)), (n || a) && (r = {}, n && Object.assign(r, {
            mathbackground: n
          }), a && Object.assign(r, {
            style: a
        ...
        new o.CommandMap("bbox", {
          bbox: "BBox"
        }, e.BboxMethods), e.BboxConfiguration = a.Configuration.create("bbox", {
          handler: {
            macro: ["bbox"]
          }
        });
      ...
      2986: function (t, e, r) {
        ...
        function d(t, e, r, n) {
          ...
          return "mtext" !== e && t.configuration.parser.stack.env.boldsymbol && (i.default.setProperty(a, "fixBold", !0), t.configuration.addNode("fixBold", a)), a;
        }
        function p(t) {
          var e, r;
          try {
        ...
        u[s.TexConstant.Variant.NORMAL] = s.TexConstant.Variant.BOLD, u[s.TexConstant.Variant.ITALIC] = s.TexConstant.Variant.BOLDITALIC, u[s.TexConstant.Variant.FRAKTUR] = s.TexConstant.Variant.BOLDFRAKTUR, u[s.TexConstant.Variant.SCRIPT] = s.TexConstant.Variant.BOLDSCRIPT, u[s.TexConstant.Variant.SANSSERIF] = s.TexConstant.Variant.BOLDSANSSERIF, u["-tex-calligraphic"] = "-tex-bold-calligraphic", u["-tex-oldstyle"] = "-tex-bold-oldstyle", u["-tex-mathit"] = s.TexConstant.Variant.BOLDITALIC, e.BoldsymbolMethods = {}, e.BoldsymbolMethods.Boldsymbol = function (t, e) {
          ...
          boldsymbol: "Boldsymbol"
        }, e.BoldsymbolMethods), e.createBoldToken = d, e.rewriteBoldTokens = p, e.BoldsymbolConfiguration = o.Configuration.create("boldsymbol", {
          handler: {
            macro: ["boldsymbol"]
          },
          nodes: {
      ...
      3299: function (t, e, r) {
        ...
        new a.CommandMap("Braket-macros", {
          ...
          "|": "Bar"
        }, o.default), new a.MacroMap("Braket-characters", {
          "|": "Bar"
        }, o.default);
      },
      1277: function (t, e, r) {
        ...
        var a = n(r(7360)),
          ...
          i = n(r(3402)),
          s = {};
        s.Macro = a.default.Macro, s.Braket = function (t, e, r, n, a, o) {
          var s = t.GetNext();
      ...
      1116: function (t, e, r) {
        ...
        }, a.default), new i.EnvironmentMap("Bussproofs-environments", o.default.environment, {
      ...
      2827: function (t, e, r) {
        var n = this && this.__createBinding || (Object.create ? function (t, e, r, n) {
          ...
          s = this && this.__spreadArray || function (t, e, r) {
            if (r || 2 === arguments.length) for (var n, a = 0, o = e.length; a < o; a++) !n && a in e || (n || (n = Array.prototype.slice.call(e, 0, a)), n[a] = e[a]);
        ...
        function h(t, e, r, n, a, o, i) {
          ...
          if (p.setProperty(m, "inferenceRule", i ? "up" : "down"), n && (s = t.create("node", "mpadded", [n], {
            height: "+.5em",
            width: "+.5em",
            voffset: "-.15em"
          }), p.setProperty(s, "prooflabel", "left")), a && (l = t.create("node", "mpadded", [a], {
            height: "+.5em",
            width: "+.5em",
            voffset: "-.15em"
          }), p.setProperty(l, "prooflabel", "right")), n && a) c = [s, m, l], u = "both";else if (n) c = [s, m], u = "left";else {
            if (!a) return m;
            c = [m, l], u = "right";
          }
        ...
        f.Inference = function (t, e, r) {
          ...
          n.setProperty("left", null), n.setProperty("right", null), p.setProperty(f, "inference", o), t.configuration.addNode("inference", f), n.Push(f);
          ...
          var a = t.stack.Top();
          if ("proofTree" !== a.kind) throw new c.default("IllegalProofCommand", "Proof commands only allowed in prooftree environment.");
      ...
      378: function (t, e, r) {
        ...
        var s = i(r(4748)),
          ...
          w = function (t, r, n, a) {
            if (void 0 === a && (a = !1), (0, e.getProperty)(r, "inferenceRule") || (0, e.getProperty)(r, "labelledRule")) {
          ...
          P = function (t, r) {
            for (var n = r.pop(); r.length;) {
              var o = r.pop(),
                ...
                s = i[0],
                l = i[1];
              (0, e.getProperty)(n.parent, "axiom") && (C(t, s < 0 ? n : o, 0, "left", Math.abs(s)), C(t, l < 0 ? n : o, 2, "right", Math.abs(l))), n = o;
            }
          },
          S = function (t, e) {
        ...
        e.balanceRules = function (t) {
          ...
          !function (t) {
            ...
            if (r) for (var n = r.length - 1, a = void 0; a = r[n]; n--) if ((0, e.getProperty)(a, "sequentProcessed")) (0, e.removeProperty)(a, "sequentProcessed");else {
              var o = [],
                i = b(a);
              if (1 === (0, e.getProperty)(i, "inference")) {
                for (o.push(a); 1 === (0, e.getProperty)(i, "inference");) {
                  ...
                  (0, e.getProperty)(l, "sequent") && (a = l.childNodes[0], o.push(a), (0, e.setProperty)(a, "sequentProcessed", !0)), i = s;
                }
                P(t, o);
              }
            }
              ...
              if (null != (0, e.getProperty)(k, "inference")) {
                ...
                if (!d && (I = y(c))) {
                  ...
                  if (N) {
                    ...
                    var B = b(I);
                    B && (q = (0, e.getProperty)(B, "maxAdjust") ? Math.max((0, e.getProperty)(B, "maxAdjust"), q) : q, (0, e.setProperty)(B, "maxAdjust", q));
                  }
                } else w(a, (0, e.getProperty)(c, "proof") ? c : c.parent, q - T, !0);
              }
            }
          } catch (t) {
            r = {
        ...
        e.makeBsprAttributes = function (t) {
          t.data.root.walkTree(function (t, e) {
            ...
            t.getPropertyNames().forEach(function (e) {
              !k[e] && e.match(RegExp("^bspr_")) && r.push(e + ":" + t.getProperty(e));
      ...
      5774: function (t, e, r) {
        ...
        e.CancelMethods = {}, e.CancelMethods.Cancel = function (t, e, r) {
          ...
          i.notation = [o.TexConstant.Notation.UPDIAGONALSTRIKE, o.TexConstant.Notation.UPDIAGONALARROW, o.TexConstant.Notation.NORTHEASTARROW].join(" "), n = t.create("node", "mpadded", [n], {
            depth: "-.1em",
            height: "+.1em",
            voffset: ".1em"
          ...
          cancelto: "CancelTo"
        }, e.CancelMethods), e.CancelConfiguration = a.Configuration.create("cancel", {
          handler: {
            macro: ["cancel"]
          }
        });
      ...
      7530: function (t, e, r) {
        ...
        var g = function (t) {
          ...
          return o(e, t), e.prototype.start = function (e, r, n) {
        ...
        e.CasesTags = g, e.CasesMethods = {
          NumCases: function (t, e) {
            if (t.stack.env.closing === e.getName()) {
              ...
              return m.EmpheqUtil.left(n, a, o + "\\empheqlbrace\\,", t, "numcases-left"), t.Push(t.itemFactory.create("end").setProperty("name", e.getName())), null;
            }
        ...
        }, new l.EnvironmentMap("cases-env", m.EmpheqUtil.environment, {
      ...
      2286: function (t, e, r) {
        ...
        new l.CommandMap("centernot", {
          ...
          CenterOver: function (t, e) {
            var r = "{" + t.GetArgument(e) + "}",
              ...
              o = t.create("node", "TeXAtom", [new i.default(r, t.stack.env, t.configuration).mml(), t.create("node", "mpadded", [t.create("node", "mpadded", [n], {
                width: 0,
                lspace: "-.5width"
        ...
        }), e.filterCenterOver = u, e.CenternotConfiguration = o.Configuration.create("centernot", {
          handler: {
            macro: ["centernot"]
          },
          postprocessors: [u]
      ...
      6162: function (t, e, r) {
        ...
        e.ColorMethods = {}, e.ColorMethods.Color = function (t, e) {
          var r = t.GetBrackets(e, ""),
            ...
            o = t.itemFactory.create("style").setProperties({
              styles: {
                mathcolor: a
              }
            });
      ...
      6358: function (t, e, r) {
        ...
        e.ColorModel = l, s.set("rgb", function (t) {
          var e,
            ...
            a = t.trim().split(/\s*,\s*/),
            i = "#";
          if (3 !== a.length) throw new o.default("ModelArg1", "Color values for the %1 model require 3 numbers", "rgb");
          try {
            for (var s = n(a), l = s.next(); !l.done; l = s.next()) {
              var c = l.value;
              if (!c.match(/^(\d+(\.\d*)?|\.\d+)$/)) throw new o.default("InvalidDecimalNumber", "Invalid decimal number");
              var u = parseFloat(c);
              if (u < 0 || u > 1) throw new o.default("ModelArg2", "Color values for the %1 model must be between %2 and %3", "rgb", "0", "1");
          ...
          try {
            for (var s = n(a), l = s.next(); !l.done; l = s.next()) {
              var c = l.value;
              if (!c.match(/^\d+$/)) throw new o.default("InvalidNumber", "Invalid number");
              var u = parseInt(c);
              if (u > 255) throw new o.default("ModelArg2", "Color values for the %1 model must be between %2 and %3", "RGB", "0", "255");
              var d = u.toString(16);
              d.length < 2 && (d = "0" + d), i += d;
            }
          } catch (t) {
          ...
          if (!t.match(/^\s*(\d+(\.\d*)?|\.\d+)\s*$/)) throw new o.default("InvalidDecimalNumber", "Invalid decimal number");
          var e = parseFloat(t);
          if (e < 0 || e > 1) throw new o.default("ModelArg2", "Color values for the %1 model must be between %2 and %3", "gray", "0", "1");
      ...
      4558: function (t, e, r) {
        ...
        var i = r(2935),
          ...
          u = function (t) {
            ...
            return a(e, t), e.prototype.EndEntry = function () {
              t.prototype.EndEntry.call(this);
        ...
        e.ColorArrayItem = u, new l.CommandMap("colortbl", {
          ...
          TableColor: function (t, e, r) {
            ...
            } else if (i.color[r] = o, "row" === r && (i.Size() || i.row.length)) throw new c.default("RowColorNotFirst", "%1 must be at the beginning of a row", e);
          }
        });
      ...
      7888: function (t, e, r) {
        ...
        e.ColorV2Methods = {
          ...
          color: "Color"
        }, e.ColorV2Methods), e.ColorConfiguration = a.Configuration.create("colorv2", {
          handler: {
            macro: ["colorv2"]
          }
        });
      ...
      6359: function (t, e, r) {
        ...
        e.ConfigMacrosConfiguration = i.Configuration.create("configmacros", {
          init: function (t) {
            new l.CommandMap(f, {}, {}), new l.EnvironmentMap(m, c.default.environment, {}, {}), t.append(i.Configuration.local({
              handler: {
                macro: [f],
                environment: [m]
              },
              ...
              try {
                for (var i = a(Object.keys(o)), s = i.next(); !s.done; s = i.next()) {
                  var l = s.value,
                    ...
                    p = Array.isArray(c[2]) ? new u.Macro(l, d.default.MacroWithTemplate, c.slice(0, 2).concat(c[2])) : new u.Macro(l, d.default.Macro, c);
                  n.add(l, p);
                }
              } catch (t) {
                e = {
      ...
      2079: function (t, e, r) {
        ...
        e.EmpheqBeginItem = m, e.EmpheqMethods = {
          Empheq: function (t, e) {
            if (t.stack.env.closing === e.getName()) {
              ...
              var n = t.GetBrackets("\\begin{" + e.getName() + "}") || "",
                a = i((t.GetArgument("\\begin{" + e.getName() + "}") || "").split(/=/), 2),
                o = a[0],
                s = a[1];
              if (!f.EmpheqUtil.checkEnv(o)) throw new d.default("UnknownEnv", 'Unknown environment "%1"', o);
              n && e.setProperties(f.EmpheqUtil.splitOptions(n, {
                left: 1,
                right: 1
              })), t.stack.global.empheq = o, t.string = "\\begin{" + o + "}" + (s ? "{" + s + "}" : "") + t.string.slice(t.i), t.i = 0, t.Push(e);
            }
          },
      ...
      9301: function (t, e, r) {
        ...
        e.EmpheqUtil = {
          ...
          left: function (t, e, r, n, a) {
            var i, s, l;
            void 0 === a && (a = ""), t.attributes.set("columnalign", "right " + (t.attributes.get("columnalign") || "")), t.attributes.set("columnspacing", "0em " + (t.attributes.get("columnspacing") || ""));
            try {
              for (var c = o(t.childNodes.slice(0).reverse()), u = c.next(); !u.done; u = c.next()) {
                var d = u.value;
                l = n.create("node", "mtd"), d.childNodes.unshift(l), l.parent = d, d.isKind("mlabeledtr") && (d.childNodes[0] = d.childNodes[1], d.childNodes[1] = l);
              }
            } catch (t) {
              i = {
                error: t
          ...
          right: function (t, r, n, a, o) {
            ...
            for (var i = e.EmpheqUtil.columnCount(t), s = t.childNodes[0]; s.childNodes.length < i;) s.appendChild(a.create("node", "mtd"));
            var l = s.appendChild(a.create("node", "mtd"));
            e.EmpheqUtil.rowspanCell(l, n, r, a, o), t.attributes.set("columnalign", (t.attributes.get("columnalign") || "").split(/ /).slice(0, i).join(" ") + " left"), t.attributes.set("columnspacing", (t.attributes.get("columnspacing") || "").split(/ /).slice(0, i - 1).join(" ") + " 0em");
          },
      ...
      4272: function (t, e, r) {
        ...
        }, new o.CommandMap("enclose", {
          enclose: "Enclose"
        }, e.EncloseMethods), e.EncloseConfiguration = a.Configuration.create("enclose", {
          handler: {
            macro: ["enclose"]
          }
        });
      ...
      3646: function (t, e, r) {
        ...
        e.ExtpfeilMethods = {}, e.ExtpfeilMethods.xArrow = i.AmsMethods.xArrow, e.ExtpfeilMethods.NewExtArrow = function (t, r) {
          ...
          if (!a.match(/^(\d+),(\d+)$/)) throw new c.default("NewextarrowArg2", "Second argument to %1 must be two integers separated by a comma", r);
          if (!o.match(/^(\d+|0x[0-9A-F]+)$/i)) throw new c.default("NewextarrowArg3", "Third argument to %1 must be a unicode character number", r);
          n = n.substr(1);
          var i = a.split(",");
      ...
      2082: function (t, e, r) {
        ...
        var n = r(251),
          a = r(6108);
        new (r(5871).CharacterMap)("gensymb-symbols", function (t, e) {
          var r = e.attributes || {};
      ...
      1738: function (t, e, r) {
        ...
        var a = r(251),
          o = r(5871),
          i = n(r(6248));
        new o.CommandMap("html_macros", {
          href: "Href",
          class: "Class",
          style: "Style",
          cssId: "Id"
        }, i.default), e.HtmlConfiguration = a.Configuration.create("html", {
          handler: {
            macro: ["html_macros"]
          }
        });
        ...
        var a = n(r(4748)),
          o = {
            ...
            Style: function (t, e) {
              ...
              o && (";" !== r.charAt(r.length - 1) && (r += ";"), r = o + " " + r), a.default.setAttribute(n, "style", r), t.Push(n);
            },
            Id: function (t, e) {
              var r = t.GetArgument(e),
                n = i(t, e);
              ...
              if (p.getProperty("fixPrescript")) {
                ...
                try {
                  for (var v = (i = void 0, a([4, 5])), y = v.next(); !y.done; y = v.next()) {
                    var x = y.value;
                    l.default.isType(f[x], "mrow") && 0 === l.default.getChildren(f[x]).length && l.default.setChild(p, x, c.nodeFactory.create("node", "none"));
                  }
                } catch (t) {
                  i = {
                    error: t
      ...
      8926: function (t, e, r) {
        ...
        }, s.MathtoolsMethods), new o.EnvironmentMap("mathtools-environments", a.default.environment, {
        ...
        }, s.MathtoolsMethods), new o.DelimiterMap("mathtools-delimiters", a.default.delimiter, {
          "\\lparen": "(",
          "\\rparen": ")"
        }), new o.CommandMap("mathtools-characters", {
          ":": ["CenterColon", !0]
        }, s.MathtoolsMethods);
      },
      2178: function (t, e, r) {
        ...
        e.MathtoolsMethods = {
          ...
          MtSmallMatrix: function (t, r, n, a, o) {
            return o || (o = t.GetBrackets("\\begin{".concat(r.getName(), "}"), t.options.mathtools["smallmatrix-align"])), e.MathtoolsMethods.Array(t, r, n, a, o, s.default.Em(1 / 3), ".2em", "S", 1);
          },
          ...
          HandleShove: function (t, e, r) {
            var n = t.stack.Top();
            if ("multline" !== n.kind && "multlined" !== n.kind) throw new d.default("CommandInMultlined", "%1 can only appear within the multline or multlined environments", e);
          ...
          Cases: function (t, e, r, n, a) {
            ...
            return o.arraydef = {
              ...
              columnspacing: "1em",
              columnalign: "left"
            }, "D" === a && (o.arraydef.displaystyle = !0), o.setProperties({
              open: r,
              close: n
            }), t.Push(e), o;
          },
          ...
          UnderOverBracket: function (t, e) {
            var r = (0, m.length2em)(t.GetBrackets(e, ".1em"), .1),
              n = t.GetBrackets(e, ".2em"),
              o = t.GetArgument(e),
              i = a("o" === e.charAt(1) ? ["over", "accent", "bottom"] : ["under", "accentunder", "top"], 3),
              l = i[0],
              c = i[1],
              d = i[2],
              f = (0, m.em)(r),
          ...
          Aboxed: function (t, e) {
            ...
            var l = s.default.substituteArgs(t, [o, i], "\\rlap{\\boxed{#1{}#2}}\\kern.267em\\phantom{#1}&\\phantom{{}#2}\\kern.267em");
            t.string = l + a, t.i = 0;
          },
          ...
          ShortVDotsWithin: function (t, r) {
            var n = t.stack.Top(),
              a = t.GetStar();
            e.MathtoolsMethods.FlushSpaceAbove(t, "\\MTFlushSpaceAbove"), !a && n.EndEntry(), e.MathtoolsMethods.VDotsWithin(t, "\\vdotswithin"), a && n.EndEntry(), e.MathtoolsMethods.FlushSpaceBelow(t, "\\MTFlushSpaceBelow");
          },
          ...
          PairedDelimiters: function (t, e, r, n, o, i, l, c) {
            ...
            if (i) {
              ...
              l = s.default.substituteArgs(t, g, l), o = s.default.substituteArgs(t, g, o), c = s.default.substituteArgs(t, g, c);
            }
            o = o.replace(/\\delimsize/g, h), t.string = [l, f, r, o, m, n, c, t.string.substr(t.i)].reduce(function (e, r) {
          ...
          XMathStrut: function (t, e) {
            var r = t.GetBrackets(e),
              n = t.GetArgument(e);
            n = y.MathtoolsUtil.plusOrMinus(e, n), r = y.MathtoolsUtil.plusOrMinus(e, r || n), t.Push(t.create("node", "TeXAtom", [t.create("node", "mpadded", [t.create("node", "mphantom", [t.create("token", "mo", {
              stretchy: !1
            }, "(")])], {
              width: 0,
              height: n + "height",
          ...
          Prescript: function (t, e) {
            ...
            if (p.default.isType(r, "none") && p.default.isType(n, "none")) t.Push(a);else {
              var o = t.create("node", "mmultiscripts", [a]);
              p.default.getChildren(o).push(null, null), p.default.appendChildren(o, [t.create("node", "mprescripts"), n, r]), o.setProperty("fixPrescript", !0), t.Push(o);
            }
          },
          NewTagForm: function (t, e, r) {
            ...
            if (!a) throw new d.default("InvalidTagFormID", "Tag form name can't be empty");
            var o = t.GetBrackets(e, ""),
              i = t.GetArgument(e),
              s = t.GetArgument(e);
            if (!r && n.mtFormats.has(a)) throw new d.default("DuplicateTagForm", "Duplicate tag form: %1", a);
          ...
          SetOptions: function (t, e) {
            ...
            if (!a["allow-mathtoolsset"]) throw new d.default("ForbiddenMathtoolsSet", "%1 is disabled", e);
            var i = {};
      ...
      3298: function (t, e, r) {
        ...
        e.MathtoolsTagFormat = function (t, e) {
          ...
          var n = function (t) {
              ...
              return a(r, t), r.prototype.formatTag = function (e) {
                if (this.mtCurrent) {
                  var r = i(this.mtCurrent, 3),
                    n = r[0],
                    a = r[1],
                    o = r[2];
                  return o ? "".concat(n).concat(o, "{").concat(e, "}").concat(a) : "".concat(n).concat(e).concat(a);
                }
      ...
      5262: function (t, e, r) {
        ...
        e.MathtoolsUtil = {
          ...
          checkAlignment: function (t, e) {
            var r = t.stack.Top();
            if (r.kind !== o.EqnArrayItem.prototype.kind) throw new l.default("NotInAlignment", "%1 can only be used in aligment environments", e);
            return r;
          },
      ...
      7078: function (t, e, r) {
        ...
        }, u), e.MhchemConfiguration = a.Configuration.create("mhchem", {
          handler: {
            macro: ["mhchem"]
          }
        });
      ...
      2048: function (t, e, r) {
        ...
        e.NewcommandConfiguration = l.Configuration.create("newcommand", {
          ...
          init: function (t) {
            new p.DelimiterMap(u.default.NEW_DELIMITER, d.default.delimiter, {}), new p.CommandMap(u.default.NEW_COMMAND, {}, {}), new p.EnvironmentMap(u.default.NEW_ENVIRONMENT, d.default.environment, {}, {}), t.append(l.Configuration.local({
              handler: {
                character: [],
          ...
          p = {
            ...
            MacroDef: function (t, e) {
              var r = d.default.GetCSname(t, e),
                ...
                a = t.GetArgument(e);
              n instanceof Array ? d.default.addMacro(t, r, p.MacroWithTemplate, [a].concat(n)) : d.default.addMacro(t, r, p.Macro, [a, n]);
            },
            Let: function (t, e) {
              var r = d.default.GetCSname(t, e),
                n = t.GetNext();
              ...
              if ("\\" !== n) {
                ...
                d.default.addMacro(t, r, function (t, e) {
            ...
            MacroWithTemplate: function (t, e, r, n) {
              ...
              if (i) {
                var l = [];
                if (t.GetNext(), a[0] && !d.default.MatchParam(t, a[0])) throw new s.default("MismatchUseDef", "Use of %1 doesn't match its definition", e);
                for (var c = 0; c < i; c++) l.push(d.default.GetParameter(t, e, a[c + 1]));
            ...
            BeginEnv: function (t, e, r, n, a, o) {
              ...
              if (a) {
                ...
                for (var c = s.length; c < a; c++) s.push(t.GetArgument("\\begin{" + e.getName() + "}"));
      ...
      4406: function (t, e, r) {
        ...
        !function (t) {
          ...
          t.disassembleSymbol = function (t, e) {
            ...
            var r = t.GetBrackets(e);
            if (r && !(r = o.default.trimSpaces(r)).match(/^[0-9]+$/)) throw new i.default("IllegalParamNumber", "Illegal number of parameters specified in %1", e);
            return r;
          }, t.GetTemplate = function (t, e, r) {
            for (var n = t.GetNext(), a = [], o = 0, s = t.i; t.i < t.string.length;) {
              if ("#" === (n = t.GetNext())) {
                if (s !== t.i && (a[o] = t.string.substr(s, t.i - s)), !(n = t.string.charAt(++t.i)).match(/^[1-9]$/)) throw new i.default("CantUseHash2", "Illegal use of # in template for %1", r);
                if (parseInt(n) !== ++o) throw new i.default("SequentialParam", "Parameters for %1 must be numbered sequentially", r);
                s = t.i + 1;
              } else if ("{" === n) return s !== t.i && (a[o] = t.string.substr(s, t.i - s)), a.length > 0 ? [o.toString()].concat(a) : o;
              t.i++;
            }
            ...
            for (var a = t.i, o = 0, s = 0; t.i < t.string.length;) {
              ...
              if ("{" === l) t.i === a && (s = 1), t.GetArgument(r), o = t.i - a;else {
          ...
          }, t.MatchParam = e, t.addDelimiter = function (e, r, n, a) {
            e.configuration.handlers.retrieve(t.NEW_DELIMITER).add(r, new s.Symbol(r, n, a));
          }, t.addMacro = function (e, r, n, a, o) {
            void 0 === o && (o = ""), e.configuration.handlers.retrieve(t.NEW_COMMAND).add(r, new s.Macro(o || r, n, a));
        ...
        var i = r(1076),
          ...
          u = function (t) {
            ...
            return a(e, t), Object.defineProperty(e.prototype, "kind", {
              ...
              var o = s.default.fenced(this.factory.configuration, this.getProperty("open"), t.prototype.toMml.call(this), this.getProperty("close"), this.getProperty("big"));
      ...
      3842: function (t, e, r) {
        ...
        new a.CommandMap("Physics-automatic-bracing-macros", {
          ...
          pb: ["Commutator", "\\{", "\\}"]
        }, o.default), new a.CharacterMap("Physics-vector-mo", s.default.mathchar0mo, {
          dotproduct: ["\u22c5", {
        ...
        }, o.default), new a.CommandMap("Physics-expressions-macros", {
          sin: "Expression",
          sinh: "Expression",
          arcsin: "Expression",
          asin: "Expression",
        ...
        }, o.default), new a.CommandMap("Physics-quick-quad-macros", {
          qqtext: "Qqtext",
          qq: "Qqtext",
          qcomma: ["Macro", "\\qqtext*{,}"],
          qc: ["Macro", "\\qqtext*{,}"],
          ...
          qas: ["Qqtext", "as"],
          qin: ["Qqtext", "in"]
        }, o.default), new a.CommandMap("Physics-derivative-macros", {
          diffd: "DiffD",
        ...
        }, o.default), new a.CommandMap("Physics-bra-ket-macros", {
          bra: "Bra",
          ket: "Ket",
          innerproduct: "BraKet",
          ip: "BraKet",
          ...
          mel: "MatrixElement"
        }, o.default), new a.CommandMap("Physics-matrix-macros", {
        ...
        }, o.default), new a.EnvironmentMap("Physics-aux-envs", s.default.environment, {
          smallmatrix: ["Array", null, null, null, "c", "0.333em", ".2em", "S", 1]
        }, o.default), new a.MacroMap("Physics-characters", {
      ...
      2458: function (t, e, r) {
        ...
        p.Quantity = function (t, e, r, n, a, o, d) {
          void 0 === r && (r = "("), void 0 === n && (n = ")"), void 0 === a && (a = !1), void 0 === o && (o = ""), void 0 === d && (d = "");
          var p = !!a && t.GetStar(),
            h = t.GetNext(),
            g = t.i,
            v = null;
          ...
          var x = f[h];
          if (a && "{" !== h) throw new s.default("MissingArgFor", "Missing argument for %1", t.currentCS);
          if (!x) {
            y = t.create("node", "mrow");
            return t.Push(c.default.fenced(t.configuration, r, y, n)), void (t.i = g);
          }
          if (o) {
            var b = t.create("token", "mi", {
          ...
          if ("{" === h) {
            ...
            return h = a ? r : "\\{", x = a ? n : "\\}", _ = p ? h + " " + _ + " " + x : v ? "\\" + v + "l" + h + " " + _ + " \\" + v + "r" + x : "\\left" + h + " " + _ + " \\right" + x, void t.Push(new i.default(_, t.stack.env, t.configuration).mml());
          }
          a && (h = r, x = n), t.i++, t.Push(t.itemFactory.create("auto open").setProperties({
            open: h,
            close: x,
            big: v
          }));
          ...
          if ("{" !== o) throw new s.default("MissingArgFor", "Missing argument for %1", t.currentCS);
          var c = t.GetArgument(e) + "," + t.GetArgument(e);
          c = a ? r + " " + c + " " + n : l ? "\\" + l + "l" + r + " " + c + " \\" + l + "r" + n : "\\left" + r + " " + c + " \\right" + n, t.Push(new i.default(c, t.stack.env, t.configuration).mml());
        };
        var h = [65, 90],
          g = [97, 122],
          v = [913, 937],
        ...
        function _(t, e, r, n) {
          var a = t.configuration.parser,
            ...
            i = n.codePointAt(0);
          return 1 === n.length && !a.stack.env.font && a.stack.env.vectorFont && (b(i, h) || b(i, g) || b(i, v) || b(i, x) || b(i, y) && a.stack.env.vectorStar || u.default.getAttribute(o, "accent")) && u.default.setAttribute(o, "mathvariant", a.stack.env.vectorFont), o;
        }
        p.VectorBold = function (t, e) {
          ...
          o && (t.stack.env.font = o), delete t.stack.env.vectorFont, delete t.stack.env.vectorStar, t.configuration.nodeFactory.set("token", a), t.Push(s);
        ...
        function w(t, e, r) {
          var a = n(t, 3),
            ...
            i = a[1],
            s = a[2];
          return e && r ? "\\left\\langle{".concat(o, "}\\middle\\vert{").concat(i, "}\\middle\\vert{").concat(s, "}\\right\\rangle") : e ? "\\langle{".concat(o, "}\\vert{").concat(i, "}\\vert{").concat(s, "}\\rangle") : "\\left\\langle{".concat(o, "}\\right\\vert{").concat(i, "}\\left\\vert{").concat(s, "}\\right\\rangle");
        }
        p.OperatorApplication = function (t, e, r) {
          ...
          var c = !1,
            u = " ",
            d = " ";
          r > 2 && l.length > 2 ? (u = "^{" + (l.length - 1) + "}", c = !0) : null != o && (r > 2 && l.length > 1 && (c = !0), d = u = "^{" + o + "}");
          for (var p = a ? "\\flatfrac" : "\\frac", f = l.length > 1 ? l[0] : "", m = l.length > 1 ? l[1] : l[0], h = "", g = 2, v = void 0; v = l[g]; g++) h += n + " " + v;
          var y = p + "{" + n + u + f + "}{" + n + " " + m + d + " " + h + "}";
          t.Push(new i.default(y, t.stack.env, t.configuration).mml()), "(" === t.GetNext() && (t.i++, t.Push(t.itemFactory.create("auto open").setProperties({
            open: "(",
            close: ")",
            ignore: c
          })));
          ...
          if ("\\" === t.GetNext()) {
            ...
            var c = t.GetCS(),
              u = t.lookup("macro", c);
            u && "ket" === u.symbol ? (o = !0, l = t.i, s = t.GetStar(), "{" === t.GetNext() ? a = t.GetArgument(c, !0) : (t.i = l, s = !1)) : t.i = l;
          }
          var d = "";
          d = o ? r || s ? "\\langle{".concat(n, "}\\vert{").concat(a, "}\\rangle") : "\\left\\langle{".concat(n, "}\\middle\\vert{").concat(a, "}\\right\\rangle") : r || s ? "\\langle{".concat(n, "}\\vert") : "\\left\\langle{".concat(n, "}\\right\\vert{").concat(a, "}"), t.Push(new i.default(d, t.stack.env, t.configuration).mml());
        }, p.Ket = function (t, e) {
          var r = t.GetStar(),
            n = t.GetArgument(e),
          ...
          var o = "";
          o = null == a ? r ? "\\langle{".concat(n, "}\\vert{").concat(n, "}\\rangle") : "\\left\\langle{".concat(n, "}\\middle\\vert{").concat(n, "}\\right\\rangle") : r ? "\\langle{".concat(n, "}\\vert{").concat(a, "}\\rangle") : "\\left\\langle{".concat(n, "}\\middle\\vert{").concat(a, "}\\right\\rangle"), t.Push(new i.default(o, t.stack.env, t.configuration).mml());
          ...
          "{" === t.GetNext() && (a = t.GetArgument(e, !0));
          var o = "";
          o = null == a ? r ? "\\vert{".concat(n, "}\\rangle\\!\\langle{").concat(n, "}\\vert") : "\\left\\vert{".concat(n, "}\\middle\\rangle\\!\\middle\\langle{").concat(n, "}\\right\\vert") : r ? "\\vert{".concat(n, "}\\rangle\\!\\langle{").concat(a, "}\\vert") : "\\left\\vert{".concat(n, "}\\middle\\rangle\\!\\middle\\langle{").concat(a, "}\\right\\vert"), t.Push(new i.default(o, t.stack.env, t.configuration).mml());
          ...
          var s = a && o ? w([o, a, o], r, n) : r ? "\\langle {".concat(a, "} \\rangle") : "\\left\\langle {".concat(a, "} \\right\\rangle");
          ...
          var c = (s ? "\\left" : "") + s + "\\begin{" + a + "}{} " + o + "\\end{" + a + "}" + (s ? "\\right" : "") + l;
          ...
          var r = t.GetStar(),
            ...
            i = parseInt(a, 10),
            l = parseInt(o, 10);
          if (isNaN(i) || isNaN(l) || l.toString() !== o || i.toString() !== a) throw new s.default("InvalidNumber", "Invalid number");
          ...
          if ("{" === t.GetNext()) {
            ...
            t.string = function (t, e) {
              for (var r = t.length, n = [], a = 0; a < r; a++) n.push(Array(e ? r - a : a + 1).join("&") + "\\mqty{" + t[a] + "}");
              return n.join("\\\\ ");
            }(o, r) + t.string.slice(a), t.i = 0;
          }
        }, p.AutoClose = function (t, e, r) {
          var n = t.create("token", "mo", {
              stretchy: !1
            }, e),
            a = t.itemFactory.create("mml", n).setProperties({
              autoclose: e
            });
          t.Push(a);
      ...
      2778: function (t, e, r) {
        ...
        function v(t, e) {
          ...
          if (!(n.hasOwnProperty(a) ? n[a] : n.hasOwnProperty(e) ? n[e] : r.defaultAllow)) throw new c.default("BadRequire", 'Extension "%1" is not allowed to be loaded', a);
          d.Package.packages.has(a) ? g(t.configuration.packageData.get("require").jax, a) : f.mathjax.retryAfter(p.Loader.load(a));
        }
        e.RequireLoad = v, e.RequireMethods = {
      ...
      1596: function (t, e, r) {
        ...
        e.SetOptionsUtil = {
          ...
          filterOption: function (t, e, r) {
            ...
            if (!1 === i || null === i && !a.allowOptionsDefault) throw new s.default("OptionNotSettable", 'Option "%1" is not allowed to be set', r);
        ...
        var p = new i.CommandMap("setoptions", {
        ...
        e.SetOptionsConfiguration = o.Configuration.create("setoptions", {
          ...
          config: function (t, e) {
            ...
            r && (p.add("Require", new c.Macro("Require", r._func)), p.add("require", new c.Macro("require", u.default.Macro, ["\\Require{#2}\\setOptions[#2]{#1}", 2, ""])));
          },
          priority: 3,
          options: {
            setoptions: {
      ...
      5941: function (t, e, r) {
        ...
        function l(t, e) {
          ...
          var n = function (t) {
              ...
              return a(r, t), r.prototype.formatNumber = function (t) {
        ...
        e.tagformatConfig = l, e.TagFormatConfiguration = o.Configuration.create("tagformat", {
          config: [l, 10],
          options: {
            tagformat: {
              number: function (t) {
      ...
      6832: function (t, e, r) {
        ...
        var a = r(5871),
          ...
          s = n(r(7398)),
          l = r(787);
        new a.CommandMap("textcomp-macros", {
      ...
      3762: function (t, e, r) {
        ...
        function d(t, e, r, n) {
          ...
          return t instanceof c.TextParser || (a.texParser = t), [new c.TextParser(e, n ? {
            mathvariant: n
          } : {}, a.parseOptions, r).mml()];
        }
        r(5557), e.TextBaseConfiguration = o.Configuration.create("text-base", {
          parser: "text",
          handler: {
      ...
      5557: function (t, e, r) {
        ...
        new n.MacroMap("text-special", {
          ...
          "`": "OpenQuote",
          "'": "CloseQuote"
        }, o.TextMacrosMethods), new n.CommandMap("text-macros", {
          "(": "Math",
          $: "SelfQuote",
          _: "SelfQuote",
          "%": "SelfQuote",
      ...
      4807: function (t, e, r) {
        ...
        e.TextMacrosMethods = {
          ...
          Math: function (t, e) {
            t.saveText();
            for (var r, n, o = t.i, i = 0; n = t.GetNext();) switch (r = t.i++, n) {
              case "\\":
                ")" === t.GetCS() && (n = "\\(");
              case "$":
                if (0 === i && e === n) {
                  var s = t.texParser.configuration,
                    l = new a.default(t.string.substr(o, r - o), t.stack.env, s).mml();
      ...
      787: function (t, e, r) {
        ...
        var c = l(r(2193)),
          ...
          h = function (t) {
            ...
            return a(e, t), Object.defineProperty(e.prototype, "texParser", {
              get: function () {
              ...
              if (this.text) {
                var t = this.stack.env.mathvariant,
                  e = d.default.internalText(this, this.text, t ? {
                    mathvariant: t
                  } : {});
              ...
              e instanceof m.StyleItem ? this.stack.env.mathcolor = this.stack.env.color : e instanceof p.AbstractMmlNode && (this.addAttributes(e), this.nodes.push(e));
      ...
      5376: function (t, e, r) {
        ...
        e.UnicodeMethods.Unicode = function (t, e) {
          var r = t.GetBrackets(e),
            n = null,
            a = null;
          r && (r.replace(/ /g, "").match(/^(\d+(\.\d*)?|\.\d+),(\d+(\.\d*)?|\.\d+)$/) ? (n = r.replace(/ /g, "").split(/,/), a = t.GetBrackets(e)) : a = r);
          var i = s.default.trimSpaces(t.GetArgument(e)).replace(/^0x/, "x");
          if (!i.match(/^(x[0-9A-Fa-f]+|[0-9]+)$/)) throw new o.default("BadUnicode", "Argument to \\unicode must be a number");
          var d = parseInt(i.match(/^x/) ? "0" + i : i);
          u[d] ? a || (a = u[d][2]) : u[d] = [800, 200, a, d], n && (u[d][0] = Math.floor(1e3 * parseFloat(n[0])), u[d][1] = Math.floor(1e3 * parseFloat(n[1])));
          var p = t.stack.env.font,
            f = {};
          a ? (u[d][2] = f.fontfamily = a.replace(/'/g, "'"), p && (p.match(/bold/) && (f.fontweight = "bold"), p.match(/italic|-mathit/) && (f.fontstyle = "italic"))) : p && (f.mathvariant = p);
          var m = t.create("token", "mtext", f, (0, c.numeric)(i));
          l.default.setProperty(m, "unicode", !0), t.Push(m);
        }, new i.CommandMap("unicode", {
          unicode: "Unicode"
        }, e.UnicodeMethods), e.UnicodeConfiguration = a.Configuration.create("unicode", {
          handler: {
            macro: ["unicode"]
          }
        });
      ...
      7927: function (t, e, r) {
        ...
        var n = r(251),
          a = r(5871),
          o = r(6108);
        new a.CharacterMap("upgreek", function (t, e) {
          var r = e.attributes || {};
      ...
      8768: function (t, e, r) {
        ...
        e.VerbMethods = {}, e.VerbMethods.Verb = function (t, e) {
          ...
          verb: "Verb"
        }, e.VerbMethods), e.VerbConfiguration = a.Configuration.create("verb", {
          handler: {
            macro: ["verb"]
          }
        });
      ...
      251: function (t, e) {
        Object.defineProperty(e, "__esModule", {
          value: !0
        }), e.Configuration = MathJax._.input.tex.Configuration.Configuration, e.ConfigurationHandler = MathJax._.input.tex.Configuration.ConfigurationHandler, e.ParserConfiguration = MathJax._.input.tex.Configuration.ParserConfiguration;
      },
      2348: function (t, e) {
        Object.defineProperty(e, "__esModule", {
          value: !0
      ...
      1076: function (t, e) {
        Object.defineProperty(e, "__esModule", {
          value: !0
        }), e.MmlStack = MathJax._.input.tex.StackItem.MmlStack, e.BaseItem = MathJax._.input.tex.StackItem.BaseItem;
      },
      4924: function (t, e) {
        Object.defineProperty(e, "__esModule", {
          value: !0
        }), e.Symbol = MathJax._.input.tex.Symbol.Symbol, e.Macro = MathJax._.input.tex.Symbol.Macro;
      },
      5871: function (t, e) {
        Object.defineProperty(e, "__esModule", {
          value: !0
        }), e.parseResult = MathJax._.input.tex.SymbolMap.parseResult, e.AbstractSymbolMap = MathJax._.input.tex.SymbolMap.AbstractSymbolMap, e.RegExpMap = MathJax._.input.tex.SymbolMap.RegExpMap, e.AbstractParseMap = MathJax._.input.tex.SymbolMap.AbstractParseMap, e.CharacterMap = MathJax._.input.tex.SymbolMap.CharacterMap, e.DelimiterMap = MathJax._.input.tex.SymbolMap.DelimiterMap, e.MacroMap = MathJax._.input.tex.SymbolMap.MacroMap, e.CommandMap = MathJax._.input.tex.SymbolMap.CommandMap, e.EnvironmentMap = MathJax._.input.tex.SymbolMap.EnvironmentMap;
      },
      4680: function (t, e) {
        Object.defineProperty(e, "__esModule", {
          value: !0
        }), e.Label = MathJax._.input.tex.Tags.Label, e.TagInfo = MathJax._.input.tex.Tags.TagInfo, e.AbstractTags = MathJax._.input.tex.Tags.AbstractTags, e.NoTags = MathJax._.input.tex.Tags.NoTags, e.AllTags = MathJax._.input.tex.Tags.AllTags, e.TagsFactory = MathJax._.input.tex.Tags.TagsFactory;
      },
      6108: function (t, e) {
        Object.defineProperty(e, "__esModule", {
          value: !0
      ...
      4652: function (t, e) {
        ...
        function n(t) {
          ...
          for (e in t) for (r in t[e]) for (a = t[e][r].stateArray || [], o = 0; o < a.length; o++) {
            var i = t[e][r];
            i.action_ = [].concat(i.action_);
            for (var s = 0; s < i.action_.length; s++) "string" == typeof i.action_[s] && (i.action_[s] = {
              type_: i.action_[s]
            });
            for (var l = e.split("|"), c = 0; c < l.length; c++) if ("*" === a[o]) {
              var u = void 0;
              for (u in n) n[u].push({
                pattern: l[c],
                task: i
        ...
        var a = {
                ...
                t: for (var u = 0; u < c.length; u++) {
                  ...
                  if (d) {
                    for (var p = c[u].task, f = 0; f < p.action_.length; f++) {
                      var m = void 0;
                      if (l.actions[p.action_[f].type_]) m = l.actions[p.action_[f].type_](o, d.match_, p.action_[f].option);else {
                        if (!a.actions[p.action_[f].type_]) throw ["MhchemBugA", "mhchem bug A. Please report. (" + p.action_[f].type_ + ")"];
            ...
            patterns: {
              ...
              findObserveGroups: function (t, e, r, n, a, o, i, s, l, c) {
                ...
                return {
                  match_: f,
                  remainder: t.substr(p.endMatchEnd)
                };
              },
              match_: function (t, e) {
              ...
              ce: {
                ...
                actions: {
                  ...
                  "- after o/d": function (t, e, r) {
                    ...
                    var c = [];
                    return l ? (a.concatArray(c, this.output(t)), c.push({
                      type_: "hyphen"
                    })) : (n = a.patterns.match_("digits", t.d || ""), r && n && "" === n.remainder ? (a.concatArray(c, a.actions["d="](t, e)), a.concatArray(c, this.output(t))) : (a.concatArray(c, this.output(t)), a.concatArray(c, a.actions.bond(t, e, "-")))), c;
                  },
                  "a to o": function (t) {
                    t.o = t.a, t.a = void 0;
                  },
                  ...
                  output: function (t, e, r) {
                    ...
                    if (t.r) {
                      var o = void 0;
                      o = "M" === t.rdt ? a.go(t.rd, "tex-math") : "T" === t.rdt ? [{
                        type_: "text",
                        p1: t.rd || ""
                      }] : a.go(t.rd, "ce");
                      var i = void 0;
                      ...
                      type_: "entitySkip"
                    }), t.o || t.q || t.d || t.b || t.p || 2 === r ? t.o || t.q || t.d || !t.b && !t.p ? t.o && "kv" === t.dType && a.patterns.match_("d-oxidation$", t.d || "") ? t.dType = "oxidation" : t.o && "kv" === t.dType && !t.q && (t.dType = void 0) : (t.o = t.a, t.d = t.b, t.q = t.p, t.a = t.b = t.p = void 0) : (t.o = t.a, t.a = void 0), n.push({
                      type_: "chemfive",
                      a: a.go(t.a, "a"),
                      b: a.go(t.b, "bd"),
                      p: a.go(t.p, "pq"),
              ...
              pu: {
                ...
                actions: {
                  enumber: function (t, e) {
                    var r = [];
                    return "+-" === e[0] || "+/-" === e[0] ? r.push("\\pm ") : e[0] && r.push(e[0]), e[1] && (a.concatArray(r, a.go(e[1], "pu-9,9")), e[2] && (e[2].match(/[,.]/) ? a.concatArray(r, a.go(e[2], "pu-9,9")) : r.push(e[2])), (e[3] || e[4]) && ("e" === e[3] || "*" === e[4] ? r.push({
                      type_: "cdot"
                    }) : r.push({
                      type_: "times"
                    }))), e[5] && r.push("10^{" + e[5] + "}"), r;
                  ...
                  "number^": function (t, e) {
                    var r = [];
                    return "+-" === e[0] || "+/-" === e[0] ? r.push("\\pm ") : e[0] && r.push(e[0]), a.concatArray(r, a.go(e[1], "pu-9,9")), r.push("^{" + e[2] + "}"), r;
                  },
                  operator: function (t, e, r) {
                    return {
                      type_: "operator",
                ...
                actions: {
                  ...
                  output: function (t) {
                    ...
                    if (t.rm) {
                      ...
                      e = r && "" === r.remainder ? a.go(r.match_, "pu") : {
                        type_: "rm",
                        p1: t.rm
                      };
                    }
            ...
            _go2: function (t) {
              ...
              switch (t.type_) {
                ...
                case "state of aggregation subscript":
                  ...
                  break;
                case "bond":
                  if (!(e = o._getBond(t.kind_))) throw ["MhchemErrorBond", "mhchem Error. Unknown bond type (" + t.kind_ + ")"];
                  break;
                case "frac":
  ...
  !function () {
      ...
      _: {
        input: {
          tex: {
            AllPackages: n,
            autoload: {
              AutoloadConfiguration: a
            },
            require: {
              RequireConfiguration: o
            }
          }
        }
      }
    ...
    MathJax.loader && MathJax.loader.preLoad("[tex]/autoload", "[tex]/require"), function () {
      ...
      if (MathJax.startup) {
        ...
        MathJax.config.tex.packages = t, r && (0, s.insert)(MathJax.config.tex, {
          packages: r
        });
      }
