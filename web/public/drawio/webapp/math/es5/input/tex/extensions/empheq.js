...
!function () {
      ...
      79: function (e, t, a) {
        ...
        var p = a(251),
          ...
          d = function (e) {
            ...
            return i(t, e), Object.defineProperty(t.prototype, "kind", {
              get: function () {
                return "empheq-begin";
              },
              enumerable: !1,
        ...
        t.EmpheqBeginItem = d, t.EmpheqMethods = {
          Empheq: function (e, t) {
            if (e.stack.env.closing === t.getName()) {
              ...
              var n = e.GetBrackets("\\begin{" + t.getName() + "}") || "",
                r = o((e.GetArgument("\\begin{" + t.getName() + "}") || "").split(/=/), 2),
                i = r[0],
                l = r[1];
              if (!c.EmpheqUtil.checkEnv(i)) throw new s.default("UnknownEnv", 'Unknown environment "%1"', i);
              n && t.setProperties(c.EmpheqUtil.splitOptions(n, {
                left: 1,
                right: 1
              })), e.stack.global.empheq = i, e.string = "\\begin{" + i + "}" + (l ? "{" + l + "}" : "") + e.string.slice(e.i), e.i = 0, e.Push(t);
            }
          },
        ...
        }, new m.EnvironmentMap("empheq-env", c.EmpheqUtil.environment, {
          empheq: ["Empheq", "empheq"]
        }, t.EmpheqMethods), new m.CommandMap("empheq-macros", {
        ...
        }, t.EmpheqMethods), t.EmpheqConfiguration = p.Configuration.create("empheq", {
          handler: {
            macro: ["empheq-macros"],
      ...
      301: function (e, t, a) {
        var n = this && this.__read || function (e, t) {
          ...
          r = this && this.__spreadArray || function (e, t, a) {
            if (a || 2 === arguments.length) for (var n, r = 0, i = t.length; r < i; r++) !n && r in t || (n || (n = Array.prototype.slice.call(t, 0, r)), n[r] = t[r]);
        ...
        t.EmpheqUtil = {
          environment: function (e, t, a, i) {
            var o = i[0],
              l = e.itemFactory.create(o + "-begin").setProperties({
                name: t,
                end: o
              });
          ...
          cellBlock: function (e, t, a, n) {
            ...
            return l.appendChild(a.create("node", "mphantom", [a.create("node", "mpadded", [t], {
              width: 0
            })])), l;
          },
          topRowTable: function (e, t) {
            var a = l.default.copyNode(e, t);
            return a.setChildren(a.childNodes.slice(0, 1)), a.attributes.set("align", "baseline 1"), e.factory.create("mphantom", {}, [t.create("node", "mpadded", [a], {
              width: 0
            })]);
          },
          ...
          left: function (e, t, a, n, r) {
            var o, l, p;
            void 0 === r && (r = ""), e.attributes.set("columnalign", "right " + (e.attributes.get("columnalign") || "")), e.attributes.set("columnspacing", "0em " + (e.attributes.get("columnspacing") || ""));
            try {
              for (var m = i(e.childNodes.slice(0).reverse()), h = m.next(); !h.done; h = m.next()) {
                var s = h.value;
                p = n.create("node", "mtd"), s.childNodes.unshift(p), p.parent = s, s.isKind("mlabeledtr") && (s.childNodes[0] = s.childNodes[1], s.childNodes[1] = p);
              }
            } catch (e) {
              o = {
                error: e
          ...
          right: function (e, a, n, r, i) {
            ...
            for (var o = t.EmpheqUtil.columnCount(e), l = e.childNodes[0]; l.childNodes.length < o;) l.appendChild(r.create("node", "mtd"));
            var p = l.appendChild(r.create("node", "mtd"));
            t.EmpheqUtil.rowspanCell(p, n, a, r, i), e.attributes.set("columnalign", (e.attributes.get("columnalign") || "").split(/ /).slice(0, o).join(" ") + " left"), e.attributes.set("columnspacing", (e.attributes.get("columnspacing") || "").split(/ /).slice(0, o - 1).join(" ") + " 0em");
          },
  ...
  e = o(955), t = o(667), a = o(79), n = o(301), MathJax.loader && MathJax.loader.checkVersion("[tex]/empheq", t.q, "tex-extension"), (0, e.r8)({
    _: {
      input: {
        tex: {
          empheq: {
            EmpheqConfiguration: a,
            EmpheqUtil: n
          }
        }
      }
