...
!function () {
    ...
    o = {
        ...
        var i = a(76),
          ...
          u = function (t) {
            ...
            return n(e, t), Object.defineProperty(e.prototype, "kind", {
              ...
              var o = c.default.fenced(this.factory.configuration, this.getProperty("open"), t.prototype.toMml.call(this), this.getProperty("close"), this.getProperty("big"));
              ...
              return r && r === this.getProperty("close") && !this.openCount-- ? this.getProperty("ignore") ? (this.Clear(), [[], !0]) : [[this.toMml()], !0] : t.prototype.checkItem.call(this, e);
      ...
      842: function (t, e, a) {
        ...
        new n.CommandMap("Physics-automatic-bracing-macros", {
          ...
          pb: ["Commutator", "\\{", "\\}"]
        }, o.default), new n.CharacterMap("Physics-vector-mo", c.default.mathchar0mo, {
          dotproduct: ["\u22c5", {
        ...
        }, o.default), new n.CommandMap("Physics-expressions-macros", {
          sin: "Expression",
          sinh: "Expression",
          arcsin: "Expression",
          asin: "Expression",
        ...
        }, o.default), new n.CommandMap("Physics-quick-quad-macros", {
          qqtext: "Qqtext",
          qq: "Qqtext",
          qcomma: ["Macro", "\\qqtext*{,}"],
          qc: ["Macro", "\\qqtext*{,}"],
          ...
          qas: ["Qqtext", "as"],
          qin: ["Qqtext", "in"]
        }, o.default), new n.CommandMap("Physics-derivative-macros", {
          diffd: "DiffD",
        ...
        }, o.default), new n.CommandMap("Physics-bra-ket-macros", {
          bra: "Bra",
          ket: "Ket",
          innerproduct: "BraKet",
          ip: "BraKet",
          ...
          mel: "MatrixElement"
        }, o.default), new n.CommandMap("Physics-matrix-macros", {
        ...
        }, o.default), new n.EnvironmentMap("Physics-aux-envs", c.default.environment, {
          smallmatrix: ["Array", null, null, null, "c", "0.333em", ".2em", "S", 1]
        }, o.default), new n.MacroMap("Physics-characters", {
      ...
      458: function (t, e, a) {
        ...
        d.Quantity = function (t, e, a, r, n, o, m) {
          void 0 === a && (a = "("), void 0 === r && (r = ")"), void 0 === n && (n = !1), void 0 === o && (o = ""), void 0 === m && (m = "");
          var d = !!n && t.GetStar(),
            v = t.GetNext(),
            h = t.i,
            g = null;
          ...
          if ("{" === v) {
            ...
            return v = n ? a : "\\{", M = n ? r : "\\}", b = d ? v + " " + b + " " + M : g ? "\\" + g + "l" + v + " " + b + " \\" + g + "r" + M : "\\left" + v + " " + b + " \\right" + M, void t.Push(new i.default(b, t.stack.env, t.configuration).mml());
          }
          n && (v = a, M = r), t.i++, t.Push(t.itemFactory.create("auto open").setProperties({
            open: v,
            close: M,
            big: g
          }));
          ...
          var a = t.GetStar(),
            r = t.GetNext();
          if ("{" !== r) {
            if ("(" === r || "[" === r) return t.i++, void t.Push(t.itemFactory.create("auto open").setProperties({
              open: r,
              close: "|",
              smash: a,
              right: "\\vphantom{\\int}"
          ...
          var n = t.GetStar(),
            ...
            s = null;
          if ("\\" === o) {
            if (t.i++, !(s = t.GetCS()).match(p)) throw new c.default("MissingArgFor", "Missing argument for %1", t.currentCS);
            o = t.GetNext();
          }
          if ("{" !== o) throw new c.default("MissingArgFor", "Missing argument for %1", t.currentCS);
          var l = t.GetArgument(e) + "," + t.GetArgument(e);
          l = n ? a + " " + l + " " + r : s ? "\\" + s + "l" + a + " " + l + " \\" + s + "r" + r : "\\left" + a + " " + l + " \\right" + r, t.Push(new i.default(l, t.stack.env, t.configuration).mml());
        };
        var v = [65, 90],
          h = [97, 122],
          g = [913, 937],
        ...
        function b(t, e, a, r) {
          var n = t.configuration.parser,
            ...
            i = r.codePointAt(0);
          return 1 === r.length && !n.stack.env.font && n.stack.env.vectorFont && (y(i, v) || y(i, h) || y(i, g) || y(i, M) || y(i, x) && n.stack.env.vectorStar || u.default.getAttribute(o, "accent")) && u.default.setAttribute(o, "mathvariant", n.stack.env.vectorFont), o;
        }
        d.VectorBold = function (t, e) {
          var a = t.GetStar(),
            ...
            o = t.stack.env.font;
          delete t.stack.env.font, t.configuration.nodeFactory.set("token", b), t.stack.env.vectorFont = a ? "bold-italic" : "bold", t.stack.env.vectorStar = a;
          var c = new i.default(r, t.stack.env, t.configuration).mml();
          o && (t.stack.env.font = o), delete t.stack.env.vectorFont, delete t.stack.env.vectorStar, t.configuration.nodeFactory.set("token", n), t.Push(c);
          ...
          var s = r.join(o ? "*" : "");
          s = l.default.substituteArgs(t, i, s), t.string = l.default.addArgs(t, s, t.string.slice(t.i)), t.i = 0, l.default.checkMaxMacros(t);
        };
        var P = function (t, e, a, r, n) {
          ...
          if (s) {
            ...
            l && (t.i++, t.Push(t.itemFactory.create("auto open").setProperties({
              open: c,
              close: s
            })));
          }
        ...
        function A(t, e, a) {
          var n = r(t, 3),
            ...
            i = n[1],
            c = n[2];
          return e && a ? "\\left\\langle{".concat(o, "}\\middle\\vert{").concat(i, "}\\middle\\vert{").concat(c, "}\\right\\rangle") : e ? "\\langle{".concat(o, "}\\vert{").concat(i, "}\\vert{").concat(c, "}\\rangle") : "\\left\\langle{".concat(o, "}\\right\\vert{").concat(i, "}\\left\\vert{").concat(c, "}\\right\\rangle");
        }
        d.OperatorApplication = function (t, e, a) {
          ...
          if (o || c) {
            ...
            } else t.Push(new i.default(l, t.stack.env, t.configuration).mml()), t.i++, t.Push(t.itemFactory.create("auto open").setProperties({
              open: "(",
              close: ")"
            }));
          } else {
          ...
          var l = !1,
            u = " ",
            m = " ";
          a > 2 && s.length > 2 ? (u = "^{" + (s.length - 1) + "}", l = !0) : null != o && (a > 2 && s.length > 1 && (l = !0), m = u = "^{" + o + "}");
          for (var d = n ? "\\flatfrac" : "\\frac", f = s.length > 1 ? s[0] : "", p = s.length > 1 ? s[1] : s[0], v = "", h = 2, g = void 0; g = s[h]; h++) v += r + " " + g;
          var x = d + "{" + r + u + f + "}{" + r + " " + p + m + " " + v + "}";
          t.Push(new i.default(x, t.stack.env, t.configuration).mml()), "(" === t.GetNext() && (t.i++, t.Push(t.itemFactory.create("auto open").setProperties({
            open: "(",
            close: ")",
            ignore: l
          })));
          ...
          if ("\\" === t.GetNext()) {
            ...
            var l = t.GetCS(),
              u = t.lookup("macro", l);
            u && "ket" === u.symbol ? (o = !0, s = t.i, c = t.GetStar(), "{" === t.GetNext() ? n = t.GetArgument(l, !0) : (t.i = s, c = !1)) : t.i = s;
          }
          var m = "";
          m = o ? a || c ? "\\langle{".concat(r, "}\\vert{").concat(n, "}\\rangle") : "\\left\\langle{".concat(r, "}\\middle\\vert{").concat(n, "}\\right\\rangle") : a || c ? "\\langle{".concat(r, "}\\vert") : "\\left\\langle{".concat(r, "}\\right\\vert{").concat(n, "}"), t.Push(new i.default(m, t.stack.env, t.configuration).mml());
        }, d.Ket = function (t, e) {
          var a = t.GetStar(),
            r = t.GetArgument(e),
          ...
          var o = "";
          o = null == n ? a ? "\\langle{".concat(r, "}\\vert{").concat(r, "}\\rangle") : "\\left\\langle{".concat(r, "}\\middle\\vert{").concat(r, "}\\right\\rangle") : a ? "\\langle{".concat(r, "}\\vert{").concat(n, "}\\rangle") : "\\left\\langle{".concat(r, "}\\middle\\vert{").concat(n, "}\\right\\rangle"), t.Push(new i.default(o, t.stack.env, t.configuration).mml());
          ...
          "{" === t.GetNext() && (n = t.GetArgument(e, !0));
          var o = "";
          o = null == n ? a ? "\\vert{".concat(r, "}\\rangle\\!\\langle{").concat(r, "}\\vert") : "\\left\\vert{".concat(r, "}\\middle\\rangle\\!\\middle\\langle{").concat(r, "}\\right\\vert") : a ? "\\vert{".concat(r, "}\\rangle\\!\\langle{").concat(n, "}\\vert") : "\\left\\vert{".concat(r, "}\\middle\\rangle\\!\\middle\\langle{").concat(n, "}\\right\\vert"), t.Push(new i.default(o, t.stack.env, t.configuration).mml());
          ...
          var c = n && o ? A([o, n, o], a, r) : a ? "\\langle {".concat(n, "} \\rangle") : "\\left\\langle {".concat(n, "} \\right\\rangle");
          ...
          var a = t.GetStar(),
            ...
            i = parseInt(n, 10),
            s = parseInt(o, 10);
          if (isNaN(i) || isNaN(s) || s.toString() !== o || i.toString() !== n) throw new c.default("InvalidNumber", "Invalid number");
          ...
          if ("{" === t.GetNext()) {
            ...
            t.string = function (t, e) {
              for (var a = t.length, r = [], n = 0; n < a; n++) r.push(Array(e ? a - n : n + 1).join("&") + "\\mqty{" + t[n] + "}");
              return r.join("\\\\ ");
            }(o, a) + t.string.slice(n), t.i = 0;
          }
        }, d.AutoClose = function (t, e, a) {
          var r = t.create("token", "mo", {
              stretchy: !1
            }, e),
            n = t.itemFactory.create("mml", r).setProperties({
              autoclose: e
            });
          t.Push(n);
  ...
  t = c(955), e = c(667), a = c(996), r = c(855), n = c(458), MathJax.loader && MathJax.loader.checkVersion("[tex]/physics", e.q, "tex-extension"), (0, t.r8)({
    _: {
      input: {
        tex: {
          physics: {
