    ...
    n = {
      ...
      78: function (t, e, o) {
        ...
        var a = o(251),
          ...
          u = o(652),
          s = {};
        s.Macro = p.default.Macro, s.xArrow = c.AmsMethods.xArrow, s.Machine = function (t, e, o) {
          var n,
            a = t.GetArgument(e);
          try {
        ...
        }, s), e.MhchemConfiguration = a.Configuration.create("mhchem", {
          handler: {
            macro: ["mhchem"]
          }
        });
      ...
      652: function (t, e) {
        ...
        function n(t) {
          var e,
            o,
            n = {};
          for (e in t) for (o in t[e]) {
            var a = o.split("|");
            t[e][o].stateArray = a;
            for (var r = 0; r < a.length; r++) n[a[r]] = [];
          }
          for (e in t) for (o in t[e]) for (a = t[e][o].stateArray || [], r = 0; r < a.length; r++) {
            var i = t[e][o];
            i.action_ = [].concat(i.action_);
            for (var p = 0; p < i.action_.length; p++) "string" == typeof i.action_[p] && (i.action_[p] = {
              type_: i.action_[p]
            });
            for (var c = e.split("|"), u = 0; u < c.length; u++) if ("*" === a[r]) {
              var s = void 0;
              for (s in n) n[s].push({
                pattern: c[u],
                task: i
        ...
        var a = {
                ...
                t: for (var s = 0; s < u.length; s++) {
                  ...
                  if (_) {
                    for (var d = u[s].task, m = 0; m < d.action_.length; m++) {
                      var h = void 0;
                      if (c.actions[d.action_[m].type_]) h = c.actions[d.action_[m].type_](r, _.match_, d.action_[m].option);else {
            ...
            concatArray: function (t, e) {
              if (e) if (Array.isArray(e)) for (var o = 0; o < e.length; o++) t.push(e[o]);else t.push(e);
            },
            patterns: {
              patterns: {
                empty: /^$/,
              ...
              match_: function (t, e) {
                ...
                if (void 0 === o) throw ["MhchemBugP", "mhchem bug P. Please report. (" + t + ")"];
            ...
            actions: {
              ...
              "1/2": function (t, e) {
                ...
                return n[1] = n[1].replace(/\$/g, ""), o.push({
                  type_: "frac",
                  p1: n[1],
                  p2: n[2]
                }), n[3] && (n[3] = n[3].replace(/\$/g, ""), o.push({
                  type_: "tex-math",
                  p1: n[3]
                })), o;
              },
                ...
                actions: {
                  "o after d": function (t, e) {
                    ...
                    if ((t.d || "").match(/^[1-9][0-9]*$/)) {
                      var n = t.d;
                      t.d = void 0, (o = this.output(t)).push({
                        type_: "tinySkip"
                      }), t.b = n;
                  ...
                  "- after o/d": function (t, e, o) {
                    ...
                    var u = [];
                    return c ? (a.concatArray(u, this.output(t)), u.push({
                      type_: "hyphen"
                    })) : (n = a.patterns.match_("digits", t.d || ""), o && n && "" === n.remainder ? (a.concatArray(u, a.actions["d="](t, e)), a.concatArray(u, this.output(t))) : (a.concatArray(u, this.output(t)), a.concatArray(u, a.actions.bond(t, e, "-")))), u;
                  },
                  "a to o": function (t) {
                    t.o = t.a, t.a = void 0;
                  },
                  ...
                  output: function (t, e, o) {
                    ...
                    } else n = [], (t.a || t.b || t.p || t.o || t.q || t.d || o) && (t.sb && n.push({
                      type_: "entitySkip"
                    }), t.o || t.q || t.d || t.b || t.p || 2 === o ? t.o || t.q || t.d || !t.b && !t.p ? t.o && "kv" === t.dType && a.patterns.match_("d-oxidation$", t.d || "") ? t.dType = "oxidation" : t.o && "kv" === t.dType && !t.q && (t.dType = void 0) : (t.o = t.a, t.d = t.b, t.q = t.p, t.a = t.b = t.p = void 0) : (t.o = t.a, t.a = void 0), n.push({
                      type_: "chemfive",
                      a: a.go(t.a, "a"),
                      b: a.go(t.b, "bd"),
                      p: a.go(t.p, "pq"),
                    ...
                    for (var p in t) "parenthesisLevel" !== p && "beginsWithBond" !== p && delete t[p];
                    return n;
                  },
              ...
              pu: {
                ...
                actions: {
                  enumber: function (t, e) {
                    var o = [];
                    return "+-" === e[0] || "+/-" === e[0] ? o.push("\\pm ") : e[0] && o.push(e[0]), e[1] && (a.concatArray(o, a.go(e[1], "pu-9,9")), e[2] && (e[2].match(/[,.]/) ? a.concatArray(o, a.go(e[2], "pu-9,9")) : o.push(e[2])), (e[3] || e[4]) && ("e" === e[3] || "*" === e[4] ? o.push({
                      type_: "cdot"
                    }) : o.push({
                      type_: "times"
                    }))), e[5] && o.push("10^{" + e[5] + "}"), o;
                  ...
                  "number^": function (t, e) {
                    var o = [];
                    return "+-" === e[0] || "+/-" === e[0] ? o.push("\\pm ") : e[0] && o.push(e[0]), a.concatArray(o, a.go(e[1], "pu-9,9")), o.push("^{" + e[2] + "}"), o;
                  },
                  operator: function (t, e, o) {
                    return {
                      type_: "operator",
                ...
                actions: {
                  ...
                  "output-o": function (t) {
                    ...
                    if (t.text_ = t.text_ || "", t.text_.length > 4) {
                      var o = t.text_.length - 3,
                        n = void 0;
                      for (n = 0; n < o; n += 3) e.push(t.text_.substr(n, 3)), e.push({
                        type_: "1000 separator"
                      });
              ...
              switch (t.type_) {
                ...
                case "arrow":
                  var i = {
                    ...
                    p = r._getArrow(t.r);
                  i.rd || i.rq ? "<=>" === t.r || "<=>>" === t.r || "<<=>" === t.r || "<--\x3e" === t.r ? (p = "\\long" + p, i.rd && (p = "\\overset{" + i.rd + "}{" + p + "}"), i.rq && (p = "<--\x3e" === t.r ? "\\underset{\\lower2mu{" + i.rq + "}}{" + p + "}" : "\\underset{\\lower6mu{" + i.rq + "}}{" + p + "}"), p = " {}\\mathrel{" + p + "}{} ") : (i.rq && (p += "[{" + i.rq + "}]"), p = " {}\\mathrel{\\x" + (p += "{" + i.rd + "}") + "}{} ") : p = " {}\\mathrel{\\long" + p + "}{} ", e = p;
                  break;
                case "operator":
