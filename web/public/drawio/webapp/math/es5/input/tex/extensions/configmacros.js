...
!function () {
    ...
    n = {
      ...
      359: function (t, a, e) {
        ...
        a.ConfigMacrosConfiguration = r.Configuration.create("configmacros", {
          init: function (t) {
            new l.CommandMap(x, {}, {}), new l.EnvironmentMap(f, s.default.environment, {}, {}), t.append(r.Configuration.local({
              handler: {
                macro: [x],
                environment: [f]
              },
              ...
              try {
                for (var r = o(Object.keys(i)), p = r.next(); !p.done; p = r.next()) {
                  var l = p.value,
                    ...
                    M = Array.isArray(s[2]) ? new u.Macro(l, c.default.MacroWithTemplate, s.slice(0, 2).concat(s[2])) : new u.Macro(l, c.default.Macro, s);
                  n.add(l, M);
                }
              } catch (t) {
                a = {
      ...
      924: function (t, a) {
        Object.defineProperty(a, "__esModule", {
          value: !0
        }), a.Symbol = MathJax._.input.tex.Symbol.Symbol, a.Macro = MathJax._.input.tex.Symbol.Macro;
      },
      871: function (t, a) {
        Object.defineProperty(a, "__esModule", {
          value: !0
  ...
  t = i(955), a = i(667), e = i(359), MathJax.loader && MathJax.loader.checkVersion("[tex]/configmacros", a.q, "tex-extension"), (0, t.r8)({
    _: {
      input: {
        tex: {
          configmacros: {
            ConfigMacrosConfiguration: e
          }
        }
      }
    }
