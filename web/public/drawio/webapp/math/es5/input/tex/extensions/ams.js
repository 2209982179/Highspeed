...
!function () {
    ...
    i = {
      ...
      577: function (t, e, a) {
        ...
        e.AmsConfiguration = l.Configuration.create("ams", {
          ...
          items: (n = {}, n[o.MultlineItem.prototype.kind] = o.MultlineItem, n[o.FlalignItem.prototype.kind] = o.FlalignItem, n),
          tags: {
            ams: d
          },
          init: function (t) {
            new m.CommandMap(u.NEW_OPS, {}, {}), t.append(l.Configuration.local({
              handler: {
                macro: [u.NEW_OPS]
              },
              priority: -1
      ...
      971: function (t, e, a) {
        var r,
          ...
          i = this && this.__assign || function () {
            return i = Object.assign || function (t) {
              for (var e, a = 1, r = arguments.length; a < r; a++) for (var n in e = arguments[a]) Object.prototype.hasOwnProperty.call(e, n) && (t[n] = e[n]);
              return t;
        ...
        var o = a(935),
          ...
          c = function (t) {
            ...
            return n(e, t), Object.defineProperty(e.prototype, "kind", {
              ...
              if (1 !== this.row.length) throw new m.default("MultlineRowsOneCol", "The rows within the %1 environment must have exactly one column", "multline");
              ...
              if (t.prototype.EndTable.call(this), this.table.length) {
                var e = this.table.length - 1,
                  a = -1;
                u.default.getAttribute(u.default.getChildren(this.table[0])[0], "columnalign") || u.default.setAttribute(u.default.getChildren(this.table[0])[0], "columnalign", d.TexConstant.Align.LEFT), u.default.getAttribute(u.default.getChildren(this.table[e])[0], "columnalign") || u.default.setAttribute(u.default.getChildren(this.table[e])[0], "columnalign", d.TexConstant.Align.RIGHT);
                var r = this.factory.configuration.tags.getTag();
                if (r) {
                  a = this.arraydef.side === d.TexConstant.Align.LEFT ? 0 : this.table.length - 1;
                  var n = this.table[a],
                    i = this.create("node", "mlabeledtr", [r].concat(u.default.getChildren(n)));
        ...
        var h = function (t) {
          ...
          return n(e, t), Object.defineProperty(e.prototype, "kind", {
            ...
            if (e && this.row.length > e) throw new m.default("XalignOverflow", "Extra %1 in row of %2", "&", this.name);
          }, e.prototype.EndRow = function () {
            for (var e, a = this.row, r = this.getProperty("xalignat"); a.length < r;) a.push(this.create("node", "mtd"));
            for (this.row = [], this.padded && this.row.push(this.create("node", "mtd")); e = a.shift();) this.row.push(e), (e = a.shift()) && this.row.push(e), (a.length || this.padded) && this.row.push(this.create("node", "mtd"));
      ...
      829: function (t, e, a) {
        var r = this && this.__createBinding || (Object.create ? function (t, e, a, r) {
            void 0 === r && (r = a);
          ...
          i = this && this.__importStar || function (t) {
            ...
            var e = {};
            if (null != t) for (var a in t) "default" !== a && Object.prototype.hasOwnProperty.call(t, a) && r(e, t, a);
            return n(e, t), e;
          },
          l = this && this.__importDefault || function (t) {
            return t && t.__esModule ? t : {
        ...
        }), new s.RegExpMap("AMSmath-operatorLetter", o.AmsMethods.operatorLetter, /[-*]/i), new s.CommandMap("AMSmath-macros", {
        ...
        }, o.AmsMethods), new s.EnvironmentMap("AMSmath-environment", m.default.environment, {
          "equation*": ["Equation", null, !1],
          "eqnarray*": ["EqnArray", null, !1, !0, "rcl", d.default.cols(0, h.MATHSPACE.thickmathspace), ".5em"],
        ...
        }, o.AmsMethods), new s.DelimiterMap("AMSmath-delimiter", m.default.delimiter, {
          "\\lvert": ["|", {
      ...
      16: function (t, e, a) {
        ...
        e.AmsMethods = {}, e.AmsMethods.AmsEqnArray = function (t, e, a, r, n, i, o) {
          ...
          var i,
            ...
            u = "",
            m = [];
          if (n || (o = t.GetBrackets("\\begin{" + s + "}")), (i = t.GetArgument("\\begin{" + s + "}")).match(/[^0-9]/)) throw new d.default("PositiveIntegerArg", "Argument to %1 must me a positive integer", "\\begin{" + s + "}");
          ...
          if (i.match(/[^0-9]/)) throw new d.default("PositiveIntegerArg", "Argument to %1 must me a positive integer", "\\begin{" + a.getName() + "}");
          var l = n ? "crl" : "rlc",
          ...
          void 0 === s && (s = !1), t.Push(e), l.default.checkEqnEnv(t), i = i.split("").join(" ").replace(/r/g, "right").replace(/l/g, "left").replace(/c/g, "center");
        ...
        }, e.NEW_OPS = "ams-declare-ops", e.AmsMethods.HandleDeclareOp = function (t, a) {
          var r = t.GetStar() ? "*" : "",
            n = l.default.trimSpaces(t.GetArgument(a));
          "\\" === n.charAt(0) && (n = n.substr(1));
          var i = t.GetArgument(a);
          t.configuration.handlers.retrieve(e.NEW_OPS).add(n, new c.Macro(n, e.AmsMethods.Macro, ["\\operatorname".concat(r, "{").concat(i, "}")]));
        }, e.AmsMethods.HandleOperatorName = function (t, e) {
          var a = t.GetStar(),
            n = l.default.trimSpaces(t.GetArgument(e)),
            i = new m.default(n, r(r({}, t.stack.env), {
          ...
          if ("\\" === r) {
            var n = t.i;
            r = t.GetArgument(e), t.i = n, "\\limits" === r && (a = "\\idotsint" === e ? "\\!\\!\\mathop{\\,\\," + a + "}" : "\\!\\!\\!\\mathop{\\,\\,\\," + a + "}");
          }
          ...
          if (s.default.setAttribute(f, "voffset", "-.2em"), s.default.setAttribute(f, "height", "-.2em"), s.default.setChild(h, h.over, f), o) {
            var g = new m.default(o, t.stack.env, t.configuration).mml(),
              M = t.create("node", "mspace", [], {
                height: ".75em"
              });
            f = t.create("node", "mpadded", [g, M], i), s.default.setAttribute(f, "voffset", ".15em"), s.default.setAttribute(f, "depth", "-.15em"), s.default.setChild(h, h.under, f);
          }
          s.default.setProperty(h, "subsupOK", !0), t.Push(h);
        }, e.AmsMethods.HandleShove = function (t, e, a) {
          var r = t.stack.Top();
          if ("multline" !== r.kind) throw new d.default("CommandOnlyAllowedInEnv", "%1 only allowed in %2 environment", t.currentCS, "multline");
          if (r.Size()) throw new d.default("CommandAtTheBeginingOfLine", "%1 must come at the beginning of the line", t.currentCS);
          ...
          if (null == (a = i[a])) throw new d.default("IllegalAlign", "Illegal alignment specified in %1", t.currentCS);
          a && s.default.setProperties(h, {
            numalign: a,
            denomalign: a
          }), t.Push(h);
        }, e.AmsMethods.Genfrac = function (t, e, a, r, n, i) {
          null == a && (a = t.GetDelimiterArg(e)), null == r && (r = t.GetDelimiterArg(e)), null == n && (n = t.GetArgument(e)), null == i && (i = l.default.trimSpaces(t.GetArgument(e)));
          var o = t.ParseArg(e),
            u = t.ParseArg(e),
            m = t.create("node", "mfrac", [o, u]);
          if ("" !== n && s.default.setAttribute(m, "linethickness", n), (a || r) && (s.default.setProperty(m, "withDelims", !0), m = l.default.fixedFence(t.configuration, a, m, r)), "" !== i) {
            var c = parseInt(i, 10),
              h = ["D", "T", "S", "SS"][c];
            if (null == h) throw new d.default("BadMathStyleFor", "Bad math style for %1", t.currentCS);
  ...
  t = o(955), e = o(667), a = o(577), r = o(971), n = o(16), MathJax.loader && MathJax.loader.checkVersion("[tex]/ams", e.q, "tex-extension"), (0, t.r8)({
    _: {
      input: {
        tex: {
          ams: {
