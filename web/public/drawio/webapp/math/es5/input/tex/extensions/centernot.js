...
!function () {
  ...
  var e,
    ...
    n = {
      ...
      286: function (e, t, a) {
        ...
        function c(e) {
          ...
          try {
            for (var o = n(r.getList("centerOver")), i = o.next(); !i.done; i = o.next()) {
              ...
              null !== p && u.default.setProperties(l.parent.parent.parent.parent.parent.parent, {
                texClass: p
              });
            }
          } catch (e) {
        ...
        new l.CommandMap("centernot", {
          ...
          CenterOver: function (e, t) {
            var a = "{" + e.GetArgument(t) + "}",
              ...
              o = e.create("node", "TeXAtom", [new i.default(a, e.stack.env, e.configuration).mml(), e.create("node", "mpadded", [e.create("node", "mpadded", [n], {
                width: 0,
                lspace: "-.5width"
        ...
        }), t.filterCenterOver = c, t.CenternotConfiguration = o.Configuration.create("centernot", {
          handler: {
            macro: ["centernot"]
          },
          postprocessors: [c]
  ...
  e = o(955), t = o(667), a = o(286), MathJax.loader && MathJax.loader.checkVersion("[tex]/centernot", t.q, "tex-extension"), (0, e.r8)({
    _: {
      input: {
        tex: {
          centernot: {
            CenternotConfiguration: a
          }
        }
      }
    }
