...
!function () {
    ...
    o = {
      ...
      48: function (e, t, n) {
        ...
        t.NewcommandConfiguration = l.Configuration.create("newcommand", {
          ...
          init: function (e) {
            new d.DelimiterMap(c.default.NEW_DELIMITER, s.default.delimiter, {}), new d.CommandMap(c.default.NEW_COMMAND, {}, {}), new d.EnvironmentMap(c.default.NEW_ENVIRONMENT, s.default.environment, {}, {}), e.append(l.Configuration.local({
              handler: {
                character: [],
        ...
        var o = i(n(402)),
          u = function (e) {
            ...
            return r(t, e), Object.defineProperty(t.prototype, "kind", {
              ...
              if (t.isKind("end")) {
                if (t.getName() !== this.getName()) throw new o.default("EnvBadEnd", "\\begin{%1} ended with \\end{%2}", this.getName(), t.getName());
                return [[this.factory.create("mml", this.toMml())], !0];
              }
              if (t.isKind("stop")) throw new o.default("EnvMissingEnd", "Missing \\end{%1}", this.getName());
          ...
          d = {
            ...
            MacroDef: function (e, t) {
              var n = s.default.GetCSname(e, t),
                ...
                r = e.GetArgument(t);
              a instanceof Array ? s.default.addMacro(e, n, d.MacroWithTemplate, [r].concat(a)) : s.default.addMacro(e, n, d.Macro, [r, a]);
            },
            Let: function (e, t) {
              var n = s.default.GetCSname(e, t),
                a = e.GetNext();
              ...
              if ("\\" !== a) {
                ...
                if (o) return void s.default.addDelimiter(e, "\\" + n, o.char, o.attributes);
                ...
                s.default.addMacro(e, n, function (e, t) {
            ...
            MacroWithTemplate: function (e, t, n, a) {
              ...
              if (o) {
                var l = [];
                if (e.GetNext(), r[0] && !s.default.MatchParam(e, r[0])) throw new u.default("MismatchUseDef", "Use of %1 doesn't match its definition", t);
                for (var f = 0; f < o; f++) l.push(s.default.GetParameter(e, t, r[f + 1]));
            ...
            BeginEnv: function (e, t, n, a, r, i) {
              if (t.getProperty("end") && e.stack.env.closing === t.getName()) {
                ...
                return e.string = a, e.i = 0, e.Parse(), e.string = o, e.i = 0, e.itemFactory.create("end").setProperty("name", t.getName());
              }
              if (r) {
                var u = [];
                if (null != i) {
                ...
                for (var f = u.length; f < r; f++) u.push(e.GetArgument("\\begin{" + t.getName() + "}"));
                n = c.default.substituteArgs(e, u, n), a = c.default.substituteArgs(e, [], a);
              }
              return e.string = c.default.addArgs(e, n, e.string.slice(e.i)), e.i = 0, e.itemFactory.create("beginEnv").setProperty("name", t.getName());
            }
          };
      ...
      406: function (e, t, n) {
        ...
        !function (e) {
          ...
          e.disassembleSymbol = function (e, t) {
            var n = [e, t.char];
            if (t.attributes) for (var a in t.attributes) n.push(a), n.push(t.attributes[a]);
            return n;
          }, e.assembleSymbol = function (e) {
            for (var t = e[0], n = e[1], a = {}, r = 2; r < e.length; r += 2) a[e[r]] = e[r + 1];
            return new u.Symbol(t, n, a);
          }, e.GetCSname = function (e, t) {
            if ("\\" !== e.GetNext()) throw new o.default("MissingCS", "%1 must be followed by a control sequence", t);
            ...
            if ("\\" === n.charAt(0) && (n = n.substr(1)), !n.match(/^(.|[a-z]+)$/i)) throw new o.default("IllegalControlSequenceName", "Illegal control sequence name for %1", t);
            return n;
          }, e.GetArgCount = function (e, t) {
            var n = e.GetBrackets(t);
            if (n && !(n = i.default.trimSpaces(n)).match(/^[0-9]+$/)) throw new o.default("IllegalParamNumber", "Illegal number of parameters specified in %1", t);
            return n;
          }, e.GetTemplate = function (e, t, n) {
            for (var a = e.GetNext(), r = [], i = 0, u = e.i; e.i < e.string.length;) {
              if ("#" === (a = e.GetNext())) {
                if (u !== e.i && (r[i] = e.string.substr(u, e.i - u)), !(a = e.string.charAt(++e.i)).match(/^[1-9]$/)) throw new o.default("CantUseHash2", "Illegal use of # in template for %1", n);
                if (parseInt(a) !== ++i) throw new o.default("SequentialParam", "Parameters for %1 must be numbered sequentially", n);
                u = e.i + 1;
              } else if ("{" === a) return u !== e.i && (r[i] = e.string.substr(u, e.i - u)), r.length > 0 ? [i.toString()].concat(r) : i;
              e.i++;
            }
            ...
            for (var r = e.i, i = 0, u = 0; e.i < e.string.length;) {
              ...
              if ("{" === l) e.i === r && (u = 1), e.GetArgument(n), i = e.i - r;else {
          ...
          }, e.MatchParam = t, e.addDelimiter = function (t, n, a, r) {
            t.configuration.handlers.retrieve(e.NEW_DELIMITER).add(n, new u.Symbol(n, a, r));
          }, e.addMacro = function (t, n, a, r, i) {
            void 0 === i && (i = ""), t.configuration.handlers.retrieve(e.NEW_COMMAND).add(n, new u.Macro(i || n, a, r));
      ...
      924: function (e, t) {
        Object.defineProperty(t, "__esModule", {
          value: !0
        }), t.Symbol = MathJax._.input.tex.Symbol.Symbol, t.Macro = MathJax._.input.tex.Symbol.Macro;
      },
      871: function (e, t) {
        Object.defineProperty(t, "__esModule", {
          value: !0
  ...
  e = l(955), t = l(667), n = l(48), a = l(205), r = l(107), i = l(406), MathJax.loader && MathJax.loader.checkVersion("[tex]/newcommand", t.q, "tex-extension"), (0, e.r8)({
    _: {
      input: {
        tex: {
          newcommand: {
