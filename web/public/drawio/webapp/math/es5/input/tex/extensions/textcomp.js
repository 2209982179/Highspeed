!function () {
      ...
      832: function (t, e, n) {
        ...
        new a.CommandMap("textcomp-macros", {
          ...
          Insert: function (t, e, n, r) {
            ...
            t.Push(x.default.internalText(t, n, r ? {
              mathvariant: r
            } : {}));
          }
        });
  ...
  t = s(955), e = s(667), n = s(845), MathJax.loader && MathJax.loader.checkVersion("[tex]/textcomp", e.q, "tex-extension"), (0, t.r8)({
    _: {
      input: {
        tex: {
          textcomp: {
            TextcompConfiguration: n
          }
        }
      }
    }
