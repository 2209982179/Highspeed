...
!function () {
    ...
    i = {
      ...
      333: function (e, t, r) {
        ...
        var n = r(251),
          a = r(854),
          i = r(378);
        r(116), t.BussproofsConfiguration = n.Configuration.create("bussproofs", {
          handler: {
      ...
      854: function (e, t, r) {
        var o,
          ...
          a = this && this.__createBinding || (Object.create ? function (e, t, r, o) {
            void 0 === o && (o = r);
        ...
        var f = u(r(402)),
          ...
          p = function (e) {
            ...
            return n(t, e), Object.defineProperty(t.prototype, "kind", {
              get: function () {
                return "proofTree";
              },
              enumerable: !1,
      ...
      116: function (e, t, r) {
        ...
        }, n.default), new i.EnvironmentMap("Bussproofs-environments", a.default.environment, {
      ...
      827: function (e, t, r) {
        var o = this && this.__createBinding || (Object.create ? function (e, t, r, o) {
          ...
          l = this && this.__spreadArray || function (e, t, r) {
            if (r || 2 === arguments.length) for (var o, n = 0, a = t.length; n < a; n++) !o && n in t || (o || (o = Array.prototype.slice.call(t, 0, n)), o[n] = t[n]);
        ...
        var f = u(r(402)),
          ...
          p = {
            ...
            Axiom: function (e, t) {
              var r = e.stack.Top();
              if ("proofTree" !== r.kind) throw new f.default("IllegalProofCommand", "Proof commands only allowed in prooftree environment.");
        ...
        function h(e, t, r, o, n, a, i) {
          ...
          if (c.setProperty(m, "inferenceRule", i ? "up" : "down"), o && (l = e.create("node", "mpadded", [o], {
            height: "+.5em",
            width: "+.5em",
            voffset: "-.15em"
          }), c.setProperty(l, "prooflabel", "left")), n && (u = e.create("node", "mpadded", [n], {
            height: "+.5em",
            width: "+.5em",
            voffset: "-.15em"
          }), c.setProperty(u, "prooflabel", "right")), o && n) f = [l, m, u], s = "both";else if (o) f = [l, m], s = "left";else {
            if (!n) return m;
            f = [m, u], s = "right";
          }
        ...
        function y(e, t) {
          if ("$" !== e.GetNext()) throw new f.default("IllegalUseOfCommand", "Use of %1 does not match it's definition.", t);
          e.i++;
          var r = e.GetUpTo(t, "$");
          if (-1 === r.indexOf("\\fCenter")) throw new f.default("IllegalUseOfCommand", "Missing \\fCenter in %1.", t);
        ...
        p.Inference = function (e, t, r) {
          var o = e.stack.Top();
          if ("proofTree" !== o.kind) throw new f.default("IllegalProofCommand", "Proof commands only allowed in prooftree environment.");
          if (o.Size() < r) throw new f.default("BadProofTree", "Proof tree badly specified.");
          var n = o.getProperty("rootAtTop"),
            a = 1 !== r || o.Peek()[0].childNodes.length ? r : 0,
            i = [];
          do {
            i.length && i.unshift(e.create("node", "mtd", [], {})), i.unshift(e.create("node", "mtd", [o.Pop()], {
          ...
          o.setProperty("left", null), o.setProperty("right", null), c.setProperty(p, "inference", a), e.configuration.addNode("inference", p), o.Push(p);
          ...
          var n = e.stack.Top();
          if ("proofTree" !== n.kind) throw new f.default("IllegalProofCommand", "Proof commands only allowed in prooftree environment.");
          ...
          var o = y(e, t);
          c.setProperty(o, "axiom", !0), r.Push(o);
        }, p.FCenter = function (e, t) {}, p.InferenceF = function (e, t, r) {
          var o = e.stack.Top();
          if ("proofTree" !== o.kind) throw new f.default("IllegalProofCommand", "Proof commands only allowed in prooftree environment.");
          if (o.Size() < r) throw new f.default("BadProofTree", "Proof tree badly specified.");
          var n = o.getProperty("rootAtTop"),
      ...
      378: function (e, t, r) {
        ...
        var l = i(r(748)),
          ...
          M = function (e, r, o, n) {
            if (void 0 === n && (n = !1), (0, t.getProperty)(r, "inferenceRule") || (0, t.getProperty)(r, "labelledRule")) {
              var a = e.nodeFactory.create("node", "mrow");
              r.parent.replaceChild(a, r), a.setChildren([r]), w(r, a), r = a;
            }
            var i = n ? r.childNodes.length - 1 : 0,
              f = r.childNodes[i];
            l.default.isType(f, "mspace") ? l.default.setAttribute(f, "width", u.default.Em(u.default.dimen2em(l.default.getAttribute(f, "width")) + o)) : (f = e.nodeFactory.create("node", "mspace", [], {
          ...
          T = function (e, r) {
            for (var o = r.pop(); r.length;) {
              var a = r.pop(),
                ...
                l = i[0],
                u = i[1];
              (0, t.getProperty)(o.parent, "axiom") && (C(e, l < 0 ? o : a, 0, "left", Math.abs(l)), C(e, u < 0 ? o : a, 2, "right", Math.abs(u))), o = a;
            }
          },
          I = function (e, t) {
        ...
        t.balanceRules = function (e) {
          ...
          !function (e) {
            ...
            if (r) for (var o = r.length - 1, n = void 0; n = r[o]; o--) if ((0, t.getProperty)(n, "sequentProcessed")) (0, t.removeProperty)(n, "sequentProcessed");else {
              var a = [],
                i = b(n);
              if (1 === (0, t.getProperty)(i, "inference")) {
                for (a.push(n); 1 === (0, t.getProperty)(i, "inference");) {
                  ...
                  var l = h(p(i, (0, t.getProperty)(i, "inferenceRule"))),
                    u = (0, t.getProperty)(l, "inferenceRule") ? v(l, (0, t.getProperty)(l, "inferenceRule")) : l;
                  (0, t.getProperty)(u, "sequent") && (n = u.childNodes[0], a.push(n), (0, t.setProperty)(n, "sequentProcessed", !0)), i = l;
                }
                T(e, a);
              }
            }
              ...
              if (null != (0, t.getProperty)(S, "inference")) {
                ...
                if (!d && (L = P(f))) {
                  ...
                  if (k) {
                    ...
                    var J = b(L);
                    J && (N = (0, t.getProperty)(J, "maxAdjust") ? Math.max((0, t.getProperty)(J, "maxAdjust"), N) : N, (0, t.setProperty)(J, "maxAdjust", N));
                  }
                } else M(n, (0, t.getProperty)(f, "proof") ? f : f.parent, N - j, !0);
              }
            }
          } catch (e) {
            r = {
        ...
        t.makeBsprAttributes = function (e) {
          e.data.root.walkTree(function (e, t) {
            ...
            e.getPropertyNames().forEach(function (t) {
              !S[t] && t.match(RegExp("^bspr_")) && r.push(t + ":" + e.getProperty(t));
            }), r.length && l.default.setAttribute(e, "semantics", r.join(";"));
          });
        };
        t.saveDocument = function (e) {
          if (!("getBBox" in (f = e.document).outputJax)) throw Error("The bussproofs extension requires an output jax with a getBBox() method");
        };
      ...
      251: function (e, t) {
        Object.defineProperty(t, "__esModule", {
          value: !0
        }), t.Configuration = MathJax._.input.tex.Configuration.Configuration, t.ConfigurationHandler = MathJax._.input.tex.Configuration.ConfigurationHandler, t.ParserConfiguration = MathJax._.input.tex.Configuration.ParserConfiguration;
      },
      748: function (e, t) {
        Object.defineProperty(t, "__esModule", {
          value: !0
      ...
      76: function (e, t) {
        Object.defineProperty(t, "__esModule", {
          value: !0
        }), t.MmlStack = MathJax._.input.tex.StackItem.MmlStack, t.BaseItem = MathJax._.input.tex.StackItem.BaseItem;
      },
      871: function (e, t) {
        Object.defineProperty(t, "__esModule", {
          value: !0
  ...
  e = u(955), t = u(667), r = u(333), o = u(854), n = u(827), a = u(378), MathJax.loader && MathJax.loader.checkVersion("[tex]/bussproofs", t.q, "tex-extension"), (0, e.r8)({
    _: {
      input: {
        tex: {
          bussproofs: {
