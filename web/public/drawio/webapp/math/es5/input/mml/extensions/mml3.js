...
(function () {
  ...
  var __webpack_modules__ = {
      ...
      63: function (__unused_webpack_module, exports) {
        function createTransform() {
          ...
          return function (e, t) {
            var l,
              s = t.adaptor,
              n = s.outerHTML(e);
            n.match(/ xmlns[=:]/) || (n = n.replace(/<(?:(\w+)(:))?math/, '<$1$2math xmlns$2$1="http://www.w3.org/1998/Math/MathML"'));
            try {
              l = s.firstChild(s.body(s.parse(Saxon.transform({
        ...
        Object.defineProperty(exports, "__esModule", {
          value: !0
        }), exports.createTransform = void 0, exports.createTransform = createTransform;
      },
      514: function (e, t, l) {
        var s,
          n = this && this.__extends || (s = function (e, t) {
          ...
          m = this && this.__assign || function () {
            return m = Object.assign || function (e) {
              for (var t, l = 1, s = arguments.length; l < s; l++) for (var n in t = arguments[l]) Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]);
              return e;
          ...
          o = this && this.__read || function (e, t) {
            ...
            var s,
              ...
              o = [];
            try {
              for (; (void 0 === t || t-- > 0) && !(s = m.next()).done;) o.push(s.value);
            } catch (e) {
              n = {
                error: e
              };
          ...
          a = this && this.__spreadArray || function (e, t, l) {
            if (l || 2 === arguments.length) for (var s, n = 0, m = t.length; n < m; n++) !s && n in t || (s || (s = Array.prototype.slice.call(t, 0, n)), s[n] = t[n]);
        ...
        var c = l(63),
          i = function () {
            function e(t) {
              if ("undefined" == typeof XSLTProcessor) this.transform = (0, c.createTransform)();else {
            ...
            return e.prototype.mmlFilter = function (e) {
              e.document.options.enableMml3 && (e.data = this.transform(e.data, e.document));
            }, e;
          }();
        t.Mml3 = i, t.Mml3Handler = function (e) {
          var t;
          return e.documentClass = (t = function (e) {
            function t() {
              for (var t, l, s = [], n = 0; n < arguments.length; n++) s[n] = arguments[n];
            ...
            return n(t, e), t;
          }(e.documentClass), t.OPTIONS = m(m({}, e.documentClass.OPTIONS), {
            enableMml3: !0
          }), t), e;
  ...
  var __webpack_exports__ = {},
    ...
    mml3_node,
    mml3;
  global = __webpack_require__(955), version = __webpack_require__(667), mml3_node = __webpack_require__(63), mml3 = __webpack_require__(514), MathJax.loader && MathJax.loader.checkVersion("[mml]/mml3", version.q, "input/mml/extensions"), (0, global.r8)({
    _: {
      input: {
        mathml: {
          mml3: {
  ...
  }), MathJax.startup && MathJax.startup.extendHandler(function (e) {
