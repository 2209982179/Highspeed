  ...
  var t = {
      ...
      205: function (t, e, r) {
        ...
        var v = function (t) {
          function e(r) {
            ...
            return (0, u.userOptions)(d.options, o), h.config(n), e.tags(d, h), n.postFilters.add(f.default.cleanSubSup, -6), n.postFilters.add(f.default.setInherited, -5), n.postFilters.add(f.default.moveLimits, -4), n.postFilters.add(f.default.cleanStretchy, -3), n.postFilters.add(f.default.cleanAttributes, -2), n.postFilters.add(f.default.combineRelations, -1), n;
          }
          return i(e, t), e.configure = function (t) {
            var e = new g.ParserConfiguration(t, ["tex"]);
            return e.init(), e;
          }, e.tags = function (t, e) {
            y.TagsFactory.addTags(e.tags), y.TagsFactory.setDefault(t.options.tags), t.tags = y.TagsFactory.getDefault(), t.tags.configuration = t;
            ...
            return r = this.parseOptions.nodeFactory.create("node", "math", [r]), (null == n ? void 0 : n.indentalign) && p.default.setAttribute(r, "indentalign", n.indentalign), i && p.default.setAttribute(r, "display", "block"), this.parseOptions.tags.finishEquation(t), this.parseOptions.root = r, this.executeFilters(this.postFilters, t, e, this.parseOptions), this.mathNode = this.parseOptions.root, this.mathNode;
      ...
      552: function (t, e, r) {
        ...
        var o,
          ...
          f = function () {
            function t(t, e, r, n, i, o, a, s, l, u, c, f, p) {
              void 0 === e && (e = {}), void 0 === r && (r = {}), void 0 === n && (n = {}), void 0 === i && (i = {}), void 0 === o && (o = {}), void 0 === a && (a = {}), void 0 === s && (s = []), void 0 === l && (l = []), void 0 === u && (u = null), void 0 === c && (c = null), this.name = t, this.handler = e, this.fallback = r, this.items = n, this.tags = i, this.options = o, this.nodes = a, this.preprocessors = s, this.postprocessors = l, this.initMethod = u, this.configMethod = c, this.priority = f, this.parser = p, this.handler = Object.assign({
                character: [],
                delimiter: [],
                macro: [],
                environment: []
        ...
        var p = function () {
          ...
          return t.prototype.init = function () {
            ...
            c.TagsFactory.addTags(s.tags), (0, a.defaultOptions)(l.options, s.options), (0, a.userOptions)(l.options, r), this.addFilters(e, s), s.config && s.config(this, e);
          ...
          t.cleanStretchy = function (t) {
            ...
            try {
              for (var f = n(t.data.getList("mo")), p = f.next(); !p.done; p = f.next()) {
                var h = p.value;
                if (!h.getProperty("relationsCombined") && h.parent && (!h.parent || s.default.isType(h.parent, "mrow")) && s.default.getTexClass(h) === a.TEXCLASS.REL) {
                  for (var d = h.parent, m = void 0, y = d.childNodes, g = y.indexOf(h) + 1, v = s.default.getProperty(h, "variantForm"); g < y.length && (m = y[g]) && s.default.isType(m, "mo") && s.default.getTexClass(m) === a.TEXCLASS.REL;) {
      ...
      982: function (t, e, r) {
        ...
        var a = r(649),
          ...
          u = function (t) {
            ...
            return i(e, t), e.prototype.getPatterns = function () {
              var t = this,
                e = this.options,
                r = [],
                n = [],
              ...
              }), r.length && n.push(r.sort(s.sortLength).join("|")), e.processEnvironments && (n.push("\\\\begin\\s*\\{([^}]*)\\}"), this.env = o, o++), e.processEscapes && i.push("\\\\([\\\\$])"), e.processRefs && i.push("(\\\\(?:eq)?ref\\s*\\{[^}]*\\})"), i.length && (n.push("(" + i.join("|") + ")"), this.sub = o), this.start = new RegExp(n.join("|"), "g"), this.hasPatterns = n.length > 0;
              ...
              for (var i, a = o(n, 3), s = a[0], u = a[1], c = a[2], f = c.lastIndex = r.index + r[0].length, p = 0; i = c.exec(t);) {
                if ((i[1] || i[0]) === s && 0 === p) return (0, l.protoItem)(r[0], t.substr(f, i.index - f), i[0], e, r.index, i.index + i[0].length, u);
                "{" === i[0] ? p++ : "}" === i[0] && p && p--;
              }
              return null;
              ...
              for (this.start.lastIndex = 0; n = this.start.exec(r);) {
                if (void 0 !== n[this.env] && this.env) {
                  ...
                  (i = this.findEnd(r, e, n, ["{" + n[this.env] + "}", !0, this.endPattern(null, o)])) && (i.math = i.open + i.math + i.close, i.open = i.close = "");
                } else if (void 0 !== n[this.sub] && this.sub) {
                  var a = n[this.sub];
                  o = n.index + n[this.sub].length;
                  i = 2 === a.length ? (0, l.protoItem)("", a.substr(1), "", e, n.index, o) : (0, l.protoItem)("", a, "", e, n.index, o, !1);
      ...
      644: function (t, e, r) {
        ...
        var a = o(r(321)),
          s = function () {
            ...
            return t.createNode = function (t, e, r, n, i) {
      ...
      321: function (t, e, r) {
        ...
        !function (t) {
          ...
          }, t.setChild = a, t.copyChildren = function (t, e) {
      ...
      708: function (t, e, r) {
        ...
        !function (t) {
          t.variable = function (t, e) {
            ...
            i ? (r = t.create("token", "mn", o, i[0].replace(/[{}]/g, "")), t.i += i[0].length - 1) : r = t.create("token", "mo", o, e), t.Push(r);
      ...
      702: function (t, e, r) {
        ...
        !function (t) {
          ...
          function d(t, e) {
            ...
            }([i[1].replace(/,/, "."), i[4], i[0].length]) : [null, null, 0];
          }
          function m(t) {
          ...
          t.matchDimen = d, t.dimen2em = function (t) {
            var e = n(d(t), 2),
              i = e[0],
              o = e[1],
              a = parseFloat(i || "1"),
            ...
            if (i) a = new u.default("\\" + i + "l" + e, t.parser.stack.env, t).mml();else {
            ...
            if (l.default.appendChildren(f, [a, r]), i) a = new u.default("\\" + i + "r" + n, t.parser.stack.env, t).mml();else {
            ...
            return e && l.default.appendChildren(i, [y(t, e, "l")]), l.default.isType(r, "mrow") ? l.default.appendChildren(i, l.default.getChildren(r)) : l.default.appendChildren(i, [r]), n && l.default.appendChildren(i, [y(t, n, "r")]), i;
          }, t.mathPalette = y, t.fixInitialMO = function (t, e) {
            for (var r = 0, n = e.length; r < n; r++) {
              var i = e[r];
              if (i && !l.default.isType(i, "mspace") && (!l.default.isType(i, "TeXAtom") || l.default.getChildren(i)[0] && l.default.getChildren(l.default.getChildren(i)[0]).length)) {
            ...
            var i,
              ...
              d = 0;
            if (e.match(/\\?[${}\\]|\\\(|\\(eq)?ref\s*\{/)) {
              for (; f < e.length;) if ("$" === (i = e.charAt(f++))) "$" === h && 0 === d ? (o = t.create("node", "TeXAtom", [new u.default(e.slice(p, f - 1), {}, t.configuration).mml()]), l.push(o), h = "", p = f) : "" === h && (p < f - 1 && l.push(g(t, e.slice(p, f - 1), s)), h = "$", p = f);else if ("{" === i && "" !== h) d++;else if ("}" === i) {
                if ("}" === h && 0 === d) {
                  var m = new u.default(e.slice(p, f), {}, t.configuration).mml();
                  o = t.create("node", "TeXAtom", [m], s), l.push(o), h = "", p = f;
                } else "" !== h && d && d--;
              } else if ("\\" === i) if ("" === h && e.substr(f).match(/^(eq)?ref\s*\{/)) {
                var y = RegExp["$&"].length;
                p < f - 1 && l.push(g(t, e.slice(p, f - 1), s)), h = "}", p = f - 1, f += y;
              } else "(" === (i = e.charAt(f++)) && "" === h ? (p < f - 2 && l.push(g(t, e.slice(p, f - 2), s)), h = ")", p = f) : ")" === i && ")" === h && 0 === d ? (o = t.create("node", "TeXAtom", [new u.default(e.slice(p, f - 2), {}, t.configuration).mml()]), l.push(o), h = "", p = f) : i.match(/[${}\\]/) && "" === h && (f--, e = e.substr(0, f - 1) + e.substr(f));
              if ("" !== h) throw new c.default("MathNotTerminated", "Math not terminated in text box");
            }
            return p < e.length && l.push(g(t, e.slice(p), s)), null != r ? l = [t.create("node", "mstyle", l, {
              displaystyle: !1,
              scriptlevel: r
            })] : l.length > 1 && (l = [t.create("node", "mrow", l)]), l;
          }, t.internalText = g, t.underOver = function (e, r, n, i, o) {
            ...
            for (var n = "", i = "", o = 0; o < r.length;) {
              var a = r.charAt(o++);
              if ("\\" === a) n += a + r.charAt(o++);else if ("#" === a) {
                if ("#" === (a = r.charAt(o++))) n += a;else {
            ...
            var s = function (t) {
              var e,
                ...
                s = {},
                l = t;
              for (; l;) o = (e = n(x(l, ["=", ","]), 3))[0], i = e[1], l = e[2], "=" === i ? (a = (r = n(x(l, [","]), 3))[0], i = r[1], l = r[2], a = "false" === a || "true" === a ? JSON.parse(a) : a, s[o] = a) : o && (s[o] = !0);
              return s;
            }(t);
            if (e) try {
              ...
              try {
                for (var l = n(r), u = l.next(); !u.done; u = l.next()) {
                  ...
                  if (c) {
                    ...
                    var p = i(this.stack.length ? this.Top().checkItem(f) : [null, !0], 2),
                      h = p[0],
                      d = p[1];
                    d && (h ? (this.Pop(), this.Push.apply(this, o([], i(h), !1))) : (this.stack.push(f), f.env ? (f.copyEnv && Object.assign(f.env, this.env), this.env = f.env) : f.env = this.env));
                  }
                }
              } catch (e) {
                t = {
      ...
      44: function (t, e, r) {
        ...
        var f = function (t) {
          ...
          return i(e, t), Object.defineProperty(e.prototype, "kind", {
            get: function () {
              return "base";
            },
            enumerable: !1,
      ...
      628: function (t, e, r) {
        ...
        var p = function (t) {
          ...
          return i(e, t), e.prototype.contains = function (t) {
        ...
        var h = function (t) {
          ...
          return i(e, t), e.prototype.lookup = function (t) {
            return this.map.get(t);
        ...
        var m = function (t) {
          ...
          return i(e, t), e.prototype.parse = function (e) {
            var r = o(e, 2),
              n = r[0],
              i = r[1];
        ...
        var y = function (t) {
          ...
          return i(e, t), e.prototype.parserFor = function (t) {
            var e = this.lookup(t);
      ...
      251: function (t, e, r) {
        ...
        var u = function (t, e, r, n, i, o, a, s) {
          void 0 === t && (t = ""), void 0 === e && (e = !1), void 0 === r && (r = !1), void 0 === n && (n = null), void 0 === i && (i = ""), void 0 === o && (o = ""), void 0 === a && (a = !1), void 0 === s && (s = ""), this.env = t, this.taggable = e, this.defaultTags = r, this.tag = n, this.tagId = i, this.tagFormat = o, this.noTag = a, this.labelId = s;
        };
        e.TagInfo = u;
        var c = function () {
          function t() {
        ...
        var f = function (t) {
          ...
          return i(e, t), e.prototype.autoTag = function () {}, e.prototype.getTag = function () {
        ...
        var p = function (t) {
          ...
          return i(e, t), e.prototype.finalize = function (t, e) {
        ...
        var r = function () {
          ...
          return t.processString = function (e, r) {
            for (var n = e.split(t.pattern), i = 1, o = n.length; i < o; i += 2) {
              var a = n[i].charAt(0);
              if (a >= "0" && a <= "9") n[i] = r[parseInt(n[i], 10) - 1], "number" == typeof n[i] && (n[i] = n[i].toString());else if ("{" === a) {
                if ((a = n[i].substr(1)) >= "0" && a <= "9") n[i] = r[parseInt(n[i].substr(1, n[i].length - 2), 10) - 1], "number" == typeof n[i] && (n[i] = n[i].toString());else n[i].match(/^\{([a-z]+):%(\d+)\|(.*)\}$/) && (n[i] = "%" + n[i]);
              }
              null == n[i] && (n[i] = "???");
            }
            return n.join("");
        ...
        var s = a(r(702)),
          ...
          f = function () {
            function t(t, e, r) {
              ...
              this.configuration.pushParser(this), this.stack = new l.default(this.itemFactory, a, !s || u), this.Parse(), this.Push(this.itemFactory.create("stop"));
            }
      ...
      606: function (t, e, r) {
        ...
        function b(t, e) {
          ...
          i[4] && a.attributes.set("mathvariant", i[4]), "mo" === o && (d.default.setProperty(a, "fixStretchy", !0), t.configuration.addNode("fixStretchy", a)), t.Push(a);
        }
        ...
        e.BaseTags = x, e.BaseConfiguration = f.Configuration.create("base", {
          handler: {
          ...
          postprocessors: [[function (t) {
            ...
            try {
              for (var i = u(n.getList("nonscript")), o = i.next(); !o.done; o = i.next()) {
                ...
                } else a.isKind("mrow") && (a.parent.replaceChild(a.childNodes[0], a), n.removeFromList("mrow", [a]));
              }
            } catch (t) {
              e = {
                error: t
      ...
      389: function (t, e, r) {
        ...
        var M = function (t) {
          ...
          return i(e, t), Object.defineProperty(e.prototype, "kind", {
            ...
            if (e.isKind("right")) return [[this.factory.create("mml", p.default.fenced(this.factory.configuration, this.getProperty("delim"), this.toMml(), e.getProperty("delim"), "", e.getProperty("color")))], !0];
            if (e.isKind("middle")) {
              var r = {
                stretchy: !0
              };
        ...
        var E = function (t) {
          ...
          return i(e, t), Object.defineProperty(e.prototype, "isFinal", {
            get: function () {
              return !0;
            },
            enumerable: !1,
        ...
        var N = function (t) {
          ...
          return i(e, t), Object.defineProperty(e.prototype, "kind", {
            ...
            }), "none" === (this.arraydef.columnlines || "none") && "none" === (this.arraydef.rowlines || "none") || h.default.setAttribute(e, "data-padding", 0)), (this.getProperty("open") || this.getProperty("close")) && (e = p.default.fenced(this.factory.configuration, this.getProperty("open"), e, this.getProperty("close"))), e;
            ...
            if (this.arraydef.rowspacing) {
              ...
              for (var n = this.getProperty("rowspacing"); e.length < this.table.length;) e.push(p.default.Em(n));
      ...
      724: function (t, e, r) {
        ...
        function M(t, e) {
          ...
          if (a.leftRoot || a.upRoot) {
            var s = {};
            a.leftRoot && (s.width = a.leftRoot), a.upRoot && (s.voffset = a.upRoot, s.height = a.upRoot), o = t.create("node", "mpadded", [o], s);
          }
          return r.inRoot = n, o;
        }
        x.Open = function (t, e) {
          ...
          var o = t.stack.Top();
          o.isKind("prime") ? (i = (r = s(o.Peek(2), 2))[0], n = r[1], t.stack.Pop()) : (i = t.stack.Prev()) || (i = t.create("token", "mi", {}, ""));
          var a = c.default.getProperty(i, "movesupsub"),
            l = c.default.isType(i, "msubsup") ? i.sup : i.over;
          if (c.default.isType(i, "msubsup") && !c.default.isType(i, "msup") && c.default.getChildAt(i, i.sup) || c.default.isType(i, "munderover") && !c.default.isType(i, "mover") && c.default.getChildAt(i, i.over) && !c.default.getProperty(i, "subsupOK")) throw new f.default("DoubleExponent", "Double exponent: use braces to clarify");
          c.default.isType(i, "msubsup") && !c.default.isType(i, "msup") || (a ? ((!c.default.isType(i, "munderover") || c.default.isType(i, "mover") || c.default.getChildAt(i, i.over)) && (i = t.create("node", "munderover", [i], {
            movesupsub: !0
          })), l = i.over) : l = (i = t.create("node", "msubsup", [i])).sup), t.Push(t.itemFactory.create("subsup", i).setProperties({
            position: l,
            primes: n,
            movesupsub: a
          }));
          ...
          if (c.default.isType(i, "msubsup") && !c.default.isType(i, "msup") && c.default.getChildAt(i, i.sub) || c.default.isType(i, "munderover") && !c.default.isType(i, "mover") && c.default.getChildAt(i, i.under) && !c.default.getProperty(i, "subsupOK")) throw new f.default("DoubleSubscripts", "Double subscripts: use braces to clarify");
          c.default.isType(i, "msubsup") && !c.default.isType(i, "msup") || (a ? ((!c.default.isType(i, "munderover") || c.default.isType(i, "mover") || c.default.getChildAt(i, i.under)) && (i = t.create("node", "munderover", [i], {
            movesupsub: !0
          })), l = i.under) : l = (i = t.create("node", "msubsup", [i])).sub), t.Push(t.itemFactory.create("subsup", i).setProperties({
            position: l,
            primes: n,
            movesupsub: a
          }));
          ...
          var i = t.GetArgument(e),
            o = new p.default(i, n(n({}, t.stack.env), {
              font: r,
          ...
          t.stack.env.style = r, t.stack.env.level = i, t.Push(t.itemFactory.create("style").setProperty("styles", {
            displaystyle: n,
            scriptlevel: i
          }));
          ...
          var i,
            o = t.stack.Top();
          c.default.isType(n, "munderover") && !r ? (i = t.create("node", "msubsup"), c.default.copyChildren(n, i), n = o.Last = i) : c.default.isType(n, "msubsup") && r && (i = t.create("node", "munderover"), c.default.copyChildren(n, i), n = o.Last = i), c.default.setProperty(n, "movesupsub", !!r), c.default.setProperties(c.default.getCoreMO(n), {
            movablelimits: !1
          ...
          var r = t.ParseArg(e),
            n = t.ParseArg(e),
            i = t.ParseArg(e);
          d.default.checkMovableLimits(i), r.isKind("mo") && c.default.setAttribute(r, "accent", !1), n.isKind("mo") && c.default.setAttribute(n, "accent", !1);
          ...
          if (r === m.TEXCLASS.OP) {
            ...
            l ? (a.mathvariant = h.TexConstant.Variant.NORMAL, i = t.create("token", "mi", a, l[1])) : (o = new p.default(s, t.stack.env, t.configuration).mml(), i = t.create("node", "TeXAtom", [o], a)), n = t.itemFactory.create("fn", i);
          ...
          for (; "" !== i;) {
            ...
            if (!r.attributes.hasDefault(l[1]) && !T[l[1]]) throw new f.default("UnknownAttrForElement", "%1 is not a recognized attribute for %2", l[1], n);
            var u = d.default.MmlFilterAttribute(t, l[1], l[2].replace(/^(['"])(.*)\1$/, "$2"));
            u && ("true" === u.toLowerCase() ? u = !0 : "false" === u.toLowerCase() && (u = !1), a[l[1]] = u, s.push(l[1])), i = i.substr(l[0].length);
          }
          ...
          (r || n) && (i = t.create("node", "mpadded", [i]), n && (c.default.setAttribute(i, "height", 0), c.default.setAttribute(i, "depth", 0)), r && c.default.setAttribute(i, "width", 0));
          ...
          var o = t.create("node", "TeXAtom", [t.create("node", "menclose", i, {
            notation: "box"
          })], {
          ...
          p.arraydef = {
            rowspacing: a || "4pt",
            columnspacing: o || "1em"
          }, l && p.setProperty("isCases", !0), u && (p.setProperty("isNumbered", !0), p.arraydef.side = u), (r || n) && (p.setProperty("open", r), p.setProperty("close", n)), "D" === s && (p.arraydef.displaystyle = !0), null != i && (p.arraydef.columnalign = i), t.Push(p);
          ...
          if (r.getProperty("isCases") || n) {
            for (var i = t.string, o = 0, a = -1, s = t.i, l = i.length, u = n ? new RegExp("^\\\\end\\s*\\{".concat(n.replace(/\*/, "\\*"), "\\}")) : null; s < l;) {
              var c = i.charAt(s);
              if ("{" === c) o++, s++;else if ("}" === c) 0 === o ? l = 0 : (0 === --o && a < 0 && (a = s - t.i), s++);else {
          ...
          if (void 0 === r && (r = !1), !r && ("*" === t.string.charAt(t.i) && t.i++, "[" === t.string.charAt(t.i))) {
            var i = t.GetBrackets(e, ""),
              ...
              a = o[0],
              l = o[1];
            if (i && !a) throw new f.default("BracketMustBeDimension", "Bracket argument to %1 must be a dimension", t.currentCS);
            n = a + l;
          }
          t.Push(t.itemFactory.create("cell").setProperties({
            isCR: !0,
          ...
          var c,
            p = t.stack.Top();
          p instanceof u.ArrayItem ? n && p.addRowSpacing(n) : (n && (c = t.create("node", "mspace", [], {
            depth: n
          ...
          if (n.table.length) {
            for (var i = n.arraydef.rowlines ? n.arraydef.rowlines.split(/ /) : []; i.length < n.table.length;) i.push("none");
          ...
          i = (i = i.replace(/[^clr]/g, "").split("").join(" ")).replace(/l/g, "left").replace(/r/g, "right").replace(/c/g, "center");
          ...
          t.Push(e), n && d.default.checkEqnEnv(t), i = (i = i.replace(/[^clr]/g, "").split("").join(" ")).replace(/l/g, "left").replace(/r/g, "right").replace(/c/g, "center");
