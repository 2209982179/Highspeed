...
!function () {
  ...
  var t = {
      ...
      7205: function (t, e, r) {
        ...
        var v = function (t) {
          function e(r) {
            ...
            return (0, u.userOptions)(p.options, o), h.config(n), e.tags(p, h), n.postFilters.add(f.default.cleanSubSup, -6), n.postFilters.add(f.default.setInherited, -5), n.postFilters.add(f.default.moveLimits, -4), n.postFilters.add(f.default.cleanStretchy, -3), n.postFilters.add(f.default.cleanAttributes, -2), n.postFilters.add(f.default.combineRelations, -1), n;
          }
          return a(e, t), e.configure = function (t) {
            ...
            try {
              var o = new h.default(this.latex, {
                display: a,
                isInner: !1
              }, this.parseOptions);
            ...
            return r = this.parseOptions.nodeFactory.create("node", "math", [r]), (null == n ? void 0 : n.indentalign) && d.default.setAttribute(r, "indentalign", n.indentalign), a && d.default.setAttribute(r, "display", "block"), this.parseOptions.tags.finishEquation(t), this.parseOptions.root = r, this.executeFilters(this.postFilters, t, e, this.parseOptions), this.mathNode = this.parseOptions.root, this.mathNode;
          ...
          }, e.NAME = "TeX", e.OPTIONS = o(o({}, l.AbstractInputJax.OPTIONS), {
            FindTeX: null,
            packages: ["base"],
      ...
      6552: function (t, e, r) {
        ...
        var o,
          ...
          f = function () {
            function t(t, e, r, n, a, o, i, s, l, u, c, f, d) {
              void 0 === e && (e = {}), void 0 === r && (r = {}), void 0 === n && (n = {}), void 0 === a && (a = {}), void 0 === o && (o = {}), void 0 === i && (i = {}), void 0 === s && (s = []), void 0 === l && (l = []), void 0 === u && (u = null), void 0 === c && (c = null), this.name = t, this.handler = e, this.fallback = r, this.items = n, this.tags = a, this.options = o, this.nodes = i, this.preprocessors = s, this.postprocessors = l, this.initMethod = u, this.configMethod = c, this.priority = f, this.parser = d, this.handler = Object.assign({
                character: [],
                delimiter: [],
                macro: [],
                environment: []
        ...
        var d = function () {
          function t(t, e) {
            var r, a, o, i;
            void 0 === e && (e = ["tex"]), this.initMethod = new l.FunctionList(), this.configMethod = new l.FunctionList(), this.configurations = new u.PrioritizedList(), this.parsers = [], this.handlers = new s.SubHandlers(), this.items = {}, this.tags = {}, this.options = {}, this.nodes = {}, this.parsers = e;
            try {
          ...
          return t.prototype.init = function () {
            ...
            c.TagsFactory.addTags(s.tags), (0, i.defaultOptions)(l.options, s.options), (0, i.userOptions)(l.options, r), this.addFilters(e, s), s.config && s.config(this, e);
          ...
          t.cleanStretchy = function (t) {
            ...
            try {
              for (var f = n(t.data.getList("mo")), d = f.next(); !d.done; d = f.next()) {
                var h = d.value;
                if (!h.getProperty("relationsCombined") && h.parent && (!h.parent || s.default.isType(h.parent, "mrow")) && s.default.getTexClass(h) === i.TEXCLASS.REL) {
                  for (var p = h.parent, m = void 0, g = p.childNodes, y = g.indexOf(h) + 1, v = s.default.getProperty(h, "variantForm"); y < g.length && (m = g[y]) && s.default.isType(m, "mo") && s.default.getTexClass(m) === i.TEXCLASS.REL;) {
                    if (v !== s.default.getProperty(m, "variantForm") || !r(h, m)) {
                      null == h.attributes.getExplicit("rspace") && s.default.setAttribute(h, "rspace", "0pt"), null == m.attributes.getExplicit("lspace") && s.default.setAttribute(m, "lspace", "0pt");
                      break;
                    }
            ...
            a = function (t, e, r) {
              ...
              try {
                for (var l = n(t.getList("m" + e + r)), u = l.next(); !u.done; u = l.next()) {
                  ...
                  if (!f[c[e]] || !f[c[r]]) {
                    var d = c.parent,
                      h = f[c[e]] ? t.nodeFactory.create("node", "m" + e, [f[c.base], f[c[e]]]) : t.nodeFactory.create("node", "m" + r, [f[c.base], f[c[r]]]);
      ...
      2982: function (t, e, r) {
        ...
        var i = r(9649),
          ...
          u = function (t) {
            ...
            return a(e, t), e.prototype.getPatterns = function () {
              var t = this,
                e = this.options,
                r = [],
                n = [],
              ...
              }), r.length && n.push(r.sort(s.sortLength).join("|")), e.processEnvironments && (n.push("\\\\begin\\s*\\{([^}]*)\\}"), this.env = o, o++), e.processEscapes && a.push("\\\\([\\\\$])"), e.processRefs && a.push("(\\\\(?:eq)?ref\\s*\\{[^}]*\\})"), a.length && (n.push("(" + a.join("|") + ")"), this.sub = o), this.start = new RegExp(n.join("|"), "g"), this.hasPatterns = n.length > 0;
              ...
              for (var a, i = o(n, 3), s = i[0], u = i[1], c = i[2], f = c.lastIndex = r.index + r[0].length, d = 0; a = c.exec(t);) {
                if ((a[1] || a[0]) === s && 0 === d) return (0, l.protoItem)(r[0], t.substr(f, a.index - f), a[0], e, r.index, a.index + a[0].length, u);
                "{" === a[0] ? d++ : "}" === a[0] && d && d--;
              }
              return null;
              ...
              for (this.start.lastIndex = 0; n = this.start.exec(r);) {
                if (void 0 !== n[this.env] && this.env) {
                  ...
                  (a = this.findEnd(r, e, n, ["{" + n[this.env] + "}", !0, this.endPattern(null, o)])) && (a.math = a.open + a.math + a.close, a.open = a.close = "");
                } else if (void 0 !== n[this.sub] && this.sub) {
                  var i = n[this.sub];
                  o = n.index + n[this.sub].length;
                  a = 2 === i.length ? (0, l.protoItem)("", i.substr(1), "", e, n.index, o) : (0, l.protoItem)("", i, "", e, n.index, o, !1);
      ...
      8644: function (t, e, r) {
        ...
        var i = o(r(8321)),
          s = function () {
            ...
            return t.createNode = function (t, e, r, n, a) {
      ...
      8321: function (t, e, r) {
        ...
        !function (t) {
          ...
          function r(t, r) {
            ...
            try {
              for (var i = n(Object.keys(r)), s = i.next(); !s.done; s = i.next()) {
                var l = s.value,
                  u = r[l];
                "texClass" === l ? (t.texClass = u, t.setProperty(l, u)) : "movablelimits" === l ? (t.setProperty("movablelimits", u), (t.isKind("mo") || t.isKind("mstyle")) && t.attributes.set("movablelimits", u)) : "inferred" === l || (e.has(l) ? t.setProperty(l, u) : t.attributes.set(l, u));
              }
            } catch (t) {
              a = {
                error: t
          ...
          }, t.isType = u, t.isEmbellished = function (t) {
      ...
      4708: function (t, e, r) {
        ...
        !function (t) {
          t.variable = function (t, e) {
            ...
            a ? (r = t.create("token", "mn", o, a[0].replace(/[{}]/g, "")), t.i += a[0].length - 1) : r = t.create("token", "mo", o, e), t.Push(r);
      ...
      7702: function (t, e, r) {
        ...
        !function (t) {
          ...
          function p(t, e) {
            ...
            }([a[1].replace(/,/, "."), a[4], a[0].length]) : [null, null, 0];
          }
          function m(t) {
          ...
          function v(t, e, r) {
            if (r.match(/^[a-z]/i) && e.match(/(^|[^\\])(\\\\)*\\[a-z]+$/i) && (e += " "), e.length + r.length > t.configuration.options.maxBuffer) throw new c.default("MaxBufferSize", "MathJax internal buffer size exceeded; is there a recursive macro call?");
            return e + r;
          }
          function b(t, e) {
            ...
            for (var r = t.length, n = 0, a = "", o = 0, i = 0, s = !0, l = !1; o < r;) {
              ...
              switch (u) {
                ...
                case "}":
                  ...
                  break;
                default:
                  if (!n && -1 !== e.indexOf(u)) return [l ? "true" : b(a, i), u, t.slice(o)];
                  s = !1, l = !1;
              }
              a += u;
            }
          ...
          t.matchDimen = p, t.dimen2em = function (t) {
            var e = n(p(t), 2),
              a = e[0],
              o = e[1],
              i = parseFloat(a || "1"),
            ...
            if (a) i = new u.default("\\" + a + "l" + e, t.parser.stack.env, t).mml();else {
            ...
            if (l.default.appendChildren(f, [i, r]), a) i = new u.default("\\" + a + "r" + n, t.parser.stack.env, t).mml();else {
            ...
            return e && l.default.appendChildren(a, [g(t, e, "l")]), l.default.isType(r, "mrow") ? l.default.appendChildren(a, l.default.getChildren(r)) : l.default.appendChildren(a, [r]), n && l.default.appendChildren(a, [g(t, n, "r")]), a;
          }, t.mathPalette = g, t.fixInitialMO = function (t, e) {
            for (var r = 0, n = e.length; r < n; r++) {
              var a = e[r];
              if (a && !l.default.isType(a, "mspace") && (!l.default.isType(a, "TeXAtom") || l.default.getChildren(a)[0] && l.default.getChildren(l.default.getChildren(a)[0]).length)) {
            ...
            var a,
              ...
              p = 0;
            if (e.match(/\\?[${}\\]|\\\(|\\(eq)?ref\s*\{/)) {
              for (; f < e.length;) if ("$" === (a = e.charAt(f++))) "$" === h && 0 === p ? (o = t.create("node", "TeXAtom", [new u.default(e.slice(d, f - 1), {}, t.configuration).mml()]), l.push(o), h = "", d = f) : "" === h && (d < f - 1 && l.push(y(t, e.slice(d, f - 1), s)), h = "$", d = f);else if ("{" === a && "" !== h) p++;else if ("}" === a) {
                if ("}" === h && 0 === p) {
                  var m = new u.default(e.slice(d, f), {}, t.configuration).mml();
                  o = t.create("node", "TeXAtom", [m], s), l.push(o), h = "", d = f;
                } else "" !== h && p && p--;
              } else if ("\\" === a) if ("" === h && e.substr(f).match(/^(eq)?ref\s*\{/)) {
                var g = RegExp["$&"].length;
                d < f - 1 && l.push(y(t, e.slice(d, f - 1), s)), h = "}", d = f - 1, f += g;
              } else "(" === (a = e.charAt(f++)) && "" === h ? (d < f - 2 && l.push(y(t, e.slice(d, f - 2), s)), h = ")", d = f) : ")" === a && ")" === h && 0 === p ? (o = t.create("node", "TeXAtom", [new u.default(e.slice(d, f - 2), {}, t.configuration).mml()]), l.push(o), h = "", d = f) : a.match(/[${}\\]/) && "" === h && (f--, e = e.substr(0, f - 1) + e.substr(f));
              if ("" !== h) throw new c.default("MathNotTerminated", "Math not terminated in text box");
            }
            return d < e.length && l.push(y(t, e.slice(d), s)), null != r ? l = [t.create("node", "mstyle", l, {
              displaystyle: !1,
              scriptlevel: r
            })] : l.length > 1 && (l = [t.create("node", "mrow", l)]), l;
          }, t.internalText = y, t.underOver = function (e, r, n, a, o) {
            ...
            var c = u;
            return o && (c = e.create("node", "TeXAtom", [u], {
            ...
            for (var n = "", a = "", o = 0; o < r.length;) {
              var i = r.charAt(o++);
              if ("\\" === i) n += i + r.charAt(o++);else if ("#" === i) {
                if ("#" === (i = r.charAt(o++))) n += i;else {
                  if (!i.match(/[1-9]/) || parseInt(i, 10) > e.length) throw new c.default("IllegalMacroParam", "Illegal macro parameter reference");
            ...
            if (void 0 === e && (e = !0), !(++t.macroCount <= t.configuration.options.maxMacros)) throw e ? new c.default("MaxMacroSub1", "MathJax maximum macro substitution count exceeded; is here a recursive macro call?") : new c.default("MaxMacroSub2", "MathJax maximum substitution count exceeded; is there a recursive latex environment?");
            ...
            var s = function (t) {
              var e,
                ...
                s = {},
                l = t;
              for (; l;) o = (e = n(A(l, ["=", ","]), 3))[0], a = e[1], l = e[2], "=" === a ? (i = (r = n(A(l, [","]), 3))[0], a = r[1], l = r[2], i = "false" === i || "true" === i ? JSON.parse(i) : i, s[o] = i) : o && (s[o] = !0);
              return s;
            }(t);
            if (e) try {
              ...
              try {
                for (var l = n(r), u = l.next(); !u.done; u = l.next()) {
                  ...
                  if (c) {
                    ...
                    var d = a(this.stack.length ? this.Top().checkItem(f) : [null, !0], 2),
                      h = d[0],
                      p = d[1];
                    p && (h ? (this.Pop(), this.Push.apply(this, o([], a(h), !1))) : (this.stack.push(f), f.env ? (f.copyEnv && Object.assign(f.env, this.env), this.env = f.env) : f.env = this.env));
                  }
                }
              } catch (e) {
                t = {
      ...
      7628: function (t, e, r) {
        ...
        var d = function (t) {
          ...
          return a(e, t), e.prototype.contains = function (t) {
        ...
        var h = function (t) {
          ...
          return a(e, t), e.prototype.lookup = function (t) {
            return this.map.get(t);
        ...
        var m = function (t) {
          ...
          return a(e, t), e.prototype.parse = function (e) {
            var r = o(e, 2),
              n = r[0],
              a = r[1];
        ...
        var g = function (t) {
          ...
          return a(e, t), e.prototype.parserFor = function (t) {
            var e = this.lookup(t);
      ...
      7251: function (t, e, r) {
        ...
        var u = function (t, e, r, n, a, o, i, s) {
          void 0 === t && (t = ""), void 0 === e && (e = !1), void 0 === r && (r = !1), void 0 === n && (n = null), void 0 === a && (a = ""), void 0 === o && (o = ""), void 0 === i && (i = !1), void 0 === s && (s = ""), this.env = t, this.taggable = e, this.defaultTags = r, this.tag = n, this.tagId = a, this.tagFormat = o, this.noTag = i, this.labelId = s;
        };
        e.TagInfo = u;
        var c = function () {
          function t() {
            this.counter = 0, this.allCounter = 0, this.configuration = null, this.ids = {}, this.allIds = {}, this.labels = {}, this.allLabels = {}, this.redo = !1, this.refUpdate = !1, this.currentTag = new u(), this.history = [], this.stack = [], this.enTag = function (t, e) {
          ...
          return t.prototype.start = function (t, e, r) {
            ...
            this.history = [], this.stack = [], this.clearTag(), this.currentTag = new u("", void 0, void 0), this.labels = {}, this.ids = {}, this.counter = this.allCounter, this.redo = !1;
        ...
        var f = function (t) {
          ...
          return a(e, t), e.prototype.autoTag = function () {}, e.prototype.getTag = function () {
        ...
        var d = function (t) {
          ...
          return a(e, t), e.prototype.finalize = function (t, e) {
        ...
        var r = function () {
          ...
          return t.processString = function (e, r) {
            for (var n = e.split(t.pattern), a = 1, o = n.length; a < o; a += 2) {
              var i = n[a].charAt(0);
              if (i >= "0" && i <= "9") n[a] = r[parseInt(n[a], 10) - 1], "number" == typeof n[a] && (n[a] = n[a].toString());else if ("{" === i) {
                if ((i = n[a].substr(1)) >= "0" && i <= "9") n[a] = r[parseInt(n[a].substr(1, n[a].length - 2), 10) - 1], "number" == typeof n[a] && (n[a] = n[a].toString());else n[a].match(/^\{([a-z]+):%(\d+)\|(.*)\}$/) && (n[a] = "%" + n[a]);
              }
              null == n[a] && (n[a] = "???");
            }
            return n.join("");
        ...
        var s = i(r(7702)),
          ...
          f = function () {
            function t(t, e, r) {
              ...
              this.configuration.pushParser(this), this.stack = new l.default(this.itemFactory, i, !s || u), this.Parse(), this.Push(this.itemFactory.create("stop"));
            }
      ...
      3946: function (t, e, r) {
        ...
        e.AmsConfiguration = i.Configuration.create("ams", {
          ...
          init: function (t) {
            new c.CommandMap(u.NEW_OPS, {}, {}), t.append(i.Configuration.local({
              handler: {
                macro: [u.NEW_OPS]
              },
              priority: -1
      ...
      3632: function (t, e, r) {
        ...
        var s = r(8389),
          ...
          d = function (t) {
            ...
            return a(e, t), Object.defineProperty(e.prototype, "kind", {
              ...
              if (1 !== this.row.length) throw new c.default("MultlineRowsOneCol", "The rows within the %1 environment must have exactly one column", "multline");
              ...
              if (t.prototype.EndTable.call(this), this.table.length) {
                var e = this.table.length - 1,
                  r = -1;
                u.default.getAttribute(u.default.getChildren(this.table[0])[0], "columnalign") || u.default.setAttribute(u.default.getChildren(this.table[0])[0], "columnalign", f.TexConstant.Align.LEFT), u.default.getAttribute(u.default.getChildren(this.table[e])[0], "columnalign") || u.default.setAttribute(u.default.getChildren(this.table[e])[0], "columnalign", f.TexConstant.Align.RIGHT);
                var n = this.factory.configuration.tags.getTag();
                if (n) {
                  r = this.arraydef.side === f.TexConstant.Align.LEFT ? 0 : this.table.length - 1;
                  var a = this.table[r],
                    o = this.create("node", "mlabeledtr", [n].concat(u.default.getChildren(a)));
        ...
        var h = function (t) {
          ...
          return a(e, t), Object.defineProperty(e.prototype, "kind", {
            ...
            if (e && this.row.length > e) throw new c.default("XalignOverflow", "Extra %1 in row of %2", "&", this.name);
          }, e.prototype.EndRow = function () {
      ...
      8285: function (t, e, r) {
        ...
        new l.CharacterMap("AMSmath-mathchar0mo", c.default.mathchar0mo, {
        ...
        }, s.AmsMethods), new l.EnvironmentMap("AMSmath-environment", c.default.environment, {
          "equation*": ["Equation", null, !1],
          "eqnarray*": ["EqnArray", null, !1, !0, "rcl", f.default.cols(0, h.MATHSPACE.thickmathspace), ".5em"],
        ...
        }, s.AmsMethods), new l.DelimiterMap("AMSmath-delimiter", c.default.delimiter, {
          "\\lvert": ["|", {
          ...
          blacklozenge: "\u29eb",
          circledS: ["\u24c8", {
            mathvariant: u.TexConstant.Variant.NORMAL
          }],
          bigstar: "\u2605",
          sphericalangle: "\u2222",
          measuredangle: "\u2221",
          ...
          diagdown: "\u2572",
          Bbbk: ["k", {
            mathvariant: u.TexConstant.Variant.DOUBLESTRUCK
          }],
          yen: "\xa5",
          circledR: "\xae",
          checkmark: "\u2713",
      ...
      2684: function (t, e, r) {
        ...
        e.AmsMethods = {}, e.AmsMethods.AmsEqnArray = function (t, e, r, n, a, o, s) {
          ...
          var o,
            ...
            u = "",
            c = [];
          if (a || (s = t.GetBrackets("\\begin{" + l + "}")), (o = t.GetArgument("\\begin{" + l + "}")).match(/[^0-9]/)) throw new f.default("PositiveIntegerArg", "Argument to %1 must me a positive integer", "\\begin{" + l + "}");
          ...
          if (o.match(/[^0-9]/)) throw new f.default("PositiveIntegerArg", "Argument to %1 must me a positive integer", "\\begin{" + r.getName() + "}");
          var i = a ? "crl" : "rlc",
          ...
          t.configuration.handlers.retrieve(e.NEW_OPS).add(a, new d.Macro(a, e.AmsMethods.Macro, ["\\operatorname".concat(n, "{").concat(o, "}")]));
        }, e.AmsMethods.HandleOperatorName = function (t, e) {
          var r = t.GetStar(),
            a = i.default.trimSpaces(t.GetArgument(e)),
            o = new c.default(a, n(n({}, t.stack.env), {
          ...
          var r = a(m(t.ParseArg(e)), 2),
            ...
            f = t.ParseArg(e),
            d = f;
          n && (o ? n.replaceChild(t.create("node", "mphantom", [t.create("node", "mpadded", [i.default.copyNode(f, t)], {
            width: 0
          })]), l.default.getChildAt(n, 0)) : (d = t.create("node", "mmultiscripts", [f]), u && l.default.appendChildren(d, [l.default.getChildAt(u, 1) || t.create("node", "none"), l.default.getChildAt(u, 2) || t.create("node", "none")]), l.default.setProperty(d, "scriptalign", "left"), l.default.appendChildren(d, [t.create("node", "mprescripts"), l.default.getChildAt(n, 1) || t.create("node", "none"), l.default.getChildAt(n, 2) || t.create("node", "none")]))), u && d === f && (u.replaceChild(f, l.default.getChildAt(u, 0)), d = u);
          var h = t.create("node", "TeXAtom", [], {
            texClass: p.TEXCLASS.OP,
            movesupsub: !0,
            movablelimits: !0
          });
          o && (n && h.appendChild(n), h.appendChild(o)), h.appendChild(d), c && h.appendChild(c), t.Push(h);
          ...
          if (l.default.setAttribute(m, "voffset", "-.2em"), l.default.setAttribute(m, "height", "-.2em"), l.default.setChild(h, h.over, m), s) {
            var g = new c.default(s, t.stack.env, t.configuration).mml(),
              y = t.create("node", "mspace", [], {
                height: ".75em"
              });
            m = t.create("node", "mpadded", [g, y], o), l.default.setAttribute(m, "voffset", ".15em"), l.default.setAttribute(m, "depth", "-.15em"), l.default.setChild(h, h.under, m);
          }
          l.default.setProperty(h, "subsupOK", !0), t.Push(h);
        }, e.AmsMethods.HandleShove = function (t, e, r) {
          var n = t.stack.Top();
          if ("multline" !== n.kind) throw new f.default("CommandOnlyAllowedInEnv", "%1 only allowed in %2 environment", t.currentCS, "multline");
          if (n.Size()) throw new f.default("CommandAtTheBeginingOfLine", "%1 must come at the beginning of the line", t.currentCS);
          ...
          if (null == (r = o[r])) throw new f.default("IllegalAlign", "Illegal alignment specified in %1", t.currentCS);
          r && l.default.setProperties(h, {
            numalign: r,
            denomalign: r
          }), t.Push(h);
          ...
          if ("" !== a && l.default.setAttribute(c, "linethickness", a), (r || n) && (l.default.setProperty(c, "withDelims", !0), c = i.default.fixedFence(t.configuration, r, c, n)), "" !== o) {
            var d = parseInt(o, 10),
              h = ["D", "T", "S", "SS"][d];
            if (null == h) throw new f.default("BadMathStyleFor", "Bad math style for %1", t.currentCS);
      ...
      3606: function (t, e, r) {
        ...
        function b(t, e) {
          ...
          a[4] && i.attributes.set("mathvariant", a[4]), "mo" === o && (p.default.setProperty(i, "fixStretchy", !0), t.configuration.addNode("fixStretchy", i)), t.Push(i);
        }
        ...
        e.BaseTags = A, e.BaseConfiguration = f.Configuration.create("base", {
          handler: {
      ...
      8389: function (t, e, r) {
        ...
        var b = function (t) {
          ...
          return a(e, t), Object.defineProperty(e.prototype, "kind", {
            ...
            var e = o(this.Peek(2), 2),
              r = e[0],
              n = e[1];
            return !h.default.isType(r, "msubsup") || h.default.isType(r, "msup") ? [[this.create("node", "msup", [r, n]), t], !0] : (h.default.setChild(r, r.sup, n), [[r, t], !0]);
          }, e;
        }(p.BaseItem);
        e.PrimeItem = b;
        var A = function (t) {
          ...
          return a(e, t), Object.defineProperty(e.prototype, "kind", {
            ...
            if (e.isKind("mml")) {
              if (this.getProperty("primes")) if (2 !== n) h.default.setChild(r, 2, this.getProperty("primes"));else {
                h.default.setProperty(this.getProperty("primes"), "variantForm", !0);
                var a = this.create("node", "mrow", [this.getProperty("primes"), e.First]);
                e.First = a;
              }
              return h.default.setChild(r, n, e.First), null != this.getProperty("movesupsub") && h.default.setProperty(r, "movesupsub", this.getProperty("movesupsub")), [[this.factory.create("mml", r)], !0];
            }
        ...
        var M = function (t) {
          ...
          return a(e, t), Object.defineProperty(e.prototype, "kind", {
            ...
            if (e.isKind("over")) throw new f.default("AmbiguousUseOf", "Ambiguous use of %1", e.getName());
            if (e.isClose) {
              var r = this.create("node", "mfrac", [this.getProperty("num"), this.toMml(!1)]);
              return null != this.getProperty("thickness") && h.default.setAttribute(r, "linethickness", this.getProperty("thickness")), (this.getProperty("open") || this.getProperty("close")) && (h.default.setProperty(r, "withDelims", !0), r = d.default.fixedFence(this.factory.configuration, this.getProperty("open"), r, this.getProperty("close"))), [[this.factory.create("mml", r), e], !0];
            }
            return t.prototype.checkItem.call(this, e);
          }, e.prototype.toString = function () {
        ...
        var S = function (t) {
          ...
          return a(e, t), Object.defineProperty(e.prototype, "kind", {
            ...
            if (e.isKind("end")) {
              if (e.getName() !== this.getName()) throw new f.default("EnvBadEnd", "\\begin{%1} ended with \\end{%2}", this.getName(), e.getName());
              return this.getProperty("end") ? p.BaseItem.fail : [[this.factory.create("mml", this.toMml())], !0];
            }
            if (e.isKind("stop")) throw new f.default("EnvMissingEnd", "Missing \\end{%1}", this.getName());
            return t.prototype.checkItem.call(this, e);
          }, e;
        }(p.BaseItem);
        e.BeginItem = S;
        ...
        var C = function (t) {
          ...
          return a(e, t), Object.defineProperty(e.prototype, "kind", {
            ...
            if (e.isClose) throw new f.default("MissingBoxFor", "Missing box for %1", this.getName());
            if (e.isFinal) {
              var r = e.toMml();
        ...
        var E = function (t) {
          ...
          return a(e, t), Object.defineProperty(e.prototype, "isFinal", {
            get: function () {
              return !0;
            },
            enumerable: !1,
          ...
          return a(e, t), Object.defineProperty(e.prototype, "kind", {
            ...
            if (r) {
              ...
              if (!e.isKind("fn")) {
                ...
                if (h.default.isType(n, "mstyle") && n.childNodes.length && h.default.isType(n.childNodes[0].childNodes[0], "mspace") || h.default.isType(n, "mspace")) return [[r, e], !0];
                h.default.isEmbellished(n) && (n = h.default.getCoreMO(n));
                var a = h.default.getForm(n);
                if (null != a && [0, 0, 1, 1, 0, 1, 1, 0, 0, 0][a[2]]) return [[r, e], !0];
              }
              var o = this.create("token", "mo", {
        ...
        var I = function (t) {
          ...
          return a(e, t), Object.defineProperty(e.prototype, "kind", {
            ...
            return [[e = this.create("node", "TeXAtom", [o], {
        ...
        var F = function (t) {
          ...
          return a(e, t), Object.defineProperty(e.prototype, "kind", {
            ...
            if (e.isClose && !e.isKind("over")) {
              if (e.getProperty("isEntry")) return this.EndEntry(), this.clearEnv(), p.BaseItem.fail;
              if (e.getProperty("isCR")) return this.EndEntry(), this.EndRow(), this.clearEnv(), p.BaseItem.fail;
            ...
            return t && e.setProperty("scriptlevel", t), 4 === this.frame.length ? h.default.setAttribute(e, "frame", this.dashed ? "dashed" : "solid") : this.frame.length && (this.arraydef.rowlines && (this.arraydef.rowlines = this.arraydef.rowlines.replace(/none( none)+$/, "none")), h.default.setAttribute(e, "frame", ""), e = this.create("node", "menclose", [e], {
              notation: this.frame.join(" ")
            }), "none" === (this.arraydef.columnlines || "none") && "none" === (this.arraydef.rowlines || "none") || h.default.setAttribute(e, "data-padding", 0)), (this.getProperty("open") || this.getProperty("close")) && (e = d.default.fenced(this.factory.configuration, this.getProperty("open"), e, this.getProperty("close"))), e;
          }, e.prototype.EndEntry = function () {
            var t = this.create("node", "mtd", this.nodes);
            this.hfill.length && (0 === this.hfill[0] && h.default.setAttribute(t, "columnalign", "right"), this.hfill[this.hfill.length - 1] === this.Size() && h.default.setAttribute(t, "columnalign", h.default.getAttribute(t, "columnalign") ? "center" : "left")), this.row.push(t), this.Clear(), this.hfill = [];
          }, e.prototype.EndRow = function () {
            var t;
      ...
      4962: function (t, e, r) {
        ...
        var s = o(r(7628)),
          ...
          d = r(8921),
          h = r(6914);
        new s.RegExpMap("letter", c.default.variable, /[a-z]/i), new s.RegExpMap("digit", c.default.digit, /[0-9.,]/), new s.RegExpMap("command", c.default.controlSequence, /^\\/), new s.MacroMap("special", {
          "{": "Open",
          "}": "Close",
          "~": "Tilde",
          "^": "Superscript",
          ...
          "\xa0": "Space",
          "\u2019": "Prime"
        }, u.default), new s.CharacterMap("mathchar0mi", c.default.mathchar0mi, {
          alpha: "\u03b1",
          beta: "\u03b2",
          gamma: "\u03b3",
          delta: "\u03b4",
          ...
          mmlToken: "MmlToken"
        }, u.default), new s.EnvironmentMap("environment", c.default.environment, {
          array: ["AlignedArray"],
          equation: ["Equation", null, !0],
          eqnarray: ["EqnArray", null, !0, !0, "rcl", f.default.cols(0, h.MATHSPACE.thickmathspace), ".5em"]
        }, u.default), new s.CharacterMap("not_remap", null, {
          "\u2190": "\u219a",
          "\u2192": "\u219b",
          "\u2194": "\u21ae",
          "\u21d0": "\u21cd",
      ...
      724: function (t, e, r) {
        ...
        function x(t, e) {
          ...
          if (i.leftRoot || i.upRoot) {
            var s = {};
            i.leftRoot && (s.width = i.leftRoot), i.upRoot && (s.voffset = i.upRoot, s.height = i.upRoot), o = t.create("node", "mpadded", [o], s);
          }
          return r.inRoot = n, o;
        }
        A.Open = function (t, e) {
        ...
        }, A.Space = function (t, e) {}, A.Superscript = function (t, e) {
          var r, n, a;
          t.GetNext().match(/\d/) && (t.string = t.string.substr(0, t.i + 1) + " " + t.string.substr(t.i + 1));
          var o = t.stack.Top();
          o.isKind("prime") ? (a = (r = s(o.Peek(2), 2))[0], n = r[1], t.stack.Pop()) : (a = t.stack.Prev()) || (a = t.create("token", "mi", {}, ""));
          var i = c.default.getProperty(a, "movesupsub"),
            l = c.default.isType(a, "msubsup") ? a.sup : a.over;
          if (c.default.isType(a, "msubsup") && !c.default.isType(a, "msup") && c.default.getChildAt(a, a.sup) || c.default.isType(a, "munderover") && !c.default.isType(a, "mover") && c.default.getChildAt(a, a.over) && !c.default.getProperty(a, "subsupOK")) throw new f.default("DoubleExponent", "Double exponent: use braces to clarify");
          c.default.isType(a, "msubsup") && !c.default.isType(a, "msup") || (i ? ((!c.default.isType(a, "munderover") || c.default.isType(a, "mover") || c.default.getChildAt(a, a.over)) && (a = t.create("node", "munderover", [a], {
            movesupsub: !0
          })), l = a.over) : l = (a = t.create("node", "msubsup", [a])).sup), t.Push(t.itemFactory.create("subsup", a).setProperties({
            position: l,
            primes: n,
            movesupsub: i
          }));
          ...
          if (c.default.isType(a, "msubsup") && !c.default.isType(a, "msup") && c.default.getChildAt(a, a.sub) || c.default.isType(a, "munderover") && !c.default.isType(a, "mover") && c.default.getChildAt(a, a.under) && !c.default.getProperty(a, "subsupOK")) throw new f.default("DoubleSubscripts", "Double subscripts: use braces to clarify");
          c.default.isType(a, "msubsup") && !c.default.isType(a, "msup") || (i ? ((!c.default.isType(a, "munderover") || c.default.isType(a, "mover") || c.default.getChildAt(a, a.under)) && (a = t.create("node", "munderover", [a], {
            movesupsub: !0
          })), l = a.under) : l = (a = t.create("node", "msubsup", [a])).sub), t.Push(t.itemFactory.create("subsup", a).setProperties({
            position: l,
            primes: n,
            movesupsub: i
          }));
          ...
          var r = t.stack.Prev();
          if (r || (r = t.create("node", "mi")), c.default.isType(r, "msubsup") && !c.default.isType(r, "msup") && c.default.getChildAt(r, r.sup)) throw new f.default("DoubleExponentPrime", "Prime causes double exponent: use braces to clarify");
          var n = "";
          t.i--;
          do {
          ...
          var a = t.GetArgument(e),
            o = new d.default(a, n(n({}, t.stack.env), {
              font: r,
          ...
          t.stack.env.style = r, t.stack.env.level = a, t.Push(t.itemFactory.create("style").setProperty("styles", {
            displaystyle: n,
            scriptlevel: a
          }));
          ...
          if (!n || c.default.getTexClass(c.default.getCoreMO(n)) !== m.TEXCLASS.OP && null == c.default.getProperty(n, "movesupsub")) throw new f.default("MisplacedLimits", "%1 is allowed only on operators", t.currentCS);
          var a,
            o = t.stack.Top();
          c.default.isType(n, "munderover") && !r ? (a = t.create("node", "msubsup"), c.default.copyChildren(n, a), n = o.Last = a) : c.default.isType(n, "msubsup") && r && (a = t.create("node", "munderover"), c.default.copyChildren(n, a), n = o.Last = a), c.default.setProperty(n, "movesupsub", !!r), c.default.setProperties(c.default.getCoreMO(n), {
            movablelimits: !1
          }), (c.default.getAttribute(n, "movablelimits") || c.default.getProperty(n, "movablelimits")) && c.default.setProperties(n, {
            movablelimits: !1
          });
        }, A.Over = function (t, e, r, n) {
          var a = t.itemFactory.create("over").setProperty("name", t.currentCS);
          r || n ? (a.setProperty("open", r), a.setProperty("close", n)) : e.match(/withdelims$/) && (a.setProperty("open", t.GetDelimiter(e)), a.setProperty("close", t.GetDelimiter(e))), e.match(/^\\above/) ? a.setProperty("thickness", t.GetDimen(e)) : (e.match(/^\\atop/) || r || n) && a.setProperty("thickness", 0), t.Push(a);
        }, A.Frac = function (t, e) {
          var r = t.ParseArg(e),
            n = t.ParseArg(e),
          ...
          if (!t.stack.env.inRoot) throw new f.default("MisplacedMoveRoot", "%1 can appear only within a root", t.currentCS);
          if (t.stack.global[r]) throw new f.default("MultipleMoveRoot", "Multiple use of %1", t.currentCS);
          var n = t.GetArgument(e);
          if (!n.match(/-?[0-9]+/)) throw new f.default("IntegerArg", "The argument to %1 must be an integer", t.currentCS);
          ...
          (c.default.isType(u, "mo") || c.default.getProperty(u, "movablelimits")) && c.default.setProperties(u, {
            movablelimits: !1
          });
          ...
          var r = t.ParseArg(e),
            n = t.ParseArg(e),
            a = t.ParseArg(e);
          p.default.checkMovableLimits(a), r.isKind("mo") && c.default.setAttribute(r, "accent", !1), n.isKind("mo") && c.default.setAttribute(n, "accent", !1);
          ...
          if (r === m.TEXCLASS.OP) {
            ...
            l ? (i.mathvariant = h.TexConstant.Variant.NORMAL, a = t.create("token", "mi", i, l[1])) : (o = new d.default(s, t.stack.env, t.configuration).mml(), a = t.create("node", "TeXAtom", [o], i)), n = t.itemFactory.create("fn", a);
          ...
          if (!r || !r.isToken) throw new f.default("NotMathMLToken", "%1 is not a token element", n);
          for (; "" !== a;) {
            var l = a.match(/^([a-z]+)\s*=\s*('[^']*'|"[^"]*"|[^ ,]*)\s*,?\s*/i);
            if (!l) throw new f.default("InvalidMathMLAttr", "Invalid MathML attribute: %1", a);
            if (!r.attributes.hasDefault(l[1]) && !M[l[1]]) throw new f.default("UnknownAttrForElement", "%1 is not a recognized attribute for %2", l[1], n);
            var u = p.default.MmlFilterAttribute(t, l[1], l[2].replace(/^(['"])(.*)\1$/, "$2"));
            u && ("true" === u.toLowerCase() ? u = !0 : "false" === u.toLowerCase() && (u = !1), i[l[1]] = u, s.push(l[1])), a = a.substr(l[0].length);
          }
          ...
          (r || n) && (a = t.create("node", "mpadded", [a]), n && (c.default.setAttribute(a, "height", 0), c.default.setAttribute(a, "depth", 0)), r && c.default.setAttribute(a, "width", 0));
          ...
          r && (o = t.create("node", "mpadded", [o], {
            voffset: r
          }), r.match(/^\-/) ? (c.default.setAttribute(o, "height", r), c.default.setAttribute(o, "depth", "+" + r.substr(1))) : c.default.setAttribute(o, "height", "+" + r)), t.Push(o);
          ...
          var o = t.create("node", "TeXAtom", [t.create("node", "menclose", a, {
            notation: "box"
          })], {
          ...
          var c = t.GetNext();
          if ("" === c) throw new f.default("MissingArgFor", "Missing argument for %1", t.currentCS);
          "{" === c ? t.i++ : (t.string = c + "}" + t.string.slice(t.i + 1), t.i = 0);
          var d = t.itemFactory.create("array").setProperty("requireClose", !0);
          d.arraydef = {
            rowspacing: i || "4pt",
            columnspacing: o || "1em"
          }, l && d.setProperty("isCases", !0), u && (d.setProperty("isNumbered", !0), d.arraydef.side = u), (r || n) && (d.setProperty("open", r), d.setProperty("close", n)), "D" === s && (d.arraydef.displaystyle = !0), null != a && (d.arraydef.columnalign = a), t.Push(d);
          ...
          if (r.getProperty("isCases") || n) {
            for (var a = t.string, o = 0, i = -1, s = t.i, l = a.length, u = n ? new RegExp("^\\\\end\\s*\\{".concat(n.replace(/\*/, "\\*"), "\\}")) : null; s < l;) {
              var c = a.charAt(s);
              if ("{" === c) o++, s++;else if ("}" === c) 0 === o ? l = 0 : (0 === --o && i < 0 && (i = s - t.i), s++);else {
                if ("&" === c && 0 === o) throw new f.default("ExtraAlignTab", "Extra alignment tab in \\cases text");
                if ("\\" === c) {
                  var d = a.substr(s);
          ...
          if (void 0 === r && (r = !1), !r && ("*" === t.string.charAt(t.i) && t.i++, "[" === t.string.charAt(t.i))) {
            var a = t.GetBrackets(e, ""),
              ...
              i = o[0],
              l = o[1];
            if (a && !i) throw new f.default("BracketMustBeDimension", "Bracket argument to %1 must be a dimension", t.currentCS);
            n = i + l;
          }
          t.Push(t.itemFactory.create("cell").setProperties({
            isCR: !0,
          ...
          var c,
            d = t.stack.Top();
          d instanceof u.ArrayItem ? n && d.addRowSpacing(n) : (n && (c = t.create("node", "mspace", [], {
            depth: n
          }), t.Push(c)), c = t.create("node", "mspace", [], {
            linebreak: h.TexConstant.LineBreak.NEWLINE
          }), t.Push(c));
        }, A.HLine = function (t, e, r) {
          null == r && (r = "solid");
          var n = t.stack.Top();
          if (!(n instanceof u.ArrayItem) || n.Size()) throw new f.default("Misplaced", "Misplaced %1", t.currentCS);
          if (n.table.length) {
          ...
          var r = t.stack.Top();
          if (!(r instanceof u.ArrayItem)) throw new f.default("UnsupportedHFill", "Unsupported use of %1", t.currentCS);
          r.hfill.push(r.Size());
        }, A.BeginEnd = function (t, e) {
          var r = t.GetArgument(e);
          if (r.match(/\\/i)) throw new f.default("InvalidEnv", "Invalid environment name '%1'", r);
          ...
          return t.Push(e), p.default.checkEqnEnv(t), t.itemFactory.create("equation", r).setProperty("name", e.getName());
        }, A.EqnArray = function (t, e, r, n, a, o) {
          t.Push(e), n && p.default.checkEqnEnv(t), a = (a = a.replace(/[^clr]/g, "").split("").join(" ")).replace(/l/g, "left").replace(/r/g, "right").replace(/c/g, "center");
          ...
          if ("" !== r && !t.tags.refUpdate) {
            if (t.tags.label) throw new f.default("MultipleCommand", "Multiple %1", t.currentCS);
            if (t.tags.label = r, (t.tags.allLabels[r] || t.tags.labels[r]) && !t.options.ignoreDuplicateLabels) throw new f.default("MultipleLabel", "Label '%1' multiply defined", r);
      ...
      3274: function (t, e, r) {
        ...
        e.ConfigMacrosConfiguration = i.Configuration.create("configmacros", {
          init: function (t) {
            new l.CommandMap(h, {}, {}), new l.EnvironmentMap(p, u.default.environment, {}, {}), t.append(i.Configuration.local({
              handler: {
                macro: [h],
                environment: [p]
              },
              ...
              try {
                for (var i = a(Object.keys(o)), s = i.next(); !s.done; s = i.next()) {
                  var l = s.value,
                    ...
                    d = Array.isArray(u[2]) ? new c.Macro(l, f.default.MacroWithTemplate, u.slice(0, 2).concat(u[2])) : new c.Macro(l, f.default.Macro, u);
                  n.add(l, d);
                }
              } catch (t) {
                e = {
      ...
      2200: function (t, e, r) {
        ...
        e.NewcommandConfiguration = l.Configuration.create("newcommand", {
          ...
          init: function (t) {
            new d.DelimiterMap(c.default.NEW_DELIMITER, f.default.delimiter, {}), new d.CommandMap(c.default.NEW_COMMAND, {}, {}), new d.EnvironmentMap(c.default.NEW_ENVIRONMENT, f.default.environment, {}, {}), t.append(l.Configuration.local({
              handler: {
                character: [],
          ...
          d = {
            ...
            MacroDef: function (t, e) {
              var r = f.default.GetCSname(t, e),
                ...
                a = t.GetArgument(e);
              n instanceof Array ? f.default.addMacro(t, r, d.MacroWithTemplate, [a].concat(n)) : f.default.addMacro(t, r, d.Macro, [a, n]);
            },
            Let: function (t, e) {
              var r = f.default.GetCSname(t, e),
                n = t.GetNext();
              ...
              if ("\\" !== n) {
                ...
                if (i) return void f.default.addDelimiter(t, "\\" + r, i.char, i.attributes);
                ...
                f.default.addMacro(t, r, function (t, e) {
            ...
            MacroWithTemplate: function (t, e, r, n) {
              ...
              if (i) {
                var l = [];
                if (t.GetNext(), a[0] && !f.default.MatchParam(t, a[0])) throw new s.default("MismatchUseDef", "Use of %1 doesn't match its definition", e);
                for (var u = 0; u < i; u++) l.push(f.default.GetParameter(t, e, a[u + 1]));
            ...
            BeginEnv: function (t, e, r, n, a, o) {
              ...
              if (a) {
                ...
                for (var u = s.length; u < a; u++) s.push(t.GetArgument("\\begin{" + e.getName() + "}"));
                r = c.default.substituteArgs(t, s, r), n = c.default.substituteArgs(t, [], n);
              }
              return t.string = c.default.addArgs(t, r, t.string.slice(t.i)), t.i = 0, t.itemFactory.create("beginEnv").setProperty("name", e.getName());
            }
          };
      ...
      4303: function (t, e, r) {
        ...
        function g(t, e) {
          ...
          if (o.indexOf(i) < 0) {
            ...
            if (l) {
              var u = m[e] || {};
              l.options && 1 === Object.keys(l.options).length && l.options[i] && ((r = {})[i] = u, u = r), t.configuration.add(i, t, u);
        ...
        function y(t, e) {
          ...
          if (!(n.hasOwnProperty(a) ? n[a] : n.hasOwnProperty(e) ? n[e] : r.defaultAllow)) throw new u.default("BadRequire", 'Extension "%1" is not allowed to be loaded', a);
          f.Package.packages.has(a) ? g(t.configuration.packageData.get("require").jax, a) : h.mathjax.retryAfter(d.Loader.load(a));
        }
        e.RequireLoad = y, e.RequireMethods = {
          Require: function (t, e) {
            var r = t.GetArgument(e);
            if (r.match(/[^_a-zA-Z0-9]/) || "" === r) throw new u.default("BadPackageName", "Argument for %1 is not a valid package name", e);
            y(t, r);
          }
        }, e.options = {
          require: {
  ...
  !function () {
      ...
      _: {
        input: {
          ...
          tex: {
            ...
            noundefined: {
              NoUndefinedConfiguration: N
            },
            require: {
              RequireConfiguration: F
            }
          }
        }
      }
    ...
    var j = r(9077);
    r(847).Loader.preLoad("input/tex-base", "[tex]/ams", "[tex]/newcommand", "[tex]/noundefined", "[tex]/require", "[tex]/autoload", "[tex]/configmacros"), function () {
      ...
      if (MathJax.startup) {
        ...
        MathJax.config.tex.packages = t, r && (0, j.insert)(MathJax.config.tex, {
          packages: r
        });
      }
