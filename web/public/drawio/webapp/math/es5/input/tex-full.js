...
!function () {
  ...
  var t = {
      ...
      7205: function (t, e, r) {
        ...
        var v = function (t) {
          function e(r) {
            ...
            return (0, c.userOptions)(h.options, a), f.config(n), e.tags(h, f), n.postFilters.add(p.default.cleanSubSup, -6), n.postFilters.add(p.default.setInherited, -5), n.postFilters.add(p.default.moveLimits, -4), n.postFilters.add(p.default.cleanStretchy, -3), n.postFilters.add(p.default.cleanAttributes, -2), n.postFilters.add(p.default.combineRelations, -1), n;
          }
          return o(e, t), e.configure = function (t) {
            var e = new y.ParserConfiguration(t, ["tex"]);
            return e.init(), e;
          }, e.tags = function (t, e) {
            g.TagsFactory.addTags(e.tags), g.TagsFactory.setDefault(t.options.tags), t.tags = g.TagsFactory.getDefault(), t.tags.configuration = t;
            ...
            try {
              var a = new f.default(this.latex, {
                display: o,
                isInner: !1
              }, this.parseOptions);
            ...
            return r = this.parseOptions.nodeFactory.create("node", "math", [r]), (null == n ? void 0 : n.indentalign) && d.default.setAttribute(r, "indentalign", n.indentalign), o && d.default.setAttribute(r, "display", "block"), this.parseOptions.tags.finishEquation(t), this.parseOptions.root = r, this.executeFilters(this.postFilters, t, e, this.parseOptions), this.mathNode = this.parseOptions.root, this.mathNode;
          ...
          }, e.NAME = "TeX", e.OPTIONS = a(a({}, l.AbstractInputJax.OPTIONS), {
            FindTeX: null,
            packages: ["base"],
      ...
      6552: function (t, e, r) {
        ...
        var a,
          ...
          p = function () {
            function t(t, e, r, n, o, a, i, s, l, c, u, p, d) {
              void 0 === e && (e = {}), void 0 === r && (r = {}), void 0 === n && (n = {}), void 0 === o && (o = {}), void 0 === a && (a = {}), void 0 === i && (i = {}), void 0 === s && (s = []), void 0 === l && (l = []), void 0 === c && (c = null), void 0 === u && (u = null), this.name = t, this.handler = e, this.fallback = r, this.items = n, this.tags = o, this.options = a, this.nodes = i, this.preprocessors = s, this.postprocessors = l, this.initMethod = c, this.configMethod = u, this.priority = p, this.parser = d, this.handler = Object.assign({
                character: [],
                delimiter: [],
                macro: [],
                environment: []
            ...
            return t.makeProcessor = function (t, e) {
        ...
        var d = function () {
          function t(t, e) {
            var r, o, a, i;
            void 0 === e && (e = ["tex"]), this.initMethod = new l.FunctionList(), this.configMethod = new l.FunctionList(), this.configurations = new c.PrioritizedList(), this.parsers = [], this.handlers = new s.SubHandlers(), this.items = {}, this.tags = {}, this.options = {}, this.nodes = {}, this.parsers = e;
            try {
          ...
          return t.prototype.init = function () {
            ...
            u.TagsFactory.addTags(s.tags), (0, i.defaultOptions)(l.options, s.options), (0, i.userOptions)(l.options, r), this.addFilters(e, s), s.config && s.config(this, e);
            ...
            e = e || t.priority, t.initMethod && this.initMethod.add(t.initMethod[0], t.initMethod[1]), t.configMethod && this.configMethod.add(t.configMethod[0], t.configMethod[1]), this.handlers.add(t.handler, t.fallback, e), Object.assign(this.items, t.items), Object.assign(this.tags, t.tags), (0, i.defaultOptions)(this.options, t.options), Object.assign(this.nodes, t.nodes);
          ...
          t.cleanStretchy = function (t) {
            ...
            try {
              for (var p = n(t.data.getList("mo")), d = p.next(); !d.done; d = p.next()) {
                var f = d.value;
                if (!f.getProperty("relationsCombined") && f.parent && (!f.parent || s.default.isType(f.parent, "mrow")) && s.default.getTexClass(f) === i.TEXCLASS.REL) {
                  for (var h = f.parent, m = void 0, g = h.childNodes, y = g.indexOf(f) + 1, v = s.default.getProperty(f, "variantForm"); y < g.length && (m = g[y]) && s.default.isType(m, "mo") && s.default.getTexClass(m) === i.TEXCLASS.REL;) {
                    if (v !== s.default.getProperty(m, "variantForm") || !r(f, m)) {
                      null == f.attributes.getExplicit("rspace") && s.default.setAttribute(f, "rspace", "0pt"), null == m.attributes.getExplicit("lspace") && s.default.setAttribute(m, "lspace", "0pt");
                      break;
                    }
            ...
            o = function (t, e, r) {
              ...
              try {
                for (var l = n(t.getList("m" + e + r)), c = l.next(); !c.done; c = l.next()) {
                  ...
                  if (!p[u[e]] || !p[u[r]]) {
                    var d = u.parent,
                      f = p[u[e]] ? t.nodeFactory.create("node", "m" + e, [p[u.base], p[u[e]]]) : t.nodeFactory.create("node", "m" + r, [p[u.base], p[u[r]]]);
      ...
      2982: function (t, e, r) {
        ...
        var i = r(9649),
          ...
          c = function (t) {
            ...
            return o(e, t), e.prototype.getPatterns = function () {
              var t = this,
                e = this.options,
                r = [],
                n = [],
              ...
              }), r.length && n.push(r.sort(s.sortLength).join("|")), e.processEnvironments && (n.push("\\\\begin\\s*\\{([^}]*)\\}"), this.env = a, a++), e.processEscapes && o.push("\\\\([\\\\$])"), e.processRefs && o.push("(\\\\(?:eq)?ref\\s*\\{[^}]*\\})"), o.length && (n.push("(" + o.join("|") + ")"), this.sub = a), this.start = new RegExp(n.join("|"), "g"), this.hasPatterns = n.length > 0;
              ...
              for (var o, i = a(n, 3), s = i[0], c = i[1], u = i[2], p = u.lastIndex = r.index + r[0].length, d = 0; o = u.exec(t);) {
                if ((o[1] || o[0]) === s && 0 === d) return (0, l.protoItem)(r[0], t.substr(p, o.index - p), o[0], e, r.index, o.index + o[0].length, c);
                "{" === o[0] ? d++ : "}" === o[0] && d && d--;
              }
              return null;
              ...
              for (this.start.lastIndex = 0; n = this.start.exec(r);) {
                if (void 0 !== n[this.env] && this.env) {
                  ...
                  (o = this.findEnd(r, e, n, ["{" + n[this.env] + "}", !0, this.endPattern(null, a)])) && (o.math = o.open + o.math + o.close, o.open = o.close = "");
                } else if (void 0 !== n[this.sub] && this.sub) {
                  var i = n[this.sub];
                  a = n.index + n[this.sub].length;
                  o = 2 === i.length ? (0, l.protoItem)("", i.substr(1), "", e, n.index, a) : (0, l.protoItem)("", i, "", e, n.index, a, !1);
      ...
      2910: function (t, e, r) {
        ...
        var l = function () {
          ...
          return t.prototype.add = function (t, e, r) {
            var o, s;
      ...
      8644: function (t, e, r) {
        ...
        var i = a(r(8321)),
          s = function () {
            ...
            return t.createNode = function (t, e, r, n, o) {
      ...
      8321: function (t, e, r) {
        ...
        var i,
          ...
          l = r(9946);
        !function (t) {
          var e = new Map([["autoOP", !0], ["fnOP", !0], ["movesupsub", !0], ["subsupOK", !0], ["texprimestyle", !0], ["useHeight", !0], ["variantForm", !0], ["withDelims", !0], ["mathaccent", !0], ["open", !0], ["close", !0]]);
          function r(t, r) {
            var o, a;
            try {
              for (var i = n(Object.keys(r)), s = i.next(); !s.done; s = i.next()) {
                var l = s.value,
                  c = r[l];
                "texClass" === l ? (t.texClass = c, t.setProperty(l, c)) : "movablelimits" === l ? (t.setProperty("movablelimits", c), (t.isKind("mo") || t.isKind("mstyle")) && t.attributes.set("movablelimits", c)) : "inferred" === l || (e.has(l) ? t.setProperty(l, c) : t.attributes.set(l, c));
              }
            } catch (t) {
              o = {
                error: t
          ...
          t.createEntity = function (t) {
            ...
            t.setProperty(e, r);
          }, t.setProperties = r, t.getProperty = function (t, e) {
          ...
          }, t.setChild = i, t.copyChildren = function (t, e) {
          ...
          }, t.isType = c, t.isEmbellished = function (t) {
        ...
        !function (t) {
          t.variable = function (t, e) {
            var r = c.default.getFontDef(t),
              n = t.stack.env;
            n.multiLetterIdentifiers && "" !== n.font && (e = t.string.substr(t.i - 1).match(n.multiLetterIdentifiers)[0], t.i += e.length - 1, r.mathvariant === l.TexConstant.Variant.NORMAL && n.noAutoOP && e.length > 1 && (r.autoOP = !1));
            ...
            o ? (r = t.create("token", "mn", a, o[0].replace(/[{}]/g, "")), t.i += o[0].length - 1) : r = t.create("token", "mo", a, e), t.Push(r);
            ...
            var i = a[0],
              s = t.itemFactory.create("begin").setProperties({
                name: e,
                end: i
              });
      ...
      7702: function (t, e, r) {
        ...
        !function (t) {
          ...
          function h(t, e) {
            ...
            }([o[1].replace(/,/, "."), o[4], o[0].length]) : [null, null, 0];
          }
          function m(t) {
          ...
          function v(t, e, r) {
            if (r.match(/^[a-z]/i) && e.match(/(^|[^\\])(\\\\)*\\[a-z]+$/i) && (e += " "), e.length + r.length > t.configuration.options.maxBuffer) throw new u.default("MaxBufferSize", "MathJax internal buffer size exceeded; is there a recursive macro call?");
            return e + r;
          }
          function b(t, e) {
            ...
            for (var r = t.length, n = 0, o = "", a = 0, i = 0, s = !0, l = !1; a < r;) {
              ...
              switch (c) {
                ...
                case "}":
                  ...
                  break;
                default:
                  if (!n && -1 !== e.indexOf(c)) return [l ? "true" : b(o, i), c, t.slice(a)];
                  s = !1, l = !1;
              }
              o += c;
            }
            if (n) throw new u.default("ExtraOpenMissingClose", "Extra open brace or missing close brace");
            return [l ? "true" : b(o, i), "", t.slice(a)];
          }
          t.matchDimen = h, t.dimen2em = function (t) {
            var e = n(h(t), 2),
              o = e[0],
              a = e[1],
              i = parseFloat(o || "1"),
            ...
            if (o) i = new c.default("\\" + o + "l" + e, t.parser.stack.env, t).mml();else {
            ...
            if (l.default.appendChildren(p, [i, r]), o) i = new c.default("\\" + o + "r" + n, t.parser.stack.env, t).mml();else {
            ...
            return e && l.default.appendChildren(o, [g(t, e, "l")]), l.default.isType(r, "mrow") ? l.default.appendChildren(o, l.default.getChildren(r)) : l.default.appendChildren(o, [r]), n && l.default.appendChildren(o, [g(t, n, "r")]), o;
          }, t.mathPalette = g, t.fixInitialMO = function (t, e) {
            for (var r = 0, n = e.length; r < n; r++) {
              var o = e[r];
              if (o && !l.default.isType(o, "mspace") && (!l.default.isType(o, "TeXAtom") || l.default.getChildren(o)[0] && l.default.getChildren(l.default.getChildren(o)[0]).length)) {
            ...
            var o,
              ...
              h = 0;
            if (e.match(/\\?[${}\\]|\\\(|\\(eq)?ref\s*\{/)) {
              for (; p < e.length;) if ("$" === (o = e.charAt(p++))) "$" === f && 0 === h ? (a = t.create("node", "TeXAtom", [new c.default(e.slice(d, p - 1), {}, t.configuration).mml()]), l.push(a), f = "", d = p) : "" === f && (d < p - 1 && l.push(y(t, e.slice(d, p - 1), s)), f = "$", d = p);else if ("{" === o && "" !== f) h++;else if ("}" === o) {
                if ("}" === f && 0 === h) {
                  var m = new c.default(e.slice(d, p), {}, t.configuration).mml();
                  a = t.create("node", "TeXAtom", [m], s), l.push(a), f = "", d = p;
                } else "" !== f && h && h--;
              } else if ("\\" === o) if ("" === f && e.substr(p).match(/^(eq)?ref\s*\{/)) {
                var g = RegExp["$&"].length;
                d < p - 1 && l.push(y(t, e.slice(d, p - 1), s)), f = "}", d = p - 1, p += g;
              } else "(" === (o = e.charAt(p++)) && "" === f ? (d < p - 2 && l.push(y(t, e.slice(d, p - 2), s)), f = ")", d = p) : ")" === o && ")" === f && 0 === h ? (a = t.create("node", "TeXAtom", [new c.default(e.slice(d, p - 2), {}, t.configuration).mml()]), l.push(a), f = "", d = p) : o.match(/[${}\\]/) && "" === f && (p--, e = e.substr(0, p - 1) + e.substr(p));
              if ("" !== f) throw new u.default("MathNotTerminated", "Math not terminated in text box");
            }
            return d < e.length && l.push(y(t, e.slice(d), s)), null != r ? l = [t.create("node", "mstyle", l, {
              displaystyle: !1,
              scriptlevel: r
            })] : l.length > 1 && (l = [t.create("node", "mrow", l)]), l;
          }, t.internalText = y, t.underOver = function (e, r, n, o, a) {
            ...
            var u = c;
            return a && (u = e.create("node", "TeXAtom", [c], {
            ...
            (l.default.getProperty(t, "movablelimits") || e && e[3] && e[3].movablelimits) && l.default.setProperties(t, {
              movablelimits: !1
            });
            ...
            return "t" === (r = t.trimSpaces(r || "")) ? e.arraydef.align = "baseline 1" : "b" === r ? e.arraydef.align = "baseline -1" : "c" === r ? e.arraydef.align = "axis" : r && (e.arraydef.align = r), e;
          }, t.substituteArgs = function (t, e, r) {
            for (var n = "", o = "", a = 0; a < r.length;) {
              var i = r.charAt(a++);
              if ("\\" === i) n += i + r.charAt(a++);else if ("#" === i) {
                if ("#" === (i = r.charAt(a++))) n += i;else {
                  if (!i.match(/[1-9]/) || parseInt(i, 10) > e.length) throw new u.default("IllegalMacroParam", "Illegal macro parameter reference");
                  o = v(t, v(t, o, n), e[parseInt(i, 10) - 1]), n = "";
                }
              } else n += i;
            }
            return v(t, o, n);
          }, t.addArgs = v, t.checkMaxMacros = function (t, e) {
            if (void 0 === e && (e = !0), !(++t.macroCount <= t.configuration.options.maxMacros)) throw e ? new u.default("MaxMacroSub1", "MathJax maximum macro substitution count exceeded; is here a recursive macro call?") : new u.default("MaxMacroSub2", "MathJax maximum substitution count exceeded; is there a recursive latex environment?");
          }, t.checkEqnEnv = function (t) {
            if (t.stack.global.eqnenv) throw new u.default("ErroneousNestingEq", "Erroneous nesting of equation structures");
            ...
            var s = function (t) {
              var e,
                ...
                s = {},
                l = t;
              for (; l;) a = (e = n(x(l, ["=", ","]), 3))[0], o = e[1], l = e[2], "=" === o ? (i = (r = n(x(l, [","]), 3))[0], o = r[1], l = r[2], i = "false" === i || "true" === i ? JSON.parse(i) : i, s[a] = i) : a && (s[a] = !0);
              return s;
            }(t);
            if (e) try {
              for (var l = o(Object.keys(s)), c = l.next(); !c.done; c = l.next()) {
                ...
                if (!e.hasOwnProperty(p)) {
                  if (r) throw new u.default("InvalidOption", "Invalid option: %1", p);
                  delete s[p];
                }
              }
            } catch (t) {
      ...
      9874: function (t, e, r) {
        ...
        var s = i(r(8321)),
          l = function () {
            function t(t, e, r) {
              this._factory = t, this._env = e, this.global = {}, this.stack = [], this.global = {
                isInner: r
              }, this.stack = [this._factory.create("start", this.global)], e && (this.stack[0].env = e), this.env = this.stack[0].env;
            }
            return Object.defineProperty(t.prototype, "env", {
              get: function () {
                return this._env;
              },
              set: function (t) {
              ...
              for (var t, e, r = [], i = 0; i < arguments.length; i++) r[i] = arguments[i];
              try {
                for (var l = n(r), c = l.next(); !c.done; c = l.next()) {
                  ...
                  if (u) {
                    ...
                    var d = o(this.stack.length ? this.Top().checkItem(p) : [null, !0], 2),
                      f = d[0],
                      h = d[1];
                    h && (f ? (this.Pop(), this.Push.apply(this, a([], o(f), !1))) : (this.stack.push(p), p.env ? (p.copyEnv && Object.assign(p.env, this.env), this.env = p.env) : p.env = this.env));
                  }
                }
              } catch (e) {
                t = {
        ...
        var c = l(r(3466)),
          u = function () {
            ...
            return Object.defineProperty(t.prototype, "nodes", {
              ...
              return void 0 === t && (t = !0), 1 !== this._nodes.length || e ? this.create("node", t ? "inferredMrow" : "mrow", this._nodes, {}) : this.First;
            }, t.prototype.create = function (t) {
      ...
      7628: function (t, e, r) {
        ...
        Object.defineProperty(e, "__esModule", {
          value: !0
        }), e.EnvironmentMap = e.CommandMap = e.MacroMap = e.DelimiterMap = e.CharacterMap = e.AbstractParseMap = e.RegExpMap = e.AbstractSymbolMap = e.parseResult = void 0;
        var l = r(4237),
          c = r(2910);
        function u(t) {
          return void 0 === t || t;
        ...
        var d = function (t) {
          ...
          return o(e, t), e.prototype.contains = function (t) {
        ...
        var f = function (t) {
          ...
          return o(e, t), e.prototype.lookup = function (t) {
            return this.map.get(t);
        ...
        var m = function (t) {
          ...
          return o(e, t), e.prototype.parse = function (e) {
            var r = a(e, 2),
              n = r[0],
              o = r[1];
        ...
        var g = function (t) {
          ...
          return o(e, t), e.prototype.parserFor = function (t) {
            var e = this.lookup(t);
      ...
      7251: function (t, e, r) {
        ...
        var c = function (t, e, r, n, o, a, i, s) {
          void 0 === t && (t = ""), void 0 === e && (e = !1), void 0 === r && (r = !1), void 0 === n && (n = null), void 0 === o && (o = ""), void 0 === a && (a = ""), void 0 === i && (i = !1), void 0 === s && (s = ""), this.env = t, this.taggable = e, this.defaultTags = r, this.tag = n, this.tagId = o, this.tagFormat = a, this.noTag = i, this.labelId = s;
        };
        e.TagInfo = c;
        var u = function () {
          function t() {
            this.counter = 0, this.allCounter = 0, this.configuration = null, this.ids = {}, this.allIds = {}, this.labels = {}, this.allLabels = {}, this.redo = !1, this.refUpdate = !1, this.currentTag = new c(), this.history = [], this.stack = [], this.enTag = function (t, e) {
          ...
          return t.prototype.start = function (t, e, r) {
            ...
            this.history = [], this.stack = [], this.clearTag(), this.currentTag = new c("", void 0, void 0), this.labels = {}, this.ids = {}, this.counter = this.allCounter, this.redo = !1;
        ...
        var p = function (t) {
          ...
          return o(e, t), e.prototype.autoTag = function () {}, e.prototype.getTag = function () {
        ...
        var d = function (t) {
          ...
          return o(e, t), e.prototype.finalize = function (t, e) {
            if (!e.display || this.history.find(function (t) {
              return t.taggable;
            })) return t;
            var r = this.getTag(!0);
            return this.enTag(t, r);
      ...
      7007: function (t, e) {
        Object.defineProperty(e, "__esModule", {
          value: !0
        }), e.TexConstant = void 0, function (t) {
          t.Variant = {
            NORMAL: "normal",
            BOLD: "bold",
            ITALIC: "italic",
      ...
      3466: function (t, e) {
        ...
        var r = function () {
          ...
          return t.processString = function (e, r) {
            for (var n = e.split(t.pattern), o = 1, a = n.length; o < a; o += 2) {
              var i = n[o].charAt(0);
              if (i >= "0" && i <= "9") n[o] = r[parseInt(n[o], 10) - 1], "number" == typeof n[o] && (n[o] = n[o].toString());else if ("{" === i) {
                if ((i = n[o].substr(1)) >= "0" && i <= "9") n[o] = r[parseInt(n[o].substr(1, n[o].length - 2), 10) - 1], "number" == typeof n[o] && (n[o] = n[o].toString());else n[o].match(/^\{([a-z]+):%(\d+)\|(.*)\}$/) && (n[o] = "%" + n[o]);
              }
              null == n[o] && (n[o] = "???");
            }
            return n.join("");
        ...
        var s = i(r(7702)),
          ...
          p = function () {
            function t(t, e, r) {
              ...
              this.configuration.pushParser(this), this.stack = new l.default(this.itemFactory, i, !s || c), this.Parse(), this.Push(this.itemFactory.create("stop"));
            }
            return Object.defineProperty(t.prototype, "options", {
              ...
              switch (this.GetNext()) {
                case "":
                  if (!e) throw new c.default("MissingArgFor", "Missing argument for %1", this.currentCS);
                  return null;
                case "}":
                  if (!e) throw new c.default("ExtraCloseMissingOpen", "Extra close brace or missing open brace");
                  return null;
                case "\\":
              ...
              for (var r = ++this.i, n = 0; this.i < this.string.length;) switch (this.string.charAt(this.i++)) {
                case "{":
                  n++;
                  break;
                case "\\":
                  ...
                  break;
                case "}":
                  if (n-- <= 0) throw new c.default("ExtraCloseLooking", "Extra close brace while looking for %1", "']'");
                  break;
                case "]":
                  if (0 === n) return this.string.slice(r, this.i - 1);
              }
              ...
              var r = this.GetNext();
              if (this.i += r.length, this.i <= this.string.length && ("\\" === r ? r += this.GetCS() : "{" === r && e && (this.i--, r = this.GetArgument(t).trim()), this.contains("delimiter", r))) return this.convertDelimiter(r);
      ...
      1313: function (t, e, r) {
        ...
        var o = r(6552),
          ...
          i = r(7628),
          s = n(r(724));
        e.ActionMethods = {}, e.ActionMethods.Macro = s.default.Macro, e.ActionMethods.Toggle = function (t, e) {
          for (var r, n = []; "\\endtoggle" !== (r = t.GetArgument(e));) n.push(new a.default(r, t.stack.env, t.configuration).mml());
          t.Push(t.create("node", "maction", n, {
            actiontype: "toggle"
          }));
        ...
        }, e.ActionMethods), e.ActionConfiguration = o.Configuration.create("action", {
          handler: {
            macro: ["action-macros"]
          }
        });
      ...
      3946: function (t, e, r) {
        ...
        e.AmsConfiguration = i.Configuration.create("ams", {
          ...
          init: function (t) {
            new u.CommandMap(c.NEW_OPS, {}, {}), t.append(i.Configuration.local({
              handler: {
                macro: [c.NEW_OPS]
              },
              priority: -1
          ...
          config: function (t, e) {
            e.parseOptions.options.multlineWidth && (e.parseOptions.options.ams.multlineWidth = e.parseOptions.options.multlineWidth), delete e.parseOptions.options.multlineWidth;
          },
          options: {
            multlineWidth: "",
            ams: {
      ...
      3632: function (t, e, r) {
          ...
          d = function (t) {
            ...
            return o(e, t), Object.defineProperty(e.prototype, "kind", {
              ...
              var t = this.getProperty("shove"),
                e = this.create("node", "mtd", this.nodes, t ? {
                  columnalign: t
                } : {});
              this.setProperty("shove", null), this.row.push(e), this.Clear();
            }, e.prototype.EndRow = function () {
              if (1 !== this.row.length) throw new u.default("MultlineRowsOneCol", "The rows within the %1 environment must have exactly one column", "multline");
        ...
        var f = function (t) {
          ...
          return o(e, t), Object.defineProperty(e.prototype, "kind", {
            ...
            for (this.row = [], this.padded && this.row.push(this.create("node", "mtd")); e = r.shift();) this.row.push(e), (e = r.shift()) && this.row.push(e), (r.length || this.padded) && this.row.push(this.create("node", "mtd"));
      ...
      8285: function (t, e, r) {
        ...
        new l.CharacterMap("AMSmath-mathchar0mo", u.default.mathchar0mo, {
        ...
        }), new l.RegExpMap("AMSmath-operatorLetter", s.AmsMethods.operatorLetter, /[-*]/i), new l.CommandMap("AMSmath-macros", {
        ...
        }, s.AmsMethods), new l.EnvironmentMap("AMSmath-environment", u.default.environment, {
          "equation*": ["Equation", null, !1],
          "eqnarray*": ["EqnArray", null, !1, !0, "rcl", p.default.cols(0, f.MATHSPACE.thickmathspace), ".5em"],
        ...
        }, s.AmsMethods), new l.DelimiterMap("AMSmath-delimiter", u.default.delimiter, {
          "\\lvert": ["|", {
            texClass: d.TEXCLASS.OPEN
          }],
          "\\rvert": ["|", {
            texClass: d.TEXCLASS.CLOSE
          }],
          "\\lVert": ["\u2016", {
            texClass: d.TEXCLASS.OPEN
          }],
          ...
          diagdown: "\u2572",
          Bbbk: ["k", {
            mathvariant: c.TexConstant.Variant.DOUBLESTRUCK
          }],
          yen: "\xa5",
          circledR: "\xae",
          checkmark: "\u2713",
      ...
      2684: function (t, e, r) {
        ...
        e.AmsMethods = {}, e.AmsMethods.AmsEqnArray = function (t, e, r, n, o, a, s) {
          ...
          var a,
            ...
            c = "",
            u = [];
          if (o || (s = t.GetBrackets("\\begin{" + l + "}")), (a = t.GetArgument("\\begin{" + l + "}")).match(/[^0-9]/)) throw new p.default("PositiveIntegerArg", "Argument to %1 must me a positive integer", "\\begin{" + l + "}");
          ...
          if (a.match(/[^0-9]/)) throw new p.default("PositiveIntegerArg", "Argument to %1 must me a positive integer", "\\begin{" + r.getName() + "}");
          var i = o ? "crl" : "rlc",
          ...
          void 0 === l && (l = !1), t.Push(e), i.default.checkEqnEnv(t), a = a.split("").join(" ").replace(/r/g, "right").replace(/l/g, "left").replace(/c/g, "center");
        ...
        }, e.NEW_OPS = "ams-declare-ops", e.AmsMethods.HandleDeclareOp = function (t, r) {
          var n = t.GetStar() ? "*" : "",
            o = i.default.trimSpaces(t.GetArgument(r));
          "\\" === o.charAt(0) && (o = o.substr(1));
          var a = t.GetArgument(r);
          t.configuration.handlers.retrieve(e.NEW_OPS).add(o, new d.Macro(o, e.AmsMethods.Macro, ["\\operatorname".concat(n, "{").concat(a, "}")]));
        }, e.AmsMethods.HandleOperatorName = function (t, e) {
          var r = t.GetStar(),
            o = i.default.trimSpaces(t.GetArgument(e)),
            a = new u.default(o, n(n({}, t.stack.env), {
          ...
          if (l.default.setAttribute(m, "voffset", "-.2em"), l.default.setAttribute(m, "height", "-.2em"), l.default.setChild(f, f.over, m), s) {
            var g = new u.default(s, t.stack.env, t.configuration).mml(),
              y = t.create("node", "mspace", [], {
                height: ".75em"
              });
            m = t.create("node", "mpadded", [g, y], a), l.default.setAttribute(m, "voffset", ".15em"), l.default.setAttribute(m, "depth", "-.15em"), l.default.setChild(f, f.under, m);
          }
          l.default.setProperty(f, "subsupOK", !0), t.Push(f);
        }, e.AmsMethods.HandleShove = function (t, e, r) {
          var n = t.stack.Top();
          if ("multline" !== n.kind) throw new p.default("CommandOnlyAllowedInEnv", "%1 only allowed in %2 environment", t.currentCS, "multline");
          if (n.Size()) throw new p.default("CommandAtTheBeginingOfLine", "%1 must come at the beginning of the line", t.currentCS);
          ...
          if (null == (r = a[r])) throw new p.default("IllegalAlign", "Illegal alignment specified in %1", t.currentCS);
          r && l.default.setProperties(f, {
            numalign: r,
            denomalign: r
          }), t.Push(f);
        }, e.AmsMethods.Genfrac = function (t, e, r, n, o, a) {
          null == r && (r = t.GetDelimiterArg(e)), null == n && (n = t.GetDelimiterArg(e)), null == o && (o = t.GetArgument(e)), null == a && (a = i.default.trimSpaces(t.GetArgument(e)));
          var s = t.ParseArg(e),
            c = t.ParseArg(e),
            u = t.create("node", "mfrac", [s, c]);
          if ("" !== o && l.default.setAttribute(u, "linethickness", o), (r || n) && (l.default.setProperty(u, "withDelims", !0), u = i.default.fixedFence(t.configuration, r, u, n)), "" !== a) {
            var d = parseInt(a, 10),
              f = ["D", "T", "S", "SS"][d];
            if (null == f) throw new p.default("BadMathStyleFor", "Bad math style for %1", t.currentCS);
      ...
      7673: function (t, e, r) {
        ...
        var s = a(r(7628)),
          l = i(r(4708)),
          c = i(r(7215));
        new s.EnvironmentMap("amscd_environment", l.default.environment, {
          CD: "CD"
        }, c.default), new s.CommandMap("amscd_macros", {
          minCDarrowwidth: "minCDarrowwidth",
          minCDarrowheight: "minCDarrowheight"
        }, c.default), new s.MacroMap("amscd_special", {
          "@": "arrow"
        }, c.default);
      },
      7215: function (t, e, r) {
        ...
        var o = n(r(810)),
          ...
          l = {
            ...
            arrow: function (t, e) {
              ...
              for (var c, u = n, p = u.table.length % 2 == 1, d = (u.row.length + (p ? 0 : 1)) % 2; d;) l.cell(t, e), d--;
              var f = {
                  minsize: u.getProperty("minw"),
                  stretchy: !0
                },
                h = {
              ...
              if ("." === r) ;else if ("|" === r) c = t.create("token", "mo", h, "\u2225");else if ("=" === r) c = t.create("token", "mo", f, "=");else {
                var m = {
                    ">": "\u2192",
                    "<": "\u2190",
                    V: "\u2193",
                ...
                if (">" === r || "<" === r) {
                  ...
                  c = M, (g || y) && (c = t.create("node", "mrow"), g && s.default.appendChildren(c, [new o.default("\\scriptstyle\\llap{" + g + "}", t.stack.env, t.configuration).mml()]), M.texClass = i.TEXCLASS.ORD, s.default.appendChildren(c, [M]), y && s.default.appendChildren(c, [new o.default("\\scriptstyle\\rlap{" + y + "}", t.stack.env, t.configuration).mml()]));
                }
              }
            ...
            cell: function (t, e) {
              var r = t.stack.Top();
              (r.table || []).length % 2 == 0 && 0 === (r.row || []).length && t.Push(t.create("node", "mpadded", [], {
                height: "8.5pt",
                depth: "2pt"
      ...
      3606: function (t, e, r) {
        ...
        function b(t, e) {
          ...
          o[4] && i.attributes.set("mathvariant", o[4]), "mo" === a && (h.default.setProperty(i, "fixStretchy", !0), t.configuration.addNode("fixStretchy", i)), t.Push(i);
        }
        ...
        e.BaseTags = x, e.BaseConfiguration = p.Configuration.create("base", {
          handler: {
      ...
      8389: function (t, e, r) {
        ...
        Object.defineProperty(e, "__esModule", {
          value: !0
        }), e.EquationItem = e.EqnArrayItem = e.ArrayItem = e.DotsItem = e.NonscriptItem = e.NotItem = e.FnItem = e.MmlItem = e.CellItem = e.PositionItem = e.StyleItem = e.EndItem = e.BeginItem = e.RightItem = e.Middle = e.LeftItem = e.OverItem = e.SubsupItem = e.PrimeItem = e.CloseItem = e.OpenItem = e.StopItem = e.StartItem = void 0;
        var l = r(2910),
          c = r(9029),
          u = r(8921),
          p = s(r(3466)),
        ...
        var b = function (t) {
          ...
          return o(e, t), Object.defineProperty(e.prototype, "kind", {
            ...
            var e = a(this.Peek(2), 2),
              r = e[0],
              n = e[1];
            return !f.default.isType(r, "msubsup") || f.default.isType(r, "msup") ? [[this.create("node", "msup", [r, n]), t], !0] : (f.default.setChild(r, r.sup, n), [[r, t], !0]);
          }, e;
        }(h.BaseItem);
        e.PrimeItem = b;
        var x = function (t) {
          ...
          return o(e, t), Object.defineProperty(e.prototype, "kind", {
            ...
            if (e.isKind("mml")) {
              if (this.getProperty("primes")) if (2 !== n) f.default.setChild(r, 2, this.getProperty("primes"));else {
                f.default.setProperty(this.getProperty("primes"), "variantForm", !0);
                var o = this.create("node", "mrow", [this.getProperty("primes"), e.First]);
                e.First = o;
              }
              return f.default.setChild(r, n, e.First), null != this.getProperty("movesupsub") && f.default.setProperty(r, "movesupsub", this.getProperty("movesupsub")), [[this.factory.create("mml", r)], !0];
            }
        ...
        var _ = function (t) {
          ...
          return o(e, t), Object.defineProperty(e.prototype, "kind", {
            ...
            if (e.isClose) {
              ...
              return null != this.getProperty("thickness") && f.default.setAttribute(r, "linethickness", this.getProperty("thickness")), (this.getProperty("open") || this.getProperty("close")) && (f.default.setProperty(r, "withDelims", !0), r = d.default.fixedFence(this.factory.configuration, this.getProperty("open"), r, this.getProperty("close"))), [[this.factory.create("mml", r), e], !0];
            }
            return t.prototype.checkItem.call(this, e);
          }, e.prototype.toString = function () {
        ...
        var M = function (t) {
          ...
          return o(e, t), Object.defineProperty(e.prototype, "kind", {
            ...
            if (e.isKind("right")) return [[this.factory.create("mml", d.default.fenced(this.factory.configuration, this.getProperty("delim"), this.toMml(), e.getProperty("delim"), "", e.getProperty("color")))], !0];
            if (e.isKind("middle")) {
              var r = {
                stretchy: !0
              };
              return e.getProperty("color") && (r.mathcolor = e.getProperty("color")), this.Push(this.create("node", "TeXAtom", [], {
                texClass: u.TEXCLASS.CLOSE
              }), this.create("token", "mo", r, e.getProperty("delim")), this.create("node", "TeXAtom", [], {
        ...
        var k = function (t) {
          ...
          return o(e, t), Object.defineProperty(e.prototype, "isFinal", {
            get: function () {
              return !0;
            },
            enumerable: !1,
          ...
          return o(e, t), Object.defineProperty(e.prototype, "kind", {
            ...
            if (r) {
              ...
              if (!e.isKind("fn")) {
                ...
                if (f.default.isType(n, "mstyle") && n.childNodes.length && f.default.isType(n.childNodes[0].childNodes[0], "mspace") || f.default.isType(n, "mspace")) return [[r, e], !0];
                f.default.isEmbellished(n) && (n = f.default.getCoreMO(n));
                var o = f.default.getForm(n);
                if (null != o && [0, 0, 1, 1, 0, 1, 1, 0, 0, 0][o[2]]) return [[r, e], !0];
              }
              var a = this.create("token", "mo", {
        ...
        var I = function (t) {
          ...
          return o(e, t), Object.defineProperty(e.prototype, "kind", {
            ...
            return [[e = this.create("node", "TeXAtom", [a], {
        ...
        var L = function (t) {
          ...
          return o(e, t), Object.defineProperty(e.prototype, "kind", {
            ...
            if (e.isClose && !e.isKind("over")) {
              ...
              if (e.getProperty("isCR")) return this.EndEntry(), this.EndRow(), this.clearEnv(), h.BaseItem.fail;
            ...
            return t && e.setProperty("scriptlevel", t), 4 === this.frame.length ? f.default.setAttribute(e, "frame", this.dashed ? "dashed" : "solid") : this.frame.length && (this.arraydef.rowlines && (this.arraydef.rowlines = this.arraydef.rowlines.replace(/none( none)+$/, "none")), f.default.setAttribute(e, "frame", ""), e = this.create("node", "menclose", [e], {
              notation: this.frame.join(" ")
            }), "none" === (this.arraydef.columnlines || "none") && "none" === (this.arraydef.rowlines || "none") || f.default.setAttribute(e, "data-padding", 0)), (this.getProperty("open") || this.getProperty("close")) && (e = d.default.fenced(this.factory.configuration, this.getProperty("open"), e, this.getProperty("close"))), e;
          }, e.prototype.EndEntry = function () {
            var t = this.create("node", "mtd", this.nodes);
            this.hfill.length && (0 === this.hfill[0] && f.default.setAttribute(t, "columnalign", "right"), this.hfill[this.hfill.length - 1] === this.Size() && f.default.setAttribute(t, "columnalign", f.default.getAttribute(t, "columnalign") ? "center" : "left")), this.row.push(t), this.Clear(), this.hfill = [];
          }, e.prototype.EndRow = function () {
            var t;
            this.getProperty("isNumbered") && 3 === this.row.length ? (this.row.unshift(this.row.pop()), t = this.create("node", "mlabeledtr", this.row)) : t = this.create("node", "mtr", this.row), this.table.push(t), this.row = [];
          }, e.prototype.EndTable = function () {
            ...
            if (this.arraydef.rowlines) {
              ...
              t.length === this.table.length ? (this.frame.push("bottom"), t.pop(), this.arraydef.rowlines = t.join(" ")) : t.length < this.table.length - 1 && (this.arraydef.rowlines += " none");
            }
            ...
            if (this.arraydef.rowspacing) {
              ...
              for (var n = this.getProperty("rowspacing"); e.length < this.table.length;) e.push(d.default.Em(n));
        ...
        var F = function (t) {
          ...
          return o(e, t), Object.defineProperty(e.prototype, "kind", {
            ...
            t.prototype.EndTable.call(this), this.factory.configuration.tags.end(), this.extendArray("columnalign", this.maxrow), this.extendArray("columnwidth", this.maxrow), this.extendArray("columnspacing", this.maxrow - 1);
      ...
      4962: function (t, e, r) {
        ...
        var s = a(r(7628)),
          ...
          d = r(8921),
          f = r(6914);
        new s.RegExpMap("letter", u.default.variable, /[a-z]/i), new s.RegExpMap("digit", u.default.digit, /[0-9.,]/), new s.RegExpMap("command", u.default.controlSequence, /^\\/), new s.MacroMap("special", {
          "{": "Open",
          "}": "Close",
          "~": "Tilde",
          "^": "Superscript",
          ...
          "\xa0": "Space",
          "\u2019": "Prime"
        }, c.default), new s.CharacterMap("mathchar0mi", u.default.mathchar0mi, {
          alpha: "\u03b1",
          beta: "\u03b2",
          gamma: "\u03b3",
          delta: "\u03b4",
          ...
          eqalignno: ["Matrix", null, null, "right left", (0, f.em)(f.MATHSPACE.thickmathspace), ".5em", "D", null, "right"],
          leqalignno: ["Matrix", null, null, "right left", (0, f.em)(f.MATHSPACE.thickmathspace), ".5em", "D", null, "left"],
          hfill: "HFill",
          hfil: "HFill",
          hfilll: "HFill",
          ...
          mmlToken: "MmlToken"
        }, c.default), new s.EnvironmentMap("environment", u.default.environment, {
          array: ["AlignedArray"],
          equation: ["Equation", null, !0],
          eqnarray: ["EqnArray", null, !0, !0, "rcl", p.default.cols(0, f.MATHSPACE.thickmathspace), ".5em"]
        }, c.default), new s.CharacterMap("not_remap", null, {
          "\u2190": "\u219a",
          "\u2192": "\u219b",
          "\u2194": "\u21ae",
          "\u21d0": "\u21cd",
      ...
      724: function (t, e, r) {
        ...
        function M(t, e) {
          ...
          if (i.leftRoot || i.upRoot) {
            var s = {};
            i.leftRoot && (s.width = i.leftRoot), i.upRoot && (s.voffset = i.upRoot, s.height = i.upRoot), a = t.create("node", "mpadded", [a], s);
          }
          return r.inRoot = n, a;
        }
        x.Open = function (t, e) {
        ...
        }, x.Space = function (t, e) {}, x.Superscript = function (t, e) {
          var r, n, o;
          t.GetNext().match(/\d/) && (t.string = t.string.substr(0, t.i + 1) + " " + t.string.substr(t.i + 1));
          var a = t.stack.Top();
          a.isKind("prime") ? (o = (r = s(a.Peek(2), 2))[0], n = r[1], t.stack.Pop()) : (o = t.stack.Prev()) || (o = t.create("token", "mi", {}, ""));
          var i = u.default.getProperty(o, "movesupsub"),
            l = u.default.isType(o, "msubsup") ? o.sup : o.over;
          if (u.default.isType(o, "msubsup") && !u.default.isType(o, "msup") && u.default.getChildAt(o, o.sup) || u.default.isType(o, "munderover") && !u.default.isType(o, "mover") && u.default.getChildAt(o, o.over) && !u.default.getProperty(o, "subsupOK")) throw new p.default("DoubleExponent", "Double exponent: use braces to clarify");
          u.default.isType(o, "msubsup") && !u.default.isType(o, "msup") || (i ? ((!u.default.isType(o, "munderover") || u.default.isType(o, "mover") || u.default.getChildAt(o, o.over)) && (o = t.create("node", "munderover", [o], {
            movesupsub: !0
          })), l = o.over) : l = (o = t.create("node", "msubsup", [o])).sup), t.Push(t.itemFactory.create("subsup", o).setProperties({
            position: l,
            primes: n,
            movesupsub: i
          }));
          ...
          if (u.default.isType(o, "msubsup") && !u.default.isType(o, "msup") && u.default.getChildAt(o, o.sub) || u.default.isType(o, "munderover") && !u.default.isType(o, "mover") && u.default.getChildAt(o, o.under) && !u.default.getProperty(o, "subsupOK")) throw new p.default("DoubleSubscripts", "Double subscripts: use braces to clarify");
          u.default.isType(o, "msubsup") && !u.default.isType(o, "msup") || (i ? ((!u.default.isType(o, "munderover") || u.default.isType(o, "mover") || u.default.getChildAt(o, o.under)) && (o = t.create("node", "munderover", [o], {
            movesupsub: !0
          })), l = o.under) : l = (o = t.create("node", "msubsup", [o])).sub), t.Push(t.itemFactory.create("subsup", o).setProperties({
            position: l,
            primes: n,
            movesupsub: i
          }));
          ...
          var r = t.stack.Prev();
          if (r || (r = t.create("node", "mi")), u.default.isType(r, "msubsup") && !u.default.isType(r, "msup") && u.default.getChildAt(r, r.sup)) throw new p.default("DoubleExponentPrime", "Prime causes double exponent: use braces to clarify");
          var n = "";
          t.i--;
          do {
          ...
          var o = t.GetArgument(e),
            a = new d.default(o, n(n({}, t.stack.env), {
              font: r,
          ...
          t.stack.env.style = r, t.stack.env.level = o, t.Push(t.itemFactory.create("style").setProperty("styles", {
            displaystyle: n,
            scriptlevel: o
          }));
        }, x.SetSize = function (t, e, r) {
          t.stack.env.size = r, t.Push(t.itemFactory.create("style").setProperty("styles", {
            mathsize: (0, y.em)(r)
          }));
          ...
          if (!n || u.default.getTexClass(u.default.getCoreMO(n)) !== m.TEXCLASS.OP && null == u.default.getProperty(n, "movesupsub")) throw new p.default("MisplacedLimits", "%1 is allowed only on operators", t.currentCS);
          var o,
            a = t.stack.Top();
          u.default.isType(n, "munderover") && !r ? (o = t.create("node", "msubsup"), u.default.copyChildren(n, o), n = a.Last = o) : u.default.isType(n, "msubsup") && r && (o = t.create("node", "munderover"), u.default.copyChildren(n, o), n = a.Last = o), u.default.setProperty(n, "movesupsub", !!r), u.default.setProperties(u.default.getCoreMO(n), {
            movablelimits: !1
          }), (u.default.getAttribute(n, "movablelimits") || u.default.getProperty(n, "movablelimits")) && u.default.setProperties(n, {
            movablelimits: !1
          });
        }, x.Over = function (t, e, r, n) {
          var o = t.itemFactory.create("over").setProperty("name", t.currentCS);
          r || n ? (o.setProperty("open", r), o.setProperty("close", n)) : e.match(/withdelims$/) && (o.setProperty("open", t.GetDelimiter(e)), o.setProperty("close", t.GetDelimiter(e))), e.match(/^\\above/) ? o.setProperty("thickness", t.GetDimen(e)) : (e.match(/^\\atop/) || r || n) && o.setProperty("thickness", 0), t.Push(o);
        }, x.Frac = function (t, e) {
          var r = t.ParseArg(e),
            n = t.ParseArg(e),
          ...
          (u.default.isType(c, "mo") || u.default.getProperty(c, "movablelimits")) && u.default.setProperties(c, {
            movablelimits: !1
          });
          ...
          var r = t.ParseArg(e),
            n = t.ParseArg(e),
            o = t.ParseArg(e);
          h.default.checkMovableLimits(o), r.isKind("mo") && u.default.setAttribute(r, "accent", !1), n.isKind("mo") && u.default.setAttribute(n, "accent", !1);
          ...
          if (r === m.TEXCLASS.OP) {
            ...
            l ? (i.mathvariant = f.TexConstant.Variant.NORMAL, o = t.create("token", "mi", i, l[1])) : (a = new d.default(s, t.stack.env, t.configuration).mml(), o = t.create("node", "TeXAtom", [a], i)), n = t.itemFactory.create("fn", o);
          ...
          for (; "" !== o;) {
            ...
            if (!r.attributes.hasDefault(l[1]) && !_[l[1]]) throw new p.default("UnknownAttrForElement", "%1 is not a recognized attribute for %2", l[1], n);
            var c = h.default.MmlFilterAttribute(t, l[1], l[2].replace(/^(['"])(.*)\1$/, "$2"));
            c && ("true" === c.toLowerCase() ? c = !0 : "false" === c.toLowerCase() && (c = !1), i[l[1]] = c, s.push(l[1])), o = o.substr(l[0].length);
          }
          ...
          (r || n) && (o = t.create("node", "mpadded", [o]), n && (u.default.setAttribute(o, "height", 0), u.default.setAttribute(o, "depth", 0)), r && u.default.setAttribute(o, "width", 0));
          ...
          var r = t.GetDimen(e),
            n = t.itemFactory.create("position").setProperties({
              name: t.currentCS,
              move: "vertical"
            });
          "-" === r.charAt(0) && (r = r.slice(1), e = "raise" === e.substr(1) ? "\\lower" : "\\raise"), "\\lower" === e ? (n.setProperty("dh", "-" + r), n.setProperty("dd", "+" + r)) : (n.setProperty("dh", "+" + r), n.setProperty("dd", "-" + r)), t.Push(n);
          ...
          r && (a = t.create("node", "mpadded", [a], {
            voffset: r
          }), r.match(/^\-/) ? (u.default.setAttribute(a, "height", r), u.default.setAttribute(a, "depth", "+" + r.substr(1))) : u.default.setAttribute(a, "height", "+" + r)), t.Push(a);
          ...
          r && (o = [t.create("node", "mpadded", o, {
            width: r,
            "data-align": (0, b.lookup)(n, {
              l: "left",
              r: "right"
            }, "center")
          })]);
          var a = t.create("node", "TeXAtom", [t.create("node", "menclose", o, {
            notation: "box"
          })], {
          ...
          var u = t.GetNext();
          if ("" === u) throw new p.default("MissingArgFor", "Missing argument for %1", t.currentCS);
          "{" === u ? t.i++ : (t.string = u + "}" + t.string.slice(t.i + 1), t.i = 0);
          var d = t.itemFactory.create("array").setProperty("requireClose", !0);
          d.arraydef = {
            rowspacing: i || "4pt",
            columnspacing: a || "1em"
          }, l && d.setProperty("isCases", !0), c && (d.setProperty("isNumbered", !0), d.arraydef.side = c), (r || n) && (d.setProperty("open", r), d.setProperty("close", n)), "D" === s && (d.arraydef.displaystyle = !0), null != o && (d.arraydef.columnalign = o), t.Push(d);
          ...
          if (r.getProperty("isCases") || n) {
            for (var o = t.string, a = 0, i = -1, s = t.i, l = o.length, c = n ? new RegExp("^\\\\end\\s*\\{".concat(n.replace(/\*/, "\\*"), "\\}")) : null; s < l;) {
              var u = o.charAt(s);
              if ("{" === u) a++, s++;else if ("}" === u) 0 === a ? l = 0 : (0 === --a && i < 0 && (i = s - t.i), s++);else {
                if ("&" === u && 0 === a) throw new p.default("ExtraAlignTab", "Extra alignment tab in \\cases text");
                if ("\\" === u) {
                  var d = o.substr(s);
          ...
          if (void 0 === r && (r = !1), !r && ("*" === t.string.charAt(t.i) && t.i++, "[" === t.string.charAt(t.i))) {
            var o = t.GetBrackets(e, ""),
              ...
              i = a[0],
              l = a[1];
            if (o && !i) throw new p.default("BracketMustBeDimension", "Bracket argument to %1 must be a dimension", t.currentCS);
            n = i + l;
          }
          t.Push(t.itemFactory.create("cell").setProperties({
            isCR: !0,
          ...
          var u,
            d = t.stack.Top();
          d instanceof c.ArrayItem ? n && d.addRowSpacing(n) : (n && (u = t.create("node", "mspace", [], {
            depth: n
          }), t.Push(u)), u = t.create("node", "mspace", [], {
            linebreak: f.TexConstant.LineBreak.NEWLINE
          }), t.Push(u));
        }, x.HLine = function (t, e, r) {
          null == r && (r = "solid");
          var n = t.stack.Top();
          if (!(n instanceof c.ArrayItem) || n.Size()) throw new p.default("Misplaced", "Misplaced %1", t.currentCS);
          if (n.table.length) {
            for (var o = n.arraydef.rowlines ? n.arraydef.rowlines.split(/ /) : []; o.length < n.table.length;) o.push("none");
            o[n.table.length - 1] = r, n.arraydef.rowlines = o.join(" ");
          } else n.frame.push("top");
        }, x.HFill = function (t, e) {
          var r = t.stack.Top();
          if (!(r instanceof c.ArrayItem)) throw new p.default("UnsupportedHFill", "Unsupported use of %1", t.currentCS);
          r.hfill.push(r.Size());
          ...
          o = (o = o.replace(/[^clr]/g, "").split("").join(" ")).replace(/l/g, "left").replace(/r/g, "right").replace(/c/g, "center");
          var u = t.itemFactory.create("array");
          return u.arraydef = {
            columnalign: o,
            columnspacing: a || "1em",
            rowspacing: i || "4pt"
          }, c.match(/[|:]/) && (c.charAt(0).match(/[|:]/) && (u.frame.push("left"), u.dashed = ":" === c.charAt(0)), c.charAt(c.length - 1).match(/[|:]/) && u.frame.push("right"), c = c.substr(1, c.length - 2), u.arraydef.columnlines = c.split("").join(" ").replace(/[^|: ]/g, "none").replace(/\|/g, "solid").replace(/:/g, "dashed")), r && u.setProperty("open", t.convertDelimiter(r)), n && u.setProperty("close", t.convertDelimiter(n)), "'" === (s || "").charAt(1) && (u.arraydef["data-cramped"] = !0, s = s.charAt(0)), "D" === s ? u.arraydef.displaystyle = !0 : s && (u.arraydef.displaystyle = !1), "S" === s && (u.arraydef.scriptlevel = 1), l && (u.arraydef.useHeight = !1), t.Push(e), u;
          ...
          return t.Push(e), h.default.checkEqnEnv(t), t.itemFactory.create("equation", r).setProperty("name", e.getName());
        }, x.EqnArray = function (t, e, r, n, o, a) {
          t.Push(e), n && h.default.checkEqnEnv(t), o = (o = o.replace(/[^clr]/g, "").split("").join(" ")).replace(/l/g, "left").replace(/r/g, "right").replace(/c/g, "center");
          ...
          if ("" !== r && !t.tags.refUpdate) {
            ...
            if (t.tags.label = r, (t.tags.allLabels[r] || t.tags.labels[r]) && !t.options.ignoreDuplicateLabels) throw new p.default("MultipleLabel", "Label '%1' multiply defined", r);
      ...
      3067: function (t, e, r) {
        ...
        e.BboxMethods = {}, e.BboxMethods.BBox = function (t, e) {
          for (var r, n, o, a = t.GetBrackets(e, ""), c = t.ParseArg(e), u = a.split(/,/), p = 0, d = u.length; p < d; p++) {
            var f = u[p].trim(),
          ...
          r && (c = t.create("node", "mpadded", [c], r)), (n || o) && (r = {}, n && Object.assign(r, {
            mathbackground: n
          }), o && Object.assign(r, {
            style: o
          }), c = t.create("node", "mstyle", [c], r)), t.Push(c);
        };
        var s = function (t) {
            return t;
          },
        ...
        new a.CommandMap("bbox", {
          bbox: "BBox"
        }, e.BboxMethods), e.BboxConfiguration = o.Configuration.create("bbox", {
          handler: {
            macro: ["bbox"]
          }
        });
      ...
      9267: function (t, e, r) {
        ...
        function p(t, e, r, n) {
          ...
          return "mtext" !== e && t.configuration.parser.stack.env.boldsymbol && (i.default.setProperty(o, "fixBold", !0), t.configuration.addNode("fixBold", o)), o;
        }
        function d(t) {
          var e, r;
          try {
            for (var o = n(t.data.getList("fixBold")), a = o.next(); !a.done; a = o.next()) {
              ...
              if (i.default.getProperty(l, "fixBold")) {
                ...
                null == c ? i.default.setAttribute(l, "mathvariant", s.TexConstant.Variant.BOLD) : i.default.setAttribute(l, "mathvariant", u[c] || c), i.default.removeProperties(l, "fixBold");
              }
            }
          } catch (t) {
            e = {
        ...
        u[s.TexConstant.Variant.NORMAL] = s.TexConstant.Variant.BOLD, u[s.TexConstant.Variant.ITALIC] = s.TexConstant.Variant.BOLDITALIC, u[s.TexConstant.Variant.FRAKTUR] = s.TexConstant.Variant.BOLDFRAKTUR, u[s.TexConstant.Variant.SCRIPT] = s.TexConstant.Variant.BOLDSCRIPT, u[s.TexConstant.Variant.SANSSERIF] = s.TexConstant.Variant.BOLDSANSSERIF, u["-tex-calligraphic"] = "-tex-bold-calligraphic", u["-tex-oldstyle"] = "-tex-bold-oldstyle", u["-tex-mathit"] = s.TexConstant.Variant.BOLDITALIC, e.BoldsymbolMethods = {}, e.BoldsymbolMethods.Boldsymbol = function (t, e) {
          ...
          boldsymbol: "Boldsymbol"
        }, e.BoldsymbolMethods), e.createBoldToken = p, e.rewriteBoldTokens = d, e.BoldsymbolConfiguration = a.Configuration.create("boldsymbol", {
          handler: {
            macro: ["boldsymbol"]
          },
          nodes: {
        ...
        var i = r(7044),
          ...
          c = function (t) {
            ...
            return o(e, t), Object.defineProperty(e.prototype, "kind", {
              ...
              return e.isKind("close") ? [[this.factory.create("mml", this.toMml())], !0] : e.isKind("mml") ? (this.Push(e.toMml()), this.getProperty("single") ? [[this.toMml()], !0] : i.BaseItem.fail) : t.prototype.checkItem.call(this, e);
      ...
      7076: function (t, e, r) {
        ...
        new o.CommandMap("Braket-macros", {
          ...
          "|": "Bar"
        }, a.default), new o.MacroMap("Braket-characters", {
          "|": "Bar"
        }, a.default);
      },
      1990: function (t, e, r) {
        ...
        var o = n(r(724)),
          ...
          i = n(r(3466)),
          s = {};
        s.Macro = o.default.Macro, s.Braket = function (t, e, r, n, o, a) {
          var s = t.GetNext();
          ...
          if ("braket" !== n.kind || n.getProperty("barcount") >= n.getProperty("barmax")) {
            ...
            if ("|" === r && "|" === t.GetNext() && (t.i++, r = "\u2225"), n.getProperty("stretchy")) {
              ...
              t.Push(i), n.setProperty("barcount", n.getProperty("barcount") + 1), i = t.create("token", "mo", {
                stretchy: !0,
                braketbar: !0
              }, r), t.Push(i), i = t.create("node", "TeXAtom", [], {
      ...
      7404: function (t, e, r) {
        ...
        r(1597), e.BussproofsConfiguration = o.Configuration.create("bussproofs", {
          ...
          postprocessors: [[i.clearDocument, 3], [i.makeBsprAttributes, 2], [i.balanceRules, 1]]
        });
      },
      2146: function (t, e, r) {
        var n,
          ...
          a = this && this.__createBinding || (Object.create ? function (t, e, r, n) {
            void 0 === n && (n = r);
            var o = Object.getOwnPropertyDescriptor(e, r);
            o && !("get" in o ? !e.__esModule : o.writable || o.configurable) || (o = {
              enumerable: !0,
      ...
      1597: function (t, e, r) {
        ...
        }, o.default), new i.EnvironmentMap("Bussproofs-environments", a.default.environment, {
      ...
      3583: function (t, e, r) {
        ...
        var c = l(r(3466)),
          ...
          f = {
            Prooftree: function (t, e) {
              return t.Push(e), t.itemFactory.create("proofTree").setProperties({
                name: e.getName(),
                line: "solid",
                currentLine: "solid",
                rootAtTop: !1
        ...
        function m(t, e, r, n, o, a, i) {
          ...
          if (d.setProperty(h, "inferenceRule", i ? "up" : "down"), n && (s = t.create("node", "mpadded", [n], {
            height: "+.5em",
            width: "+.5em",
            voffset: "-.15em"
          }), d.setProperty(s, "prooflabel", "left")), o && (l = t.create("node", "mpadded", [o], {
            height: "+.5em",
            width: "+.5em",
            voffset: "-.15em"
          }), d.setProperty(l, "prooflabel", "right")), n && o) c = [s, h, l], u = "both";else if (n) c = [s, h], u = "left";else {
            if (!o) return h;
            c = [h, l], u = "right";
          }
        ...
        f.Inference = function (t, e, r) {
          ...
          var o = n.getProperty("rootAtTop"),
            ...
            i = [];
          do {
            i.length && i.unshift(t.create("node", "mtd", [], {})), i.unshift(t.create("node", "mtd", [n.Pop()], {
          ...
          n.setProperty("left", null), n.setProperty("right", null), d.setProperty(f, "inference", a), t.configuration.addNode("inference", f), n.Push(f);
          ...
          var n = g(t, e);
          d.setProperty(n, "axiom", !0), r.Push(n);
        }, f.FCenter = function (t, e) {}, f.InferenceF = function (t, e, r) {
          var n = t.stack.Top();
          if ("proofTree" !== n.kind) throw new c.default("IllegalProofCommand", "Proof commands only allowed in prooftree environment.");
          if (n.Size() < r) throw new c.default("BadProofTree", "Proof tree badly specified.");
          var o = n.getProperty("rootAtTop"),
      ...
      3118: function (t, e, r) {
        ...
        var s = i(r(8321)),
          ...
          w = function (t, r, n, o) {
            ...
            var i = o ? r.childNodes.length - 1 : 0,
              c = r.childNodes[i];
            s.default.isType(c, "mspace") ? s.default.setAttribute(c, "width", l.default.Em(l.default.dimen2em(s.default.getAttribute(c, "width")) + n)) : (c = t.nodeFactory.create("node", "mspace", [], {
          ...
          P = function (t, r) {
            for (var n = r.pop(); r.length;) {
              var a = r.pop(),
                ...
                s = i[0],
                l = i[1];
              (0, e.getProperty)(n.parent, "axiom") && (C(t, s < 0 ? n : a, 0, "left", Math.abs(s)), C(t, l < 0 ? n : a, 2, "right", Math.abs(l))), n = a;
            }
          },
          S = function (t, e) {
        ...
        e.balanceRules = function (t) {
          ...
          !function (t) {
            ...
            if (r) for (var n = r.length - 1, o = void 0; o = r[n]; n--) if ((0, e.getProperty)(o, "sequentProcessed")) (0, e.removeProperty)(o, "sequentProcessed");else {
              var a = [],
                i = x(o);
              if (1 === (0, e.getProperty)(i, "inference")) {
                for (a.push(o); 1 === (0, e.getProperty)(i, "inference");) {
                  ...
                  var s = m(f(i, (0, e.getProperty)(i, "inferenceRule"))),
                    l = (0, e.getProperty)(s, "inferenceRule") ? y(s, (0, e.getProperty)(s, "inferenceRule")) : s;
              ...
              if (null != (0, e.getProperty)(T, "inference")) {
                ...
                if (!p && (N = v(c))) {
                  ...
                  if (q) {
                    ...
                    var F = x(N);
                    F && (k = (0, e.getProperty)(F, "maxAdjust") ? Math.max((0, e.getProperty)(F, "maxAdjust"), k) : k, (0, e.setProperty)(F, "maxAdjust", k));
                  }
                } else w(o, (0, e.getProperty)(c, "proof") ? c : c.parent, k - E, !0);
              }
            }
          } catch (t) {
            r = {
        ...
        e.makeBsprAttributes = function (t) {
          t.data.root.walkTree(function (t, e) {
            ...
            t.getPropertyNames().forEach(function (e) {
              !T[e] && e.match(RegExp("^bspr_")) && r.push(e + ":" + t.getProperty(e));
      ...
      9489: function (t, e, r) {
        ...
        var o = r(6552),
          ...
          s = n(r(7702)),
          l = r(6755);
        e.CancelMethods = {}, e.CancelMethods.Cancel = function (t, e, r) {
          ...
          i.notation = [a.TexConstant.Notation.UPDIAGONALSTRIKE, a.TexConstant.Notation.UPDIAGONALARROW, a.TexConstant.Notation.NORTHEASTARROW].join(" "), n = t.create("node", "mpadded", [n], {
            depth: "-.1em",
            height: "+.1em",
            voffset: ".1em"
          ...
          cancelto: "CancelTo"
        }, e.CancelMethods), e.CancelConfiguration = o.Configuration.create("cancel", {
          handler: {
            macro: ["cancel"]
          }
        });
      ...
      2632: function (t, e, r) {
        ...
        var s = r(6552),
          ...
          m = function (t) {
            ...
            return a(e, t), Object.defineProperty(e.prototype, "kind", {
              get: function () {
                return "cases-begin";
              },
              enumerable: !1,
              ...
              return e.isKind("end") && e.getName() === this.getName() && this.getProperty("end") ? (this.setProperty("end", !1), [[], !0]) : t.prototype.checkItem.call(this, e);
            }, e;
          }(d.BeginItem);
        e.CasesBeginItem = m;
        var g = function (t) {
          ...
          return a(e, t), e.prototype.start = function (e, r, n) {
            this.subcounter = 0, t.prototype.start.call(this, e, r, n);
          }, e.prototype.autoTag = function () {
            null == this.currentTag.tag && ("subnumcases" === this.currentTag.env ? (0 === this.subcounter && this.counter++, this.subcounter++, this.tag(this.formatNumber(this.counter, this.subcounter), !1)) : (0 !== this.subcounter && "numcases-left" === this.currentTag.env || this.counter++, this.tag(this.formatNumber(this.counter), !1)));
          }, e.prototype.formatNumber = function (t, e) {
            return void 0 === e && (e = null), t.toString() + (null === e ? "" : String.fromCharCode(96 + e));
          }, e;
        }(f.AmsTags);
        e.CasesTags = g, e.CasesMethods = {
          NumCases: function (t, e) {
            if (t.stack.env.closing === e.getName()) {
              ...
              return h.EmpheqUtil.left(n, o, a + "\\empheqlbrace\\,", t, "numcases-left"), t.Push(t.itemFactory.create("end").setProperty("name", e.getName())), null;
            }
          ...
          Entry: function (t, e) {
            ...
            for (var r = t.string, n = 0, o = t.i, a = r.length; o < a;) {
              ...
              if ("{" === i) n++, o++;else if ("}" === i) {
                ...
                if ("&" === i && 0 === n) throw new p.default("ExtraCasesAlignTab", "Extra alignment tab in text for numcase environment");
                if ("\\" === i && 0 === n) {
        ...
        }, new l.EnvironmentMap("cases-env", h.EmpheqUtil.environment, {
          numcases: ["NumCases", "cases"],
          subnumcases: ["NumCases", "cases"]
        }, e.CasesMethods), new l.MacroMap("cases-macros", {
          "&": "Entry"
        }, e.CasesMethods), e.CasesConfiguration = s.Configuration.create("cases", {
          handler: {
      ...
      322: function (t, e, r) {
        ...
        function u(t) {
          ...
          try {
            for (var a = n(o.getList("centerOver")), i = a.next(); !i.done; i = a.next()) {
              ...
              null !== c && s.default.setProperties(l.parent.parent.parent.parent.parent.parent, {
                texClass: c
              });
            }
          } catch (t) {
        ...
        new l.CommandMap("centernot", {
          ...
          CenterOver: function (t, e) {
            var r = "{" + t.GetArgument(e) + "}",
              ...
              a = t.create("node", "TeXAtom", [new i.default(r, t.stack.env, t.configuration).mml(), t.create("node", "mpadded", [t.create("node", "mpadded", [n], {
                width: 0,
                lspace: "-.5width"
        ...
        }), e.filterCenterOver = u, e.CenternotConfiguration = a.Configuration.create("centernot", {
          handler: {
            macro: ["centernot"]
          },
          postprocessors: [u]
      ...
      9574: function (t, e, r) {
        ...
        e.ColorMethods = {}, e.ColorMethods.Color = function (t, e) {
          var r = t.GetBrackets(e, ""),
            n = t.GetArgument(e),
            o = t.configuration.packageData.get("color").model.getColor(r, n),
            a = t.itemFactory.create("style").setProperties({
              styles: {
                mathcolor: o
              }
            });
      ...
      3997: function (t, e, r) {
        ...
        var a = o(r(3466)),
          ...
          l = function () {
            ...
            return t.prototype.normalizeColor = function (t, e) {
        ...
        e.ColorModel = l, s.set("rgb", function (t) {
          var e,
            r,
            o = t.trim().split(/\s*,\s*/),
            i = "#";
      ...
      9570: function (t, e, r) {
        ...
        var i = r(8389),
          ...
          u = function (t) {
            ...
            return o(e, t), e.prototype.EndEntry = function () {
              t.prototype.EndEntry.call(this);
              ...
              return r.isKind("menclose") && (r = r.childNodes[0].childNodes[0]), this.hasColor && "none" === r.attributes.get("frame") && r.attributes.set("frame", ""), e;
            }, e;
          }(i.ArrayItem);
        e.ColorArrayItem = u, new l.CommandMap("colortbl", {
          ...
          TableColor: function (t, e, r) {
            ...
            } else if (i.color[r] = a, "row" === r && (i.Size() || i.row.length)) throw new c.default("RowColorNotFirst", "%1 must be at the beginning of a row", e);
          }
        });
      ...
      2298: function (t, e, r) {
        ...
        }, new n.CommandMap("colorv2", {
          color: "Color"
        }, e.ColorV2Methods), e.ColorConfiguration = o.Configuration.create("colorv2", {
          handler: {
            macro: ["colorv2"]
          }
        });
      ...
      3274: function (t, e, r) {
        ...
        e.ConfigMacrosConfiguration = i.Configuration.create("configmacros", {
          init: function (t) {
            new l.CommandMap(f, {}, {}), new l.EnvironmentMap(h, c.default.environment, {}, {}), t.append(i.Configuration.local({
              handler: {
                macro: [f],
                environment: [h]
              },
              ...
              try {
                for (var i = o(Object.keys(a)), s = i.next(); !s.done; s = i.next()) {
                  var l = s.value,
                    ...
                    d = Array.isArray(c[2]) ? new u.Macro(l, p.default.MacroWithTemplate, c.slice(0, 2).concat(c[2])) : new u.Macro(l, p.default.Macro, c);
                  n.add(l, d);
                }
              } catch (t) {
                e = {
      ...
      8430: function (t, e, r) {
        ...
        e.EmpheqBeginItem = h, e.EmpheqMethods = {
          Empheq: function (t, e) {
            if (t.stack.env.closing === e.getName()) {
              delete t.stack.env.closing, t.Push(t.itemFactory.create("end").setProperty("name", t.stack.global.empheq)), t.stack.global.empheq = "";
              var r = t.stack.Top();
              ...
              var n = t.GetBrackets("\\begin{" + e.getName() + "}") || "",
                ...
                a = o[0],
                s = o[1];
              if (!f.EmpheqUtil.checkEnv(a)) throw new p.default("UnknownEnv", 'Unknown environment "%1"', a);
              n && e.setProperties(f.EmpheqUtil.splitOptions(n, {
                left: 1,
                right: 1
              })), t.stack.global.empheq = a, t.string = "\\begin{" + a + "}" + (s ? "{" + s + "}" : "") + t.string.slice(t.i), t.i = 0, t.Push(e);
            }
          },
          ...
          EmpheqDelim: function (t, e) {
            ...
            t.Push(t.create("token", "mo", {
              stretchy: !0,
              symmetric: !0
            }, r));
          }
        }, new c.EnvironmentMap("empheq-env", f.EmpheqUtil.environment, {
          empheq: ["Empheq", "empheq"]
        }, e.EmpheqMethods), new c.CommandMap("empheq-macros", {
        ...
        }, e.EmpheqMethods), e.EmpheqConfiguration = l.Configuration.create("empheq", {
          handler: {
            macro: ["empheq-macros"],
      ...
      3904: function (t, e, r) {
        ...
        e.EmpheqUtil = {
          environment: function (t, e, r, a) {
            var i = a[0],
              s = t.itemFactory.create(i + "-begin").setProperties({
                name: e,
                end: i
              });
          ...
          cellBlock: function (t, e, r, n) {
            ...
            return s.appendChild(r.create("node", "mphantom", [r.create("node", "mpadded", [e], {
              width: 0
            })])), s;
          },
          topRowTable: function (t, e) {
            var r = s.default.copyNode(t, e);
            return r.setChildren(r.childNodes.slice(0, 1)), r.attributes.set("align", "baseline 1"), t.factory.create("mphantom", {}, [e.create("node", "mpadded", [r], {
              width: 0
            })]);
          },
          ...
          left: function (t, e, r, n, o) {
            var i, s, l;
            void 0 === o && (o = ""), t.attributes.set("columnalign", "right " + (t.attributes.get("columnalign") || "")), t.attributes.set("columnspacing", "0em " + (t.attributes.get("columnspacing") || ""));
            try {
              for (var c = a(t.childNodes.slice(0).reverse()), u = c.next(); !u.done; u = c.next()) {
                var p = u.value;
                l = n.create("node", "mtd"), p.childNodes.unshift(l), l.parent = p, p.isKind("mlabeledtr") && (p.childNodes[0] = p.childNodes[1], p.childNodes[1] = l);
              }
            } catch (t) {
              i = {
                error: t
          ...
          right: function (t, r, n, o, a) {
            ...
            e.EmpheqUtil.rowspanCell(l, n, r, o, a), t.attributes.set("columnalign", (t.attributes.get("columnalign") || "").split(/ /).slice(0, i).join(" ") + " left"), t.attributes.set("columnspacing", (t.attributes.get("columnspacing") || "").split(/ /).slice(0, i - 1).join(" ") + " 0em");
          },
      ...
      6755: function (t, e, r) {
        ...
        e.ENCLOSE_OPTIONS = {
          ...
          "data-padding": 1,
          "data-thickness": 1
        }, e.EncloseMethods = {}, e.EncloseMethods.Enclose = function (t, r) {
        ...
        }, new a.CommandMap("enclose", {
          enclose: "Enclose"
        }, e.EncloseMethods), e.EncloseConfiguration = o.Configuration.create("enclose", {
          handler: {
            macro: ["enclose"]
          }
        });
      ...
      5246: function (t, e, r) {
        ...
        var o = r(6552),
          ...
          l = r(2200),
          c = n(r(3466));
        e.ExtpfeilMethods = {}, e.ExtpfeilMethods.xArrow = i.AmsMethods.xArrow, e.ExtpfeilMethods.NewExtArrow = function (t, r) {
      ...
      1307: function (t, e, r) {
        ...
        var n = r(6552),
          o = r(7007);
        new (r(7628).CharacterMap)("gensymb-symbols", function (t, e) {
          var r = e.attributes || {};
      ...
      153: function (t, e, r) {
        ...
        var o = r(6552),
          a = r(7628),
          i = n(r(2565));
        new a.CommandMap("html_macros", {
          href: "Href",
          class: "Class",
          style: "Style",
          cssId: "Id"
        }, i.default), e.HtmlConfiguration = o.Configuration.create("html", {
          handler: {
            macro: ["html_macros"]
          }
        });
      ...
      856: function (t, e, r) {
              ...
              if (d.getProperty("fixPrescript")) {
                ...
                try {
                  for (var y = (i = void 0, o([4, 5])), v = y.next(); !v.done; v = y.next()) {
                    var b = v.value;
                    l.default.isType(f[b], "mrow") && 0 === l.default.getChildren(f[b]).length && l.default.setChild(d, b, c.nodeFactory.create("node", "none"));
                  }
                } catch (t) {
                  i = {
                    error: t
        ...
        e.PAIREDDELIMS = "mathtools-paired-delims", e.fixPrescripts = f, e.MathtoolsConfiguration = i.Configuration.create("mathtools", {
          handler: {
          ...
          init: function (t) {
            new s.CommandMap(e.PAIREDDELIMS, {}, {}), t.append(i.Configuration.local({
              handler: {
                macro: [e.PAIREDDELIMS]
              },
              priority: -5
            }));
          },
      ...
      3642: function (t, e, r) {
        ...
        }, s.MathtoolsMethods), new a.EnvironmentMap("mathtools-environments", o.default.environment, {
        ...
        }, s.MathtoolsMethods), new a.DelimiterMap("mathtools-delimiters", o.default.delimiter, {
          "\\lparen": "(",
          "\\rparen": ")"
        }), new a.CommandMap("mathtools-characters", {
          ":": ["CenterColon", !0]
        }, s.MathtoolsMethods);
      },
      8155: function (t, e, r) {
        ...
        e.MathtoolsMethods = {
          ...
          MtSmallMatrix: function (t, r, n, o, a) {
            return a || (a = t.GetBrackets("\\begin{".concat(r.getName(), "}"), t.options.mathtools["smallmatrix-align"])), e.MathtoolsMethods.Array(t, r, n, o, a, s.default.Em(1 / 3), ".2em", "S", 1);
          },
          ...
          HandleShove: function (t, e, r) {
            var n = t.stack.Top();
            if ("multline" !== n.kind && "multlined" !== n.kind) throw new p.default("CommandInMultlined", "%1 can only appear within the multline or multlined environments", e);
            if (n.Size()) throw new p.default("CommandAtTheBeginingOfLine", "%1 must come at the beginning of the line", e);
            n.setProperty("shove", r);
            var o = t.GetBrackets(e),
              a = t.ParseArg(e);
            if (o) {
          ...
          Cases: function (t, e, r, n, o) {
            ...
            return a.arraydef = {
              ...
              columnspacing: "1em",
              columnalign: "left"
            }, "D" === o && (a.arraydef.displaystyle = !0), a.setProperties({
              open: r,
              close: n
            }), t.Push(e), a;
          },
          MathLap: function (t, e, r, o) {
            var a = t.GetBrackets(e, "").trim(),
              i = t.create("node", "mstyle", [t.create("node", "mpadded", [t.ParseArg(e)], n({
                width: 0
              }, "r" === r ? {} : {
          ...
          UnderOverBracket: function (t, e) {
            var r = (0, h.length2em)(t.GetBrackets(e, ".1em"), .1),
          ...
          ArrowBetweenLines: function (t, e) {
            var r = v.MathtoolsUtil.checkAlignment(t, e);
            if (r.Size() || r.row.length) throw new p.default("BetweenLines", "%1 must be on a row by itself", e);
            var n = t.GetStar(),
          ...
          VDotsWithin: function (t, e) {
            var r = t.stack.Top(),
              ...
              i = new u.default(a, t.stack.env, t.configuration).mml(),
              s = t.create("node", "mpadded", [t.create("node", "mpadded", [t.create("node", "mo", [t.create("text", "\u22ee")])], n({
                width: 0,
                lspace: "-.5width"
              }, o ? {
                height: "-.6em",
          ...
          ShortVDotsWithin: function (t, r) {
            var n = t.stack.Top(),
              o = t.GetStar();
            e.MathtoolsMethods.FlushSpaceAbove(t, "\\MTFlushSpaceAbove"), !o && n.EndEntry(), e.MathtoolsMethods.VDotsWithin(t, "\\vdotswithin"), o && n.EndEntry(), e.MathtoolsMethods.FlushSpaceBelow(t, "\\MTFlushSpaceBelow");
          },
          ...
          PairedDelimiters: function (t, e, r, n, a, i, l, c) {
            ...
            a = a.replace(/\\delimsize/g, m), t.string = [l, f, r, a, h, n, c, t.string.substr(t.i)].reduce(function (e, r) {
          ...
          CenterColon: function (t, e, r, o, a) {
            ...
            if (r && (i.centercolon || o)) {
              ...
              s = t.create("node", "mpadded", [s], n({
                voffset: l,
                height: "+".concat(l),
                depth: "-".concat(l)
              }, a ? {
                width: i["thincolon-dw"],
                lspace: i["thincolon-dx"]
              } : {}));
            }
            t.Push(s);
          },
          Relation: function (t, e, r, n) {
            t.options.mathtools["use-unicode"] && n ? t.Push(t.create("token", "mo", {
              texClass: f.TEXCLASS.REL
            }, n)) : (r = "\\mathrel{" + r.replace(/:/g, "\\MTThinColon").replace(/-/g, "\\mathrel{-}") + "}", t.string = s.default.addArgs(t, r, t.string.substr(t.i)), t.i = 0);
          },
          NArrow: function (t, e, r, n) {
            t.Push(t.create("node", "TeXAtom", [t.create("token", "mtext", {}, r), t.create("node", "mpadded", [t.create("node", "mpadded", [t.create("node", "menclose", [t.create("node", "mspace", [], {
              height: ".2em",
              depth: 0,
              width: ".4em"
            })], {
          ...
          SplitFrac: function (t, e, r) {
            var n = t.ParseArg(e),
              o = t.ParseArg(e);
            t.Push(t.create("node", "mstyle", [t.create("node", "mfrac", [t.create("node", "mstyle", [n, t.create("token", "mi"), t.create("token", "mspace", {
              width: "1em"
            })], {
              scriptlevel: 0
            }), t.create("node", "mstyle", [t.create("token", "mspace", {
              width: "1em"
            }), t.create("token", "mi"), o], {
              scriptlevel: 0
            })], {
          ...
          XMathStrut: function (t, e) {
            var r = t.GetBrackets(e),
              n = t.GetArgument(e);
            n = v.MathtoolsUtil.plusOrMinus(e, n), r = v.MathtoolsUtil.plusOrMinus(e, r || n), t.Push(t.create("node", "TeXAtom", [t.create("node", "mpadded", [t.create("node", "mphantom", [t.create("token", "mo", {
              stretchy: !1
            }, "(")])], {
              width: 0,
              height: n + "height",
          ...
          Prescript: function (t, e) {
            ...
            if (d.default.isType(r, "none") && d.default.isType(n, "none")) t.Push(o);else {
              var a = t.create("node", "mmultiscripts", [o]);
              d.default.getChildren(a).push(null, null), d.default.appendChildren(a, [t.create("node", "mprescripts"), n, r]), a.setProperty("fixPrescript", !0), t.Push(a);
            }
          },
          NewTagForm: function (t, e, r) {
            void 0 === r && (r = !1);
            var n = t.tags;
            if (!("mtFormats" in n)) throw new p.default("TagsNotMT", "%1 can only be used with ams or mathtools tags", e);
            var o = t.GetArgument(e).trim();
            if (!o) throw new p.default("InvalidTagFormID", "Tag form name can't be empty");
            var a = t.GetBrackets(e, ""),
              i = t.GetArgument(e),
              s = t.GetArgument(e);
            if (!r && n.mtFormats.has(o)) throw new p.default("DuplicateTagForm", "Duplicate tag form: %1", o);
            n.mtFormats.set(o, [i, s, a]);
          },
          UseTagForm: function (t, e) {
            var r = t.tags;
            if (!("mtFormats" in r)) throw new p.default("TagsNotMT", "%1 can only be used with ams or mathtools tags", e);
            var n = t.GetArgument(e).trim();
            if (n) {
              if (!r.mtFormats.has(n)) throw new p.default("UndefinedTagForm", "Undefined tag form: %1", n);
          ...
          SetOptions: function (t, e) {
            ...
            if (!o["allow-mathtoolsset"]) throw new p.default("ForbiddenMathtoolsSet", "%1 is disabled", e);
            var i = {};
      ...
      1331: function (t, e, r) {
        ...
        e.MathtoolsTagFormat = function (t, e) {
          ...
          var n = function (t) {
              function r() {
                ...
                try {
                  for (var s = a(Object.keys(i)), c = s.next(); !c.done; c = s.next()) {
                    var u = c.value;
                    if (!Array.isArray(i[u]) || 3 !== i[u].length) throw new l.default("InvalidTagFormDef", 'The tag form definition for "%1" should be an array fo three strings', u);
              ...
              return o(r, t), r.prototype.formatTag = function (e) {
                if (this.mtCurrent) {
      ...
      1323: function (t, e, r) {
        ...
        var o = r(6552),
          ...
          c = r(7865),
          u = {};
        u.Macro = s.default.Macro, u.xArrow = l.AmsMethods.xArrow, u.Machine = function (t, e, r) {
          var n,
            o = t.GetArgument(e);
          try {
        ...
        }, u), e.MhchemConfiguration = o.Configuration.create("mhchem", {
          handler: {
            macro: ["mhchem"]
          }
        });
      ...
      2200: function (t, e, r) {
        ...
        e.NewcommandConfiguration = l.Configuration.create("newcommand", {
          ...
          init: function (t) {
            new d.DelimiterMap(u.default.NEW_DELIMITER, p.default.delimiter, {}), new d.CommandMap(u.default.NEW_COMMAND, {}, {}), new d.EnvironmentMap(u.default.NEW_ENVIRONMENT, p.default.environment, {}, {}), t.append(l.Configuration.local({
              handler: {
                character: [],
          ...
          d = {
            ...
            MacroDef: function (t, e) {
              var r = p.default.GetCSname(t, e),
                ...
                o = t.GetArgument(e);
              n instanceof Array ? p.default.addMacro(t, r, d.MacroWithTemplate, [o].concat(n)) : p.default.addMacro(t, r, d.Macro, [o, n]);
            },
            Let: function (t, e) {
              var r = p.default.GetCSname(t, e),
                n = t.GetNext();
              ...
              if ("\\" !== n) {
                ...
                if (i) return void p.default.addDelimiter(t, "\\" + r, i.char, i.attributes);
                ...
                p.default.addMacro(t, r, function (t, e) {
            ...
            MacroWithTemplate: function (t, e, r, n) {
              ...
              if (i) {
                var l = [];
                if (t.GetNext(), o[0] && !p.default.MatchParam(t, o[0])) throw new s.default("MismatchUseDef", "Use of %1 doesn't match its definition", e);
                for (var c = 0; c < i; c++) l.push(p.default.GetParameter(t, e, o[c + 1]));
            ...
            BeginEnv: function (t, e, r, n, o, a) {
              ...
              return t.string = u.default.addArgs(t, r, t.string.slice(t.i)), t.i = 0, t.itemFactory.create("beginEnv").setProperty("name", e.getName());
            }
          };
      ...
      5282: function (t, e, r) {
        ...
        !function (t) {
          function e(t, e) {
            return t.string.substr(t.i, e.length) !== e || e.match(/\\[a-z]+$/i) && t.string.charAt(t.i + e.length).match(/[a-z]/i) ? 0 : (t.i += e.length, 1);
          }
          t.disassembleSymbol = function (t, e) {
            ...
            if ("\\" === r.charAt(0) && (r = r.substr(1)), !r.match(/^(.|[a-z]+)$/i)) throw new i.default("IllegalControlSequenceName", "Illegal control sequence name for %1", e);
            return r;
          }, t.GetArgCount = function (t, e) {
            var r = t.GetBrackets(e);
            if (r && !(r = a.default.trimSpaces(r)).match(/^[0-9]+$/)) throw new i.default("IllegalParamNumber", "Illegal number of parameters specified in %1", e);
            return r;
          }, t.GetTemplate = function (t, e, r) {
            for (var n = t.GetNext(), o = [], a = 0, s = t.i; t.i < t.string.length;) {
              if ("#" === (n = t.GetNext())) {
                if (s !== t.i && (o[a] = t.string.substr(s, t.i - s)), !(n = t.string.charAt(++t.i)).match(/^[1-9]$/)) throw new i.default("CantUseHash2", "Illegal use of # in template for %1", r);
            ...
            for (var o = t.i, a = 0, s = 0; t.i < t.string.length;) {
              ...
              if ("{" === l) t.i === o && (s = 1), t.GetArgument(r), a = t.i - o;else {
          ...
          }, t.MatchParam = e, t.addDelimiter = function (e, r, n, o) {
          ...
          }, t.NEW_DELIMITER = "new-Delimiter", t.NEW_COMMAND = "new-Command", t.NEW_ENVIRONMENT = "new-Environment";
        }(o || (o = {})), e.default = o;
      },
      9569: function (t, e, r) {
        Object.defineProperty(e, "__esModule", {
        ...
        var i = r(7044),
          ...
          u = function (t) {
            ...
            return o(e, t), Object.defineProperty(e.prototype, "kind", {
              ...
              var a = s.default.fenced(this.factory.configuration, this.getProperty("open"), t.prototype.toMml.call(this), this.getProperty("close"), this.getProperty("big"));
              ...
              return n && n === this.getProperty("close") && !this.openCount-- ? this.getProperty("ignore") ? (this.Clear(), [[], !0]) : [[this.toMml()], !0] : t.prototype.checkItem.call(this, e);
      ...
      8047: function (t, e, r) {
        ...
        new o.CommandMap("Physics-automatic-bracing-macros", {
          ...
          pb: ["Commutator", "\\{", "\\}"]
        }, a.default), new o.CharacterMap("Physics-vector-mo", s.default.mathchar0mo, {
          dotproduct: ["\u22c5", {
        ...
        }, a.default), new o.CommandMap("Physics-expressions-macros", {
          sin: "Expression",
          sinh: "Expression",
          arcsin: "Expression",
          asin: "Expression",
        ...
        }, a.default), new o.CommandMap("Physics-quick-quad-macros", {
          qqtext: "Qqtext",
          qq: "Qqtext",
          qcomma: ["Macro", "\\qqtext*{,}"],
          qc: ["Macro", "\\qqtext*{,}"],
          ...
          qas: ["Qqtext", "as"],
          qin: ["Qqtext", "in"]
        }, a.default), new o.CommandMap("Physics-derivative-macros", {
          diffd: "DiffD",
        ...
        }, a.default), new o.CommandMap("Physics-bra-ket-macros", {
          bra: "Bra",
          ket: "Ket",
          innerproduct: "BraKet",
          ip: "BraKet",
          ...
          mel: "MatrixElement"
        }, a.default), new o.CommandMap("Physics-matrix-macros", {
        ...
        }, a.default), new o.EnvironmentMap("Physics-aux-envs", s.default.environment, {
          smallmatrix: ["Array", null, null, null, "c", "0.333em", ".2em", "S", 1]
        }, a.default), new o.MacroMap("Physics-characters", {
      ...
      1541: function (t, e, r) {
        ...
        d.Quantity = function (t, e, r, n, o, a, p) {
          void 0 === r && (r = "("), void 0 === n && (n = ")"), void 0 === o && (o = !1), void 0 === a && (a = ""), void 0 === p && (p = "");
          var d = !!o && t.GetStar(),
            m = t.GetNext(),
            g = t.i,
            y = null;
          ...
          var b = f[m];
          if (o && "{" !== m) throw new s.default("MissingArgFor", "Missing argument for %1", t.currentCS);
          if (!b) {
            v = t.create("node", "mrow");
            return t.Push(c.default.fenced(t.configuration, r, v, n)), void (t.i = g);
          }
          if (a) {
            var x = t.create("token", "mi", {
              texClass: l.TEXCLASS.OP
            }, a);
            p && u.default.setAttribute(x, "mathvariant", p), t.Push(t.itemFactory.create("fn", x));
          }
          if ("{" === m) {
            var _ = t.GetArgument(e);
            return m = o ? r : "\\{", b = o ? n : "\\}", _ = d ? m + " " + _ + " " + b : y ? "\\" + y + "l" + m + " " + _ + " \\" + y + "r" + b : "\\left" + m + " " + _ + " \\right" + b, void t.Push(new i.default(_, t.stack.env, t.configuration).mml());
          }
          o && (m = r, b = n), t.i++, t.Push(t.itemFactory.create("auto open").setProperties({
            open: m,
            close: b,
            big: y
          }));
          ...
          var r = t.GetStar(),
            n = t.GetNext();
          if ("{" !== n) {
            if ("(" === n || "[" === n) return t.i++, void t.Push(t.itemFactory.create("auto open").setProperties({
              open: n,
              close: "|",
              smash: r,
              right: "\\vphantom{\\int}"
          ...
          var o = t.GetStar(),
            ...
            l = null;
          if ("\\" === a) {
            if (t.i++, !(l = t.GetCS()).match(h)) throw new s.default("MissingArgFor", "Missing argument for %1", t.currentCS);
            a = t.GetNext();
          }
          if ("{" !== a) throw new s.default("MissingArgFor", "Missing argument for %1", t.currentCS);
          var c = t.GetArgument(e) + "," + t.GetArgument(e);
          c = o ? r + " " + c + " " + n : l ? "\\" + l + "l" + r + " " + c + " \\" + l + "r" + n : "\\left" + r + " " + c + " \\right" + n, t.Push(new i.default(c, t.stack.env, t.configuration).mml());
        };
        var m = [65, 90],
          g = [97, 122],
          y = [913, 937],
        ...
        function _(t, e, r, n) {
          var o = t.configuration.parser,
            ...
            i = n.codePointAt(0);
          return 1 === n.length && !o.stack.env.font && o.stack.env.vectorFont && (x(i, m) || x(i, g) || x(i, y) || x(i, b) || x(i, v) && o.stack.env.vectorStar || u.default.getAttribute(a, "accent")) && u.default.setAttribute(a, "mathvariant", o.stack.env.vectorFont), a;
        }
        d.VectorBold = function (t, e) {
          var r = t.GetStar(),
            ...
            a = t.stack.env.font;
          delete t.stack.env.font, t.configuration.nodeFactory.set("token", _), t.stack.env.vectorFont = r ? "bold-italic" : "bold", t.stack.env.vectorStar = r;
          var s = new i.default(n, t.stack.env, t.configuration).mml();
          a && (t.stack.env.font = a), delete t.stack.env.vectorFont, delete t.stack.env.vectorStar, t.configuration.nodeFactory.set("token", o), t.Push(s);
        ...
        var M = function (t, e, r, n, o) {
          ...
          if (l) {
            ...
            c && (t.i++, t.Push(t.itemFactory.create("auto open").setProperties({
              open: s,
              close: l
            })));
          }
        ...
        function w(t, e, r) {
          var o = n(t, 3),
            ...
            i = o[1],
            s = o[2];
          return e && r ? "\\left\\langle{".concat(a, "}\\middle\\vert{").concat(i, "}\\middle\\vert{").concat(s, "}\\right\\rangle") : e ? "\\langle{".concat(a, "}\\vert{").concat(i, "}\\vert{").concat(s, "}\\rangle") : "\\left\\langle{".concat(a, "}\\right\\vert{").concat(i, "}\\left\\vert{").concat(s, "}\\right\\rangle");
        }
        d.OperatorApplication = function (t, e, r) {
          ...
          t.Push(t.itemFactory.create("fn", a)), "(" === t.GetNext() && (t.i++, t.Push(t.itemFactory.create("auto open").setProperties({
            open: "(",
            close: ")"
          })));
          ...
          if (a || s) {
            ...
            } else t.Push(new i.default(c, t.stack.env, t.configuration).mml()), t.i++, t.Push(t.itemFactory.create("auto open").setProperties({
              open: "(",
              close: ")"
            }));
          } else {
          ...
          var c = !1,
            u = " ",
            p = " ";
          r > 2 && l.length > 2 ? (u = "^{" + (l.length - 1) + "}", c = !0) : null != a && (r > 2 && l.length > 1 && (c = !0), p = u = "^{" + a + "}");
          for (var d = o ? "\\flatfrac" : "\\frac", f = l.length > 1 ? l[0] : "", h = l.length > 1 ? l[1] : l[0], m = "", g = 2, y = void 0; y = l[g]; g++) m += n + " " + y;
          var v = d + "{" + n + u + f + "}{" + n + " " + h + p + " " + m + "}";
          t.Push(new i.default(v, t.stack.env, t.configuration).mml()), "(" === t.GetNext() && (t.i++, t.Push(t.itemFactory.create("auto open").setProperties({
            open: "(",
            close: ")",
            ignore: c
          })));
          ...
          if ("\\" === t.GetNext()) {
            ...
            var c = t.GetCS(),
              u = t.lookup("macro", c);
            u && "ket" === u.symbol ? (a = !0, l = t.i, s = t.GetStar(), "{" === t.GetNext() ? o = t.GetArgument(c, !0) : (t.i = l, s = !1)) : t.i = l;
          }
          var p = "";
          p = a ? r || s ? "\\langle{".concat(n, "}\\vert{").concat(o, "}\\rangle") : "\\left\\langle{".concat(n, "}\\middle\\vert{").concat(o, "}\\right\\rangle") : r || s ? "\\langle{".concat(n, "}\\vert") : "\\left\\langle{".concat(n, "}\\right\\vert{").concat(o, "}"), t.Push(new i.default(p, t.stack.env, t.configuration).mml());
        }, d.Ket = function (t, e) {
          var r = t.GetStar(),
            n = t.GetArgument(e),
          ...
          var a = "";
          a = null == o ? r ? "\\langle{".concat(n, "}\\vert{").concat(n, "}\\rangle") : "\\left\\langle{".concat(n, "}\\middle\\vert{").concat(n, "}\\right\\rangle") : r ? "\\langle{".concat(n, "}\\vert{").concat(o, "}\\rangle") : "\\left\\langle{".concat(n, "}\\middle\\vert{").concat(o, "}\\right\\rangle"), t.Push(new i.default(a, t.stack.env, t.configuration).mml());
          ...
          "{" === t.GetNext() && (o = t.GetArgument(e, !0));
          var a = "";
          a = null == o ? r ? "\\vert{".concat(n, "}\\rangle\\!\\langle{").concat(n, "}\\vert") : "\\left\\vert{".concat(n, "}\\middle\\rangle\\!\\middle\\langle{").concat(n, "}\\right\\vert") : r ? "\\vert{".concat(n, "}\\rangle\\!\\langle{").concat(o, "}\\vert") : "\\left\\vert{".concat(n, "}\\middle\\rangle\\!\\middle\\langle{").concat(o, "}\\right\\vert"), t.Push(new i.default(a, t.stack.env, t.configuration).mml());
          ...
          var s = o && a ? w([a, o, a], r, n) : r ? "\\langle {".concat(o, "} \\rangle") : "\\left\\langle {".concat(o, "} \\right\\rangle");
          ...
          var p = "";
          if (1 === i && 1 === l) p = n;else if (1 === i) {
            c = [];
            for (var d = 1; d <= l; d++) c.push("".concat(n, "_{").concat(d, "}"));
            p = c.join(" & ");
          } else if (1 === l) {
            for (c = [], d = 1; d <= i; d++) c.push("".concat(n, "_{").concat(d, "}"));
            p = c.join("\\\\ ");
          } else {
            var f = [];
            for (d = 1; d <= i; d++) {
              c = [];
              for (var h = 1; h <= l; h++) c.push("".concat(n, "_{{").concat(d, "}{").concat(h, "}}"));
              f.push(c.join(" & "));
            }
            p = f.join("\\\\ ");
          }
          ...
          if ("{" === t.GetNext()) {
            ...
            t.string = function (t, e) {
              ...
              return n.join("\\\\ ");
            }(a, r) + t.string.slice(o), t.i = 0;
          }
        }, d.AutoClose = function (t, e, r) {
          var n = t.create("token", "mo", {
              stretchy: !1
            }, e),
            o = t.itemFactory.create("mml", n).setProperties({
              autoclose: e
            });
          t.Push(o);
      ...
      4303: function (t, e, r) {
        ...
        function g(t, e) {
          ...
          if (a.indexOf(i) < 0) {
            ...
            if (l) {
              var c = m[e] || {};
              l.options && 1 === Object.keys(l.options).length && l.options[i] && ((r = {})[i] = c, c = r), t.configuration.add(i, t, c);
        ...
        function y(t, e) {
          ...
          if (!(n.hasOwnProperty(o) ? n[o] : n.hasOwnProperty(e) ? n[e] : r.defaultAllow)) throw new c.default("BadRequire", 'Extension "%1" is not allowed to be loaded', o);
          p.Package.packages.has(o) ? g(t.configuration.packageData.get("require").jax, o) : f.mathjax.retryAfter(d.Loader.load(o));
        }
        e.RequireLoad = y, e.RequireMethods = {
          Require: function (t, e) {
            var r = t.GetArgument(e);
            if (r.match(/[^_a-zA-Z0-9]/) || "" === r) throw new c.default("BadPackageName", "Argument for %1 is not a valid package name", e);
            y(t, r);
          }
        }, e.options = {
          require: {
        ...
        }, new l.CommandMap("require", {
          require: "Require"
        }, e.RequireMethods), e.RequireConfiguration = s.Configuration.create("require", {
          handler: {
            macro: ["require"]
          },
          config: function (t, e) {
      ...
      955: function (t, e, r) {
        ...
        e.SetOptionsUtil = {
          filterPackage: function (t, e) {
            ...
            var r = t.options.setoptions,
              n = r.allowOptions[e];
            if (void 0 === n && !r.allowPackageDefault || !1 === n) throw new s.default("PackageNotSettable", 'Options can\'t be set for package "%1"', e);
            return !0;
          },
          filterOption: function (t, e, r) {
            ...
            if (!(null === (n = "tex" === e ? t.options : t.options[e]) || void 0 === n ? void 0 : n.hasOwnProperty(r))) throw "tex" === e ? new s.default("InvalidTexOption", 'Invalid TeX option "%1"', r) : new s.default("InvalidOptionKey", 'Invalid option "%1" for package "%2"', r, e);
            return !0;
          },
        ...
        var d = new i.CommandMap("setoptions", {
        ...
        e.SetOptionsConfiguration = a.Configuration.create("setoptions", {
          ...
          config: function (t, e) {
            ...
            r && (d.add("Require", new c.Macro("Require", r._func)), d.add("require", new c.Macro("require", u.default.Macro, ["\\Require{#2}\\setOptions[#2]{#1}", 2, ""])));
          },
          priority: 3,
          options: {
            setoptions: {
      ...
      7368: function (t, e, r) {
        ...
        function l(t, e) {
          ...
          var n = function (t) {
              ...
              return o(r, t), r.prototype.formatNumber = function (t) {
        ...
        e.tagformatConfig = l, e.TagFormatConfiguration = a.Configuration.create("tagformat", {
          config: [l, 10],
          options: {
            tagformat: {
              number: function (t) {
      ...
      4609: function (t, e, r) {
        ...
        var o = r(7628),
          ...
          s = n(r(7702)),
          l = r(4302);
        new o.CommandMap("textcomp-macros", {
          ...
          Insert: function (t, e, r, n) {
            ...
            t.Push(s.default.internalText(t, r, n ? {
              mathvariant: n
            } : {}));
          }
        });
      ...
      82: function (t, e, r) {
        ...
        function p(t, e, r, n) {
          ...
          return t instanceof c.TextParser || (o.texParser = t), [new c.TextParser(e, n ? {
            mathvariant: n
          } : {}, o.parseOptions, r).mml()];
        }
        r(7900), e.TextBaseConfiguration = a.Configuration.create("text-base", {
          parser: "text",
          handler: {
          ...
          fallback: {
            ...
            macro: function (t, e) {
              var r = t.texParser,
                n = r.lookup("macro", e);
              n && n._func !== u.TextMacrosMethods.Macro && t.Error("MathMacro", "%1 is only supported in math mode", "\\" + e), r.parse("macro", [t, e]);
            }
          },
          items: (n = {}, n[l.StartItem.prototype.kind] = l.StartItem, n[l.StopItem.prototype.kind] = l.StopItem, n[l.MmlItem.prototype.kind] = l.MmlItem, n[l.StyleItem.prototype.kind] = l.StyleItem, n)
          ...
          config: function (t, e) {
            ...
            n.options = e.parseOptions.options, r.config(e), s.TagsFactory.addTags(r.tags), n.tags = s.TagsFactory.getDefault(), n.tags.configuration = n, n.packageData = e.parseOptions.packageData, n.packageData.set("textmacros", {
              parseOptions: n,
              jax: e,
              texParser: null
            }), n.options.internalMath = p;
          },
          preprocessors: [function (t) {
      ...
      7900: function (t, e, r) {
        ...
        new n.MacroMap("text-special", {
          ...
          "`": "OpenQuote",
          "'": "CloseQuote"
        }, a.TextMacrosMethods), new n.CommandMap("text-macros", {
          "(": "Math",
          $: "SelfQuote",
          _: "SelfQuote",
          "%": "SelfQuote",
      ...
      440: function (t, e, r) {
        ...
        e.TextMacrosMethods = {
          ...
          Math: function (t, e) {
            t.saveText();
            for (var r, n, a = t.i, i = 0; n = t.GetNext();) switch (r = t.i++, n) {
              case "\\":
                ")" === t.GetCS() && (n = "\\(");
              case "$":
                if (0 === i && e === n) {
      ...
      4302: function (t, e, r) {
        ...
        var c = l(r(810)),
          ...
          m = function (t) {
            ...
            return o(e, t), Object.defineProperty(e.prototype, "texParser", {
              get: function () {
              ...
              if (this.text) {
                var t = this.stack.env.mathvariant,
                  e = p.default.internalText(this, this.text, t ? {
                    mathvariant: t
                  } : {});
                this.text = "", this.Push(e);
              }
            }, e.prototype.Push = function (e) {
              if (this.text && this.saveText(), e instanceof h.StopItem) return t.prototype.Push.call(this, e);
              e instanceof h.StyleItem ? this.stack.env.mathcolor = this.stack.env.color : e instanceof d.AbstractMmlNode && (this.addAttributes(e), this.nodes.push(e));
              ...
              try {
                for (var o = a(["mathsize", "mathcolor"]), i = o.next(); !i.done; i = o.next()) {
                  var s = i.value;
                  n[s] && !t.attributes.getExplicit(s) && (t.isToken || t.isKind("mstyle") || (t = this.create("node", "mstyle", [t])), f.default.setAttribute(t, s, n[s]));
                }
              } catch (t) {
                e = {
                  error: t
      ...
      1158: function (t, e, r) {
        ...
        e.UnicodeMethods.Unicode = function (t, e) {
          var r = t.GetBrackets(e),
            n = null,
            o = null;
          r && (r.replace(/ /g, "").match(/^(\d+(\.\d*)?|\.\d+),(\d+(\.\d*)?|\.\d+)$/) ? (n = r.replace(/ /g, "").split(/,/), o = t.GetBrackets(e)) : o = r);
          ...
          u[p] ? o || (o = u[p][2]) : u[p] = [800, 200, o, p], n && (u[p][0] = Math.floor(1e3 * parseFloat(n[0])), u[p][1] = Math.floor(1e3 * parseFloat(n[1])));
          var d = t.stack.env.font,
            f = {};
          o ? (u[p][2] = f.fontfamily = o.replace(/'/g, "'"), d && (d.match(/bold/) && (f.fontweight = "bold"), d.match(/italic|-mathit/) && (f.fontstyle = "italic"))) : d && (f.mathvariant = d);
          var h = t.create("token", "mtext", f, (0, c.numeric)(i));
          l.default.setProperty(h, "unicode", !0), t.Push(h);
        }, new i.CommandMap("unicode", {
          unicode: "Unicode"
        }, e.UnicodeMethods), e.UnicodeConfiguration = o.Configuration.create("unicode", {
          handler: {
            macro: ["unicode"]
          }
        });
      ...
      3450: function (t, e, r) {
        ...
        var n = r(6552),
          o = r(7628),
          a = r(7007);
        new o.CharacterMap("upgreek", function (t, e) {
          var r = e.attributes || {};
      ...
      4325: function (t, e, r) {
        ...
        var o = r(6552),
          ...
          i = r(7628),
          s = n(r(3466));
        e.VerbMethods = {}, e.VerbMethods.Verb = function (t, e) {
          var r = t.GetNext(),
            n = ++t.i;
        ...
        }, new i.CommandMap("verb", {
          verb: "Verb"
        }, e.VerbMethods), e.VerbConfiguration = o.Configuration.create("verb", {
          handler: {
            macro: ["verb"]
          }
        });
      ...
      3857: function (t, e) {
        Object.defineProperty(e, "__esModule", {
          value: !0
        }), e.OPDEF = MathJax._.core.MmlTree.OperatorDictionary.OPDEF, e.MO = MathJax._.core.MmlTree.OperatorDictionary.MO, e.RANGES = MathJax._.core.MmlTree.OperatorDictionary.RANGES, e.getRange = MathJax._.core.MmlTree.OperatorDictionary.getRange, e.MMLSPACING = MathJax._.core.MmlTree.OperatorDictionary.MMLSPACING, e.OPTABLE = MathJax._.core.MmlTree.OperatorDictionary.OPTABLE;
      },
      752: function (t, e) {
        Object.defineProperty(e, "__esModule", {
          value: !0
      ...
      239: function (t, e) {
        Object.defineProperty(e, "__esModule", {
          value: !0
        }), e.handleRetriesFor = MathJax._.util.Retries.handleRetriesFor, e.retryAfter = MathJax._.util.Retries.retryAfter;
      },
      6914: function (t, e) {
        Object.defineProperty(e, "__esModule", {
          value: !0
      ...
      6720: function (t, e) {
        Object.defineProperty(e, "__esModule", {
          value: !0
        }), e.sortLength = MathJax._.util.string.sortLength, e.quotePattern = MathJax._.util.string.quotePattern, e.unicodeChars = MathJax._.util.string.unicodeChars, e.unicodeString = MathJax._.util.string.unicodeString, e.isPercent = MathJax._.util.string.isPercent, e.split = MathJax._.util.string.split;
      },
      847: function (t, e) {
        Object.defineProperty(e, "__esModule", {
          value: !0
        }), e.PathFilters = MathJax._.components.loader.PathFilters, e.Loader = MathJax._.components.loader.Loader, e.MathJax = MathJax._.components.loader.MathJax, e.CONFIG = MathJax._.components.loader.CONFIG;
      },
      1993: function (t, e) {
        Object.defineProperty(e, "__esModule", {
          value: !0
        }), e.PackageError = MathJax._.components.package.PackageError, e.Package = MathJax._.components.package.Package;
      },
      7865: function (t, e) {
        /*!
         *************************************************************************
        ...
        function n(t) {
          var e,
            r,
            n = {};
          for (e in t) for (r in t[e]) {
            var o = r.split("|");
            t[e][r].stateArray = o;
            for (var a = 0; a < o.length; a++) n[o[a]] = [];
          }
          for (e in t) for (r in t[e]) for (o = t[e][r].stateArray || [], a = 0; a < o.length; a++) {
            var i = t[e][r];
            i.action_ = [].concat(i.action_);
            for (var s = 0; s < i.action_.length; s++) "string" == typeof i.action_[s] && (i.action_[s] = {
              type_: i.action_[s]
            });
            for (var l = e.split("|"), c = 0; c < l.length; c++) if ("*" === o[a]) {
              var u = void 0;
              for (u in n) n[u].push({
                pattern: l[c],
                task: i
        ...
        var o = {
                ...
                t: for (var u = 0; u < c.length; u++) {
                  ...
                  if (p) {
                    for (var d = c[u].task, f = 0; f < d.action_.length; f++) {
                      var h = void 0;
                      if (l.actions[d.action_[f].type_]) h = l.actions[d.action_[f].type_](a, p.match_, d.action_[f].option);else {
                        if (!o.actions[d.action_[f].type_]) throw ["MhchemBugA", "mhchem bug A. Please report. (" + d.action_[f].type_ + ")"];
                        h = o.actions[d.action_[f].type_](a, p.match_, d.action_[f].option);
                      }
                      o.concatArray(s, h);
                    }
                    if (n = d.nextState || n, !(t.length > 0)) return s;
                    if (d.revisit || (t = p.remainder), !d.toContinue) break t;
                  }
                }
            ...
            concatArray: function (t, e) {
              if (e) if (Array.isArray(e)) for (var r = 0; r < e.length; r++) t.push(e[r]);else t.push(e);
            },
            patterns: {
              patterns: {
                empty: /^$/,
                ...
                "\\color{(...)}{(...)}": function (t) {
                  return o.patterns.findObserveGroups(t, "\\color{", "", "", "}", "{", "", "", "}") || o.patterns.findObserveGroups(t, "\\color", "\\", "", /^(?=\{)/, "{", "", "", "}");
                },
                "\\ce{(...)}": function (t) {
            ...
            actions: {
              ...
              "1/2": function (t, e) {
                ...
                return n[1] = n[1].replace(/\$/g, ""), r.push({
                  type_: "frac",
                  p1: n[1],
                  p2: n[2]
                }), n[3] && (n[3] = n[3].replace(/\$/g, ""), r.push({
                  type_: "tex-math",
                  p1: n[3]
                })), r;
              },
                ...
                actions: {
                  "o after d": function (t, e) {
                    ...
                    if ((t.d || "").match(/^[1-9][0-9]*$/)) {
                      var n = t.d;
                      t.d = void 0, (r = this.output(t)).push({
                        type_: "tinySkip"
                      }), t.b = n;
                  ...
                  "- after o/d": function (t, e, r) {
                    ...
                    var c = [];
                    return l ? (o.concatArray(c, this.output(t)), c.push({
                      type_: "hyphen"
                    })) : (n = o.patterns.match_("digits", t.d || ""), r && n && "" === n.remainder ? (o.concatArray(c, o.actions["d="](t, e)), o.concatArray(c, this.output(t))) : (o.concatArray(c, this.output(t)), o.concatArray(c, o.actions.bond(t, e, "-")))), c;
                  },
                  "a to o": function (t) {
                    t.o = t.a, t.a = void 0;
                  },
                  ...
                  output: function (t, e, r) {
                    ...
                    if (t.r) {
                      var a = void 0;
                      a = "M" === t.rdt ? o.go(t.rd, "tex-math") : "T" === t.rdt ? [{
                        type_: "text",
                        p1: t.rd || ""
                      }] : o.go(t.rd, "ce");
                      var i = void 0;
                      i = "M" === t.rqt ? o.go(t.rq, "tex-math") : "T" === t.rqt ? [{
                        type_: "text",
                        p1: t.rq || ""
                      }] : o.go(t.rq, "ce"), n = {
                        type_: "arrow",
                    ...
                    } else n = [], (t.a || t.b || t.p || t.o || t.q || t.d || r) && (t.sb && n.push({
                      type_: "entitySkip"
                    }), t.o || t.q || t.d || t.b || t.p || 2 === r ? t.o || t.q || t.d || !t.b && !t.p ? t.o && "kv" === t.dType && o.patterns.match_("d-oxidation$", t.d || "") ? t.dType = "oxidation" : t.o && "kv" === t.dType && !t.q && (t.dType = void 0) : (t.o = t.a, t.d = t.b, t.q = t.p, t.a = t.b = t.p = void 0) : (t.o = t.a, t.a = void 0), n.push({
                      type_: "chemfive",
                      a: o.go(t.a, "a"),
                      b: o.go(t.b, "bd"),
                      p: o.go(t.p, "pq"),
              ...
              pu: {
                ...
                actions: {
                  enumber: function (t, e) {
                    var r = [];
                    return "+-" === e[0] || "+/-" === e[0] ? r.push("\\pm ") : e[0] && r.push(e[0]), e[1] && (o.concatArray(r, o.go(e[1], "pu-9,9")), e[2] && (e[2].match(/[,.]/) ? o.concatArray(r, o.go(e[2], "pu-9,9")) : r.push(e[2])), (e[3] || e[4]) && ("e" === e[3] || "*" === e[4] ? r.push({
                      type_: "cdot"
                    }) : r.push({
                      type_: "times"
                    }))), e[5] && r.push("10^{" + e[5] + "}"), r;
                  ...
                  "number^": function (t, e) {
                    var r = [];
                    return "+-" === e[0] || "+/-" === e[0] ? r.push("\\pm ") : e[0] && r.push(e[0]), o.concatArray(r, o.go(e[1], "pu-9,9")), r.push("^{" + e[2] + "}"), r;
                  },
                  operator: function (t, e, r) {
                    return {
                      type_: "operator",
                  ...
                  output: function (t) {
                    ...
                    if (n && "" === n.remainder && (t.q = n.match_), t.d && (t.d = t.d.replace(/\u00B0C|\^oC|\^{o}C/g, "{}^{\\circ}C"), t.d = t.d.replace(/\u00B0F|\^oF|\^{o}F/g, "{}^{\\circ}F")), t.q) {
                ...
                actions: {
                  ...
                  output: function (t) {
                    ...
                    if (t.rm) {
                      ...
                      e = r && "" === r.remainder ? o.go(r.match_, "pu") : {
                        type_: "rm",
                        p1: t.rm
                      };
                    }
                ...
                actions: {
                  ...
                  "output-0": function (t) {
                    ...
                    if (t.text_ = t.text_ || "", t.text_.length > 4) {
                      ...
                      0 === r && (r = 3);
                      for (var n = t.text_.length - 3; n > 0; n -= 3) e.push(t.text_.substr(n, 3)), e.push({
                  ...
                  "output-o": function (t) {
                    ...
                    if (t.text_ = t.text_ || "", t.text_.length > 4) {
                      var r = t.text_.length - 3,
                        n = void 0;
                      for (n = 0; n < r; n += 3) e.push(t.text_.substr(n, 3)), e.push({
                        type_: "1000 separator"
                      });
            ...
            _go2: function (t) {
              ...
              switch (t.type_) {
                case "chemfive":
                  ...
                  r.a && (r.a.match(/^[+\-]/) && (r.a = "{" + r.a + "}"), e += r.a + "\\,"), (r.b || r.p) && (e += "{\\vphantom{A}}", e += "^{\\hphantom{" + (r.b || "") + "}}_{\\hphantom{" + (r.p || "") + "}}", e += "\\mkern-1.5mu", e += "{\\vphantom{A}}", e += "^{\\smash[t]{\\vphantom{2}}\\llap{" + (r.b || "") + "}}", e += "_{\\vphantom{2}\\llap{\\smash[t]{" + (r.p || "") + "}}}"), r.o && (r.o.match(/^[+\-]/) && (r.o = "{" + r.o + "}"), e += r.o), "kv" === t.dType ? ((r.d || r.q) && (e += "{\\vphantom{A}}"), r.d && (e += "^{" + r.d + "}"), r.q && (e += "_{\\smash[t]{" + r.q + "}}")) : "oxidation" === t.dType ? (r.d && (e += "{\\vphantom{A}}", e += "^{" + r.d + "}"), r.q && (e += "{\\vphantom{A}}", e += "_{\\smash[t]{" + r.q + "}}")) : (r.q && (e += "{\\vphantom{A}}", e += "_{\\smash[t]{" + r.q + "}}"), r.d && (e += "{\\vphantom{A}}", e += "^{" + r.d + "}"));
                  break;
                case "rm":
                case "roman numeral":
                  e = "\\mathrm{" + t.p1 + "}";
                ...
                case "arrow":
                  var i = {
                    ...
                    s = a._getArrow(t.r);
                  i.rd || i.rq ? "<=>" === t.r || "<=>>" === t.r || "<<=>" === t.r || "<--\x3e" === t.r ? (s = "\\long" + s, i.rd && (s = "\\overset{" + i.rd + "}{" + s + "}"), i.rq && (s = "<--\x3e" === t.r ? "\\underset{\\lower2mu{" + i.rq + "}}{" + s + "}" : "\\underset{\\lower6mu{" + i.rq + "}}{" + s + "}"), s = " {}\\mathrel{" + s + "}{} ") : (i.rq && (s += "[{" + i.rq + "}]"), s = " {}\\mathrel{\\x" + (s += "{" + i.rd + "}") + "}{} ") : s = " {}\\mathrel{\\long" + s + "}{} ", e = s;
                  break;
                case "operator":
  ...
  !function () {
      ...
      _: {
        input: {
          ...
          tex: {
            ...
            TexParser: M,
            action: {
              ActionConfiguration: w
            },
            amscd: {
              AmsCdConfiguration: A,
              AmsCdMethods: C
            },
            ams: {
              AmsConfiguration: P,
            ...
            cancel: {
              CancelConfiguration: V
            },
            cases: {
              CasesConfiguration: U
            },
            centernot: {
              CenternotConfiguration: $
            },
            colortbl: {
              ColortblConfiguration: X
            },
            colorv2: {
              ColorV2Configuration: z
            },
            color: {
            ...
            configmacros: {
              ConfigMacrosConfiguration: Q
            },
            empheq: {
              EmpheqConfiguration: Z,
              EmpheqUtil: Y
            },
            enclose: {
              EncloseConfiguration: tt
            },
            extpfeil: {
              ExtpfeilConfiguration: et
            },
            gensymb: {
              GensymbConfiguration: rt
            },
            html: {
              HtmlConfiguration: nt,
              HtmlMethods: ot
            },
            mathtools: {
            ...
            noerrors: {
              NoErrorsConfiguration: mt
            },
            noundefined: {
              NoUndefinedConfiguration: gt
            },
            physics: {
            ...
            require: {
              RequireConfiguration: xt
            },
            setoptions: {
              SetOptionsConfiguration: _t
            },
            tagformat: {
              TagFormatConfiguration: Mt
            },
            textcomp: {
              TextcompConfiguration: wt
            },
            textmacros: {
            ...
            unicode: {
              UnicodeConfiguration: St
            },
            upgreek: {
              UpgreekConfiguration: Ot
            },
            verb: {
              VerbConfiguration: Tt
            }
          }
        }
      }
    ...
    function It() {
      ...
      if (MathJax.startup) {
        e && (MathJax.startup.registerConstructor("tex", MathJax._.input.tex_ts.TeX), MathJax.startup.useInput("tex")), MathJax.config.tex || (MathJax.config.tex = {});
        var r = MathJax.config.tex.packages;
        MathJax.config.tex.packages = t, r && (0, Et.insert)(MathJax.config.tex, {
          packages: r
        });
      }
    }
    ...
    MathJax.loader && MathJax.loader.preLoad("[tex]/autoload", "[tex]/require"), It(["require"].concat(function (t) {
      if (Array.isArray(t)) return Nt(t);
    }(kt = o.AllPackages) || function (t) {
    ...
    }()), !1), MathJax.loader && MathJax.loader.preLoad("input/tex-base", "[tex]/all-packages"), It();
  }();
}();