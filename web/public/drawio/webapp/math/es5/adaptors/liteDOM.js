...
!function () {
    ...
    s = {
      244: function (t, e, n) {
        ...
        e.NodeMixinOptions = {
          ...
          var r;
          return void 0 === n && (n = {}), n = (0, a.userOptions)((0, a.defaultOptions)({}, e.NodeMixinOptions), n), r = function (t) {
            function e() {
            ...
            return o(e, t), e.prototype.fontSize = function (e) {
              return n.badCSS ? this.options.fontSize : t.prototype.fontSize.call(this, e);
            }, e.prototype.fontFamily = function (e) {
              return n.badCSS ? this.options.fontFamily : t.prototype.fontFamily.call(this, e);
            }, e.prototype.nodeSize = function (r, o, i) {
              if (void 0 === o && (o = 1), void 0 === i && (i = null), !n.badSizes) return t.prototype.nodeSize.call(this, r, o, i);
              var a = this.textContent(r),
                l = Array.from(a.replace(e.cjkPattern, "")).length;
              return [(Array.from(a).length - l) * this.options.cjkCharWidth + l * this.options.unknownCharWidth, this.options.unknownCharHeight];
            ...
            unknownCharWidth: .6,
            unknownCharHeight: .8
          } : {}), r.cjkPattern = new RegExp(["[", "\u1100-\u115f", "\u2329\u232a", "\u2e80-\u303e", "\u3040-\u3247", "\u3250-\u4dbf", "\u4e00-\ua4c6", "\ua960-\ua97c", "\uac00-\ud7a3", "\uf900-\ufaff", "\ufe10-\ufe19", "\ufe30-\ufe6b", "\uff01-\uff60\uffe0-\uffe6", "\ud82c\udc00-\ud82c\udc01", "\ud83c\ude00-\ud83c\ude51", "\ud840\udc00-\ud8bf\udffd", "]"].join(""), "gu"), r;
        };
      },
      877: function (t, e, n) {
        Object.defineProperty(e, "__esModule", {
      ...
      946: function (t, e) {
        ...
        var a = function (t, e, a) {
          ...
          try {
            for (var s = i(this.children), c = s.next(); !c.done; c = s.next()) c.value.parent = this;
          } catch (t) {
            l = {
              error: t
            };
      ...
      246: function (t, e, n) {
        ...
        var f = function () {
          function t() {}
          return t.prototype.parseFromString = function (t, e, n) {
            void 0 === e && (e = "text/html"), void 0 === n && (n = null);
            for (var r = n.createDocument(), o = n.body(r), i = t.replace(/<\?.*?\?>/g, "").split(u.tag); i.length;) {
              var a = i.shift(),
                l = i.shift();
              a && this.addText(n, o, a), l && ">" === l.charAt(l.length - 1) && ("!" === l.charAt(1) ? this.addComment(n, o, l) : o = "/" === l.charAt(1) ? this.closeTag(n, o, l) : this.openTag(n, o, l, i));
            }
            ...
            for (var r = n.slice(2, n.length - 1).toLowerCase(); t.parent(e) && t.kind(e) !== r;) e = t.parent(e);
            return t.parent(e);
            ...
            var o = this.constructor.PCDATA,
              ...
              l = t.node(a),
              s = n.replace(/^<.*?[\s\n>]/, "").split(u.attrsplit);
            return (s.pop().match(/>$/) || s.length < 5) && (this.addAttributes(t, l, s), t.append(e, l), i[a] || n.match(/\/>$/) || (o[a] ? this.handlePCDATA(t, l, a, r) : e = l)), e;
            ...
            for (var o = [], i = "</" + n + ">", a = ""; r.length && a !== i;) o.push(a), o.push(r.shift()), a = r.shift();
            ...
            var o = this.constructor.SELF_CLOSING,
              ...
              a = t.kind(e),
              l = t.allAttributes(e).map(function (t) {
                return t.name + '="' + (i[t.name] ? t.value : r.protectAttribute(t.value)) + '"';
              }).join(" "),
              u = this.serializeInner(t, e, n);
            return "<" + a + (l ? " " + l : "") + (n && !u || o[a] ? n ? "/>" : ">" : ">".concat(u, "</").concat(a, ">"));
          }, t.prototype.serializeInner = function (t, e, n) {
            var r = this;
            return void 0 === n && (n = !1), this.constructor.PCDATA.hasOwnProperty(e.kind) ? t.childNodes(e).map(function (e) {
              return t.value(e);
            }).join("") : t.childNodes(e).map(function (e) {
              var o = t.kind(e);
              return "#text" === o ? r.protectHTML(t.value(e)) : "#comment" === o ? e.value : r.serialize(t, e, n);
            }).join("");
      ...
      735: function (t, e) {
        ...
        var i = function (t) {
          ...
          return r(e, t), Object.defineProperty(e.prototype, "kind", {
            get: function () {
              return "#comment";
            },
            enumerable: !1,
      ...
      492: function (t, e, n) {
        ...
        var r = n(946),
          ...
          a = n(246),
          l = function () {
            this.DOMParser = a.LiteParser, this.NodeList = i.LiteList, this.HTMLCollection = i.LiteList, this.HTMLElement = r.LiteElement, this.DocumentFragment = i.LiteList, this.Document = o.LiteDocument, this.document = new o.LiteDocument();
          };
        e.LiteWindow = l;
      },
      250: function (t, e, n) {
        ...
        var s = n(857),
          ...
          b = function (t) {
            ...
            return o(e, t), e.prototype.parse = function (t, e) {
              ...
              for (var i = t; i;) {
                var a = i.kind;
                "#text" !== a && "#comment" !== a && (i = i, a === e && o.push(i), i.children.length && (r = i.children.concat(r))), i = r.shift();
              }
              return o;
              ...
              for (var n = [], r = [], o = t; o;) {
                if ("#text" !== o.kind && "#comment" !== o.kind) ((o = o).attributes.class || "").trim().split(/ +/).includes(e) && r.push(o), o.children.length && (n = o.children.concat(n));
                o = n.shift();
              }
              return r;
                ...
                for (var l = a(t), u = l.next(); !u.done; u = l.next()) {
                  ...
                  if ("string" == typeof s) {
                    if ("#" === s.charAt(0)) {
                      ...
                      c && o.push(c);
                    } else "." === s.charAt(0) ? o = o.concat(this.elementsByClass(i, s.slice(1))) : s.match(/^[-a-z][-a-z0-9]*$/i) && (o = o.concat(this.tags(i, s)));
                  } else Array.isArray(s) ? o = o.concat(s) : s instanceof this.window.NodeList || s instanceof this.window.HTMLCollection ? o = o.concat(s.nodes) : o.push(s);
                }
              } catch (t) {
                n = {
                  error: t
              ...
              return t.value = t.value.slice(0, e), t.parent.children.splice(this.childIndex(t) + 1, 0, n), n.parent = t.parent, n;
              ...
              void 0 === r && (r = null), "string" != typeof n && (n = String(n)), r && (e = r.replace(/.*\//, "") + ":" + e.replace(/^.*:/, "")), t.attributes[e] = n, "style" === e && (t.styles = null);
              ...
              t.styles || (t.styles = new v.Styles(this.getAttribute(t, "style"))), t.styles.set(e, n), t.attributes.style = t.styles.cssText;
        ...
        e.LiteAdaptor = m, e.liteAdaptor = function (t) {
  ...
  t = p(723), e = p(306), n = p(250), r = p(877), o = p(946), i = p(6), a = p(246), l = p(735), u = p(492), MathJax.loader && MathJax.loader.checkVersion("adaptors/liteDOM", e.q, "adaptors"), (0, t.r8)({
    _: {
      adaptors: {
        liteAdaptor: n,
        lite: {
