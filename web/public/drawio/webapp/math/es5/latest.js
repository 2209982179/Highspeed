...
!function () {
  ...
  var t = {
      907: function (t, e) {
        ...
        var n = new Map([["cdnjs.cloudflare.com", {
          ...
          try {
            for (var o = r(n.keys()), i = o.next(); !i.done; i = o.next()) {
              var c = i.value,
                ...
                u = s.base,
                d = t.src;
              if (d && d.substr(0, u.length) === u && d.match(/\/latest\.js(\?|$)/)) return l(t, s);
            }
          } catch (t) {
            e = {
              error: t
        ...
        function p(t) {
          return 3 === parseInt(t.split(/\./)[0]) && !t.match(/-(beta|rc)/) && (function (t) {
            try {
              var e = t + " " + Date.now();
        ...
        function m(t, e, r) {
          ...
          a ? (a.onreadystatechange = function () {
            4 === a.readyState && (200 === a.status ? !e(JSON.parse(a.responseText)) && r() : (s("Problem acquiring MathJax version: status = " + a.status), r()));
          }, a.open("GET", t.api, !0), a.send(null)) : (s("Can't create XMLHttpRequest object"), r());
        }
        function y() {
          m(c.cdn, function (t) {
            return t instanceof Array && (t = t[0]), p(t[c.cdn.key]) || m(o, function (t) {
              var e, a;
              if (!(t instanceof Array)) return !1;
              try {
                for (var n = r(t), i = n.next(); !i.done; i = n.next()) if (p(i.value[o.key])) return !0;
              } catch (t) {
                e = {
                  error: t
                };
