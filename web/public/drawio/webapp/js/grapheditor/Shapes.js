...
(function () {
  ...
  TableShape.prototype.paintTableForeground = function (c, x, y, w, h) {
    var lines = this.state.view.graph.getTableLines(this.state.cell, mxUtils.getValue(this.state.style, 'rowLines', '1') != '0', mxUtils.getValue(this.state.style, 'columnLines', '1') != '0');
  ...
  mxRectangleShape.prototype.isHtmlAllowed = function () {
    return !this.outline && (this.style == null || mxUtils.getValue(this.style, 'comic', '0') == '0' && mxUtils.getValue(this.style, 'sketch', urlParams['rough'] == '1' ? '1' : '0') == '0') && mxRectangleShapeIsHtmlAllowed0.apply(this, arguments);
  };
  ...
  HexagonShape.prototype.redrawPath = function (c, x, y, w, h) {
    var fixed = mxUtils.getValue(this.style, 'fixedSize', '0') != '0';
    var s = fixed ? Math.max(0, Math.min(w * 0.5, parseFloat(mxUtils.getValue(this.style, 'size', this.fixedSize)))) : w * Math.max(0, Math.min(1, parseFloat(mxUtils.getValue(this.style, 'size', this.size))));
    var arcSize = mxUtils.getValue(this.style, mxConstants.STYLE_ARCSIZE, mxConstants.LINE_ARCSIZE) / 2;
  ...
  UmlFrame.prototype.configurePointerEvents = function (c) {
    ...
    if (this.style != null && (bg == null || bg == mxConstants.NONE || this.opacity == 0 || this.fillOpacity == 0) && mxUtils.getValue(this.style, mxConstants.STYLE_POINTER_EVENTS, '1') == '0') {
      c.pointerEvents = false;
    }
  };
  ...
  */
  ...
  ModuleShape.prototype.getConstraints = function (style, w, h) {
    ...
    var constr = [new mxConnectionConstraint(new mxPoint(0, 0), false, null, x0), new mxConnectionConstraint(new mxPoint(0.25, 0), true), new mxConnectionConstraint(new mxPoint(0.5, 0), true), new mxConnectionConstraint(new mxPoint(0.75, 0), true), new mxConnectionConstraint(new mxPoint(1, 0), true), new mxConnectionConstraint(new mxPoint(1, 0.25), true), new mxConnectionConstraint(new mxPoint(1, 0.5), true), new mxConnectionConstraint(new mxPoint(1, 0.75), true), new mxConnectionConstraint(new mxPoint(0, 1), false, null, x0), new mxConnectionConstraint(new mxPoint(0.25, 1), true), new mxConnectionConstraint(new mxPoint(0.5, 1), true), new mxConnectionConstraint(new mxPoint(0.75, 1), true), new mxConnectionConstraint(new mxPoint(1, 1), true), new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, Math.min(h - 0.5 * dy, 1.5 * dy)), new mxConnectionConstraint(new mxPoint(0, 0), false, null, 0, Math.min(h - 0.5 * dy, 3.5 * dy))];
    if (h > 5 * dy) {
