...
Actions.prototype.init = function () {
  ...
  this.put('smartFit', new Action(mxResources.get('fitWindow') + ' / ' + mxResources.get('resetView'), function () {
    ...
    if (Math.abs(scale - graph.view.scale) < 0.00001 && Math.abs(sx - graph.container.scrollLeft) < thresh && Math.abs(sy - graph.container.scrollTop) < thresh && tx == graph.view.translate.x && ty == graph.view.translate.y) {
