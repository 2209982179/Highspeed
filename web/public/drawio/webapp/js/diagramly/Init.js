...
window.RT_WEBSOCKET_URL = window.RT_WEBSOCKET_URL || 'wss://' + (window.location.hostname == 'test.draw.io' ? 'app.diagrams.net' : window.location.hostname) + '/rt';
...
if (window.mxLanguages == null) {
  ...
  if (window.mxLanguage == null && (window.location.hostname == 'test.draw.io' || window.location.hostname == 'www.draw.io' || window.location.hostname == 'viewer.diagrams.net' || window.location.hostname == 'embed.diagrams.net' || window.location.hostname == 'app.diagrams.net' || window.location.hostname == 'jgraph.github.io')) {
...
window.uiTheme = window.uiTheme || function () {
  ...
  try {
    if (ui == null && urlParams['embed'] != '1' && (urlParams['dev'] == 1 || urlParams['test'] == 1 || window.location.hostname === 'test.draw.io' || window.location.hostname === 'www.draw.io' || window.location.hostname === 'preprod.diagrams.net' || window.location.hostname === 'app.diagrams.net' || window.location.hostname === 'jgraph.github.io')) {
      var iw = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth;
      var userAgent = navigator.userAgent || navigator.vendor || window.opera;
      if (iw <= 1024 || /android/i.test(userAgent) || /iPad|iPhone|iPod/.test(userAgent) && !window.MSStream || navigator.userAgent.match(/Mac/) && navigator.maxTouchPoints && navigator.maxTouchPoints > 2) {
        ui = 'simple';
      }
    }
  } catch (e) {
  ...
  if (ui == 'sketch' && urlParams['sketch'] == null && window.location.hostname === 'ac.draw.io') {
    urlParams['sketch'] = '1';
