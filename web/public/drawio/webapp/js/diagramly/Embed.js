...
(function (stylesheet, stencils) {
  ...
  try {
    ...
    style.type = 'text/css';
    style.innerHTML = ['div.mxTooltip {', '-webkit-box-shadow: 3px 3px 12px #C0C0C0;', '-moz-box-shadow: 3px 3px 12px #C0C0C0;', 'box-shadow: 3px 3px 12px #C0C0C0;', 'background: #FFFFCC;', 'border-style: solid;', 'border-width: 1px;', 'border-color: black;', 'font-family: Arial;', 'font-size: 8pt;', 'position: absolute;', 'cursor: default;', 'padding: 4px;', 'color: black;}'].join('\n');
    ...
    function initGraph(container) {
      try {
        ...
        if (xmlDocument.documentElement != null && xmlDocument.documentElement.nodeName == 'mxGraphModel') {
          ...
          if (container.style.width != '100%' && fit != '1' && resize != '0' || container.style.width == '' && container.style.height == '') {
          ...
          if (links != '0' || tooltips != '0') {
            ...
            graph.addMouseListener({
              currentState: null,
              currentLink: null,
              highlight: hl != null && hl != '' && hl != mxConstants.NONE ? new mxCellHighlight(graph, hl, 2) : null,
              startX: 0,
              startY: 0,
