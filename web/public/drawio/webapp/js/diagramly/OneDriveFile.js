  ...
  if (this.meta.parentReference != null) {
    try {
      ...
      if (this.meta.parentReference.driveType == 'personal') {
        url = 'https://onedrive.live.com/?cid=' + encodeURIComponent(this.meta.parentReference.driveId) + '&id=' + encodeURIComponent(this.meta.id);
...
OneDriveFile.prototype.getIdOf = function (itemObj, parent) {
  ...
  return (itemObj.parentReference != null && itemObj.parentReference.driveId != null ? itemObj.parentReference.driveId + '/' : '') + (parent != null ? itemObj.parentReference.id : itemObj.id + (itemObj.folder && itemObj.folder.isRoot ? '/root' : ''));
};
...
OneDriveFile.prototype.getChannelKey = function () {
  if (typeof CryptoJS !== 'undefined') {
    return CryptoJS.MD5(this.meta.createdDateTime + (this.meta.createdBy != null && this.meta.createdBy.user != null ? this.meta.createdBy.user.id : '')).toString();
  }
  return null;
};
    ...
    if (this.getTitle() == title) {
      var doSave = mxUtils.bind(this, function () {
        try {
          ...
          var etag = !overwrite && this.constructor == OneDriveFile && (DrawioFile.SYNC == 'manual' || DrawioFile.SYNC == 'auto') ? this.getCurrentEtag() : null;
