...
(function () {
   ...
   * Specifies if custom properties should be enabled.
   */
  Editor.enableServiceWorker = urlParams['pwa'] != '0' && 'serviceWorker' in navigator && (urlParams['offline'] == '1' || /.*\.diagrams\.net$/.test(window.location.hostname) || /.*\.draw\.io$/.test(window.location.hostname));
    ...
    if (f.substring(0, 8) == '%PDF-1.7') {
      ...
      if (blockStart > -1) {
        ...
        if (fileInfo.indexOf('application#2Fvnd.jgraph.mxfile') > 0) {
          ...
          return pako.inflateRaw(Graph.stringToArrayBuffer(f.substring(streamStart, streamEnd)), {
            to: 'string'
          });
        }
      }
  ...
  if (urlParams['save-dialog'] == '0') {
    Editor.prototype.diagramFileTypes.push({
      description: 'diagramXmlDesc',
      extension: 'xml',
      mimeType: 'text/xml'
    });
  ...
  Editor.prototype.isCorsEnabledForUrl = function (url) {
    ...
    return this.corsRegExp != null && this.corsRegExp.test(url) || url.substring(0, 34) === 'https://raw.githubusercontent.com/' || url.substring(0, 29) === 'https://fonts.googleapis.com/' || url.substring(0, 26) === 'https://fonts.gstatic.com/';
  };
        ...
        mxUtils.get(url, mxUtils.bind(this, function (req) {
          if (req.getStatus() >= 200 && req.getStatus() <= 299) {
            ...
            if (req.getStatus() == 0) {
              ...
              error({
                message: this.getErrorMessage(req)
              }, req);
            }
          }
        }), function (req) {
  ...
  Editor.prototype.exportToCanvas = function (callback, width, imageCache, background, error, limitHeight, ignoreSelection, scale, transparentBackground, addShadow, converter, graph, border, noCrop, grid, theme, exportType, cells) {
    try {
      ...
      this.convertImages(graph.getSvg(null, null, border, noCrop, null, ignoreSelection, null, null, null, addShadow, null, theme, exportType, cells), mxUtils.bind(this, function (svgRoot) {
        try {
          var img = new Image();
  ...
  if (window.StyleFormatPanel != null) {
    ...
    StyleFormatPanel.prototype.addStyles = function (div) {
      if (this.defaultColorSchemes != null) {
        ...
        var stylenames = ['plain-gray', 'plain-blue', 'plain-green', 'plain-turquoise', 'plain-orange', 'plain-yellow', 'plain-red', 'plain-pink', 'plain-purple', 'gray', 'blue', 'green', 'turquoise', 'orange', 'yellow', 'red', 'pink', 'purple'];
        ...
        left.style.cssText = 'position:absolute;left:10px;top:8px;bottom:' + bottom + 'px;width:20px;margin:4px;opacity:0.5;' + 'background-repeat:no-repeat;background-position:center center;background-image:url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAwAAAAQBAMAAADQT4M0AAAAIVBMVEUAAAB2dnZ4eHh3d3d1dXVxcXF2dnZ2dnZ2dnZxcXF2dnYmb3w1AAAACnRSTlMAfCTkhhvb7cQSPH2JPgAAADRJREFUCNdjwACMAmBKaiGYs2oJmLPKAZ3DabU8AMRTXpUKopislqFyVzCAuUZgikkBZjoAcMYLnp53P/UAAAAASUVORK5CYII=);';
    ...
    if (image != null && image.src != null && Graph.isPageLink(image.originalSrc)) {
      try {
        ...
        if (svg != null) {
          ...
          image = new mxImage(Editor.createSvgDataUri(mxUtils.getXml(doc.documentElement)), image.width, image.height, image.x, image.y);
        }
      } catch (e) {
        // ignore
      }
  ...
  Graph.prototype.getSvg = function (background, scale, border, nocrop, crisp, ignoreSelection, showText, imgExport, linkTarget, hasShadow, incExtFonts, theme, exportType, cells, noCssClass) {
    var temp = null;
    var tempFg = null;
    var tempBg = null;
    if (!Editor.enableCssDarkMode && this.themes != null && theme != null && theme == 'dark' != (this.defaultThemeName == 'darkTheme')) {
  ...
  mxGraphView.prototype.validateBackgroundPage = function () {
    ...
    if (mxClient.IS_GC && this.getDrawPane() != null) {
      ...
      } else if (this.webKitForceRepaintNode != null && (!this.graph.mathEnabled || this.graph.container.firstChild.nodeName != 'svg' && this.graph.container.firstChild != this.webKitForceRepaintNode)) {
  ...
  PrintDialog.prototype.create = function (editorUi, titleText) {
    ...
    function preview(print) {
        ...
        if (pv == null) {
          ...
          pv.writeHead = function (doc) {
            ...
            for (var i = 0; i < extFonts.length; i++) {
              ...
              if (Graph.isCssFontUrl(fontUrl)) {
                doc.writeln('<link rel="stylesheet" href="' + mxUtils.htmlEntities(Graph.rewriteGoogleFontUrl(fontUrl)) + '" charset="UTF-8" type="text/css">');
              } else {
                doc.writeln('<style type="text/css">');
          ...
          if (Editor.enableCssDarkMode) {
            ...
            pv.getBackgroundImage = function () {
              return graph.adaptBackgroundPage(printGetBackgroundImage.apply(this, arguments));
            };
          }
          if (typeof MathJax !== 'undefined') {
      ...
      if (EditorUi.isElectronApp) {
        PrintDialog.electronPrint(editorUi, allPagesRadio.checked, pagesFrom, pagesTo, fitRadio.checked, sheetsAcrossInput.value, sheetsDownInput.value, parseInt(zoomInput.value) / 100, parseInt(pageScaleInput.value) / 100, accessor.get());
        return;
      }
      if (ignorePages) {
