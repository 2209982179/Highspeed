            ...
            return this.buildOauthPromise(e).then(function (e) {
              ...
              if ("success" === e.type) {
                ...
                var s = {
                  ...
                  u = void 0;
                if (!t.needAPICall() || i && "rps" === t.accessToken.toLowerCase()) u = v.Promise.resolve(s);else {
      ...
      !function (e, t, r, a, u, s, l, d, c, p, i, f) {
        ...
        function T(e, t) {
          ...
          e[m] ? function (e) {
            ...
            var r, i, n;
            var o;
            if (e.switchAccount) t = f.appendQueryString(t, "prompt", "select_account");else if (e.loginHint) {
        ...
        function b(e, t) {
          if (e.state) {
            ...
            2 !== r.length && s.throwError(new p.default(l.default.badResponse, "received bad state parameter from Oauth endpoint, state received: " + e.state)).exposeToPublic();
            var i = r[0];
            t ? t.send(w + JSON.stringify(e), i) : s.throwError(new p.default(l.default.popupOpen, "opener is not defined")).exposeToPublic();
                  ...
                  if (e.origin === t[0] + "//" + t[2]) {
                    ...
                    if (0 === i.indexOf(m) && e.source === r.getReceiver()) {
                      var n = JSON.parse(i.substring(m.length)),
                        ...
                        a = n.conversationId,
                        s = n.type;
                      if (o === d.id) if ("initialize" === s) r.send("[OneDrive-ToPicker]" + JSON.stringify({
                        pickerId: o,
                        conversationId: a,
                        type: "activate"
                      }), e.origin);else {
      ...
      r = this, i = function () {
        ...
        function q(e, t) {
          ...
          if (r(t)) {
            ...
            if (0 === this.length) U(this.promise, this._result);else {
        ...
        q.prototype._eachEntry = function (t, e) {
          ...
          if (i === m) {
            var n = b(t);
            if (n === v && t._state !== _) this._settledAt(t._state, e, t._result);else if ("function" != typeof n) {
              this._remaining--;
              this._result[e] = t;
            } else if (r === L) {
              var o = new r(y);
