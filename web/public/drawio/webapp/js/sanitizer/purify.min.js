  ...
  var V = function t() {
    ...
    const mt = function (e) {
      ...
      At = function (e, t, n) {
        ...
        if (be && !_e[t] && E(ue, t)) ;else if (Ne && E(me, t)) ;else if (!Te[t] || _e[t]) {
      ...
      Nt = function (e) {
        ...
        for (; r--;) {
          ...
          if (At(p, s, f)) {
            if (!Ie || "id" !== s && "name" !== s || (pt(a, e), f = Me + f), Q && "object" == typeof G && "function" == typeof G.getAttributeType) if (l) ;else switch (G.getAttributeType(p, s)) {
              case "TrustedHTML":
                f = Q.createHTML(f);
                break;
    ...
    return o.sanitize = function (e) {
      ...
      } else if (e instanceof N) n = dt("\x3c!----\x3e"), r = n.ownerDocument.importNode(e, !0), 1 === r.nodeType && "BODY" === r.nodeName || "HTML" === r.nodeName ? n = r : n.appendChild(r);else {
