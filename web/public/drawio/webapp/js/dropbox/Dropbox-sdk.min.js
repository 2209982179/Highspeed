...
!function (e, t) {
  ...
  return function (e) {
    ...
    (function (t, n) {
      ...
      */
      !function (t, r) {
        ...
        function T(e, t, r) {
          t.constructor === e.constructor && r === d && t.constructor.resolve === _ ? w(e, t) : r === ae ? (E(e, ae.error), ae.error = null) : void 0 === r ? A(e, t) : i(r) ? q(e, t, r) : A(e, t);
        }
        function x(t, r) {
        ...
        function R(e) {
          var t = e._subscribers,
            r = e._state;
          if (0 !== t.length) {
            for (var n = void 0, i = void 0, s = e._result, o = 0; o < t.length; o += 3) n = t[o], i = t[o + r], n ? S(r, n, i, s) : i(s);
        ...
        function S(e, t, r, n) {
          var s = i(r),
            ...
            c = void 0;
          if (s) {
            if (o = P(r, n), o === ce ? (c = !0, u = o.error, o.error = null) : a = !0, t === o) return void E(t, v());
          } else o = n, a = !0;
        ...
        function F(e, t) {
          this._instanceConstructor = e, this.promise = new e(m), this.promise[ie] || U(this.promise), J(t) ? (this.length = t.length, this._remaining = t.length, this._result = new Array(this.length), 0 === this.length ? A(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(t), 0 === this._remaining && A(this.promise, this._result))) : E(this.promise, M());
        }
        function M() {
        ...
        function z(e) {
          this[ie] = O(), this._result = this._state = void 0, this._subscribers = [], m !== e && ("function" != typeof e && H(), this instanceof z ? D(this, e) : B());
        }
        function N() {
          var e = void 0;
        ...
        return F.prototype._enumerate = function (e) {
          ...
          if (n === _) {
            var i = g(e);
            if (i === d && e._state !== se) this._settledAt(e._state, t, e._result);else if ("function" != typeof i) this._remaining--, this._result[t] = e;else if (r === z) {
              var s = new r(m);
          ...
          var n = this.promise;
          n._state === se && (this._remaining--, e === ue ? E(n, r) : this._result[t] = r), 0 === this._remaining && A(n, this._result);
        ...
        }, z.all = j, z.race = G, z.resolve = _, z.reject = I, z._setScheduler = s, z._setAsap = o, z._asap = V, z.prototype = {
          constructor: z,
          then: d,
          catch: function (e) {
            return this.then(null, e);
          }
        }, z.polyfill = N, z.Promise = z, z;
      });
    }).call(t, r(8), function () {
      return this;
    }());
    ...
    function s(e, t, r) {
      if (null != r) {
        if (Array.isArray(r)) r.forEach(function (r) {
          s(e, t, r);
        });else if (_(r)) for (var n in r) s(e, t + "[" + n + "]", r[n]);else e.push(encodeURIComponent(t) + "=" + encodeURIComponent(r));
      } else null === r && e.push(encodeURIComponent(t));
    }
    function o(e) {
      for (var t, r, n = {}, i = e.split("&"), s = 0, o = i.length; s < o; ++s) t = i[s], r = t.indexOf("="), r == -1 ? n[decodeURIComponent(t)] = "" : n[decodeURIComponent(t.slice(0, r))] = decodeURIComponent(t.slice(r + 1));
      return n;
    }
    function u(e) {
      for (var t, r, n, i, s = e.split(/\r?\n/), o = {}, u = 0, a = s.length; u < a; ++u) r = s[u], t = r.indexOf(":"), t !== -1 && (n = r.slice(0, t).toLowerCase(), i = g(r.slice(t + 1)), o[n] = i);
      return o;
    }
    function a(e) {
    ...
    function p(e, t) {
      ...
      this._query = this._query || [], this.method = e, this.url = t, this.header = {}, this._header = {}, this.on("end", function () {
        ...
        try {
          ...
          return e = new Error("Parser is unable to parse the response"), e.parse = !0, e.original = t, r.xhr ? (e.rawResponse = "undefined" == typeof r.xhr.responseType ? r.xhr.responseText : r.xhr.response, e.status = r.xhr.status ? r.xhr.status : null, e.statusCode = e.status) : (e.rawResponse = null, e.status = null), r.callback(e);
        }
        r.emit("response", t);
        var n;
        try {
    ...
    v.serializeObject = i, v.parseString = o, v.types = {
      ...
      return this.req._parser ? this.req._parser(this, e) : (!t && a(this.type) && (t = v.parse["application/json"]), t && e && (e.length || e instanceof Object) ? t(e) : null);
      ...
      if (this._withCredentials && (t.withCredentials = !0), !this._formData && "GET" != this.method && "HEAD" != this.method && "string" != typeof r && !this._isHost(r)) {
        var i = this._header["content-type"],
          s = this._serializer || v.serialize[i ? i.split(";")[0] : ""];
      ...
      return this._responseType && (t.responseType = this._responseType), this.emit("request", this), t.send("undefined" != typeof r ? r : null), this;
    }, v.agent = function () {
      return new y();
    ...
    }), y.prototype.del = y.prototype.delete, v.get = function (e, t, r) {
      var n = v("GET", e);
      return "function" == typeof t && (r = t, t = null), t && n.query(t), r && n.end(r), n;
    }, v.head = function (e, t, r) {
      var n = v("HEAD", e);
      return "function" == typeof t && (r = t, t = null), t && n.query(t), r && n.end(r), n;
    }, v.options = function (e, t, r) {
      var n = v("OPTIONS", e);
      return "function" == typeof t && (r = t, t = null), t && n.send(t), r && n.end(r), n;
    }, v.del = l, v.delete = l, v.patch = function (e, t, r) {
      var n = v("PATCH", e);
      return "function" == typeof t && (r = t, t = null), t && n.send(t), r && n.end(r), n;
    }, v.post = function (e, t, r) {
      var n = v("POST", e);
      return "function" == typeof t && (r = t, t = null), t && n.send(t), r && n.end(r), n;
    ...
    var n,
      i = r(16);
    r(15), n = function (e) {
      e = e || {}, this.accessToken = e.accessToken, this.clientId = e.clientId, this.selectUser = e.selectUser;
    }, n.prototype.setAccessToken = function (e) {
      this.accessToken = e;
      ...
      var r,
        ...
        i = this.getClientId();
      if (!i) throw new Error("A client id is required. You can set the client id using .setClientId().");
      if (!e) throw new Error("A redirect uri is required.");
      return r = n + "?response_type=token&client_id=" + i, e && (r = r + "&redirect_uri=" + e), t && (r = r + "&state=" + t), r;
    }, n.prototype.authenticateWithCordova = function (e, t) {
      var r = "https://www.dropbox.com/1/oauth2/redirect_receiver",
        n = this.getAuthenticationUrl(r),
        ...
        u = function (r) {
          var n = "&error=",
            s = r.url.indexOf(n);
          if (s > -1) window.setTimeout(function () {
            i.close();
          }, 10), t();else {
            var o = "#access_token=",
              u = r.url.indexOf(o),
              a = r.url.indexOf("&token_type=");
            if (u > -1) {
              u += o.length, window.setTimeout(function () {
                i.close();
              }, 10);
        ...
        a = function (e) {
          s || (i.removeEventListener("loaderror", o), i.removeEventListener("loadstop", u), i.removeEventListener("exit", a), s = !0);
        };
      ...
      return void 0 === n.prototype.rpcRequest && (n.prototype.rpcRequest = r(18)), n.prototype.rpcRequest;
      ...
      return void 0 === n.prototype.uploadRequest && (n.prototype.uploadRequest = r(19)), n.prototype.uploadRequest;
    }, e.exports = n;
  }, function (e, t, r) {
    function n(e) {
      if (e) return i(e);
    ...
    n.prototype._shouldRetry = function (e, t) {
      ...
      if (t && s(this._data)) for (var n in e) this._data[n] = e[n];else "string" == typeof e ? (r || this.type("form"), r = this._header["content-type"], "application/x-www-form-urlencoded" == r ? this._data = this._data ? this._data + "&" + e : e : this._data = (this._data || "") + e) : this._data = e;
    ...
    o.parse["application/octect-stream"] = function (e) {
      ...
      var h = function (r, u) {
        ...
        function d(e, t) {
          var r;
          e ? f(n(e, t)) : (r = JSON.parse(t.headers["dropbox-api-result"]), t.xhr ? r.fileBlob = t.xhr.response : r.fileBinary = t.res.text, h(r));
        }
        var _;
        _ = o.post(a(i) + e).set("Authorization", "Bearer " + p).set("Dropbox-API-Arg", c(t)).on("request", function () {
          this.xhr && (this.xhr.responseType = "blob");
        }), l && (_ = _.set("Dropbox-API-Select-User", l)), "undefined" == typeof window ? _.buffer(!0).parse(s).end(d) : _.end(d);
      };
      return new u(h);
    }, e.exports = i;
  }, function (e, t, r) {
    ...
    n = function (e) {
      i.call(this, e);
    }, n.prototype = Object.create(i.prototype), n.prototype.constructor = n, n.prototype = Object.assign(n.prototype, s), n.prototype.filesGetSharedLinkFile = function (e) {
    ...
    "function" != typeof Object.assign && !function () {
      Object.assign = function (e) {
        ...
        for (t = Object(e), r = 1; r < arguments.length; r++) if (n = arguments[r], void 0 !== n && null !== n) for (i in n) n.hasOwnProperty(i) && (t[i] = n[i]);
        return t;
      };
    }();
  }, function (e, t) {
    ...
    var n = r(2),
      ...
      a = function (e, t, r, a, c, p) {
        ...
        var l = function (r, i) {
          ...
          var d,
            _ = t.contents;
          delete t.contents, d = n.post(s(a) + e).type("application/octet-stream").set("Authorization", "Bearer " + c).set("Dropbox-API-Arg", o(t)), p && (d = d.set("Dropbox-API-Select-User", p)), d.send(_).end(f);
        };
        return new i(l);
      };
    e.exports = a;
